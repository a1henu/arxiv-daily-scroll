...
**一句话要点**：提出SkyDreamer，基于模型强化学习的端到端视觉无人机竞速系统，实现高鲁棒性飞行。

**关键词**：无人机竞速, 端到端视觉, 模型强化学习, 仿真到真实转移, 机载执行, 状态估计

## 3 点简述
- 核心问题：现有自主无人机竞速系统缺乏端到端视觉方法，难以同时实现全仿真到真实转移、机载执行和冠军级性能。
- 方法要点：采用基于模型的强化学习，世界模型解码特权信息，作为隐式状态估计器，提升可解释性。
- 实验或效果：在真实世界实现高速飞行，最高速度21 m/s，加速度6 g，并展示对视觉模糊和电池消耗的鲁棒性。
