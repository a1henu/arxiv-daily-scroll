...
**关键词**：卫星图像理解, 光谱表示蒸馏, 视觉语言模型, 指令增强LLM, 零样本学习

## 3 点简述
- 问题：卫星图像多光谱数据冗余且与文本对齐弱，限制视觉语言模型在遥感中的应用。
- 方法：先蒸馏光谱表示到RGB学生模型，再与指令增强LLM进行光谱对齐。
- 效果：在EuroSAT等数据集上，零样本分类、检索和线性探测性能平均提升4.2%、5.9%和2.7%。
