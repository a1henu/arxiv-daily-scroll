...
**一句话要点**：提出LLMServingSim 2.0统一模拟器，以建模异构与解耦LLM服务基础设施中的运行时交互。

**关键词**：LLM服务模拟, 异构硬件建模, 解耦系统, 运行时交互, 性能分析, 系统级仿真

## 3 点简述
- 核心问题：现有模拟器无法统一建模异构硬件与解耦服务技术间的运行时交互，影响性能分析。
- 方法要点：嵌入服务决策与硬件行为到单一运行时循环，支持基于配置文件的扩展建模，捕获动态系统效应。
- 实验或效果：验证显示平均误差0.97%，模拟时间约10分钟，为硬件创新与服务设计提供实用桥梁。
