...
**一句话要点**：提出标签介导的弱监督视觉-语言建模方法，用于人脑显微图像的自然语言描述生成。

**关键词**：弱监督学习, 视觉-语言建模, 人脑显微图像, 细胞构筑学, 自然语言接口

## 3 点简述
- 核心问题：在细胞体染色人脑组织切片分析中，缺乏成对图像-文本数据以连接视觉与语言。
- 方法要点：通过标签自动挖掘文献描述作为合成标题，训练现有视觉基础模型与大型语言模型耦合。
- 实验或效果：在57个脑区生成合理描述，支持开放集拒绝，准确率达90.6%匹配参考标签。
