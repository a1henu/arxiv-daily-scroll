...
**关键词**：贝叶斯更新, 粒子流滤波, 物理信息神经网络, 无监督学习, 高维非线性估计

## 3 点简述
- 核心问题：高维非线性贝叶斯更新计算复杂，现有方法常忽略有限时域概率传输的几何结构或产生刚性微分方程
- 方法要点：结合对数同伦轨迹与连续性方程推导主PDE，嵌入损失函数训练神经网络近似传输速度场，实现无监督学习
- 实验或效果：在基准测试中展示更好的模态覆盖和鲁棒性，降低在线计算复杂度
