...
**一句话要点**：提出基于随机八卦通信的去中心化排名聚合算法，以解决分布式网络中的Borda和Copeland共识计算问题。

**关键词**：去中心化计算, 排名聚合, 八卦算法, Borda规则, Copeland规则, 共识机制

## 3 点简述
- 核心问题：在去中心化网络中，如何可靠计算排名聚合共识，避免集中式数据收集。
- 方法要点：利用随机八卦算法，通过局部交互实现Borda、Copeland等规则的全局共识，无需中央协调。
- 实验或效果：在多种网络拓扑和数据集上验证快速收敛，并提供理论收敛保证和速率界限。
