...
**一句话要点**：在齐次神经网络中推导出随机梯度下降的泛化界，支持更慢步长衰减

**关键词**：泛化界, 随机梯度下降, 齐次神经网络, 步长衰减, 非凸优化, 算法稳定性

## 3 点简述
- 核心问题：传统泛化分析需步长η_t=O(1/t)，可能阻碍优化且不实用
- 方法要点：在齐次神经网络下，证明步长可衰减为Ω(1/√t)，扩展至非Lipschitz情形
- 实验或效果：理论结果广泛适用，涵盖全连接和卷积网络及ReLU/LeakyReLU激活
