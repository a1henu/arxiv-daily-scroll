...
**一句话要点**：提出半监督多模态域泛化框架，以少量标签实现跨域鲁棒性

**关键词**：多模态学习, 域泛化, 半监督学习, 伪标签生成, 跨模态对齐, 缺失模态鲁棒性

## 3 点简述
- 核心问题：现有方法无法同时处理多模态、域偏移和半监督学习，导致数据效率低和泛化能力差
- 方法要点：通过共识驱动一致性正则化、分歧感知正则化和跨模态原型对齐，提升模型鲁棒性和数据利用率
- 实验或效果：在标准与缺失模态场景下，新方法在基准测试中均优于基线，并开源了代码和数据集
