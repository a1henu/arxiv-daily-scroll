...
**关键词**：多智能体强化学习, 值分解方法, Q值高估缓解, 动作相似性加权, 学习稳定性提升

## 3 点简述
- 核心问题：值分解方法在MARL中因联合动作空间组合爆炸导致Q值系统性高估，影响学习稳定性。
- 方法要点：基于动作相似性重构TD目标，对近贪婪联合动作空间进行加权期望，平滑目标以缓解高估。
- 实验或效果：QSIM可无缝集成多种值分解方法，实验显示其提升性能与稳定性，并显著减轻高估现象。
