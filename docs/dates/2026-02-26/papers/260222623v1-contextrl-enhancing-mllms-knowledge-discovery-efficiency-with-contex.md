...
**关键词**：上下文增强强化学习, 多模态大语言模型, 知识发现效率, 奖励黑客缓解, 多轮采样策略, 过程验证

## 3 点简述
- 核心问题：多模态大语言模型在强化学习训练中面临可识别性和可达性瓶颈，导致知识发现效率低和奖励黑客问题
- 方法要点：引入上下文增强，为奖励模型提供完整参考解决方案以提升可识别性，并采用多轮采样策略生成错误报告以改善可达性
- 实验或效果：在11个感知和推理基准上显著提升性能，使Qwen3-VL-8B模型达到与32B模型相当水平，有效缓解奖励黑客
