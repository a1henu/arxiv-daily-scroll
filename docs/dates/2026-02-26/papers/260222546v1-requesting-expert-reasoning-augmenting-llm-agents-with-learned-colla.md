...
## 3 点简述
- 核心问题：LLM代理在专业领域因训练数据中缺乏长尾知识而表现不佳，人类专家指导虽可用但非结构化且不可靠。
- 方法要点：引入AHCE框架，通过Human Feedback Module学习策略，将人类专家视为交互式推理工具进行按需协作。
- 实验或效果：在Minecraft实验中，任务成功率在普通难度任务上提高32%，高难度任务上提高近70%，且人类干预最小。
