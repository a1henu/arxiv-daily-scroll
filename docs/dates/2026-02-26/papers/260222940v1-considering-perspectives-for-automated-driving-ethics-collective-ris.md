...
**arXiv**：[2602.22940v1](https://arxiv.org/abs/2602.22940) · [PDF](https://arxiv.org/pdf/2602.22940.pdf)  
**作者**：Leon Tolksdorf, Arturo Tejada, Christian Birkner, Nathan van de Wouw  

**一句话要点**：提出多视角风险最小化运动规划策略以提升自动驾驶伦理决策

**关键词**：自动驾驶伦理, 运动规划, 风险最小化, 集体风险, 多视角决策, 交通安全性

## 3 点简述
- 核心问题：现有自动驾驶运动规划仅从自身视角最小化风险，未考虑其他道路使用者的风险视角，可能导致伦理问题。
- 方法要点：设计支持在所有道路使用者视角间切换风险最小化策略的运动规划方法，以平衡集体风险。
- 实验或效果：发现集体风险最小化策略能降低整体交通风险，提升自动驾驶效率，并符合人类驾驶行为。
