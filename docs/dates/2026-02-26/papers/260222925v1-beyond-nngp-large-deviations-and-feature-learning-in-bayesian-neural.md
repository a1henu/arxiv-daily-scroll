...
**一句话要点**：提出基于大偏差理论的变分目标，以超越高斯过程极限，研究宽贝叶斯神经网络的后验集中与特征学习。

**关键词**：贝叶斯神经网络, 大偏差理论, 特征学习, 后验集中, 变分优化, 核选择

## 3 点简述
- 核心问题：宽贝叶斯神经网络中，超越高斯过程极限的罕见但统计主导的波动如何影响后验集中。
- 方法要点：利用大偏差理论，在预测器层面定义变分目标（率函数），通过联合优化预测器和内部核来捕捉特征学习。
- 实验或效果：数值实验表明，该方法能准确描述中等规模网络的有限宽度行为，包括非高斯尾部、后验变形和数据依赖核选择效应。
