...
**一句话要点**：提出SettleFL协议以解决无许可区块链上联邦学习的去中心化奖励结算成本与可扩展性问题

**关键词**：联邦学习, 区块链奖励结算, 可扩展协议, 去中心化系统, 成本优化

## 3 点简述
- 核心问题：无许可区块链的高成本与联邦学习高频迭代训练冲突，现有方案牺牲去中心化或可扩展性
- 方法要点：基于共享电路架构，提供乐观执行与争议仲裁或每轮有效性证明两种可互操作策略，灵活适应延迟与成本约束
- 实验或效果：结合真实联邦学习负载与模拟实验，在800参与者规模下保持实用，显著降低gas成本
