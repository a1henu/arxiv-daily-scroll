...
**一句话要点**：提出SettleFL协议以解决无许可区块链上联邦学习的去中心化奖励结算成本高和可扩展性差问题

**关键词**：联邦学习, 区块链奖励结算, 可扩展协议, 去中心化系统, 乐观执行, 有效性证明

## 3 点简述
- 核心问题：无许可区块链成本高与联邦学习高频迭代训练冲突，现有方案牺牲去中心化或可扩展性
- 方法要点：基于共享电路架构，提供乐观执行和有效性证明两种可互操作策略，灵活适应延迟与成本约束
