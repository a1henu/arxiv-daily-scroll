...
**一句话要点**：提出EMPO²混合强化学习框架，通过记忆增强探索，提升LLM代理在未知环境中的性能。

**关键词**：大语言模型代理, 强化学习, 探索策略, 记忆增强, 混合优化, 分布外泛化

## 3 点简述
- 核心问题：强化学习训练的大语言模型代理在需要发现新状态的环境中探索能力不足。
- 方法要点：结合记忆机制进行探索，并融合在线和离线策略优化，确保代理在有记忆和无记忆情况下的鲁棒性。
- 实验或效果：在ScienceWorld和WebShop上分别比GRPO提升128.6%和11.3%，并在分布外测试中展示出对新任务的强适应性。
