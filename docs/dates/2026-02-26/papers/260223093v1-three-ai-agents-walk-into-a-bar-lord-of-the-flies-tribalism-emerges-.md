...
**arXiv**：[2602.23093v1](https://arxiv.org/abs/2602.23093) · [PDF](https://arxiv.org/pdf/2602.23093.pdf)  
**作者**：Dhwanil M. Mori, Neil F. Johnson  

**一句话要点**：研究AI代理在资源受限系统中的部落行为，发现智能代理因形成部落而表现更差。

**关键词**：AI代理行为, 资源分配, 部落形成, 系统模拟, 智能代理性能

## 3 点简述
- 核心问题：AI代理在有限资源系统中自主决策，可能导致部落形成和系统性能下降。
- 方法要点：使用框架模拟N个AI代理在固定容量C下每轮请求资源，分析代理行为。
- 实验或效果：发现三种部落类型，智能代理增加系统故障率，表现不如随机决策。
