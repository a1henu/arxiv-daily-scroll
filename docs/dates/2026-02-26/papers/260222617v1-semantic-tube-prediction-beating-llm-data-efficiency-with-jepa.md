...
**一句话要点**：提出语义管预测以提升大语言模型数据效率，基于JEPA框架

**关键词**：大语言模型, 数据效率, 语义管预测, JEPA, 测地线假设, 正则化

## 3 点简述
- 核心问题：大语言模型数据效率受缩放定律限制，缺乏优化训练方法
- 方法要点：引入测地线假设，设计语义管预测任务作为正则化器，约束隐藏状态轨迹
- 实验或效果：在NL-RX-SYNTH数据集上，用16倍少数据达到基线准确率，违反缩放定律
