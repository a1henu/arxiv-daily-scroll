...
**关键词**：长时记忆评估, 智能体应用, 因果图, 工具增强检索, 合成轨迹, 基准测试

## 3 点简述
- 现有评估标准与实际应用脱节，缺乏对智能体-环境交互的连续流评估。
- AMA-Bench包含真实和合成轨迹，结合专家和规则QA，全面测试长时记忆。
- AMA-Agent引入因果图和工具增强检索，在AMA-Bench上准确率达57.22%，超越基线11.16%。
