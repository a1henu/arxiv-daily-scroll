...
**一句话要点**：提出基于认知模型与AI算法的模板，以设计模块化语言智能体。

**关键词**：语言智能体, 模块化设计, 认知模型, AI算法, 可解释性

## 3 点简述
- 核心问题：单个大语言模型难以处理复杂任务，需组合多个模型但设计方法不明确。
- 方法要点：形式化智能体模板，从认知模型和AI算法中提取设计蓝图，指导模块化组合。
- 实验或效果：综述现有语言智能体，展示其模板源自认知科学和AI，促进可解释性开发。
