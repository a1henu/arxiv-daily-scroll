...
**关键词**：差分隐私联邦学习, 隐私异质性, 客户端选择, 凸优化, 收敛分析, 隐私预算

## 3 点简述
- 核心问题：现有差分隐私联邦学习假设统一隐私预算，忽略实际中隐私需求异质性，影响模型训练效果。
- 方法要点：基于收敛分析理论，将隐私感知客户端选择建模为凸优化问题，自适应调整选择概率以最小化训练误差。
- 实验或效果：在基准数据集上实验，相比基线方法，在CIFAR-10上测试准确率提升最高达10%。
