...
**一句话要点**：提出ParamMem参数化记忆模块，通过编码跨样本反思模式增强语言代理的反思多样性。

**关键词**：语言代理, 参数化记忆, 反思多样性, 温度采样, 跨样本学习, 自我改进

## 3 点简述
- 核心问题：语言代理自我反思常产生重复输出，限制推理性能，需提升反思多样性。
- 方法要点：引入参数化记忆模块，编码跨样本反思模式，支持温度控制采样生成多样反思。
- 实验或效果：在代码生成、数学推理和多跳问答任务中优于基线，支持样本高效和弱到强迁移。
