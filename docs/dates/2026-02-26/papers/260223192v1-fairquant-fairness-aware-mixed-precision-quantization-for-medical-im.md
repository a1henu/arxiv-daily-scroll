...
**一句话要点**：提出FairQuant框架，通过混合精度量化优化医学图像分类的公平性

**关键词**：医学图像分类, 混合精度量化, 算法公平性, 位感知量化, 神经网络压缩

## 3 点简述
- 核心问题：现有量化方法未考虑算法公平性，可能影响医疗模型在不同群体间的性能
- 方法要点：结合组感知重要性分析、预算混合精度分配和可学习位感知量化模式，联合优化权重与位分配
- 实验或效果：在Fitzpatrick17k和ISIC2019数据集上，4-6位平均精度恢复大部分8位精度，并改善最差群体性能
