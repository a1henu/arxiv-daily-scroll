...
**一句话要点**：提出双耦合PnP扩散与谱同质化方法，解决医学图像重建中的稳态偏差与幻觉权衡问题。

**关键词**：医学图像重建, 扩散模型, PnP框架, ADMM优化, 谱同质化, 稳态偏差

## 3 点简述
- 核心问题：现有PnP扩散求解器因无记忆更新导致稳态偏差，无法严格满足物理测量。
- 方法要点：引入双变量耦合提供积分反馈，结合谱同质化调制结构化残差为伪AWGN输入。
