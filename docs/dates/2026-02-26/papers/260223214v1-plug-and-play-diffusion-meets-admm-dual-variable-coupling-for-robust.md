...
**一句话要点**：提出双耦合PnP扩散与谱均匀化方法，解决医学图像重建中的稳态偏差与幻觉权衡问题。

**关键词**：医学图像重建, 扩散模型, 即插即用先验, ADMM优化, 谱均匀化, 稳态偏差

## 3 点简述
- 核心问题：现有PnP扩散求解器因无记忆更新导致稳态偏差，且严格优化引入结构化伪影违反扩散先验假设。
- 方法要点：引入双变量耦合提供积分反馈保证收敛，并设计谱均匀化机制调制残差为伪AWGN输入。
- 实验或效果：在CT和MRI重建中实现高保真度与加速收敛，解决偏差-幻觉权衡。
