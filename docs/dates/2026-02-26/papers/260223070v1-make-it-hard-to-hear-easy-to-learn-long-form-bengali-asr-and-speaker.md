...
**一句话要点**：提出极端增强与完美对齐方法，解决孟加拉语长音频ASR与说话人日志化的资源稀缺问题。

**关键词**：孟加拉语语音识别, 说话人日志化, 长音频处理, 数据增强, 低资源语音处理, 实时因子优化

## 3 点简述
- 核心问题：孟加拉语长音频ASR与说话人日志化资源严重不足，现有模型性能不佳。
- 方法要点：ASR采用完美对齐标注与合成声学退化微调；说话人日志化依赖启发式后处理优化基线输出。
- 实验或效果：构建882小时数据集，优化双管道实现约0.019实时因子，为低资源长音频处理提供基准。
