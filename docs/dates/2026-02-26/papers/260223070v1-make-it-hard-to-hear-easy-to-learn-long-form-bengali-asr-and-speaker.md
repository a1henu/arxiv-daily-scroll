...
**关键词**：孟加拉语语音识别, 说话人日志, 长音频处理, 数据增强, 低资源语音, 后处理优化

## 3 点简述
- 核心问题：孟加拉语长音频ASR与说话人日志资源匮乏，现有模型在复杂数据上表现不佳。
- 方法要点：ASR采用完美对齐标注与合成声学退化微调；说话人日志依赖启发式后处理优化基线输出。
- 实验或效果：构建882小时多说话人数据集，双管道实现约0.019实时因子，为低资源长音频处理提供基准。
