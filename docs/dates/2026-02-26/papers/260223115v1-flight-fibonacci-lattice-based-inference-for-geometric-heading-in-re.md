...
**一句话要点**：提出基于斐波那契格点的单位球面霍夫变换方法，用于实时估计相机航向

**关键词**：相机航向估计, 霍夫变换, 斐波那契格点, 单位球面, 实时计算, SLAM

## 3 点简述
- 核心问题：单目视频中相机航向估计在噪声和异常值增加时精度下降或计算成本高
- 方法要点：利用对应关系生成大圆，通过斐波那契格点离散化单位球面进行投票
- 实验或效果：在三个数据集上实现精度与效率的帕累托前沿，SLAM实验中通过航向校正降低RMSE
