...
**关键词**：广义规划, 转移模型学习, 样本效率, 分布外泛化, 神经网络规划, 状态预测

## 3 点简述
- 核心问题：现有Transformer规划器依赖大数据集，在长视野任务中易受状态漂移影响，泛化能力有限
- 方法要点：通过神经网络显式学习转移模型，自回归预测中间状态，而非直接预测动作序列
- 实验或效果：在多个领域，该方法以更少训练实例和更小模型，实现更高的分布外满意规划成功率
