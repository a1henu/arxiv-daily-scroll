...
**arXiv**：[2602.22998v1](https://arxiv.org/abs/2602.22998) · [PDF](https://arxiv.org/pdf/2602.22998.pdf)  
**作者**：Ryan Paul McKennaa, John Oyekan  

**一句话要点**：综述可变形物体操纵的开放挑战，聚焦感知、建模与控制进展

**关键词**：可变形物体操纵, 多模态感知, 物理强化学习, 可微模拟, 仿真到现实迁移

## 3 点简述
- 核心问题：可变形物体无限维度和动态形状变化，导致感知、建模与控制困难
- 方法要点：整合多模态感知系统，如多摄像头和触觉传感，以处理遮挡和提升适应性
- 实验或效果：探索物理强化学习和可微模拟，提高效率、精度和可扩展性
