...
**arXiv**：[2602.22527v1](https://arxiv.org/abs/2602.22527) · [PDF](https://arxiv.org/pdf/2602.22527.pdf)  
**作者**：Ying Zhu, Ruthuparna Naikar  

**一句话要点**：提出机器学习方法预测职业网球选手一发方向，以分析发球决策策略。

**关键词**：网球发球预测, 机器学习, 特征工程, 混合策略, 决策分析, 体育数据分析

## 3 点简述
- 核心问题：职业网球中发球方向预测对发球方和接发方决策至关重要，需理解选手策略。
- 方法要点：通过特征工程开发机器学习模型，预测选手一发方向，支持混合策略分析。
- 实验或效果：模型平均预测准确率男性约49%、女性约44%，表明疲劳和上下文信息影响决策。
