...
**一句话要点**：提出LeRobot开源库以整合机器人学习全栈，降低研究与应用门槛。

**关键词**：机器人学习, 开源库, 端到端学习, 数据集管理, 可扩展算法, 异步推理

## 3 点简述
- 核心问题：机器人学习领域因工具碎片化与闭源而发展缓慢。
- 方法要点：集成从底层电机控制到大规模数据集处理的端到端机器人学习栈。
- 实验或效果：支持可访问硬件平台与多种先进算法，强调可扩展学习。
