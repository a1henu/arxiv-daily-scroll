...
**关键词**：无人机图像, 小目标检测, 端到端检测, 频率特征增强, 多尺度建模, 边缘计算

## 3 点简述
- 核心问题：无人机图像中小目标检测面临尺度变化、密集分布和主导性难题。
- 方法要点：集成LSKNet骨干网络优化感受野，结合DAttention和AIFI模块建模多尺度关系，引入DynFreq-C3模块增强频率特征。
- 实验或效果：相比RT-DETR-L，在检测性能和计算效率上均有显著优势，适用于无人机边缘计算。
