...
**关键词**：多模态智能体, 长时程工具使用, 现实视觉场景, 基准评估, 跨模态交互, 工具调用

## 3 点简述
- 现有基准未充分捕捉现实性、视觉细节和长时程工具使用，限制了多模态智能体评估
- AgentVista涵盖7类25子领域，结合真实视觉场景与混合工具使用，要求跨模态长时程交互
- 评估显示顶尖模型在长时程多模态工具使用上存在显著差距，最佳模型准确率仅27.3%
