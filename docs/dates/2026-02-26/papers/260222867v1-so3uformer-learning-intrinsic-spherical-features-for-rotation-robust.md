...
**关键词**：全景语义分割, 旋转鲁棒性, 球面Transformer, 内在特征学习, 几何编码

## 3 点简述
- 核心问题：全景分割模型依赖重力对齐假设，相机旋转导致性能下降
- 方法要点：通过去绝对纬度编码、球面注意力机制和局部几何编码学习内在球面特征
- 实验或效果：在Pose35数据集上达到72.03 mIoU，全SO(3)旋转下保持70.67 mIoU
