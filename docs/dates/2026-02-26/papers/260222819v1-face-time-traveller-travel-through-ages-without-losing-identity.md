...
**关键词**：人脸年龄变换, 扩散模型, 身份保留, 自适应注意力控制, 免调优映射

## 3 点简述
- 核心问题：现有方法在宽年龄变换中身份保留不足，且扩散模型存在静态注意力和优化繁重问题。
- 方法要点：引入Face-Attribute-Aware Prompt Refinement编码内外老化线索，Adaptive Attention Control动态平衡注意力，Angular Inversion实现免调优映射。
