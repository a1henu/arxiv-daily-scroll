...
**一句话要点**：提出GIFSplat以解决稀疏视图下前馈3D高斯溅射的性能与效率平衡问题

**关键词**：3D高斯溅射, 稀疏视图重建, 前馈迭代细化, 生成先验蒸馏, 秒级推理, 无姿态优化

## 3 点简述
- 核心问题：现有前馈方法在稀疏视图下性能受限，引入生成先验后难以保持秒级推理时间。
- 方法要点：采用纯前馈迭代细化框架，通过残差更新逐步优化3D场景，并蒸馏扩散先验为高斯级线索。
- 实验或效果：在多个数据集上优于现有方法，PSNR提升达+2.1 dB，保持秒级推理时间，无需相机姿态或测试时梯度优化。
