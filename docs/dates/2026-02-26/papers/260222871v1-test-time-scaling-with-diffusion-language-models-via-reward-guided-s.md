...
**一句话要点**：提出基于奖励引导拼接的扩散语言模型测试时扩展方法，以提升推理任务性能

**关键词**：扩散语言模型, 推理聚合, 过程奖励模型, 测试时扩展, 数学推理

## 3 点简述
- 核心问题：现有聚合策略丢弃部分正确推理轨迹中的有用中间步骤
- 方法要点：通过扩散模型采样、过程奖励模型评分、跨轨迹拼接高质量步骤构建复合推理链
- 实验效果：在数学推理基准上实现最高23.8%准确率提升和1.8倍延迟降低
