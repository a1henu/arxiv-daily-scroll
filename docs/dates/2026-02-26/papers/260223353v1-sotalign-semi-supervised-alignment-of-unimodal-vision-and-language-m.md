...
**一句话要点**：提出SOTAlign框架，通过最优传输在半监督场景下对齐预训练视觉与语言模型

**关键词**：半监督对齐, 最优传输, 视觉语言模型, 预训练模型, 多模态学习

## 3 点简述
- 核心问题：如何用少量配对数据和大量未配对数据对齐预训练单模态模型，减少监督依赖
- 方法要点：两阶段框架，先用线性教师从配对数据恢复粗略共享几何，再基于最优传输在未配对数据上精炼对齐
