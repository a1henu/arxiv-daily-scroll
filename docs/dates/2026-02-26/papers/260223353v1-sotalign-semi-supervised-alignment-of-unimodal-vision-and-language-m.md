...
**关键词**：多模态对齐, 半监督学习, 最优传输, 预训练模型, 图像-文本嵌入

## 3 点简述
- 核心问题：如何用少量配对数据和大量未配对数据对齐预训练单模态编码器，减少监督依赖
- 方法要点：两阶段框架，先用线性教师从配对数据恢复粗略共享几何，再基于最优传输散度在未配对数据上精炼对齐
- 实验或效果：有效利用未配对图像和文本，学习鲁棒联合嵌入，显著优于监督和半监督基线
