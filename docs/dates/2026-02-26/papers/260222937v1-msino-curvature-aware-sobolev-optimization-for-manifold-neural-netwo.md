...
**关键词**：黎曼流形优化, Sobolev训练, 曲率感知学习, 神经网络训练, 几何深度学习, 机器人学应用

## 3 点简述
- 核心问题：在黎曼流形上训练神经网络时，标准欧几里得导数监督可能导致梯度对齐和稳定性问题。
- 方法要点：使用协变Sobolev损失替代欧几里得导数，结合平行传输和Laplace Beltrami正则化，提升训练稳定性。
- 实验或效果：在表面成像、物理信息学习和机器人学（如SO(3)、SE(3)）等应用中，提供曲率感知的收敛保证。
