...
**一句话要点**：提出多智能体LLM情感去毒系统MALLET，通过个性化强度控制保护消费者免受过度情感刺激。

**关键词**：情感去毒, 多智能体系统, 个性化强度控制, 消费者保护, 语义保持, 情感分析

## 3 点简述
- 核心问题：注意力经济中煽情内容导致消费者情感过载，影响冷静决策。
- 方法要点：使用四智能体系统分析情感强度、调整文本、监控平衡并提供个性化指导。
- 实验或效果：在AG News数据集上实现刺激分数显著降低，语义保持独立可控，类别间效果差异明显。
