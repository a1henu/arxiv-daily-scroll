...
**一句话要点**：提出接口感知轨迹重建算法，以解决辅助机器人因低维接口限制导致演示轨迹次优的问题。

**关键词**：轨迹重建, 接口限制, 辅助机器人, 机器人学习, 演示学习

## 3 点简述
- 核心问题：低维接口控制高自由度机器人时，演示轨迹受接口限制，无法反映用户真实意图。
- 方法要点：基于任务、环境和接口约束，重建轨迹以提升到机器人完整控制空间。
- 实验或效果：在真实世界ADL任务中，重建轨迹比接口受限轨迹更快、更高效，同时尊重用户偏好。
