...
**arXiv**：[2602.23023v1](https://arxiv.org/abs/2602.23023) · [PDF](https://arxiv.org/pdf/2602.23023.pdf)  
**作者**：Alexandra Carpentier, Nicolas Verzelen  

**一句话要点**：提出低度多项式下界以解决中等维度聚类中的计算极限问题

**关键词**：聚类分析, 高斯混合模型, 计算复杂度, 低度多项式, 中等维度, 非参数率

## 3 点简述
- 研究高斯混合聚类中均值向量最小距离Δ对部分恢复的影响
- 建立中等维度（n≥dK且d≥K）下的低度多项式下界，揭示非参数率现象
- 提出匹配该下界的新非谱算法，阐明计算难度
