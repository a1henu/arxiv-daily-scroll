...
**一句话要点**：提出CC-BOS框架，利用古文优化黑盒越狱提示以增强攻击效果

**关键词**：大语言模型安全, 越狱攻击, 古文对抗提示, 果蝇优化算法, 黑盒攻击

## 3 点简述
- 研究古文在LLM越狱攻击中的作用，因其简洁隐晦可部分绕过安全约束
- 基于果蝇优化算法，自动生成古文对抗提示，编码为八个策略维度并迭代优化
- 实验表明CC-BOS在黑盒设置下优于现有越狱攻击方法，并设计翻译模块提升评估
