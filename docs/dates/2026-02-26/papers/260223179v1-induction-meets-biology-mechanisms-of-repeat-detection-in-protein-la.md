...
**关键词**：蛋白质语言模型, 重复序列检测, 内部机制分析, 掩码预测, 生物信息学, 注意力机制

## 3 点简述
- 核心问题：蛋白质序列中的精确和近似重复检测机制未知，影响结构功能理解
- 方法要点：通过掩码预测分析，发现近似重复机制包含精确重复，涉及位置注意和氨基酸相似性编码
- 实验或效果：识别两阶段机制：特征表示构建和诱导头对齐，展示模型结合语言与生物知识的能力
