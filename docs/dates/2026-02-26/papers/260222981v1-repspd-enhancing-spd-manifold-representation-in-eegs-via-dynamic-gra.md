...
**一句话要点**：提出RepSPD模型，通过动态图增强EEG中SPD流形表示以提升脑活动解码性能

**关键词**：脑电图解码, 黎曼流形学习, 动态图神经网络, 对称正定矩阵, 几何深度学习, 功能连接分析

## 3 点简述
- 核心问题：现有基于SPD的EEG方法忽视频率特异性同步和脑区局部拓扑结构，导致表示不充分
- 方法要点：在黎曼流形上使用交叉注意力机制，结合图功能连接特征调制SPD几何属性，并引入全局双向对齐策略减少几何失真
- 实验或效果：实验表明RepSPD显著优于现有EEG表示方法，具有更强的鲁棒性和泛化能力
