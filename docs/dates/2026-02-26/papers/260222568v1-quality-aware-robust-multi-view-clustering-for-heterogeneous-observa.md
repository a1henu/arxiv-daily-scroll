...
**一句话要点**：提出质量感知鲁棒多视图聚类框架以解决异构观测噪声问题

**关键词**：多视图聚类, 异构噪声, 信息瓶颈, 质量感知, 鲁棒学习, 对比学习

## 3 点简述
- 核心问题：现有方法假设噪声为二元分布，忽略现实应用中噪声强度连续变化的异构性。
- 方法要点：利用信息瓶颈提取语义，通过重建差异量化噪声强度，设计质量加权对比和融合策略。
- 实验或效果：在五个基准数据集上优于现有方法，尤其在异构噪声强度场景中表现突出。
