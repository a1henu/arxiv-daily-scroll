...
**arXiv**：[2602.23335v1](https://arxiv.org/abs/2602.23335) · [PDF](https://arxiv.org/pdf/2602.23335.pdf)  
...
**一句话要点**：提出Asta交互数据集以分析AI科研工具在真实场景中的使用模式与用户行为

**关键词**：AI科研工具, 用户交互分析, 检索增强生成, 查询模式, 数据集发布, 真实世界评估

## 3 点简述
- 核心问题：AI科研工具在真实研究环境中的使用模式与用户行为缺乏清晰洞察
- 方法要点：收集并分析来自LLM增强检索生成平台的两个工具的大规模交互日志，包含超过20万用户查询
- 实验或效果：发现用户提交更长更复杂的查询，将系统视为协作伙伴，并随经验增加更深入使用引用
