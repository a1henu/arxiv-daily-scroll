...
**arXiv**：[2602.22533v1](https://arxiv.org/abs/2602.22533) · [PDF](https://arxiv.org/pdf/2602.22533.pdf)  
**作者**：Yonghui Li, Wansuo Duan, Hao Li, Wei Han, Han Zhang, Yinuo Li  

**一句话要点**：提出基于正交条件非线性最优扰动的AI优化集合预报系统，以解决热带气旋预报中计算效率与动态一致性的平衡问题。

**关键词**：热带气旋预报, 集合预报系统, 正交条件非线性最优扰动, AI天气预测, 动态一致性, FuXi模型

## 3 点简述
- 核心问题：AI天气预报中计算效率与动态一致性难以兼顾，传统集合受限于计算成本，AI集合扰动方法不足。
- 方法要点：使用正交条件非线性最优扰动生成动态优化扰动，捕捉FuXi模型快速增长误差，保持物理合理性。
- 实验或效果：在热带气旋路径预报中，确定性及概率性技能优于业务集成预报系统集合预报系统。
