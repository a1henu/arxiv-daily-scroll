...
**关键词**：多光谱成像, 土壤质地分类, USDA纹理三角形, 回归模型, 机器学习框架, 现场部署

## 3 点简述
- 核心问题：土壤质地传统检测方法缓慢、劳动密集，现有传感技术成本高或分辨率不足，难以现场部署。
- 方法要点：使用低成本多光谱成像设备（365-940 nm，13个波段）捕获土壤光谱特性，结合回归模型估计黏土、粉土和砂土百分比，并通过分类器直接预测USDA质地类别。
