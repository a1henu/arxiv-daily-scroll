...
**关键词**：代理人工智能, 意图驱动优化, 无小区O-RAN, 参数高效微调, 深度强化学习, 多代理协作

## 3 点简述
- 核心问题：现有O-RAN代理AI研究多处理简单意图，缺乏对需多代理协调的复杂意图的探索。
- 方法要点：设计多代理框架，包括监督代理翻译意图、用户权重代理确定优先级、O-RU管理代理节能决策，并采用参数高效微调提升可扩展性。
- 实验或效果：仿真显示，在节能模式下，框架相比基线方案减少41.93%的活跃O-RU，参数高效微调降低92%内存使用。
