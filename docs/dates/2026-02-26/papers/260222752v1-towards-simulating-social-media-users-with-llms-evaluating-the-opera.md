...
**一句话要点**：提出条件评论预测任务以评估大语言模型在社交媒体用户行为模拟中的操作有效性

**关键词**：条件评论预测, 社交媒体模拟, 操作有效性评估, 监督微调, 低资源语言, 用户行为建模

## 3 点简述
- 核心问题：大语言模型作为社会科学中主动硅基主体的操作有效性缺乏广泛验证
- 方法要点：通过条件评论预测任务，比较生成输出与真实数字痕迹来评估模型能力
