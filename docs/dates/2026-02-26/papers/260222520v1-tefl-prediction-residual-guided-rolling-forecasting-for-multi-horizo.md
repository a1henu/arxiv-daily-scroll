...
**一句话要点**：提出TEFL框架，通过历史预测残差反馈提升多步时间序列预测精度

**关键词**：时间序列预测, 残差反馈学习, 多步预测, 滚动预测, 低秩适配器

## 3 点简述
- 核心问题：现有深度预测模型未充分利用滚动预测中的历史残差信息
- 方法要点：设计轻量级低秩适配器整合可观测多步残差，采用两阶段联合训练
- 实验效果：在10个真实数据集上平均降低MAE 5-10%，分布偏移场景提升显著
