...
**一句话要点**：提出基于超网络的框架，通过隐式神经表示实现网格无关的函数数据聚类

**关键词**：函数数据聚类, 超网络, 隐式神经表示, 网格无关表示, 高维数据, 鲁棒聚类

## 3 点简述
- 核心问题：现有函数聚类方法依赖采样网格，导致聚类结果受分辨率或预处理影响。
- 方法要点：使用超网络编码坐标-值对，映射到隐式神经表示的权重空间，实现网格无关的紧凑表示。
