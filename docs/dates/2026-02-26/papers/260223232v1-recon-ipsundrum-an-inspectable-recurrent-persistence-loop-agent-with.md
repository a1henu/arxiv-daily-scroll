...
**arXiv**：[2602.23232v1](https://arxiv.org/abs/2602.23232) · [PDF](https://arxiv.org/pdf/2602.23232.pdf)  
**作者**：Aishik Sanyal  

**一句话要点**：提出ReCoN-Ipsundrum可检查代理，通过循环持久性环路和情感耦合控制，在无奖励探索中实现偏好稳定和结构化行为。

**关键词**：机器意识, 循环神经网络, 情感耦合控制, 行为稳定性, 因果干预, 可检查代理

## 3 点简述
- 核心问题：基于指标的机器意识方法需机制关联证据，结合架构检查和因果干预。
- 方法要点：扩展ReCoN状态机，添加循环持久性环路和可选情感代理，操作化Humphrey的qualiaphilia为熟悉度控制的路由选择。
- 实验或效果：情感耦合变体在探索中显示结构化扫描和持久谨慎，病变实验揭示循环与持久性、情感与行为稳定的关联。
