...
**关键词**：量化感知训练, 低比特语言模型, 参数解耦, 线性层量化, 模型压缩, 边缘部署

## 3 点简述
- 核心问题：现有极低比特量化方法存在参数民主化效应，导致参数敏感性同质化，限制模型表达能力
- 方法要点：将线性层解耦为1比特主导分支和高精度分支，通过特征缩放引导敏感参数分配至高精度分支
- 实验或效果：在极低比特量化中实现最先进性能，支持高效容量扩展
