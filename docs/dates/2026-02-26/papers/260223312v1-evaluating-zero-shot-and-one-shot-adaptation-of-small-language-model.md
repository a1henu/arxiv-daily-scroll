...
**关键词**：小语言模型, 人机交互, 角色分类, 零样本适应, 微调策略, 边缘计算

## 3 点简述
- 研究小语言模型在人机交互中实时角色分类的可行性，以解决资源受限机器人的部署挑战。
- 通过提示工程和微调策略，在零样本和单样本模式下评估模型，使用Qwen2.5-0.5B进行实验。
- 零样本微调达到86.66%准确率和22.2毫秒延迟，优于基线，但单样本模式性能下降，揭示对话复杂度与分类可靠性的权衡。
