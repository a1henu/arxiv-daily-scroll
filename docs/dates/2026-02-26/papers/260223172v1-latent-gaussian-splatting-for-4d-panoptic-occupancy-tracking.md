...
**一句话要点**：提出LaGS方法，通过潜在高斯泼溅实现4D全景占用跟踪，以提升动态环境中机器人场景理解。

**关键词**：4D场景理解, 全景占用跟踪, 潜在高斯泼溅, 多视图融合, 机器人感知, 时空建模

## 3 点简述
- 核心问题：现有方法在动态环境中仅提供粗略几何跟踪或缺乏时间关联的详细3D结构，难以实现4D时空场景理解。
- 方法要点：结合相机端到端跟踪与基于掩码的多视图全景占用预测，利用潜在高斯泼溅高效聚合多视图信息到3D体素网格。
