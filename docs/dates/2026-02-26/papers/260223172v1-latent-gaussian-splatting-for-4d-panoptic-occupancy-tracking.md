...
**关键词**：4D全景占用跟踪, 潜在高斯泼溅, 多视图融合, 时空场景理解, 体素网格解码

## 3 点简述
- 核心问题：现有方法在动态环境中仅提供粗略几何跟踪或缺乏时间关联的详细3D结构，无法实现高效时空场景理解。
- 方法要点：采用潜在高斯泼溅，将多视图信息融合为稀疏点中心潜在表示，再泼溅到3D体素网格进行基于掩码的分割解码。
- 实验或效果：在Occ3D nuScenes和Waymo数据集上评估，实现了4D全景占用跟踪的最先进性能。
