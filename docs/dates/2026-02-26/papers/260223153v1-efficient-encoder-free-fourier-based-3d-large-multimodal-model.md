...
**关键词**：3D大模型, 点云处理, 傅里叶变换, 无编码器架构, 高效计算, 全局上下文建模

## 3 点简述
- 核心问题：3D大模型依赖重型编码器提取几何特征，导致效率低下，难以处理无序大规模点云。
- 方法要点：结合点云序列化和快速傅里叶变换，设计新型分词器，实现高效全局上下文建模和基于图的令牌合并。
- 实验或效果：性能媲美编码器基3D大模型，计算和参数效率显著提升，项目网站已公开。
