...
**一句话要点**：提出L-HAKT框架，通过双智能体对齐和双曲空间建模，解决知识追踪中认知状态层次演化与个性化难度感知不足的问题。

**关键词**：知识追踪, 大型语言模型, 双曲空间, 对比学习, 层次建模, 教育数据

## 3 点简述
- 核心问题：现有知识追踪方法难以捕捉认知状态的层次演化和个性化问题难度感知，因语义建模有限。
- 方法要点：使用教师智能体解析问题语义构建知识点层次依赖，学生智能体模拟学习行为生成合成数据，在双曲空间进行对比学习对齐特征分布。
