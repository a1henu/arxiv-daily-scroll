...
**关键词**：机器人装配, 仿真到现实迁移, 强化学习, 残差策略, 视觉观察, 稀疏奖励

## 3 点简述
- 核心问题：机器人装配因仿真到现实差距导致策略性能下降，而真实世界强化学习依赖人工监督且泛化能力差。
- 方法要点：使用仿真训练的基础策略提供先验行为，结合真实世界学习的残差策略补偿动态和传感器噪声差异。
- 实验或效果：在真实世界实验中，SPARR在多样装配任务中实现接近完美的成功率，相比零样本方法提升38.4%，减少29.7%周期时间。
