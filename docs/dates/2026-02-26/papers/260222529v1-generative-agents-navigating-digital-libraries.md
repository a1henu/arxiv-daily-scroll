...
**arXiv**：[2602.22529v1](https://arxiv.org/abs/2602.22529) · [PDF](https://arxiv.org/pdf/2602.22529.pdf)  
**作者**：Saber Zerhoudi, Michael Granitzer  

**一句话要点**：提出Agent4DL模拟器以解决数字图书馆用户搜索行为数据稀缺问题

**关键词**：数字图书馆, 用户行为模拟, 大语言模型, 搜索策略, 隐私保护

## 3 点简述
- 核心问题：数字图书馆研究因隐私问题缺乏公开用户搜索模式数据集
- 方法要点：基于大语言模型生成逼真用户档案和动态搜索会话，模拟查询、点击和停止行为
- 实验或效果：通过与真实用户数据比较验证准确性，相比SimIIR 2.0能生成更多样化和上下文感知的行为
