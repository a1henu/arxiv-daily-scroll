...
**关键词**：全身移动操作, 意图驱动感知, 结构化协调, 跨模态对齐, 控制解耦, 机器人感知

## 3 点简述
- 核心问题：全身移动操作中基座与机械臂动作强耦合导致控制优化困难，以及移动时视角变化导致感知注意力分配不佳
- 方法要点：InCoM推断潜在运动意图以动态重加权多尺度感知特征，并引入几何-语义结构化对齐机制增强跨模态对应
- 实验或效果：在ManiSkill-HAB三个场景中，InCoM在无特权感知信息下，成功率比现有方法提升23.6%至28.2%
