...
**一句话要点**：提出多智能体模仿学习理论分析，在线性马尔可夫博弈中降低样本复杂度并实现高效交互算法。

**关键词**：多智能体模仿学习, 线性马尔可夫博弈, 特征近似, 交互式学习, 样本复杂度, 深度算法

## 3 点简述
- 核心问题：分析多智能体模仿学习在线性马尔可夫博弈中的理论性能，解决样本复杂度高的问题。
- 方法要点：利用特征线性结构，将状态-动作级集中系数替换为特征级系数，降低样本需求；提出交互式算法，样本复杂度仅依赖特征维度。
- 实验或效果：在Tic-Tac-Toe和Connect4游戏中，深度交互算法明显优于行为克隆。
