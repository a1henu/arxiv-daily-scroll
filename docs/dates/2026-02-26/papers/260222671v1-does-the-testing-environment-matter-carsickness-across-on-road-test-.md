...
**arXiv**：[2602.22671v1](https://arxiv.org/abs/2602.22671) · [PDF](https://arxiv.org/pdf/2602.22671.pdf)  
**作者**：Georgios Papaioannou, Barys Shyrokau  

**一句话要点**：比较道路、测试场和驾驶模拟器中的晕车现象，揭示模拟器因低频运动限制导致晕车评分较低

**关键词**：晕车研究, 驾驶模拟器, 运动病评估, 多环境比较, 低频运动, 自动化车辆

## 3 点简述
- 核心问题：晕车研究缺乏标准化，难以跨环境比较，特别是多环境对比存在空白
- 方法要点：在运动驾驶模拟器中复现道路晕车暴露，结合主观报告和客观测量评估晕车
- 实验或效果：模拟器晕车评分显著低于道路和测试场，归因于其低频运动再现能力有限
