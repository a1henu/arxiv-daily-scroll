...
**arXiv**：[2602.23303v1](https://arxiv.org/abs/2602.23303) · [PDF](https://arxiv.org/pdf/2602.23303.pdf)  
**作者**：Ilya Balabin, Thomas M. Kaiser  

**一句话要点**：提出因果机制理论框架以解决化学生物学中机器学习因果结构缺失问题

**关键词**：因果机器学习, 化学生物学, 机制建模, 焦点概念, 理论框架, Akt抑制剂

## 3 点简述
- 核心问题：机器学习在自然科学中常被视为黑箱，缺乏对数据因果结构的深入考量
- 方法要点：结合化学、生物、概率和因果理论，引入焦点概念以揭示隐藏机制
- 实验或效果：在Akt抑制剂家族上提供初步原理验证，后续论文将扩展理论和实验
