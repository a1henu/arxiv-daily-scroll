...
**一句话要点**：揭示二语汉语韵律习得中边界数量趋同但结构映射分化的非线性模式

**关键词**：二语习得, 韵律-句法接口, C-ToBI标注, 依存语法, 韵律边界, 越南学习者

## 3 点简述
- 研究二语学习者如何将习得的句法映射到韵律结构，聚焦于韵律-句法接口的石化与稳定性问题
- 结合C-ToBI边界标注与依存语法分析，量化韵律边界数量并评估其与句法关系的映射准确性
- 实验发现高熟练度学习者在主要短语层面边界数量趋同，但在主谓和动宾接口的结构映射显著偏离母语模式
