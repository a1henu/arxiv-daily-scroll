...
**一句话要点**：提出层次化组策略优化以解决长视野智能体任务中的上下文不一致问题

**关键词**：强化学习, 长视野任务, 策略优化, 上下文一致性, 智能体学习, 优势估计

## 3 点简述
- 核心问题：基于组的强化学习在逐步策略优化中，因组内步骤历史上下文不一致导致优势估计偏差
- 方法要点：通过将步骤分配到多个层次化组，基于上下文一致性计算并自适应聚合优势，优化偏差-方差权衡
- 实验或效果：在ALFWorld和WebShop任务上，使用Qwen2.5模型，HGPO显著优于现有方法，无需额外模型或轨迹
