...
**一句话要点**：提出ArtPro框架，通过自适应整合运动提议，解决自监督铰接物体重建中初始分割敏感性问题。

**关键词**：铰接物体重建, 自监督学习, 运动提议整合, 3D高斯泼溅, 碰撞感知剪枝, 数字孪生

## 3 点简述
- 核心问题：现有自监督方法对初始分割高度敏感，易陷入局部最优，影响复杂多部件物体重建。
- 方法要点：基于几何特征和运动先验初始化过分割，动态合并提议，并采用碰撞感知运动剪枝机制。
