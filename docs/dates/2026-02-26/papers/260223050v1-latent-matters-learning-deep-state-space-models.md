...
**一句话要点**：提出约束优化框架和扩展卡尔曼VAE以提升深度状态空间模型的动态学习能力

**关键词**：深度状态空间模型, 约束优化, 扩展卡尔曼滤波, 变分自编码器, 系统识别, 动态学习

## 3 点简述
- 核心问题：传统证据下界训练无法确保深度状态空间模型学习真实动态
- 方法要点：引入约束优化框架，结合扩展卡尔曼滤波与变分自编码器
- 实验或效果：在系统识别和预测精度上优于现有模型，实现特征解耦
