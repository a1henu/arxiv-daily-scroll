...
**一句话要点**：提出DIR-TIR框架，通过对话迭代优化解决交互式文本到图像检索问题

**关键词**：文本到图像检索, 对话系统, 迭代精炼, 视觉语义对齐, 交互式检索

## 3 点简述
- 核心问题：传统单查询方法在交互式文本到图像检索中缺乏可控性和容错性
- 方法要点：结合对话精炼和图像精炼模块，通过多轮对话逐步提取信息并减少视觉语义差异
- 实验或效果：在多个数据集上显著超越仅使用初始描述的基线，提高检索精度和交互体验
