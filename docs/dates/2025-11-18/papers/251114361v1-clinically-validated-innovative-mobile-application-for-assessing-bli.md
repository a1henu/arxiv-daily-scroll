...
**arXiv**：[2511.14361v1](https://arxiv.org/abs/2511.14361) · [PDF](https://arxiv.org/pdf/2511.14361.pdf)  
...
**一句话要点**：提出移动应用Bapp以解决眼睑运动客观评估的临床挑战

**关键词**：眼睑运动分析, 移动健康应用, 实时计算机视觉, 临床验证, 眨眼检测

## 3 点简述
- 核心问题：眼睑运动客观评估复杂、昂贵且临床适用性有限。
- 方法要点：使用Flutter框架和Google ML Kit实现实时设备端分析。
- 实验或效果：基于45个患者视频验证，精度98.4%，召回96.9%，准确率98.3%。
