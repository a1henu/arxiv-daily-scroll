...
**一句话要点**：综述人工与自然系统中的地点识别机制，以促进自主系统创新

**关键词**：地点识别, 自主系统, 生物导航, 拓扑映射, 线索整合, 空间认知

## 3 点简述
- 核心问题：地点识别在生物导航和自主系统中的关键作用及环境变异性挑战
- 方法要点：整合机器人、动物和人类研究，探讨拓扑映射、线索整合和记忆管理策略
- 实验或效果：未知具体实验，但提出统一概念以应对泛化性和鲁棒性问题
