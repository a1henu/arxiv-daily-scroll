...
**arXiv**：[2511.14327v1](https://arxiv.org/abs/2511.14327) · [PDF](https://arxiv.org/pdf/2511.14327.pdf)  
**作者**：Felipe Ballen-Moreno, Pasquale Ferrentino, Milan Amighi, Bram Vanderborght, Tom Verstraten  

**一句话要点**：提出双变量力表征方法以解决可穿戴机器人交互中多自由度力响应建模问题

**关键词**：可穿戴机器人, 力表征方法, 人机交互, 软组织建模, 多自由度分析

## 3 点简述
- 核心问题：可穿戴机器人交互涉及多自由度，现有单变量方法适用性受限
- 方法要点：引入法向和切向力双变量表征，识别材料参数并评估单变量拟合影响
- 实验或效果：分析归一化均方误差，验证双变量方法对力和扭矩响应的改进
