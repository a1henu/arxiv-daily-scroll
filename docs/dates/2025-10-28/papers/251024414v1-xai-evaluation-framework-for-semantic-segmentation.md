...
**arXiv**：[2510.24414v1](https://arxiv.org/abs/2510.24414) · [PDF](https://arxiv.org/pdf/2510.24414.pdf)  
**作者**：Reem Hammoud, Abdul karim Gizzini, Ali J. Ghandour  

**一句话要点**：提出语义分割XAI评估框架以解决空间与上下文复杂性评估不足问题

**关键词**：可解释AI, 语义分割, 评估框架, 像素级评估, 类激活映射
