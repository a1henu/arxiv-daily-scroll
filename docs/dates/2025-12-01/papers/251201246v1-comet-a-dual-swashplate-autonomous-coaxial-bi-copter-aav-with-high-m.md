...
**arXiv**：[2512.01246v1](https://arxiv.org/abs/2512.01246) · [PDF](https://arxiv.org/pdf/2512.01246.pdf)  
**作者**：Shuai Wang, Xiaoming Tang, Junning Liang, Haowen Zheng, Biyu Ye, Zhaofeng Liu, Fei Gao, Ximin Lyu  

**一句话要点**：提出双倾斜盘同轴双旋翼无人机COMET，以解决效率、机动性与紧凑性平衡问题。

**关键词**：同轴双旋翼无人机, 双倾斜盘机制, 高机动性, 长续航, 轨迹跟踪, 自主飞行

## 3 点简述
- 核心问题：同轴双旋翼无人机在效率、机动性与紧凑性间难以平衡，限制实际应用。
- 方法要点：采用双倾斜盘机制优化系统，通过台架测试提升效率与紧凑性。
- 实验或效果：飞行续航与轨迹跟踪测试验证了效率、鲁棒性和机动性提升，支持自主飞行应用。
