...
**arXiv**：[2512.01977v1](https://arxiv.org/abs/2512.01977) · [PDF](https://arxiv.org/pdf/2512.01977.pdf)  
**作者**：William Xu, Amir Eskanlou, Mansur Arief, David Zhen Yin, Jef K. Caers  

**一句话要点**：提出基于部分可观测马尔可夫决策过程的AI驱动方法，以优化不确定性下的矿物处理操作。

**关键词**：矿物处理优化, 不确定性优化, 部分可观测马尔可夫决策过程, AI驱动方法, 浮选模拟

## 3 点简述
- 核心问题：矿物处理效率受原料变异性和过程动态复杂性带来的不确定性限制。
- 方法要点：将矿物处理建模为部分可观测马尔可夫决策过程，整合信息收集与过程优化。
- 实验或效果：在模拟浮选单元中展示优于传统方法，提升净现值等整体目标。
