...
**arXiv**：[2512.01419v1](https://arxiv.org/abs/2512.01419) · [PDF](https://arxiv.org/pdf/2512.01419.pdf)  
**作者**：Tushar Pranav, Eshan Pandey, Austria Lyka Diane Bala, Aman Chadha, Indriyati Atmosukarto, Donny Soh Cheng Lock  

**一句话要点**：提出RICE-VL基准以评估视觉语言模型在东盟国家的文化理解能力

**关键词**：视觉语言模型, 文化理解评估, 东盟国家, 视觉问答, 视觉定位, 多模态基准

## 3 点简述
- 视觉语言模型存在西方中心偏见，在东南亚等文化多样区域表现受限
- RICE-VL包含超过28,000个VQA样本和1,000个视觉定位对，由文化专家标注
- 评估显示模型在低资源国家和抽象文化领域存在显著性能差距
