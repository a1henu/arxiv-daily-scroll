...
**arXiv**：[2512.01205v1](https://arxiv.org/abs/2512.01205) · [PDF](https://arxiv.org/pdf/2512.01205.pdf)  
**作者**：Wen Zhao, Jiawen Ding, Xueting Huang, Yibo Zhang  

**一句话要点**：提出基于机器学习与SHAP分析的铣床预测性维护方法，应用于智能制造环境。

**关键词**：预测性维护, 机器学习, SHAP分析, 智能制造, 铣床故障预测

## 3 点简述
- 核心问题：在智能制造中，基于AI4I 2020数据集研究铣床设备的预测性维护。
- 方法要点：结合数据预处理、模型训练、评估、选择、SHAP分析和可视化，比较八种机器学习模型。
- 实验或效果：发现XGBoost和随机森林等集成学习方法性能优异，SHAP分析揭示温度、扭矩和转速是关键故障因素。
