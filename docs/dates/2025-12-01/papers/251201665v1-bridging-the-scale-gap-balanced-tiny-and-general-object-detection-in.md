...
**一句话要点**：提出ScaleBridge-Det以解决遥感图像中密集微小与大型物体平衡检测的尺度差异问题

**关键词**：遥感图像检测, 微小物体检测, 多尺度融合, 专家路由, 查询分配, 跨域鲁棒性

## 3 点简述
- 核心问题：遥感图像中物体尺度差异大且密度分布不均，现有方法难以平衡微小与大型物体的检测性能
- 方法要点：引入路由增强混合注意力模块动态融合多尺度专家特征，结合密度引导动态查询模块自适应分配检测资源
- 实验或效果：在AI-TOD-V2和DTOD数据集上达到最先进性能，并在VisDrone上展示优越的跨域鲁棒性
