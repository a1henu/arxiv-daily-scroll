...
**arXiv**：[2512.01681v1](https://arxiv.org/abs/2512.01681) · [PDF](https://arxiv.org/pdf/2512.01681.pdf)  
**作者**：Farzaneh Seyedshahi, Francesca Damiola, Sylvie Lantuejoul, Ke Yuan, John Le Quesne  

**一句话要点**：提出基于切除标本训练的自监督模型，用于多中心间皮瘤活检的跨域验证，以支持诊断和治疗规划。

**关键词**：自监督学习, 跨域验证, 间皮瘤活检, 形态学模式, 预后预测, 亚型分类

## 3 点简述
- 核心问题：间皮瘤中准确亚型分类和预后预测对治疗至关重要，但现有模型多基于大组织图像，难以应用于常见的小活检样本。
- 方法要点：使用切除组织训练的自监督编码器，捕获活检材料中的形态学模式，用于预测患者生存和分类肿瘤亚型。
- 实验或效果：模型在跨域验证中展示潜力，能支持AI驱动工具在间皮瘤诊断和治疗规划中的应用。
