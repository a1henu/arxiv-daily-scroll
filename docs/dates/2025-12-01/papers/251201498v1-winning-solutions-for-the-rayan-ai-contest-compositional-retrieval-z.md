...
**arXiv**：[2512.01498v1](https://arxiv.org/abs/2512.01498) · [PDF](https://arxiv.org/pdf/2512.01498.pdf)  
**作者**：Ali Nafisi, Sina Asghari, Mohammad Saeed Arvenaghi, Hossein Shakibania  

**一句话要点**：提出三种机器学习解决方案以应对图像检索、异常检测和模型安全挑战

**关键词**：组合图像检索, 零样本异常检测, 后门检测, 多模态学习, 模型安全

## 3 点简述
- 核心问题：解决组合图像检索、零样本异常检测和后门模型检测三大任务
- 方法要点：开发多模态检索系统、无异常样本的检测模型及后门触发识别方法
- 实验或效果：在竞赛中分别获得第一、第一和第二名，准确率最高达95.38%
