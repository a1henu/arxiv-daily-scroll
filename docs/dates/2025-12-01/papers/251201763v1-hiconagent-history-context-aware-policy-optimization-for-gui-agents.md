...
**一句话要点**：提出HiconAgent，通过历史上下文感知策略优化解决GUI代理中历史信息利用效率低的问题。

**关键词**：GUI代理, 历史上下文优化, 策略优化, 计算效率, 导航任务

## 3 点简述
- 核心问题：GUI代理使用完整历史导致计算开销大和无关信息干扰。
- 方法要点：采用动态上下文采样和锚点引导历史压缩，优化历史信息利用。
- 实验效果：在GUI-Odyssey基准上超越GUI-R1-7B，实现计算加速和FLOPs减少。
