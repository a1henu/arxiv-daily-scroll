...
**arXiv**：[2512.01171v1](https://arxiv.org/abs/2512.01171) · [PDF](https://arxiv.org/pdf/2512.01171.pdf)  
**作者**：Tao Xue, Yanwu Yang, Panyu Zhai  

**一句话要点**：综述在线广告转化率预测的建模技术、性能评估与未来方向

**关键词**：转化率预测, 在线广告, 文献综述, 性能评估, 未来方向

## 3 点简述
- 核心问题：转化率预测方法演进与关系不明确，影响广告决策效率。
- 方法要点：将现有模型分为六类，分析技术框架、优缺点及关联。
- 实验或效果：总结公开与专有数据集上的性能，指出评估结果不一致。
