...
**arXiv**：[2512.01262v1](https://arxiv.org/abs/2512.01262) · [PDF](https://arxiv.org/pdf/2512.01262.pdf)  
**作者**：Junfeng Wu, Xiangmin Zhou, Erica Kuligowski, Dhirendra Singh, Enrico Ronchi, Max Kinateder  

**一句话要点**：综述社交媒体数据挖掘技术以改进山火疏散行为研究

**关键词**：社交媒体数据挖掘, 山火疏散行为, 数据质量挑战, 应急管理, 文献综述, 行为分析

## 3 点简述
- 核心问题：传统山火疏散行为数据源存在局限，社交媒体数据虽丰富但分散、不完整，需克服挑战以提升应用价值。
- 方法要点：通过文献综述，总结相关数据挖掘技术进展，指导如何有效利用社交媒体数据。
- 实验或效果：未知具体实验，但讨论未来应用如疏散模型校准、应急通信和开放问题如数据质量、偏见等。
