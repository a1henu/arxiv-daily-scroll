...
**arXiv**：[2512.01523v1](https://arxiv.org/abs/2512.01523) · [PDF](https://arxiv.org/pdf/2512.01523.pdf)  
**作者**：Pankaj Jalore, Y. Raghu Reddy, Vasudeva Varma  

**一句话要点**：提出在线多机构协作教学模型，以解决软件工程高级课程师资不足问题，并融入行业参与。

**关键词**：在线教育, 多机构协作, 软件工程教学, 行业参与, 研究级课程

## 3 点简述
- 核心问题：单个机构在软件工程高级领域缺乏足够师资或学生，难以独立开设研究级课程。
- 方法要点：利用在线平台，联合多机构与行业专家，共同教授“AI在软件工程”课程。
- 实验或效果：通过实验报告分享教学经验，表明该模型适用于计算机科学应用领域的研究级课程。
