...
**一句话要点**：提出L2M-Calib单键校准方法，用于激光雷达与多磁传感器融合系统的外参和内参联合估计。

**关键词**：传感器融合, 外参校准, 磁传感器, 激光雷达, 多模态感知, 鲁棒优化

## 3 点简述
- 核心问题：磁传感器与激光雷达融合缺乏有效校准技术，影响多模态感知的准确性。
- 方法要点：采用迭代高斯-牛顿法优化外参，结合加权岭正则化总体最小二乘法校准内参，增强鲁棒性。
- 实验或效果：在模拟和真实AGV场景中验证，方法在各种环境条件下实现高精度和鲁棒校准。
