...
**arXiv**：[2511.06839v1](https://arxiv.org/abs/2511.06839) · [PDF](https://arxiv.org/pdf/2511.06839.pdf)  
**作者**：Selim Ahmet Iz, Mustafa Unel  

**一句话要点**：提出基于视觉的系统识别方法，以改进四旋翼建模与控制性能

**关键词**：四旋翼建模, 视觉系统识别, 灰箱建模, LQR控制, 机载视觉系统

## 3 点简述
- 核心问题：四旋翼建模中推力与阻力系数存在复杂性和不确定性
- 方法要点：采用灰箱建模和机载视觉系统进行系统识别，并设计LQR控制器
- 实验或效果：模型性能一致，验证了视觉系统识别的有效性
