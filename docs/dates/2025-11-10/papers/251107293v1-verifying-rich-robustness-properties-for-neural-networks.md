...
**一句话要点**：提出统一框架以验证神经网络鲁棒性变体，支持置信度考量。

**关键词**：神经网络验证, 鲁棒性规范, 置信度考量, 统一验证框架, 近似误差控制

## 3 点简述
- 核心问题：现有方法忽略神经网络输出置信度，且编码复杂，难以验证多种鲁棒性变体。
- 方法要点：使用简单语法定义规范，通过添加层统一验证，兼容现有工具并控制近似误差。
- 实验或效果：在8870个基准测试中验证，涵盖138M参数网络，性能优于直接编码方法。
