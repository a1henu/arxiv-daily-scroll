...
**一句话要点**：提出Ostrakon-VL模型、ShopBench基准和QUAD数据管道，以解决餐饮零售场景中多模态大语言模型的部署挑战。

**关键词**：多模态大语言模型, 餐饮零售场景, 数据管道, 基准测试, 参数效率

## 3 点简述
- 核心问题：餐饮零售场景数据噪声大且缺乏标准化评估，阻碍高质量模型训练与客观评估。
- 方法要点：基于Qwen3-VL-8B开发Ostrakon-VL模型，引入ShopBench基准和QUAD多阶段数据管道。
