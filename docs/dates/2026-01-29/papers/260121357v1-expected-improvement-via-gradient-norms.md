...
**一句话要点**：提出EI-GN以提升贝叶斯优化在昂贵黑盒函数中的采样效率

**关键词**：贝叶斯优化, 期望改进, 梯度增强模型, 黑盒函数优化, 控制策略学习

## 3 点简述
- 核心问题：标准期望改进(EI)在贝叶斯优化中过于利用性，易收敛至次优平稳点。
- 方法要点：EI-GN将改进原则应用于梯度感知辅助目标，促进在高性能且接近一阶平稳区域采样。
- 实验或效果：在标准基准测试中，EI-GN相比基线方法带来一致改进，并适用于控制策略学习问题。
