...
**arXiv**：[2601.21650v1](https://arxiv.org/abs/2601.21650) · [PDF](https://arxiv.org/pdf/2601.21650.pdf)  
**作者**：Alexander Erlei, Federico Cau, Radoslav Georgiev, Sagar Kumar, Kilian Bizer, Ujwal Gadiraju  

**一句话要点**：通过实验揭示信息不对称与披露设计对AI系统市场采纳的影响

**关键词**：信息不对称, AI市场采纳, 披露设计, 实验研究, 用户决策

## 3 点简述
- 核心问题：AI市场中买卖双方信息不对称导致用户可能依赖低质量系统，阻碍采纳。
- 方法要点：在模拟AI产品市场中系统变化低质量系统密度和披露深度，分析用户反应。
- 实验或效果：结果强调信息不对称的有害影响，但部分披露设计能提升决策效率。
