...
**关键词**：无监督学习, 扩散模型, 因子分解, 对抗训练, 组合生成, 机器人视频

## 3 点简述
- 核心问题：无监督学习复杂数据的因子化表示，以支持组件重用和新样本合成。
- 方法要点：引入判别器提供对抗训练信号，优化生成器以增强重组样本的物理和语义一致性。
- 实验或效果：在多个数据集上优于基线，FID、MIG和MCC指标更优，并应用于机器人视频轨迹生成。
