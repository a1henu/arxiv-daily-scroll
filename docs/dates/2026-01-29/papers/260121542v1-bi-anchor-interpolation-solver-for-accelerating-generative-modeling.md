...
**一句话要点**：提出双锚点插值求解器以加速流匹配生成模型，在低函数评估次数下保持高质量生成。

**关键词**：流匹配模型, 常微分方程求解, 生成模型加速, 轻量级网络, 插值求解器, 图像生成

## 3 点简述
- 核心问题：流匹配模型依赖迭代常微分方程求解，导致高延迟，现有方法在低函数评估次数下性能下降或训练成本高。
- 方法要点：引入轻量级SideNet学习双向时间感知，结合双锚点速度积分，无需重训练主干网络，实现高效插值求解。
- 实验或效果：在ImageNet-256^2上，10次函数评估达到100+次欧拉求解器质量，5次评估仍保持高保真度，训练成本可忽略。
