...
**arXiv**：[2601.21822v1](https://arxiv.org/abs/2601.21822) · [PDF](https://arxiv.org/pdf/2601.21822.pdf)  
**作者**：Zitong Yu, Boquan Sun, Yang Li, Zheyan Qu, Xing Zhang  

**一句话要点**：提出CORE框架，通过分层边缘上大语言模型代理的协同编排，实现6G泛在智能。

**关键词**：6G网络, 大语言模型, 边缘计算, 协同编排, 角色调度, 泛在智能

## 3 点简述
- 核心问题：分层网络计算资源碎片化与异构，阻碍大语言模型代理执行复杂推理任务。
- 方法要点：采用多代理协同学习系统，集成实时感知、动态角色编排和流水线并行执行优化模块。
- 实验或效果：在多种6G应用场景中验证，系统效率和任务完成率显著提升，并在实际边缘计算平台部署展示稳健性能。
