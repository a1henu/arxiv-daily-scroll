...
**关键词**：电商搜索相关性, 多视角思维链, 知识蒸馏, 推理延迟优化, 大语言模型应用, 在线A/B测试

## 3 点简述
- 核心问题：现有方法依赖单视角思维链推理，无法捕捉电商相关性的多面性，且推理延迟高，蒸馏时丢弃推理结构。
- 方法要点：教师模型使用多视角思维链生成多样推理，结合监督微调与直接偏好优化；学生模型通过潜在推理知识蒸馏实现轻量推理提取。
