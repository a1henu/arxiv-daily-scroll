...
**arXiv**：[2601.21837v1](https://arxiv.org/abs/2601.21837) · [PDF](https://arxiv.org/pdf/2601.21837.pdf)  
**作者**：Xiaoshan Yu, Shangshang Yang, Ziwen Wang, Haiping Ma, Xingyi Zhang  

**一句话要点**：提出系统综述框架，从五个可信视角分析智能教育任务，以解决现有研究碎片化问题。

**关键词**：智能教育, 可信性, 系统综述, 任务分类, 隐私保护, 公平性

## 3 点简述
- 核心问题：智能教育中可信性研究缺乏系统性分类，现有方法分散或停留在高层讨论。
- 方法要点：将智能教育划分为五类任务，并从安全隐私、鲁棒性、公平性、可解释性和可持续性五个视角进行综述。
- 实验或效果：总结研究方法与策略，识别关键挑战，并讨论未来方向，旨在提供连贯参考框架。
