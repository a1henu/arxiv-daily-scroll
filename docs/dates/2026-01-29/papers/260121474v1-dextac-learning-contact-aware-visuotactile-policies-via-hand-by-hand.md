...
**关键词**：灵巧操作, 视觉触觉策略, 动觉教学, 接触感知, 多维触觉数据, 人机交互

## 3 点简述
- 核心问题：现有灵巧操作数据收集和技能学习系统常因触觉信息低维而受限，影响接触密集型任务的性能。
- 方法要点：基于动觉教学捕获多维触觉数据，包括接触力分布和空间接触区域，并整合到策略网络中，实现自主选择最优接触区域。
- 实验或效果：在单臂注射任务中达到91.67%成功率，小规模注射器场景下比仅力控基线提升31.67%。
