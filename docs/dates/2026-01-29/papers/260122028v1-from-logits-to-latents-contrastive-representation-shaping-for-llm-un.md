...
**一句话要点**：提出对比表示正则化方法CLReg以减少LLM遗忘中的表示纠缠

**关键词**：大语言模型遗忘, 表示学习, 对比学习, 正则化方法, 知识解耦

## 3 点简述
- 核心问题：现有LLM遗忘方法可能仅抑制遗忘内容生成，但遗忘概念仍残留在表示中并与保留知识纠缠
- 方法要点：CLReg通过对比学习识别遗忘特征并将其推离保留特征，最小化保留特征偏移
- 实验或效果：在多种遗忘基准和LLM上减少表示纠缠，提升主流遗忘方法效果且无额外隐私风险
