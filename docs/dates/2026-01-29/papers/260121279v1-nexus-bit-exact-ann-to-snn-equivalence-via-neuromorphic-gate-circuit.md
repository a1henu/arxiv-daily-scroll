...
**一句话要点**：提出NEXUS框架，通过基于IF神经元的门电路实现ANN到SNN的比特精确等价，以解决现有方法因离散脉冲近似导致的精度损失问题。

**关键词**：脉冲神经网络, ANN-SNN转换, 比特精确等价, 神经形态门电路, 无代理训练, 能量效率

## 3 点简述
- 核心问题：现有SNN方法因用离散脉冲近似连续值而牺牲精度，无法实现与ANN的精确等价。
- 方法要点：利用IF神经元构建IEEE-754浮点运算门电路，通过空间比特编码和分层门电路实现无代理训练，确保输出与ANN数学相同。
- 实验或效果：在LLaMA-2 70B等模型上实现零精度损失，平均ULP误差仅6.19，能量降低27-168,000倍，且对膜电位泄漏和突触噪声具有鲁棒性。
