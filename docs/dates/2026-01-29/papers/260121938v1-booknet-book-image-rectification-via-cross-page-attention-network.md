...
**关键词**：书籍图像矫正, 跨页注意力, 双分支架构, 合成数据集, 几何扭曲建模

## 3 点简述
- 核心问题：书籍图像矫正面临左右页不对称扭曲，现有单页方法无法建模相邻页的几何耦合关系。
- 方法要点：采用双分支架构与跨页注意力机制，联合估计单页和整页的扭曲流，显式建模左右页相互影响。
- 实验或效果：构建合成数据集Book3D和真实基准Book100，实验显示BookNet优于现有方法。
