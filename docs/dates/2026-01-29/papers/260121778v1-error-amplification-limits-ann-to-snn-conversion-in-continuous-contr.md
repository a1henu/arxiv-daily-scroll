...
**一句话要点**：提出跨步残差电位初始化以抑制连续控制中ANN到SNN转换的误差放大问题

**关键词**：脉冲神经网络转换, 连续控制, 误差放大, 强化学习, 无训练机制

## 3 点简述
- 核心问题：连续控制中ANN到SNN转换因动作近似误差跨步相关导致累积状态偏移和性能下降
- 方法要点：引入跨步残差电位初始化，无训练地跨决策步传递残差膜电位以抑制时间相关误差
- 实验或效果：在向量和视觉观测的连续控制基准上集成现有转换流程，显著恢复性能损失
