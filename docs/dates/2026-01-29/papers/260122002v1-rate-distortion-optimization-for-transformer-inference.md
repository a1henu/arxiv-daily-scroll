...
**关键词**：Transformer推理优化, 率失真理论, 中间表示压缩, 多设备分区, 信息论分析, PAC界限

## 3 点简述
- 核心问题：Transformer推理时计算和内存开销大，需跨设备分区并压缩中间表示。
- 方法要点：引入率失真理论框架，学习紧凑编码，在比特率和准确性间进行权衡。
- 实验效果：在语言基准测试中实现显著节省，部分情况下准确性提升，优于复杂基线方法。
