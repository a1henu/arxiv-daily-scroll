...
**一句话要点**：提出法官感知排序框架以解决无真值标签下大语言模型评估中的法官可靠性差异问题

**关键词**：大语言模型评估, 无真值标签排序, 法官可靠性建模, Bradley-Terry-Luce模型, 不确定性量化

## 3 点简述
- 核心问题：LLM-as-a-judge评估中法官LLM可靠性差异大，导致排序偏差和不确定性估计误导
- 方法要点：扩展Bradley-Terry-Luce模型，引入法官特定判别参数，联合估计模型质量和法官可靠性
- 实验或效果：在多个基准和新数据集上提升与人类偏好一致性，提高数据效率，提供校准的不确定性量化
