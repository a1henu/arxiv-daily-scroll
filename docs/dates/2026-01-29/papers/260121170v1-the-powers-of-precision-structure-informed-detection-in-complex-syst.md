...
**关键词**：复杂系统检测, 结构学习, 协方差矩阵幂次, 癫痫发作预测, 客户流失预测, 可解释机器学习

## 3 点简述
- 核心问题：复杂系统中突发事件的早期检测，面临潜在因果结构未知且数据部分观测的挑战
- 方法要点：通过协方差矩阵或精度矩阵的幂次族学习最优特征表示，再结合监督分类
- 实验效果：在癫痫发作检测和客户流失预测中取得竞争性结果，同时保持结构可解释性
