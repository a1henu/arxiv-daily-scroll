...
**关键词**：深度视觉特征, 可察觉差异建模, 任务对齐扰动, 特征质量控制, 动态量化

## 3 点简述
- 核心问题：深度视觉特征在机器感知中缺乏质量控制和任务对齐的容忍边界描述。
- 方法要点：基于任务对齐的JND公式化，预测每个特征的最大可容忍扰动图，并开发FeatJND估计器。
- 实验或效果：在分类、检测和分割任务中验证，FeatJND扰动比高斯扰动更高效，应用于动态量化提升性能。
