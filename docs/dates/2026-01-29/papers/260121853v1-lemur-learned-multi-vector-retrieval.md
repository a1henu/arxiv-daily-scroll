...
**一句话要点**：提出LEMUR框架以加速多向量检索，通过监督学习和单向量近似搜索降低延迟。

**关键词**：多向量检索, 近似最近邻搜索, 监督学习, 延迟优化, 信息检索

## 3 点简述
- 多向量检索（如ColBERT）质量高但延迟大，需高效近似最近邻搜索。
- LEMUR将多向量搜索转化为监督学习问题，并用单向量搜索加速推理。
- 在文本和视觉多向量模型上评估，LEMUR比现有方法快一个数量级。
