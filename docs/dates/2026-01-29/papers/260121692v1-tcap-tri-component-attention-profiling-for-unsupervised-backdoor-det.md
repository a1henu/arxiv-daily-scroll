...
**关键词**：多模态大语言模型, 后门检测, 无监督学习, 注意力机制, 微调即服务, 跨模态安全

## 3 点简述
- 核心问题：FTaaS中MLLM微调面临后门风险，现有防御方法依赖监督信号或泛化能力不足
- 方法要点：基于注意力分配差异，分解跨模态注意力图，利用GMM和EM投票隔离中毒样本
- 实验或效果：在多MLLM架构和攻击方法上验证，TCAP表现稳定，提供鲁棒防御
