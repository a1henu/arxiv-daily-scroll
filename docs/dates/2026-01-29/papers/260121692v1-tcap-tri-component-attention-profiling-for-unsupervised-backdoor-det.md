...
**一句话要点**：提出TCAP框架，通过三元注意力分析实现MLLM微调中的无监督后门检测

**关键词**：多模态大语言模型, 后门检测, 无监督学习, 注意力机制, 微调服务, 跨模态安全

## 3 点简述
- 核心问题：MLLM微调服务中，中毒数据引入后门风险，现有防御方法依赖监督信号或泛化性不足
- 方法要点：基于注意力分配差异，分解跨模态注意力图为三元组件，利用GMM统计分析和EM投票聚合隔离中毒样本
- 实验或效果：在多种MLLM架构和攻击方法上验证，TCAP表现稳定，成为鲁棒实用的后门防御方案
