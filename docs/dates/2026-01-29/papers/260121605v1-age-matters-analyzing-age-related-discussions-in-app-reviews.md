...
**arXiv**：[2601.21605v1](https://arxiv.org/abs/2601.21605) · [PDF](https://arxiv.org/pdf/2601.21605.pdf)  
**作者**：Shashiwadana Nirmania, Garima Sharma, Hourieh Khalajzadeh, Mojtaba Shahin  

**一句话要点**：分析应用商店评论中的年龄相关讨论，以提升移动应用对不同年龄用户的适配性。

**关键词**：年龄相关评论分析, 移动应用用户需求, RoBERTa模型, 定性主题分析, 应用商店评论挖掘

## 3 点简述
- 核心问题：移动应用在满足不同年龄用户需求方面存在不足，缺乏对用户年龄相关挑战的深入理解。
- 方法要点：手动构建包含4,163条评论的数据集，使用RoBERTa等模型自动检测年龄相关讨论，并进行定性分析。
- 实验或效果：RoBERTa模型在检测年龄相关评论时表现最佳，精确率达92.46%，并识别出六个主要用户关注主题。
