...
**一句话要点**：提出SAGE优化框架以解决生成式推荐中的对称保守性和奖励崩溃问题。

**关键词**：生成式推荐, 序列级优化, 梯度演化, 冷启动问题, 多样性维持, LLM架构复用

## 3 点简述
- 核心问题：OneRec的GBPO策略存在对称保守性，抑制冷启动项更新并导致多样性崩溃。
- 方法要点：SAGE通过序列级信号解耦和不对称自适应动态，实现梯度演化优化。
- 实验或效果：理论分析和实证结果验证SAGE能有效解锁冷启动流量并维持推荐多样性。
