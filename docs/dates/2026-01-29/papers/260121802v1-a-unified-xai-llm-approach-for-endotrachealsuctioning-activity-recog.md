...
**一句话要点**：提出统一LLM框架以解决气管内吸痰活动识别与反馈生成问题

**关键词**：视频活动识别, 大型语言模型, 可解释人工智能, 临床培训, 反馈生成

## 3 点简述
- 核心问题：气管内吸痰活动自动化识别与反馈系统在临床培训中研究不足
- 方法要点：以大型语言模型为核心，从视频数据执行时空活动识别与可解释决策分析
- 实验或效果：LLM方法在准确率和F1分数上比基线模型提升约15-20%
