...
**一句话要点**：提出认知复杂度基准与金融PoT框架以解决大语言模型在金融定量推理中的算术幻觉与认知崩溃问题。

**关键词**：金融定量推理, 认知复杂度基准, 神经符号架构, 算术幻觉, 架构解耦, 迭代自校正

## 3 点简述
- 核心问题：大语言模型在金融定量推理中易产生算术幻觉和认知崩溃，导致可靠性不足。
- 方法要点：引入认知复杂度基准进行分层评估，并提出迭代双阶段金融PoT框架，实现语义与计算的架构解耦。
