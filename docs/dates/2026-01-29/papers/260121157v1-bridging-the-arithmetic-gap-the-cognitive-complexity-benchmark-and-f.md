...
**一句话要点**：提出认知复杂度基准与金融PoT框架以提升金融定量推理的鲁棒性

**关键词**：金融定量推理, 认知复杂度基准, 神经符号架构, 算术幻觉, 架构解耦, Python沙箱

## 3 点简述
- 核心问题：大语言模型在金融定量推理中易出现算术幻觉和认知崩溃，导致可靠性不足。
- 方法要点：引入认知复杂度基准进行分层评估，并设计迭代双阶段金融PoT框架，实现语义与计算的架构解耦。
- 实验或效果：在基准测试中，该方法将Qwen3-235B模型的平均准确率从59.7%提升至67.3%，高复杂度任务性能提升高达10倍。
