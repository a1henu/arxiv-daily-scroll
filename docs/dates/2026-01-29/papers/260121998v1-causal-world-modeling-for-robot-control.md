...
**关键词**：视频世界建模, 机器人控制, 自回归扩散, 因果推理, 共享潜在空间, 异步推理

## 3 点简述
- 核心问题：视频世界建模与视觉语言预训练作为机器人学习新基础，需增强因果推理与动作执行能力。
- 方法要点：采用共享潜在空间、闭环滚动机制和异步推理管道，集成Mixture-of-Transformers架构。
- 实验或效果：在仿真与真实场景中验证，展示长时程操作、数据效率和强泛化性。
