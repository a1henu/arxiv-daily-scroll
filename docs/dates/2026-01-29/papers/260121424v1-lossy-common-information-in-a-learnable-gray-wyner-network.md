...
**一句话要点**：提出可学习的Gray-Wyner网络，通过分离共享与任务特定信息以减少计算机视觉任务中的冗余表示。

**关键词**：Gray-Wyner网络, 损失性公共信息, 任务驱动表示学习, 多任务视觉编码, 信息理论应用, 冗余减少

## 3 点简述
- 核心问题：计算机视觉任务间存在大量重叠信息，传统编解码器忽略此点导致表示冗余低效。
- 方法要点：基于Gray-Wyner理论，设计可学习三通道编解码器，分离共享信息和任务特定细节。
- 实验或效果：在六个视觉基准的双任务场景中，该方法显著减少冗余并优于独立编码。
