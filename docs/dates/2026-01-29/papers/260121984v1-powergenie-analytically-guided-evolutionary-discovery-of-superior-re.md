...
**关键词**：电源转换器设计, 进化算法, 自动化分析, 电路拓扑发现, 性能优化

## 3 点简述
- 核心问题：传统方法难以在大规模设计空间中自动发现高性能电路拓扑，依赖专家或有限模板。
- 方法要点：结合自动化分析框架评估功能与理论性能，并采用进化微调方法协同进化生成模型。
- 实验或效果：发现新型8模式转换器，FoM提升23%，SPICE仿真验证效率平均提升10%。
