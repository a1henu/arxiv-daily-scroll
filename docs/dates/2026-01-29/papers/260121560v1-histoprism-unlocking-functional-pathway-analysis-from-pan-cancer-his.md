...
**一句话要点**：提出HistoPrism以从泛癌组织学预测基因表达，实现功能通路分析

**关键词**：组织学图像分析, 基因表达预测, 泛癌建模, Transformer架构, 功能通路分析

## 3 点简述
- 核心问题：现有方法局限于单癌种和基于方差的评估，功能相关性不足
- 方法要点：基于Transformer的架构，高效预测泛癌基因表达，引入通路级基准
- 实验或效果：在高度可变基因和通路级预测上超越先前模型，展示生物相干性
