...
**关键词**：多智能体系统, 高风险决策, 可解释人工智能, 表格数据, 辩论模拟, 透明推理

## 3 点简述
- 核心问题：高风险表格决策任务中黑盒方法缺乏透明度和可控性，需可审计的推理过程
- 方法要点：基于法庭辩论结构，定义角色、协议和私有策略，实现结构化多智能体辩论
- 实验或效果：在年轻成人再犯预测上，相比单智能体推理，提供更稳定和可泛化的性能，并生成完整交互记录
