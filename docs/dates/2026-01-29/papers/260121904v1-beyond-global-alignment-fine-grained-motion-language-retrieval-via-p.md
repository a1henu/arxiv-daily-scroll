...
**关键词**：运动-语言检索, 细粒度对齐, 金字塔学习, 跨模态对应, 人类运动分析

## 3 点简述
- 现有方法主要关注全局对齐，忽略了局部运动段与身体关节和文本令牌之间的细粒度交互，导致检索性能不佳。
- 受人类运动感知的金字塔过程启发，该框架将运动分解为时空单元，通过渐进式对齐学习跨模态对应关系。
- 在多个公开基准数据集上的实验表明，该方法显著优于现有技术，实现了运动段和身体关节与文本令牌的精确对齐。
