...
**arXiv**：[2601.21212v1](https://arxiv.org/abs/2601.21212) · [PDF](https://arxiv.org/pdf/2601.21212.pdf)  
**作者**：Xixian Yong, Peilin Sun, Zihe Wang, Xiao Zhou  

**一句话要点**：提出Intelli-Planner框架，结合大语言模型与深度强化学习，实现定制化城市规划方案生成。

**关键词**：城市规划, 深度强化学习, 大语言模型, 定制化方案, 利益相关者参与, 知识增强

## 3 点简述
- 核心问题：现有城市规划方法依赖专家或深度学习，耗时且限制利益相关者参与。
- 方法要点：利用大语言模型增强决策能力，建立多维评估系统，基于利益相关者满意度评分。
- 实验或效果：在多种城市设置中验证，超越传统基线，在客观指标上媲美先进方法，提升满意度和收敛速度。
