...
**关键词**：大语言模型遗忘, 任务向量, 参数重要性, 梯度估计, Fisher信息, 过度遗忘缓解

## 3 点简述
- 核心问题：任务向量遗忘法效率高但易过度遗忘，破坏保留其他信息的关键参数
- 方法要点：基于参数重要性差异，通过梯度或Fisher信息估计权重，逐参数调整任务向量
- 实验或效果：PerTA在遗忘效果和模型效用上优于标准任务向量，常超越基于训练的遗忘方法
