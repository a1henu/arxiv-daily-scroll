...
**一句话要点**：提出因果神经符号推理模型CNRE，以解决多行为推荐中可解释性与泛化性不足的问题。

**关键词**：多行为推荐, 神经符号推理, 因果推断, 可解释性, 内生逻辑, 推荐系统

## 3 点简述
- 核心问题：现有多行为推荐牺牲可解释性追求性能，而可解释方法依赖外部信息导致泛化性有限。
- 方法要点：结合因果推理与神经符号集成，模拟内生逻辑决策过程，生成去混淆的因果中介解释。
- 实验或效果：在三个大规模数据集上验证，CNRE显著优于先进基线，提供多层次可解释性。
