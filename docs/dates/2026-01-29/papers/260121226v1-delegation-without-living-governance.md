...
**arXiv**：[2601.21226v1](https://arxiv.org/abs/2601.21226) · [PDF](https://arxiv.org/pdf/2601.21226.pdf)  
**作者**：Wolfgang Rohde  

**一句话要点**：提出治理孪生以解决运行时决策中人类参与失效问题

**关键词**：运行时治理, 治理孪生, AI决策, 人类参与, 动态治理

## 3 点简述
- 核心问题：静态合规治理在AI运行时决策中失效，人类参与度降低
- 方法要点：引入治理孪生概念，支持运行时动态治理以维持人类沟通与影响
- 实验或效果：未知，但定位为保持人类相关性的强候选方案
