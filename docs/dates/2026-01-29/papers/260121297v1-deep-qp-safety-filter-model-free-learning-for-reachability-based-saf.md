...
**一句话要点**：提出Deep QP Safety Filter，结合可达性分析与无模型学习，为黑盒动态系统提供数据驱动的安全层。

**关键词**：安全过滤器, 无模型学习, 可达性分析, 强化学习, 神经网络, 动态系统

## 3 点简述
- 核心问题：为未知动态系统设计无模型的安全过滤器，减少强化学习中的预收敛失败。
- 方法要点：结合Hamilton-Jacobi可达性与无模型学习，通过收缩损失训练神经网络近似安全值及其导数。
- 实验或效果：在多种动态系统和RL任务中，显著降低失败率并加速学习，性能优于基线方法。
