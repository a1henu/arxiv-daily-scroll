...
**一句话要点**：提出解耦感知与推理的模块化强化学习方法，以提升无演示学习布料操作的数据效率

**关键词**：布料操作, 强化学习, 数据效率, 模块化设计, 仿真到现实迁移

## 3 点简述
- 核心问题：布料操作因高维状态空间、复杂动力学和自遮挡，导致强化学习模型大、训练时间长、计算成本高
- 方法要点：通过解耦感知与推理，采用模块化设计减少模型规模和训练时间，在仿真中高效学习
- 实验或效果：在SoftGym基准测试中，使用更小模型实现优于基线的性能，并展示仿真到现实的迁移能力
