...
**一句话要点**：提出几何诱导查询键变换以解决航拍-地面行人重识别中的几何失真问题

**关键词**：航拍-地面行人重识别, 几何失真校正, 查询键变换, 注意力机制, 低秩模块, 相机几何条件

## 3 点简述
- 核心问题：航拍与地面相机间的极端视角和距离差异导致几何失真，破坏跨视图相似性空间假设。
- 方法要点：引入轻量级低秩模块GIQT，通过相机几何条件调整查询键交互，显式校正相似性空间。
- 实验或效果：在四个基准测试中提升鲁棒性，计算开销小，优于现有方法。
