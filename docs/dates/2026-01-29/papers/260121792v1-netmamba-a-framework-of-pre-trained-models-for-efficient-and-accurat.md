...
## 3 点简述
- 核心问题：加密流量分类面临Transformer计算效率低、特征表示偏差及长尾分布处理不佳的挑战。
- 方法要点：结合Mamba与Flash Attention机制，设计多模态表示方案以保留关键字节级特征并消除偏差。
- 实验或效果：在四大分类任务上F1分数提升达6.44%，推理吞吐量提高1.7倍，并展示优异的少样本学习能力。
