...
**arXiv**：[2601.21191v1](https://arxiv.org/abs/2601.21191) · [PDF](https://arxiv.org/pdf/2601.21191.pdf)  
**作者**：Xiulin Yang, Heidi Getz, Ethan Gotlieb Wilcox  

**一句话要点**：通过功能词统计特性探究从线性输入学习层次结构的条件

**关键词**：语言学习, 功能词统计, 层次结构学习, 跨语言分析, 神经网络建模

## 3 点简述
- 核心问题：统计条件如何支持从线性输入学习语言层次结构
- 方法要点：基于跨语言语料分析功能词分布特性，结合反事实语言建模与消融实验
- 实验或效果：保留高频和结构关联特性的语言变体更易被神经网络学习
