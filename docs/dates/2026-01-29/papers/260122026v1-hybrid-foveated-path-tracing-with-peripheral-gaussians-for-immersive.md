...
**一句话要点**：提出混合注视点路径追踪与外围高斯泼溅方法，用于高质量交互式医学解剖可视化。

**关键词**：体积医学可视化, 混合渲染, 注视点渲染, 高斯泼溅, 交互式更新, 路径追踪

## 3 点简述
- 核心问题：传统2D切片和现有体积渲染方法在交互性和计算成本上存在限制，影响医学解剖的空间感知。
- 方法要点：结合流式注视点路径追踪和轻量级外围高斯泼溅近似，通过体积数据优化和注视点渲染持续更新外围模型。
- 实验或效果：相比直接路径追踪和高斯泼溅，该方法在视觉质量保持的同时，外围模型再生时间小于一秒，支持交互式更新。
