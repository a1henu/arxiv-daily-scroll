...
**关键词**：批处理优化, GPU并行计算, 混合整数规划, 原始-对偶混合梯度, 线性规划求解

## 3 点简述
- 核心问题：混合整数规划中强分支和边界收紧等操作需并行求解多个相关线性规划。
- 方法要点：扩展原始-对偶混合梯度算法，利用矩阵-矩阵运算替代重复矩阵-向量运算。
- 实验或效果：在GPU上展示计算优势，识别一阶方法优于传统单纯形求解器的问题规模。
