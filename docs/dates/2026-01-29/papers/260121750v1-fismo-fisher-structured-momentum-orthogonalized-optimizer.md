...
**一句话要点**：提出FISMO优化器，通过Fisher信息几何结合各向异性曲率信息，提升大规模神经网络训练效率与性能。

**关键词**：神经网络优化, Fisher信息几何, 结构化预条件, 非凸优化, 收敛保证, 训练效率

## 3 点简述
- 核心问题：现有优化器如Muon强制各向同性更新，可能忽略梯度谱中的曲率信息，影响训练效果。
- 方法要点：将优化器更新重构为受Kronecker分解Fisher度量约束的信任域问题，实现结构化预条件，平衡几何结构与自适应性。
