...
**arXiv**：[2601.21527v1](https://arxiv.org/abs/2601.21527) · [PDF](https://arxiv.org/pdf/2601.21527.pdf)  
**作者**：Sajid Mannan, Rupert J. Myers, Rohit Batra, Rocio Mercado, Lothar Wondraczek, N. M. Anoop Krishnan  

**一句话要点**：提出ML-LCA框架以整合材料发现与生命周期评估，实现可持续材料设计

**关键词**：可持续材料发现, 机器学习-生命周期评估, 多尺度建模, 不确定性量化, 多目标优化, 材料设计框架

## 3 点简述
- 核心问题：当前AI材料发现优先性能优化，导致可持续性评估滞后，造成资源浪费。
- 方法要点：集成上游机器学习材料发现与下游生命周期评估，构建统一ML-LCA环境，包含五个组件。
- 实验或效果：通过玻璃、水泥等案例研究，验证了框架的必要性和可行性，并识别了材料特定挑战。
