...
**一句话要点**：提出自适应距离学习算法以检测大语言模型生成文本

**关键词**：大语言模型检测, 文本距离学习, 改写检测算法, 几何方法, 自适应学习

## 3 点简述
- 核心问题：大语言模型生成文本高度拟人化，引发误信息和学术诚信担忧，需可靠检测算法。
- 方法要点：基于改写检测算法，通过几何方法揭示其原理，并引入自适应学习距离函数提升检测效果。
- 实验或效果：在超过100种设置下实验，相比基线算法，在不同目标大语言模型上实现57.8%至80.6%的相对改进。
