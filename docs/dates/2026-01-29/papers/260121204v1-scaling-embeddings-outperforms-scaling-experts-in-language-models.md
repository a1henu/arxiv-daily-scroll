...
**一句话要点**：提出嵌入缩放作为稀疏扩展新维度，在特定场景下优于专家缩放

**关键词**：嵌入缩放, 稀疏扩展, MoE架构, 推理优化, 语言模型

## 3 点简述
- 核心问题：MoE架构面临收益递减和系统瓶颈，需探索稀疏扩展新方法
- 方法要点：通过嵌入缩放实现稀疏扩展，分析架构因素如参数预算、宽度与深度交互
- 实验或效果：构建LongCat-Flash-Lite模型，在推理速度与性能上超越MoE基线，在代理和编码领域表现优异
