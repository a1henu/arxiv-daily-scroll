...
**关键词**：音视频理解, 多模态大语言模型, 基准评估, 时序定位, 真实世界数据, 社会鲁棒性

## 3 点简述
- 核心问题：现有MLLM研究多关注静态图像，音视频序列数据处理能力评估不足
- 方法要点：构建包含13个对话领域、4958条人工验证标注的基准，支持摘要、多选问答和时序定位任务
- 实验或效果：闭源与开源模型在时序定位任务上性能差距达22.6%，且跨人口群体表现存在差异
