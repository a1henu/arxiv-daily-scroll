...
**关键词**：音视频理解, 多模态大语言模型, 基准评估, 时序定位, 人口统计偏差, 真实世界对话

## 3 点简述
- 核心问题：现有MLLM研究多关注静态图像，音视频序列理解评估不足，缺乏高质量基准
- 方法要点：构建包含13个对话领域、4958条人工验证标注和人口统计元数据的综合基准，支持摘要、多选问答和时序定位任务
- 实验或效果：实验显示闭源与开源模型在时序定位任务上性能差距达22.6%，且模型性能在不同人口群体间存在差异
