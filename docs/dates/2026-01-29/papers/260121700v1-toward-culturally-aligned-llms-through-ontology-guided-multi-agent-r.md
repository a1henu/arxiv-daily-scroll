...
**关键词**：文化对齐, 本体引导推理, 多智能体系统, 世界价值观调查, LLMs优化

## 3 点简述
- 核心问题：LLMs在文化敏感决策中常因训练数据偏差和缺乏结构化价值表示而出现错位。
- 方法要点：基于世界价值观调查构建全球文化本体，并利用多智能体进行推理以增强一致性和可解释性。
- 实验或效果：在四个LLM骨干上的区域社会调查基准测试中，OG-MAR提高了文化对齐和鲁棒性，并生成透明推理轨迹。
