...
**arXiv**：[2601.21153v1](https://arxiv.org/abs/2601.21153) · [PDF](https://arxiv.org/pdf/2601.21153.pdf)  
**作者**：Liang Hong  

**一句话要点**：提出新策略以解决回归场景中保险索赔有限样本有效预测区间不足的问题

**关键词**：保险索赔预测, 回归分析, 有限样本有效性, 预测区间, 精算方法

## 3 点简述
- 核心问题：现有保险文献在回归场景下缺乏有限样本有效的未来索赔预测区间
- 方法要点：将无监督iid设置中的预测方法转换为回归设置中的预测方法
- 实验或效果：使精算师能在回归设置中获得无限多个有限样本有效预测区间
