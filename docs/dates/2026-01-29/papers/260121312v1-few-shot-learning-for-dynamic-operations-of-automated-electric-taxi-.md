...
**关键词**：元强化学习, 图注意力网络, 概率嵌入, 自动电动出租车, 动态充电基础设施, 运营优化

## 3 点简述
- 核心问题：动态充电网络导致自动电动出租车车队运营效率低下，现有模型假设静态网络存在理论与实际差距。
- 方法要点：结合图注意力网络提取空间表示，使用概率嵌入强化学习实现快速适应，无需重新训练。
- 实验或效果：基于成都真实数据模拟，GAT-PEARL优于传统强化学习基线，在未见布局中泛化能力强，提升运营效率。
