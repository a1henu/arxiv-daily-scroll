...
**关键词**：机器人操作, 视觉表示, 对象中心表示, 泛化能力, 槽注意力

## 3 点简述
- 核心问题：现有全局和密集特征混合任务相关与无关信息，导致机器人操作策略在光照、纹理等变化下泛化差
- 方法要点：引入基于槽的对象中心表示，将密集特征分组为对象实体，减少噪声并保留任务信息
- 实验或效果：在模拟和真实任务中，该表示优于全局和密集特征，无需任务特定预训练即提升泛化性能
