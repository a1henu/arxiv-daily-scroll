...
**关键词**：多目标优化, 贝叶斯优化, 元学习, 高斯过程, 黑盒优化, 可扩展性

## 3 点简述
- 核心问题：多目标黑盒优化中，元学习与多目标贝叶斯优化结合方法稀缺，难以利用历史数据加速优化。
- 方法要点：基于多输出高斯过程构建结构化先验，显式学习目标间相关性，支持分层并行训练，实现线性扩展。
- 实验或效果：未知具体实验细节，但方法可无缝集成标准多目标贝叶斯优化采集函数，提升优化效率。
