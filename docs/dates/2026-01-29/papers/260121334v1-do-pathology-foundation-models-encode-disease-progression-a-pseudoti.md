...
**一句话要点**：提出基于扩散伪时间分析视觉表示的方法，以评估病理学基础模型是否编码疾病进展

**关键词**：病理学基础模型, 疾病进展表示, 扩散伪时间分析, 视觉表示学习, 轨迹保真度, 少样本分类

## 3 点简述
- 核心问题：视觉基础模型能否从离散图像中学习连续疾病进展的表示
- 方法要点：使用扩散伪时间方法分析模型表示空间中的疾病轨迹排序
- 实验或效果：在四种癌症进展和六个模型中，病理学模型显著恢复轨迹顺序，轨迹保真度预测少样本分类性能
