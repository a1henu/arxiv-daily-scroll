...
**一句话要点**：提出SR²-Net作为轻量级即插即用模型，以解决高光谱图像超分辨率中的光谱一致性问题。

**关键词**：高光谱图像超分辨率, 光谱一致性, 即插即用模型, 注意力机制, 流形学习, 轻量级网络

## 3 点简述
- 核心问题：现有方法忽视光谱一致性，导致虚假振荡和物理不合理的伪影。
- 方法要点：采用增强-校正流程，结合分层光谱-空间协同注意力和流形一致性校正。
- 实验或效果：在多个基准和骨干网络上验证，以可忽略计算开销提升光谱保真度和重建质量。
