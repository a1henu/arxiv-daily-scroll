...
**关键词**：多模态大语言模型, 通用对抗扰动, 黑盒攻击, 多图像任务, 注意力机制, 对抗鲁棒性

## 3 点简述
- 核心问题：多图像多模态大语言模型在对抗攻击下的脆弱性未知，现有攻击方法局限于单图像和白盒场景
- 方法要点：通过注意力约束和跨图像传染约束学习通用对抗扰动，实现黑盒攻击且无需修改所有输入
- 实验或效果：在多个视觉语言任务和模型上，LAMP超越现有基线，达到最高攻击成功率
