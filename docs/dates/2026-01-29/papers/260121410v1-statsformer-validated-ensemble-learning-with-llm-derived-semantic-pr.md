...
**关键词**：集成学习, 语义先验, 监督统计学习, LLM知识整合, 交叉验证

## 3 点简述
- 现有方法整合LLM知识时适应性差，易受幻觉影响或局限于单一学习器
- Statsformer采用集成架构，将LLM特征先验嵌入线性和非线性学习器，并通过交叉验证自适应校准
- 实验表明，信息性先验提升性能，非信息性或错误先验被自动降权，减少幻觉影响
