...
**关键词**：线性化拉普拉斯近似, 神经正切核, 预测不确定性, 分布外检测, 可扩展方法, 代理神经网络

## 3 点简述
- 核心问题：线性化拉普拉斯近似（LLA）中核计算需大雅可比矩阵，在大规模预训练深度神经网络上不可扩展。
- 方法要点：使用代理深度神经网络学习紧凑特征表示，其内积复制神经正切核（NTK），避免大雅可比矩阵计算，仅需高效雅可比-向量积。
