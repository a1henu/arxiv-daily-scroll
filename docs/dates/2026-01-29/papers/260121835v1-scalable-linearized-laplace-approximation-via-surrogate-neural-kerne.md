...
**关键词**：线性化拉普拉斯近似, 神经正切核, 预测不确定性, 分布外检测, 深度神经网络, 可扩展近似

## 3 点简述
- 核心问题：线性化拉普拉斯近似（LLA）计算神经正切核（NTK）时需大雅可比矩阵，在大规模预训练深度神经网络中不可扩展。
- 方法要点：使用代理深度神经网络学习紧凑特征表示，其内积复制NTK，避免大雅可比矩阵计算，仅需高效雅可比-向量积。
- 实验或效果：在不确定性估计和校准上相似或优于现有LLA近似，且偏置学习核显著提升分布外检测性能。
