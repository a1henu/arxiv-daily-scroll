...
**一句话要点**：研究模型架构与时间上下文在自然脑电解码中的交互作用，揭示效率与鲁棒性权衡

**关键词**：脑电解码, 时间上下文, 模型架构, 鲁棒性评估, 效率权衡

## 3 点简述
- 核心问题：模型架构如何与时间上下文长度交互影响自然脑电解码性能
- 方法要点：在HBN电影观看数据集上，基准测试CNN、LSTM、EEGXF、S4和S5架构，评估不同时间片段长度
- 实验或效果：S5在64秒上下文达到98.7%准确率且参数更少，但EEGXF在跨频率偏移和OOD任务中更鲁棒
