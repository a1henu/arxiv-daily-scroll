...
**一句话要点**：提出FIT框架以解决持续大语言模型遗忘中的灾难性遗忘问题

**关键词**：持续遗忘, 灾难性遗忘, 大语言模型, 数据过滤, 重要性感知更新, 层归因

## 3 点简述
- 核心问题：现有大语言模型遗忘方法难以处理持续大量删除请求，导致性能下降和灾难性遗忘。
- 方法要点：FIT通过数据过滤、重要性感知更新和针对性层归因，平衡遗忘效果与模型效用。
- 实验或效果：在PCH基准测试中，FIT在数百个删除请求下实现最佳遗忘与效用权衡，并抵抗恢复攻击。
