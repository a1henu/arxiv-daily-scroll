...
**一句话要点**：提出集合逆问题及其非迭代推理方法，应用于高能物理和全波形反演

**关键词**：集合逆问题, 条件生成模型, 后验采样, 高能物理反演, 全波形反演, 非迭代推理

## 3 点简述
- 定义集合逆问题，旨在从观测数据反演先验分布下的集合
- 提出基于条件生成模型的后验采样器，利用集合信息避免推理时显式迭代前向模型
- 在合成和真实数据集上验证方法，适用于逆成像、高能物理和全波形反演
