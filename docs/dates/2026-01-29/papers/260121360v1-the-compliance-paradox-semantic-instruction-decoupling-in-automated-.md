...
**一句话要点**：揭示大语言模型在自动代码评估中的合规悖论，提出语义保持对抗代码注入框架以暴露脆弱性

**关键词**：大语言模型评估, 代码评估脆弱性, 语义保持对抗注入, 抽象语法树攻击, 自动评分安全, 教育技术对齐

## 3 点简述
- 核心问题：大语言模型在代码评估中优先遵循隐藏指令而非代码逻辑，导致合规悖论和虚假认证
- 方法要点：引入SPACI框架和AST-ASIP协议，通过抽象语法树中的语法-语义间隙嵌入对抗指令
- 实验或效果：在25,000份提交中评估9个模型，显示高容量模型失败率超95%，量化了去耦合概率和分数差异
