...
**关键词**：自动代码评估, 合规性悖论, 语义保持对抗代码注入, 抽象语法树, 大语言模型脆弱性, 教育技术

## 3 点简述
- 核心问题：大语言模型在自动学术代码评估中，因过度遵循指令而忽略代码逻辑，导致系统性脆弱性，称为合规性悖论
- 方法要点：引入语义保持对抗代码注入框架和抽象语法树感知语义注入协议，利用语法-语义间隙在代码中嵌入对抗性指令
- 实验或效果：在25,000份提交中评估9个先进模型，发现高容量模型失败率超过95%，量化了虚假认证问题
