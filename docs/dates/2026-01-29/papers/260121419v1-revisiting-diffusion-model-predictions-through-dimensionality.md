...
**一句话要点**：提出k-Diff框架，基于数据维度理论自动学习最优预测目标以提升生成性能

**关键词**：扩散模型, 预测目标优化, 数据维度理论, 生成性能提升, 自动学习框架

## 3 点简述
- 核心问题：扩散模型中预测目标（如噪声、速度、数据）的选择缺乏理论依据，依赖数据维度未知
- 方法要点：建立广义预测理论框架，推导数据几何与最优目标关系，提出k-Diff数据驱动学习最优参数
- 实验或效果：在潜空间和像素空间图像生成中，k-Diff优于固定目标基线，适应不同架构和数据规模
