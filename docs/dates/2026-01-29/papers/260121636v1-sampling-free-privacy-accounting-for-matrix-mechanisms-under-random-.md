...
**一句话要点**：提出基于Rényi散度和条件组合的无采样隐私放大框架，用于随机分配下的矩阵机制隐私计算。

**关键词**：差分隐私, 隐私放大, 矩阵机制, Rényi散度, 随机分配

## 3 点简述
- 研究随机分配下差分隐私模型训练中矩阵机制的隐私放大问题。
- 开发基于Rényi散度的动态规划方法和条件组合方法，提供无采样隐私保证。
- 通过数值比较验证方法在多种矩阵机制中的有效性。
