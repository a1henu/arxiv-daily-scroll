...
**一句话要点**：提出自改进预训练方法，使用后训练模型通过强化学习提升预训练模型的质量与安全性

**关键词**：自改进预训练, 强化学习优化, 后训练模型评估, 流式文档处理, 生成质量提升, 模型安全性

## 3 点简述
- 核心问题：预训练阶段学习到的模式难以通过后续微调修正，影响模型生成的安全性、事实性和整体质量
- 方法要点：采用流式文档输入，利用强化学习优化生成的下K个令牌，由后训练模型评估候选生成的质量、安全性和事实性
- 实验或效果：相比标准预训练，在事实性和安全性上分别获得36.2%和18.5%的相对提升，整体生成质量胜率最高提升86.3%
