...
**一句话要点**：提出自改进预训练方法，使用后训练模型通过强化学习提升预训练模型的质量、安全性和事实性

**关键词**：自改进预训练, 强化学习, 后训练模型, 事实性提升, 安全性增强, 流式文档处理

## 3 点简述
- 核心问题：传统预训练方法难以纠正模型在预训练阶段学习到的不安全或幻觉模式，影响生成质量
- 方法要点：采用流式文档输入，利用后训练模型评估生成质量，结合强化学习优化模型在预训练中的生成行为
- 实验或效果：在事实性和安全性上相对标准预训练分别提升36.2%和18.5%，整体生成质量胜率最高提升86.3%
