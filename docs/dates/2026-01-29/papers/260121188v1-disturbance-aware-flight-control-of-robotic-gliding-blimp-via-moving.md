...
**一句话要点**：提出基于移动质量驱动的扰动感知控制框架，以增强机器人滑翔飞艇在风扰下的飞行稳定性。

**关键词**：机器人飞艇控制, 扰动感知, 移动质量驱动, 模型预测控制, 风扰动补偿, 飞行稳定性

## 3 点简述
- 核心问题：机器人飞艇作为轻于空气系统，虽具长续航和安全性，但对风扰动高度敏感，缺乏扰动感知控制框架。
- 方法要点：结合移动水平估计器实时推断风扰动，并集成模型预测控制器进行补偿，利用二自由度移动质量机制生成惯性和气动力矩。
- 实验或效果：在迎风和侧风条件下进行飞行实验，显示该框架显著优于基准PID控制，验证了扰动感知飞行的有效性。
