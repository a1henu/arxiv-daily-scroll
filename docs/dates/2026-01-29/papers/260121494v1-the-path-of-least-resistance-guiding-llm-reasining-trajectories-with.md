...
**一句话要点**：提出PoLR方法，利用前缀一致性优化大语言模型推理效率

**关键词**：大语言模型推理, 前缀一致性, 计算效率优化, 自适应推理, 令牌减少, 延迟降低

## 3 点简述
- 核心问题：自一致性等推理策略计算开销大，需扩展所有推理路径
- 方法要点：聚类推理轨迹短前缀，识别主导簇并扩展，减少令牌使用和延迟
- 实验或效果：在多个数据集匹配或超越自一致性，令牌使用减少达60%，延迟降低达50%
