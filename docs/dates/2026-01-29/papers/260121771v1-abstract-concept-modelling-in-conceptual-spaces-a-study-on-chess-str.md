...
**arXiv**：[2601.21771v1](https://arxiv.org/abs/2601.21771) · [PDF](https://arxiv.org/pdf/2601.21771.pdf)  
**作者**：Hadi Banaee, Stephanie Lowry  

**一句话要点**：提出基于概念空间的抽象概念建模框架，以国际象棋策略为例，通过轨迹分析识别意图策略。

**关键词**：概念空间建模, 抽象概念表示, 轨迹分析, 国际象棋策略, 双视角建模, 时序概念识别

## 3 点简述
- 核心问题：如何建模随时间展开的抽象概念，如国际象棋中的攻击或牺牲策略。
- 方法要点：将策略概念表示为可解释质量维度上的几何区域，游戏实例化为轨迹，通过轨迹朝向区域的方向性移动识别策略。
- 实验或效果：实现轨迹基概念识别，运动模式与专家评论一致，支持双视角建模，探索概念空间理论在时序目标导向概念中的扩展。
