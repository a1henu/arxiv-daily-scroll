...
**一句话要点**：提出基于概念空间的抽象概念建模框架，以国际象棋策略为例验证时序概念识别。

**关键词**：概念空间, 抽象概念建模, 时序概念识别, 国际象棋策略, 轨迹分析, 双视角建模

## 3 点简述
- 核心问题：如何建模随时间展开的抽象概念，如国际象棋中的攻击或牺牲策略。
- 方法要点：将策略表示为可解释质量维度上的几何区域，游戏实例化为轨迹，通过轨迹朝向区域识别策略。
- 实验或效果：实现轨迹识别可行性，运动模式与专家评论一致，支持双视角建模。
