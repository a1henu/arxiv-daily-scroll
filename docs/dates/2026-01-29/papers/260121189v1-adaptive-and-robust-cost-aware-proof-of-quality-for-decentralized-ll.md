...
**关键词**：去中心化LLM推理, 质量证明机制, 鲁棒共识聚合, 评估者采样, 激励对齐, 对抗性攻击

## 3 点简述
- 核心问题：去中心化LLM推理网络中，评估者异质性和恶意评分操纵会扭曲共识，削弱激励对齐。
- 方法要点：扩展成本感知质量证明，引入抗对手的共识形成，包括中位数、修剪均值等鲁棒聚合规则和自适应信任加权共识。
- 实验或效果：在问答和摘要任务上，鲁棒聚合提升共识与真实代理的对齐，降低对噪声和策略攻击的敏感性，并分析评估者采样的操作权衡。
