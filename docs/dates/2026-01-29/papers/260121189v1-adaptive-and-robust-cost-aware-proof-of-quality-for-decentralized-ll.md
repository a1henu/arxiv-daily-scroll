...
**一句话要点**：提出自适应鲁棒成本感知质量证明机制，以增强去中心化LLM推理网络的激励对齐

**关键词**：去中心化LLM推理, 质量证明机制, 鲁棒共识聚合, 激励对齐, 评估节点采样, 对抗性攻击

## 3 点简述
- 核心问题：去中心化LLM推理网络中，评估节点异质性和恶意评分操纵会扭曲共识，削弱激励对齐。
- 方法要点：扩展成本感知质量证明，引入抗对手的共识形成机制，包括中位数、修剪均值等鲁棒聚合规则和自适应信任加权共识。
- 实验或效果：在问答和摘要任务上，鲁棒聚合提高了共识与真实代理的对齐度，降低了对噪声和策略攻击的敏感性，并分析了评估节点采样的操作权衡。
