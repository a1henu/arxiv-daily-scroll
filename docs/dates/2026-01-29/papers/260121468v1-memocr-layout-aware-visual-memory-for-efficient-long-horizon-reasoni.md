...
**一句话要点**：提出MemOCR，通过视觉布局自适应压缩历史信息，以提升有限上下文预算下的长程推理效率。

**关键词**：长程推理, 视觉记忆, 自适应压缩, 强化学习, 上下文预算, 多模态智能体

## 3 点简述
- 核心问题：长程智能体推理需压缩增长的历史交互，但现有文本记忆系统均匀分配令牌成本，浪费预算于低价值细节。
- 方法要点：MemOCR维护结构化富文本记忆，渲染为图像供访问，视觉上优先关键证据并压缩辅助细节，通过强化学习训练适应不同预算。
