...
**一句话要点**：提出JustAsk框架以揭示代码代理中系统提示的安全漏洞

**关键词**：代码代理安全, 系统提示提取, 自主探索框架, 黑盒攻击, 大语言模型漏洞

## 3 点简述
- 核心问题：代码代理的自主性导致系统提示提取成为新兴安全风险
- 方法要点：通过在线探索和分层技能空间自主发现提取策略，无需人工干预
- 实验或效果：在41个黑盒商业模型中实现近乎完整的系统提示恢复
