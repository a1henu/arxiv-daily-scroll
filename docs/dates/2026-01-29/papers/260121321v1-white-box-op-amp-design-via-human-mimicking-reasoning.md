...
**一句话要点**：提出White-Op框架，基于大语言模型模拟人类推理，实现可解释的运算放大器参数设计。

**关键词**：运算放大器设计, 可解释人工智能, 大语言模型, 假设验证决策, 符号化极点零点, 闭式优化

## 3 点简述
- 核心问题：传统黑盒方法在运算放大器设计中缺乏可解释性，导致部分拓扑设计失败。
- 方法要点：通过引入假设约束，模拟人类假设-验证-决策流程，构建闭式数学优化问题。
- 实验效果：在9种拓扑中实现可靠设计，理论预测误差8.52%，所有拓扑晶体管级映射后功能保持。
