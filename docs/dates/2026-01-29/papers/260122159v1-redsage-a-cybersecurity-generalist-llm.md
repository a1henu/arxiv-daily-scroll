...
## 3 点简述
- 核心问题：现有网络安全LLM依赖隐私风险的专有API或缺乏领域适应的开源模型，难以支持多样化工作流。
- 方法要点：基于11.8B令牌的网络安全数据预训练，并通过代理模拟专家工作流生成266K多轮样本进行监督微调。
- 实验或效果：在网络安全基准测试中超越基线模型达+5.59点，并在通用LLM任务中提升+5.05点，展示领域增强提升通用推理能力。
