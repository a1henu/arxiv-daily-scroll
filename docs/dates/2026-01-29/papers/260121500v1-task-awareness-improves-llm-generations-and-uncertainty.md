...
**一句话要点**：提出任务感知解码框架，通过潜在结构建模提升LLM生成质量与不确定性估计

**关键词**：任务感知解码, 潜在结构建模, 贝叶斯最优响应, 不确定性估计, 决策理论框架, LLM生成优化

## 3 点简述
- 核心问题：现有解码方法忽视自然语言响应的潜在结构信息，影响生成与不确定性估计
- 方法要点：在任务依赖潜在空间中建模输出，结合差异度量计算贝叶斯最优响应
- 实验或效果：贝叶斯最优响应优于标准解码方法，不确定性估计更对齐输出质量与正确性
