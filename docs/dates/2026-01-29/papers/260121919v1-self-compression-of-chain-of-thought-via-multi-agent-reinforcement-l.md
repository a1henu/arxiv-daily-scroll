...
**关键词**：推理模型优化, 多智能体强化学习, 冗余推理压缩, 重要性加权惩罚, 推理效率提升

## 3 点简述
- 核心问题：大型推理模型中冗余推理导致推理开销大，影响交互体验和部署，现有强化学习方法难以平衡简洁性与准确性。
- 方法要点：采用多智能体强化学习框架，包括分割智能体分解推理过程为逻辑块、评分智能体量化块重要性，协同定义重要性加权长度惩罚，激励推理智能体保留关键逻辑。
- 实验或效果：实证评估显示，SCMA在多个模型规模上减少响应长度11.1%至39.0%，同时提升准确性4.33%至10.02%，消融研究和定性分析验证了框架的协同优化效果。
