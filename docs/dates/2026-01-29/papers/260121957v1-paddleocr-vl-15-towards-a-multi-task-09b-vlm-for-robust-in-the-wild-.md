...
**关键词**：文档解析, 视觉语言模型, 鲁棒性评估, 多任务学习, 印章识别, 文本定位

## 3 点简述
- 核心问题：野外文档解析面临扫描、倾斜、扭曲等物理失真挑战，影响准确性。
- 方法要点：升级模型至0.9B超紧凑视觉语言模型，集成印章识别和文本定位等多任务能力。
- 实验或效果：在OmniDocBench v1.5上达到94.5%的SOTA准确率，并在新基准Real5-OmniDocBench上验证鲁棒性。
