...
**关键词**：关联偏见, 模型间通信, 人本感知, 人口分布漂移, 可解释性分析, 缓解策略

## 3 点简述
- 核心问题：生成AI中的关联偏见在模型间通信中可能持续传播并放大，影响人本感知任务。
- 方法要点：通过图像生成与描述交替的管道，量化人口分布漂移并使用可解释性分析评估系统性偏差。
- 实验或效果：发现人口表示向年轻和女性漂移，部分预测依赖虚假视觉区域，并探讨下游行为差异。
