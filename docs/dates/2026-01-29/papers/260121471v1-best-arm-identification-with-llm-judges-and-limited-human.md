...
**一句话要点**：提出基于LLM代理和选择性人工审计的算法，以解决带偏置代理的最佳臂识别问题。

**关键词**：最佳臂识别, 多保真度学习, LLM代理, 选择性审计, 置信序列, 逆倾向加权

## 3 点简述
- 研究带偏置代理（如LLM）和选择性人工审计的最佳臂识别问题，标准方法可能导致误选。
- 开发结合代理分数和逆倾向加权残差的估计器，并构建置信序列，提出自适应审计算法。
- 算法集中审计不可靠上下文和接近臂，实验验证理论保证和优越性能。
