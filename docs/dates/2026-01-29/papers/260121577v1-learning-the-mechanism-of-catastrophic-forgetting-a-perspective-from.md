...
**关键词**：灾难性遗忘, 梯度相似性, 大语言模型, 持续学习, 知识注入, 神经元分类

## 3 点简述
- 核心问题：灾难性遗忘在大语言模型知识注入中严重削弱持续学习能力，缺乏理论基础
- 方法要点：建立梯度理论框架，证明强负梯度相似性是遗忘根本原因，识别冲突与协作神经元
- 实验或效果：协作神经元学习方法在设定内实现零遗忘，设定外减少遗忘59.1%-81.7%
