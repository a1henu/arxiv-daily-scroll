...
**一句话要点**：提出基于FLAME参数建模与3DGS神经渲染的轻量级高保真低码率3D人脸压缩框架，适用于实时视频会议。

**关键词**：3D人脸压缩, 低码率传输, 神经渲染, 高斯溅射, 实时视频会议, 参数建模

## 3 点简述
- 核心问题：传统2D压缩难以保留3D人脸几何与外观细节，NeRF等方法计算成本过高。
- 方法要点：集成FLAME参数模型与3D高斯溅射渲染，传输少量面部元数据，采用高斯属性压缩和MLP优化。
- 实验或效果：在极低码率下实现优越的率失真性能，支持高质量实时3D视频会议。
