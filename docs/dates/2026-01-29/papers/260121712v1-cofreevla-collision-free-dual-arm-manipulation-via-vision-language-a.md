...
**关键词**：双机械臂操作, 视觉-语言-动作模型, 自碰撞风险估计, 机器人安全, 端到端学习

## 3 点简述
- 核心问题：双机械臂操作中，视觉-语言-动作模型因未充分建模自碰撞而存在安全隐患
- 方法要点：引入短时域自碰撞风险估计器，基于本体感知、视觉嵌入和计划动作预测碰撞风险
- 实验或效果：在PiPER机器人上测试五个双任务，减少自碰撞并提高成功率
