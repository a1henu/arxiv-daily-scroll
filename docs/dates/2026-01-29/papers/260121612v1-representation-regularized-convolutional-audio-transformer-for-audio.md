...
**一句话要点**：提出卷积音频变换器以解决音频理解中多粒度建模和训练效率问题

**关键词**：音频理解, 自监督学习, 多粒度建模, 表示正则化, 卷积变换器, 训练效率

## 3 点简述
- 现有自监督学习方法在音频理解中受限于单粒度建模，难以捕捉复杂音频信号的多样结构
- CAT引入多分辨率块捕获层次特征，并设计表示正则化目标，利用预训练编码器指导训练
- 实验显示CAT在AudioSet等基准上性能显著提升，收敛速度比现有方法快5倍
