...
**arXiv**：[2601.21915v1](https://arxiv.org/abs/2601.21915) · [PDF](https://arxiv.org/pdf/2601.21915.pdf)  
**作者**：Yunhao Li, Sijing Wu, Zhilin Gao, Zicheng Zhang, Qi Jia, Huiyu Duan, Xiongkuo Min, Guangtao Zhai  

**一句话要点**：提出VideoAesBench基准以评估大型多模态模型的视频美学感知能力

**关键词**：视频美学评估, 大型多模态模型, 基准测试, 多模态感知, 视频质量分析

## 3 点简述
- 核心问题：大型多模态模型在视频美学质量评估能力上尚未充分探索
- 方法要点：构建包含多样视频内容和多问题格式的综合基准VideoAesBench
- 实验或效果：评估23个模型，发现当前模型仅具备基本感知能力，性能不完整
