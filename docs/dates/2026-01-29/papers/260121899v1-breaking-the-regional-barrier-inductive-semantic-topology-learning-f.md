...
**arXiv**：[2601.21899v1](https://arxiv.org/abs/2601.21899) · [PDF](https://arxiv.org/pdf/2601.21899.pdf)  
**作者**：Zhiqing Cui, Siru Zhong, Ming Jin, Shirui Pan, Qingsong Wen, Yuxuan Liang  

**一句话要点**：提出OmniAir框架以解决全球空气质量预测中的空间异质性和泛化难题

**关键词**：空气质量预测, 语义拓扑学习, 全球站级预测, 空间异质性, 泛化能力, 非欧相关性

## 3 点简述
- 全球空气质量预测面临空间异质性强和现有模型泛化到未知区域能力差的问题
- OmniAir通过编码不变物理环境属性和动态构建自适应稀疏拓扑来捕获长程非欧相关性和物理扩散模式
- 实验表明OmniAir在18个基线中达到最优性能，速度提升近10倍，并在数据稀疏区域有效填补监测空白
