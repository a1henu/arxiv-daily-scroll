...
**一句话要点**：分析课程学习对LLM预训练学习动态的影响，揭示其通过稳定优化而非改变学习阶段提升性能

**关键词**：课程学习, LLM预训练, 学习动态, 梯度方差控制, 优化稳定性, Pythia模型

## 3 点简述
- 核心问题：课程学习是否改变LLM预训练的学习轨迹，还是仅重排数据暴露顺序
- 方法要点：训练Pythia模型，比较随机排序与三种语言学课程（习得年龄、词频、动词变化）
- 实验或效果：课程学习减少梯度噪声和输出头谱饱和，提升小模型性能，但大模型增益缩小
