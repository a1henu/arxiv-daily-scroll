...
**一句话要点**：研究提示协议如何影响语言模型陈述与揭示偏好差距，发现相关性高度依赖协议设计

**关键词**：语言模型偏好, 陈述与揭示偏好差距, 提示协议, 偏好诱导, 相关性分析, 中立偏好

## 3 点简述
- 核心问题：语言模型存在陈述与揭示偏好差距，现有评估方法混淆真实偏好与协议人为因素
- 方法要点：系统分析24个语言模型，通过允许中立和弃权来改进陈述偏好与揭示偏好的相关性
- 实验或效果：陈述偏好中允许中立可提升相关性，但揭示偏好中允许弃权导致相关性接近零或负值
