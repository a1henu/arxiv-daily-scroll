...
**arXiv**：[2602.05888v1](https://arxiv.org/abs/2602.05888) · [PDF](https://arxiv.org/pdf/2602.05888.pdf)  
**作者**：Merlin de la Haye, Pascal Lenzner, Farehe Soheil, Marcus Wunderlich  

**一句话要点**：提出基于线度量距离的享乐博弈模型，研究稳定联盟形成与性质

**关键词**：享乐博弈, 联盟形成, 稳定性分析, 度量距离, 价格差异

## 3 点简述
- 核心问题：研究享乐博弈中基于代理类型值差异的联盟形成稳定性与质量
- 方法要点：定义基于距离阈值、最大值或平均值差异的成本函数，分析交换和跳跃稳定性
- 实验或效果：发现稳定联盟结构总存在，但性质与价格差异大，受联盟数量限制影响
