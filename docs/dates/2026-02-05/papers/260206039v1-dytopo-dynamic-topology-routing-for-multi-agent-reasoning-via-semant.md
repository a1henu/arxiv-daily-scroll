...
**一句话要点**：提出DyTopo框架，通过语义匹配动态重构通信图以提升多智能体推理性能

**关键词**：多智能体系统, 动态拓扑路由, 语义匹配, 大语言模型, 推理框架, 通信图

## 3 点简述
- 现有基于大语言模型的多智能体系统依赖固定通信模式，难以适应迭代问题求解的阶段需求
- DyTopo在每轮推理中基于管理器目标，通过智能体生成查询与关键描述符的语义匹配重构稀疏有向通信图
- 在代码生成和数学推理基准测试中，DyTopo平均性能提升6.2%，并提供可解释的协调轨迹
