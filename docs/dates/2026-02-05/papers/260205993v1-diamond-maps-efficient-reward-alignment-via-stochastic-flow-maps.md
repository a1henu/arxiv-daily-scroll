...
**关键词**：奖励对齐, 随机流映射, 推理时适应, 生成模型, 蒸馏学习, 可扩展性

## 3 点简述
- 核心问题：流和扩散模型训练后适应偏好或约束成本高且脆弱，奖励对齐困难。
- 方法要点：设计随机流映射模型，将多步模拟摊销为单步采样，保留随机性以支持最优对齐。
- 实验或效果：通过GLASS Flows蒸馏高效学习，奖励对齐性能更强，可扩展性优于现有方法。
