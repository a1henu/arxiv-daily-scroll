...
**一句话要点**：提出AgenticPay基准与框架，用于评估多智能体买家-卖家语言谈判

**关键词**：多智能体谈判, 语言基准, 买家-卖家交易, 战略推理, 经济交互

## 3 点简述
- 核心问题：现有基准缺乏评估多智能体语言经济交互的原则性设置
- 方法要点：基于自然语言驱动谈判，建模私有约束和产品依赖估值，支持110+任务
- 实验或效果：基准测试显示先进LLM在谈判性能和长时程战略推理方面存在显著差距
