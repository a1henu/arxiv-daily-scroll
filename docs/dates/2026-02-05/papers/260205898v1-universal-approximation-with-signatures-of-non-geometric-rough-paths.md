...
**arXiv**：[2602.05898v1](https://arxiv.org/abs/2602.05898) · [PDF](https://arxiv.org/pdf/2602.05898.pdf)  
**作者**：Mihriban Ceylan, Anna P. Kwossek, David J. Prömel  

**一句话要点**：提出非几何粗糙路径签名的通用逼近定理，扩展路径以逼近连续泛函，应用于金融模型校准与期权定价。

**关键词**：粗糙路径签名, 通用逼近定理, 路径扩展, 金融数学, 模型校准, 期权定价

## 3 点简述
- 核心问题：非几何粗糙路径的签名能否实现通用逼近，以处理更广泛的路径空间。
- 方法要点：通过扩展路径的时间及其括号项，证明线性泛函在紧集上均匀逼近连续泛函。
- 实验或效果：数值示例展示扩展路径签名在金融模型校准和期权定价中的实际应用。
