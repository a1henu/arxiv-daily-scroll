...
**关键词**：大语言模型推理, 对抗学习, 指导性语言评估, 认知协同, 奖励优化, 自我纠正

## 3 点简述
- 核心问题：传统强化学习依赖标量奖励，成本高、脆弱且忽视逻辑，阻碍模型推理能力发展。
- 方法要点：基于认知协同原则，结合对抗学习和指导性语言反馈，统一问题提出、解决和评判于单一策略模型。
- 实验或效果：在数学推理、代码生成和逻辑推理基准上，ALIVE提升准确性、跨域泛化能力和自我纠正率。
