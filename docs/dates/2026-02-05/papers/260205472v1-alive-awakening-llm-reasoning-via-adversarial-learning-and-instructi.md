...
**一句话要点**：提出ALIVE框架以解决大语言模型推理中的奖励瓶颈问题

**关键词**：大语言模型推理, 对抗学习, 指导性语言评估, 认知协同, 奖励瓶颈缓解, 无监督对齐

## 3 点简述
- 核心问题：传统强化学习依赖标量奖励，成本高、跨域脆弱且忽视逻辑，阻碍模型深度推理能力发展。
- 方法要点：基于认知协同原则，统一问题提出、解决与评判于单一策略模型，通过对抗学习和指导性语言反馈内化推理逻辑。
- 实验或效果：在数学推理、代码生成和逻辑推理基准测试中，ALIVE提升准确性、跨域泛化能力和自我纠正率，无需人工监督。
