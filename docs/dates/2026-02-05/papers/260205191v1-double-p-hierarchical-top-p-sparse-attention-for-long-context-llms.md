...
**关键词**：稀疏注意力, 长上下文推理, 大语言模型, top-p选择, 分层优化, 解码加速

## 3 点简述
- 核心问题：长上下文推理中，注意力计算成为瓶颈，现有top-p方法未联合优化精度、选择开销和稀疏成本。
- 方法要点：采用分层设计，先基于聚类进行粗粒度top-p估计，再自适应细化token级注意力计算。
- 实验或效果：在长上下文基准测试中，实现近零精度损失，计算开销降低1.8倍，解码速度提升1.3倍。
