...
**一句话要点**：提出非统计查询框架以分析标准SGD在单索引和多索引模型中的局限性

**关键词**：随机梯度下降, 多索引模型, 学习理论, 梯度方法局限性, 非统计查询框架

## 3 点简述
- 核心问题：现有统计查询框架与SGD连接薄弱，噪声假设不反映标准SGD，导致预测可能错误
- 方法要点：开发新非统计查询框架，直接研究标准SGD在单索引和多索引模型中的性能限制
- 实验或效果：框架适用于广泛设置和架构，包括深度神经网络，无需特殊算法修改
