...
**一句话要点**：提出AIM-RM智能体，通过相似性匹配提升LLM多智能体系统在供应链库存管理中的适应性与性能。

**关键词**：库存管理, 多智能体系统, 大型语言模型, 相似性匹配, 供应链优化

## 3 点简述
- 核心问题：LLM多智能体系统在库存管理中能否稳定生成最优订购策略并适应多样场景。
- 方法要点：采用结构化决策提示和基于相似性匹配的AIM-RM智能体，利用历史经验增强适应性。
- 实验或效果：AIM-RM在多种供应链场景中优于基准方法，展现出鲁棒性和适应性。
