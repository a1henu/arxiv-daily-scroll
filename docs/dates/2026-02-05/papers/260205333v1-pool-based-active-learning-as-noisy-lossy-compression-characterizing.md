...
**一句话要点**：提出信息论框架，将池式主动学习建模为噪声有损压缩问题

**关键词**：池式主动学习, 信息论框架, 噪声有损压缩, 有限块长分析, 标签复杂度, 泛化误差

## 3 点简述
- 核心问题：分析池式主动学习的理论极限，包括标签复杂度和泛化误差
- 方法要点：通过有限块长分析推导信息论下界，反映算法过拟合和归纳偏差
- 实验或效果：提供新理论视角，关联信息论界和稳定性理论，未涉及具体实验
