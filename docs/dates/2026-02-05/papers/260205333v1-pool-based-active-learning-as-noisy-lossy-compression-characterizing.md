...
**一句话要点**：提出信息论框架分析池式主动学习的理论极限，将其建模为噪声有损压缩问题。

**关键词**：池式主动学习, 信息论分析, 噪声有损压缩, 有限块长分析, 标签复杂度, 泛化误差

## 3 点简述
- 核心问题：分析池式主动学习在选择性标注下的理论极限，包括标签复杂度和泛化误差。
- 方法要点：将池式主动学习映射为噪声有损压缩，应用有限块长分析推导信息论下界。
- 实验或效果：理论界限包含过拟合和归纳偏差项，提供池式主动学习的新理论视角。
