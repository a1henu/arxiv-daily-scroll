...
**关键词**：电价预测, 时间序列基础模型, 尖峰正则化, 波动市场, 深度学习

## 3 点简述
- 核心问题：电力市场波动大，传统模型难以有效捕捉复杂时间依赖和整合异构数据。
- 方法要点：引入尖峰正则化策略，并评估多种时间序列基础模型如TTMs、MOIRAI等。
- 实验或效果：在新加坡波动市场数据上，基础模型优于传统方法，MAPE提升最高达37.4%。
