...
**一句话要点**：提出PatchFlow方法，结合局部补丁特征与归一化流模型，提升压铸表面缺陷检测精度

**关键词**：异常检测, 归一化流模型, 补丁特征, 压铸缺陷检测, 计算机视觉, 工业图像分析

## 3 点简述
- 核心问题：压铸表面缺陷检测自动化需求高，现有方法在工业图像上精度不足
- 方法要点：引入适配器模块桥接预训练特征提取器与工业图像，结合局部邻域感知补丁特征与归一化流模型
- 实验或效果：在MVTec AD数据集上图像级AUROC达99.28%，错误率降低20%，无需异常样本训练
