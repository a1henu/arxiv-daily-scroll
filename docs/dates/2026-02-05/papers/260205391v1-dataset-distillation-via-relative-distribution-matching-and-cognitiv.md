...
**一句话要点**：提出统计流匹配与分类器继承策略，以高效实现数据集蒸馏

**关键词**：数据集蒸馏, 统计流匹配, 分类器继承, 计算效率, 自监督学习, 图像合成

## 3 点简述
- 针对分类任务中基于预训练自监督模型的数据集蒸馏计算开销大问题
- 引入统计流匹配方法，通过对齐原始数据中类别中心间的统计流优化合成图像
- 实验显示在GPU内存使用减少10倍、运行时间缩短4倍下，性能达到或优于先进方法
