...
**关键词**：功能连接建模, 核心集选择, 基准测试, 自监督学习, Transformer, 神经科学

## 3 点简述
- 核心问题：大规模fMRI数据中功能连接建模方法基准测试计算成本过高，阻碍可重复神经科学评估。
- 方法要点：通过自监督框架SCLCS，学习样本功能连接结构并量化稳定性，选择代表性核心集以保持模型排名。
- 实验或效果：在REST-meta-MDD数据集上，仅用10%数据即保持模型排名，排名一致性优于现有方法达23.2%。
