...
**arXiv**：[2602.05668v1](https://arxiv.org/abs/2602.05668) · [PDF](https://arxiv.org/pdf/2602.05668.pdf)  
**作者**：Zhipeng Zhang, Kai Li  

**一句话要点**：揭示数据驱动科学的固有局限：稳定收敛可能导向错误结论

**关键词**：数据驱动科学, 推断可靠性, 观测完整性, 收敛稳定性, 诊断误导

## 3 点简述
- 核心问题：数据量增加可能系统性导致错误结论，而非提高可靠性
- 方法要点：识别标准推断过程在特定结构下收敛至错误结论的机制
- 实验或效果：通过合成实验展示数据放大错误，诊断指标保持误导性正常
