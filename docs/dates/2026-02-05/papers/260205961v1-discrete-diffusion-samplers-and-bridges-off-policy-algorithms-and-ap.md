...
**一句话要点**：提出离策略训练技术以改进离散扩散采样器，并扩展至离散域数据到能量薛定谔桥任务

**关键词**：离散扩散采样, 离策略训练, 薛定谔桥, 隐空间采样, 后验采样, 图像生成模型

## 3 点简述
- 核心问题：离散空间采样效率低，现有方法未充分利用连续空间采样思想
- 方法要点：引入离策略训练技术，提升离散扩散采样器性能，并推广至分布间桥接任务
