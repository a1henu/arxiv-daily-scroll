...
**一句话要点**：提出端到端工具链，将无人机冲击测试转化为可部署的安全限制器，以保障室内近人操作安全。

**关键词**：无人机安全, 冲击测试, 数据驱动模型, 安全限制器, 室内操作, ROS2节点

## 3 点简述
- 室内微型飞行器近人操作缺乏基于实测冲击风险的运动限制调优方法。
- 开发可复制的冲击测试装置与协议，建立速度到冲击力的数据驱动模型。
- 在多种商用无人机上验证，确保任务吞吐量同时满足安全力约束。
