...
**关键词**：无人机安全, 冲击测试, 运动限制, ROS2节点, 室内操作, 端到端工具链

## 3 点简述
- 核心问题：室内微型飞行器近人操作缺乏基于实测冲击风险的运动限制调优方法。
- 方法要点：开发可复现冲击测试装置与协议，建立速度-冲量模型，并实现ROS2在线限制节点。
- 实验或效果：在多种商用无人机上验证，确保满足力约束同时保持任务吞吐量。
