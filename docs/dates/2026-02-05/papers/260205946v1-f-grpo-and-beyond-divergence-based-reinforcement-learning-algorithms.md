...
**一句话要点**：提出f-GRPO和f-HAL算法，基于f-散度统一框架解决大语言模型通用对齐问题。

**关键词**：大语言模型对齐, f-散度, 强化学习, 策略优化, 偏好对齐, 数学推理

## 3 点简述
- 核心问题：将偏好对齐的散度视角扩展到通用对齐场景，如仅依赖环境奖励的强化学习。
- 方法要点：基于f-散度变分表示，提出f-GRPO在线策略优化和f-HAL混合策略目标。
- 实验或效果：在数学推理和安全对齐任务上验证，相比现有方法展现优越性能和灵活性。
