...
**一句话要点**：提出基于椎间盘对比学习的腰椎狭窄严重程度自动分级方法，以矢状面T2加权MRI为输入。

**关键词**：腰椎狭窄分级, 对比学习, 椎间盘特征, 医学影像分析, MRI自动诊断

## 3 点简述
- 核心问题：自动评估腰椎狭窄严重程度，需处理图像外观差异和类别不平衡。
- 方法要点：采用对比预训练和椎间盘级微调，结合辅助回归任务和加权焦点损失。
- 实验或效果：平衡准确率达78.1%，严重到正常误分类率降至2.13%，优于从头监督训练。
