...
**关键词**：三维重建, 条纹投影轮廓术, 潜在扩散模型, 高反射物体, 镜面反射抑制, 条纹图像恢复

## 3 点简述
- 核心问题：高反射物体条纹投影三维重建中，镜面反射和间接光照导致条纹图案失真或丢失
- 方法要点：使用潜在扩散模型，以编码的反射特征为条件，概率性抑制反射伪影并恢复条纹信息
- 实验或效果：实验显示，该方法优于现有方法，将平均均方根误差从1.8176毫米降至0.9619毫米
