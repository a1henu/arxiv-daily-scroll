...
**一句话要点**：提出渐进式感知-动作框架PAiD，以解决人形机器人足球技能学习中模块不稳定或目标冲突问题。

**关键词**：人形机器人, 足球技能学习, 感知-动作集成, 渐进式架构, 仿真到现实迁移, 鲁棒控制

## 3 点简述
- 核心问题：人形机器人足球技能学习面临模块化流程不稳定或端到端框架训练目标冲突的挑战。
- 方法要点：采用三阶段渐进架构，包括运动技能获取、轻量级感知-动作集成和物理感知的仿真到现实迁移。
- 实验或效果：在Unitree G1上实现高保真踢球，在多样条件下保持鲁棒性能，室内外场景一致执行。
