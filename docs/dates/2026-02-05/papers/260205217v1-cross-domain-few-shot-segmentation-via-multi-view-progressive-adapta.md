...
**一句话要点**：提出多视图渐进适应方法以解决跨域少样本分割中目标域样本有限和域差距大的问题。

**关键词**：跨域少样本分割, 渐进适应, 多视图学习, 数据增强, 监督学习, 域适应

## 3 点简述
- 核心问题：目标域样本少且多样性不足，源域模型在目标域初始少样本能力弱，域差距大阻碍适应。
- 方法要点：从数据和策略角度渐进适应，包括混合渐进增强生成复杂视图和双链多视图预测利用监督学习路径。
- 实验或效果：在跨域少样本分割任务中大幅超越现有方法，性能提升7.0%。
