...
**一句话要点**：提出多视图渐进适应方法，以解决跨域少样本分割中目标域样本有限和域差距大的问题。

**关键词**：跨域少样本分割, 渐进适应, 多视图学习, 数据增强, 监督学习, 图像分割

## 3 点简述
- 核心问题：跨域少样本分割中，目标域样本少且多样性不足，源域模型在目标域初始性能弱，域差距大，阻碍有效适应。
- 方法要点：从数据和策略角度渐进适应，包括混合渐进增强生成多样复杂视图，以及双链多视图预测通过顺序和并行路径强化监督。
- 实验或效果：在广泛实验中，MPA显著优于现有方法，性能提升7.0%，有效适应目标域。
