...
**一句话要点**：提出OmniMoE框架，通过系统算法协同设计解决细粒度MoE中路由复杂性与内存访问效率问题。

**关键词**：混合专家模型, 系统算法协同设计, 细粒度路由, 内存访问优化, 推理加速, 零样本学习

## 3 点简述
- 核心问题：现有MoE架构在专家粒度与硬件执行效率间存在固有权衡，细粒度设计导致路由复杂和内存访问瓶颈。
- 方法要点：引入向量级原子专家，采用笛卡尔积路由器降低路由复杂度，并利用专家中心调度优化内存访问为密集矩阵运算。
- 实验或效果：在七个基准测试中，OmniMoE以1.7B激活参数实现50.9%零样本准确率，推理延迟相比PEER降低10.9倍至6.7毫秒。
