...
**一句话要点**：提出基于虚拟现实数据驱动的离散事件模拟器，以规模化评估学校安全干预策略。

**关键词**：虚拟现实, 离散事件模拟, 学校安全, 数据驱动建模, 干预策略评估

## 3 点简述
- 核心问题：虚拟现实评估学校安全措施需招募新参与者，难以大规模或迭代测试干预策略。
- 方法要点：从虚拟现实实验中学习射击者行为作为随机过程，构建离散事件模拟器。
- 实验或效果：模拟器再现关键经验模式，用于评估机器人干预策略，支持规模化学习。
