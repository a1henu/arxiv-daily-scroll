...
**一句话要点**：提出AFT-Handover框架，结合LLM推理与纹理化可负担性转移，实现零样本任务导向机器人-人交接于腿式操纵器。

**关键词**：任务导向交接, 可负担性推理, 零样本泛化, 腿式操纵器, 纹理化转移

## 3 点简述
- 核心问题：现有任务导向交接方法基于对象或任务特定可负担性，泛化能力有限。
- 方法要点：利用LLM驱动可负担性推理和基于纹理的可负担性转移，实现零样本泛化。
