...
**关键词**：SE(3)位姿估计, 几何可观测性指数, 影响函数理论, 李群扰动算子, 动态特征检测, 弱可观测性分析

## 3 点简述
- 核心问题：现有工具无法解释单图像特征对位姿估计的影响及动态观测的失真效应
- 方法要点：扩展影响函数理论至矩阵李群，推导SE(3)上左平凡化M估计器的内蕴扰动算子
- 实验或效果：GOI提供轻量级诊断信号，无需修改SLAM架构即可识别动态特征和弱可观测配置
