...
**一句话要点**：提出DECO框架，通过解耦多模态条件化实现双手机器人灵巧操作，并附带触觉适配器。

**关键词**：双手机器人操作, 多模态学习, 扩散变换器, 触觉感知, 策略微调, 数据集构建

## 3 点简述
- 核心问题：双手机器人灵巧操作中多模态信号（如图像、触觉）的有效集成与策略学习。
- 方法要点：基于DiT的解耦策略，图像与动作令牌通过联合自注意力交互，触觉信号通过交叉注意力注入，使用LoRA适配器微调。
- 实验或效果：构建DECO-50数据集，包含4场景28子任务，超过50小时数据，约500万帧和8000成功轨迹。
