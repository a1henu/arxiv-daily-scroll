...
**关键词**：交通监控数据集, 遮挡车辆检测, 极端天气条件, 目标检测基准, 智能交通系统

## 3 点简述
- 核心问题：现有数据集缺乏极端天气条件，影响交通监控中遮挡车辆的准确检测
- 方法要点：构建包含超32小时真实交通视频的数据集，涵盖多种天气和八类交通参与者
- 实验或效果：建立目标检测基准，突显遮挡和恶劣天气带来的挑战，推动智能交通系统研究
