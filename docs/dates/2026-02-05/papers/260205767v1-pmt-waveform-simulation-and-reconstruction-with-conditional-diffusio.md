...
**一句话要点**：提出基于双向条件扩散网络的弱监督波形模拟与重建方法以解决光电倍增管波形重建中缺乏真实标签的问题

**关键词**：光电倍增管波形重建, 条件扩散网络, 弱监督学习, 光电子重叠, 波形模拟, 粒子物理实验

## 3 点简述
- 核心问题：光电倍增管波形重建中，多光子到达导致光电子重叠，缺乏真实标签限制监督方法应用。
- 方法要点：采用双向条件扩散网络，通过光电子条件模拟波形和波形条件重建光电子，迭代提升重建精度。
- 实验或效果：实验显示，该方法在1-5光电子范围内达到全监督学习归一化光电子数分辨率的99%和时序分辨率的80%。
