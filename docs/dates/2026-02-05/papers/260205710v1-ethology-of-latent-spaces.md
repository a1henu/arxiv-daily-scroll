...
**一句话要点**：提出计算潜在政治化等概念，以批判性评估视觉语言模型在数字艺术史中的应用条件。

**关键词**：潜在空间分析, 视觉语言模型, 计算民族学, 算法敏感性, 数字艺术史, 模型对比

## 3 点简述
- 核心问题：挑战视觉语言模型中潜在空间的中立性假设，揭示其受训练数据和架构影响的算法敏感性。
- 方法要点：采用民族学视角，通过对比分析三个模型在艺术作品上的政治和文化分类差异。
