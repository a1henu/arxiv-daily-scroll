...
**一句话要点**：提出CSRv2训练方法以解决超稀疏嵌入在性能与效率上的瓶颈，适用于实时与边缘AI系统。

**关键词**：稀疏嵌入, 对比学习, 渐进训练, 表示学习, 效率优化, 边缘计算

## 3 点简述
- 核心问题：CSR在超稀疏（如k=2）时性能严重下降，80%神经元不活跃，效率潜力未发挥。
- 方法要点：通过渐进k退火稳定稀疏学习，监督对比目标提升表示质量，全骨干微调确保端到端适应性。
- 实验或效果：将死神经元从80%降至20%，k=2时准确率提升14%，相比MRL加速7倍，计算与内存效率提升达300倍。
