...
**一句话要点**：提出CSRv2训练方法以解决超稀疏嵌入在性能与效率平衡中的退化问题

**关键词**：稀疏嵌入, 对比学习, 表示学习, 效率优化, 端到端训练, 超稀疏嵌入

## 3 点简述
- 核心问题：CSR在超稀疏状态下（如k=2）性能严重下降，死神经元过多，效率潜力未发挥。
- 方法要点：采用渐进k退火稳定稀疏学习，结合监督对比目标提升表示质量，支持全骨干微调实现端到端适应。
- 实验或效果：在文本和视觉任务中，CSRv2将死神经元从80%降至20%，k=2时准确率提升14%，效率优于MRL和密集嵌入。
