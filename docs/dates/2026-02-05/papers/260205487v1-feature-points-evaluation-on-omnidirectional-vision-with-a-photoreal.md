...
**关键词**：鱼眼图像, 特征点检测, 视觉里程计, 自标定, 车载视觉, 数据集

## 3 点简述
- 核心问题：鱼眼图像特征点检测与描述在自标定中面临先有鸡还是先有蛋的困境，缺乏准确投影模型影响特征质量
- 方法要点：提供PFSeq数据集和详细实验，比较标准特征算法在鱼眼图像上的性能，未设计新算法
- 实验或效果：基于2014年实验，未更新或同行评审，结果作为草案贡献，数据集公开可用
