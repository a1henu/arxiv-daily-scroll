...
**arXiv**：[2602.05406v1](https://arxiv.org/abs/2602.05406) · [PDF](https://arxiv.org/pdf/2602.05406.pdf)  
**作者**：Isaac Wiafe, Akon Obu Ekpezu, Sumaya Ahmed Salihs, Elikem Doe Atsakpo, Fiifi Baffoe Payin Winful, Jamal-Deen Abdulai  

**一句话要点**：提出阿坎语障碍语音数据集以解决低资源语言中包容性语音技术的数据缺乏问题。

**关键词**：障碍语音识别, 低资源语言, 阿坎语数据集, 语音障碍分类, 辅助语音技术

## 3 点简述
- 核心问题：低资源语言如阿坎语缺乏障碍语音数据，阻碍包容性语音技术发展。
- 方法要点：构建包含50.01小时音频的障碍语音数据集，涵盖口吃、脑瘫、腭裂和中风四类障碍。
- 实验或效果：数据集包含音频、转录和元数据，支持低资源自动障碍语音识别和辅助技术研究。
