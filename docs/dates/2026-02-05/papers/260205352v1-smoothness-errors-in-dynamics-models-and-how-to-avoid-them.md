...
**一句话要点**：提出松弛酉卷积以平衡平滑性，提升动态建模在物理系统上的性能。

**关键词**：图神经网络, 动态建模, 偏微分方程, 平滑性误差, 酉卷积, 天气预报

## 3 点简述
- 核心问题：图神经网络在动态建模中因过度平滑或酉卷积约束过强而性能受限。
- 方法要点：引入松弛酉卷积，在保持平滑性的同时适应物理系统的自然平滑需求。
- 实验或效果：在热方程、波动方程和天气预报任务中，优于多种基线方法。
