...
**arXiv**：[2602.05857v1](https://arxiv.org/abs/2602.05857) · [PDF](https://arxiv.org/pdf/2602.05857.pdf)  
...
**一句话要点**：提出BABE基准以评估生物AI系统的实验推理能力

**关键词**：生物AI基准, 实验推理评估, 因果推理, 跨尺度推断, 科学推理能力

## 3 点简述
- 核心问题：现有生物基准缺乏评估AI整合实验结果与背景知识的能力
- 方法要点：基于同行评审论文和真实研究构建，强调因果推理和跨尺度推断
- 实验或效果：提供框架评估AI系统能否像科学家一样推理，衡量其对生物研究的贡献潜力
