...
**关键词**：视觉语言模型, 空间推理, 以他者为中心感知, 几何重建, 帧实例化, 训练免费策略

## 3 点简述
- 核心问题：视觉语言模型在需要显式视角转换的以他者为中心空间查询中表现脆弱，答案依赖于目标中心框架而非观察视角。
- 方法要点：利用现成几何专家从图像恢复度量3D状态，实例化与指令语义意图对齐的查询条件化以他者为中心参考框架，通过确定性几何变换和结构化表示提示骨干模型。
- 实验或效果：在空间推理基准测试中，多个骨干模型上以他者为中心任务性能提升约10%，同时保持强以自我为中心性能，超越空间感知微调模型和先进开源与专有模型。
