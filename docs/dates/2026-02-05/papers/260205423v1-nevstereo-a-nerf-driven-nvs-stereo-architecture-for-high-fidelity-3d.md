...
**关键词**：神经辐射场, 多视角立体视觉, 新视角合成, 表面重建, 光束法平差, 零样本学习

## 3 点简述
- 核心问题：现有方法难以从随意拍摄图像中同时获得准确姿态、可靠深度、高质量渲染和精确3D表面。
- 方法要点：结合NeRF新视角合成、置信度引导多视角深度估计、NeRF耦合光束法平差和迭代细化，提升几何一致性。
- 实验或效果：在多个基准测试中实现零样本强性能，深度误差降低达36%，姿态精度提升10.4%，新视角合成保真度提高4.5%，网格质量达到先进水平。
