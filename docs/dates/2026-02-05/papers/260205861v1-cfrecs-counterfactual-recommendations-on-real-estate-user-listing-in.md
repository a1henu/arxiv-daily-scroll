...
**关键词**：反事实图学习, 图神经网络, 推荐系统, 房地产数据, 可解释性AI

## 3 点简述
- 核心问题：图神经网络在推荐系统中缺乏可解释性，难以提供可操作的改进建议。
- 方法要点：采用两阶段架构，结合GNN和图变分自编码器，优化图结构和节点属性的最小变化以驱动期望结果。
- 实验或效果：在Zillow用户-房源交互数据上验证有效性，为买卖双方提供竞争性住房市场导航建议。
