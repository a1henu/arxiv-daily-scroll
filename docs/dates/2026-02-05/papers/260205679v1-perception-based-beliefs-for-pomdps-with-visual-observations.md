...
**一句话要点**：提出基于感知的信念框架以解决高维视觉观测POMDP规划问题

**关键词**：部分可观测马尔可夫决策过程, 视觉观测, 信念更新, 感知模型, 不确定性量化, 图像分类器

## 3 点简述
- 核心问题：传统POMDP求解器难以处理高维视觉观测，如相机图像，导致规划不可行。
- 方法要点：引入感知模型作为图像分类器，将视觉观测映射到状态概率分布，直接集成到信念更新中。
- 实验或效果：在实验中，该框架优于端到端深度强化学习方法，且不确定性量化提升了对抗视觉损坏的鲁棒性。
