...
**一句话要点**：提出神经形态控制框架以解决视觉导航中反应式与模型式控制间的决策困境

**关键词**：神经形态控制, 视觉导航, 动态分岔, 机器人自主性, 实时系统

## 3 点简述
- 核心问题：机器人导航中反应式控制与模型式规划间的决策对称性难以调和
- 方法要点：利用动态神经元群将视觉输入直接映射为运动命令，通过动态分岔机制延迟决策
- 实验或效果：在仿真和四旋翼平台上验证了实时自主性、低计算负担和可解释性
