...
**arXiv**：[2602.05687v1](https://arxiv.org/abs/2602.05687) · [PDF](https://arxiv.org/pdf/2602.05687.pdf)  
**作者**：Pavithren V S Pakianathan, Rania Islambouli, Diogo Branco, Albrecht Schmidt, Tiago Guerreiro, Jan David Smeddinck  

**一句话要点**：探索AI增强患者生成健康数据理解：基于大语言模型的总结与对话界面在心血管风险降低中的应用研究

**关键词**：患者生成健康数据, 大语言模型, 数据理解, 临床工作流, 混合方法研究, 心血管风险降低

## 3 点简述
- 核心问题：患者生成健康数据规模大、异质性强，医疗专业人员面临时间压力和数据素养不足，阻碍临床整合。
- 方法要点：结合大语言模型生成自动总结和自然语言对话界面，支持数据探索，原型集成常见图表和AI功能。
- 实验或效果：16名医疗专业人员参与混合方法研究，AI总结提供快速概览，对话交互增强灵活分析，但存在透明度、隐私和过度依赖担忧。
