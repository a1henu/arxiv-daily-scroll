...
**arXiv**：[2602.05706v1](https://arxiv.org/abs/2602.05706) · [PDF](https://arxiv.org/pdf/2602.05706.pdf)  
**作者**：Shadi Attarha, Kanaga Shanmugi, Anna Förster  

**一句话要点**：提出基于规则和深度学习的图像篡改检测方法，以解决户外物联网摄像头静态图像篡改检测难题。

**关键词**：摄像头篡改检测, 静态图像分析, 规则方法, 深度学习, 户外物联网系统, 公开数据集

## 3 点简述
- 核心问题：户外智能摄像头易受篡改，静态图像检测因缺乏连续帧而更具挑战性。
- 方法要点：开发规则方法和深度学习方法，评估准确性、计算需求和训练数据要求。
- 实验或效果：深度学习模型准确性更高，规则方法更适合资源有限或校准不便的场景。
