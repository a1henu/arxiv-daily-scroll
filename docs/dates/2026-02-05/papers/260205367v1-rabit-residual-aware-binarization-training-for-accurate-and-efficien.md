...
**一句话要点**：提出RaBiT框架，通过残差层次化解决大语言模型二值化训练中的特征共适应问题

**关键词**：大语言模型量化, 二值化训练, 残差层次化, 硬件友好推理, 量化感知训练

## 3 点简述
- 核心问题：残差二值化训练中并行路径特征冗余，导致误差补偿结构退化
- 方法要点：从共享全精度权重顺序推导二值路径，强制残差层次化以纠正误差
- 实验或效果：在2位量化中实现最优性能，推理速度比全精度模型快4.49倍
