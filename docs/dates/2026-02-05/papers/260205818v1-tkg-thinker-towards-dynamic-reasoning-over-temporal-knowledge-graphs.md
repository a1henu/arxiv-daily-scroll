...
**一句话要点**：提出TKG-Thinker，通过智能体强化学习解决时序知识图谱问答中的推理幻觉与静态提示限制问题。

**关键词**：时序知识图谱问答, 智能体强化学习, 动态推理, 监督微调, 多轮交互

## 3 点简述
- 核心问题：当前LLM在时序知识图谱问答中易产生推理幻觉，且静态提示缺乏动态交互优化。
- 方法要点：采用双训练策略，先监督微调注入规划能力，再强化学习优化推理策略。
- 实验或效果：在基准数据集上实现最优性能，并展示强泛化能力。
