...
**关键词**：神经隐式函数, 3D心脏重建, 稀疏视图, 经胸超声心动图, CT血管造影, 形状先验学习

## 3 点简述
- 核心问题：从稀疏的CTA切片（模拟2D经胸超声心动图视图）重建完整3D心脏形状，以支持心脏解剖和功能的定量分析。
- 方法要点：使用多层感知机学习3D心脏形状先验，通过联合优化潜在编码和刚性变换，从模拟视图的切片分割中重建3D心脏腔室和左心室心肌。
- 实验或效果：在保留的CTA分割数据集上，平均Dice系数为0.86±0.04，左心室和左心房体积误差显著低于临床标准Simpson双平面规则。
