...
**一句话要点**：提出H-AdminSim以模拟医院行政工作流程，集成FHIR支持LLM自动化评估。

**关键词**：医院行政模拟, 多智能体系统, FHIR集成, LLM自动化评估, 工作流程仿真

## 3 点简述
- 核心问题：现有研究忽略医院行政工作流程的复杂性，缺乏端到端模拟。
- 方法要点：结合真实数据生成与多智能体模拟，通过FHIR集成实现跨医院环境测试。
- 实验或效果：使用详细评分标准定量评估任务，为LLM自动化提供标准化测试平台。
