...
**arXiv**：[2602.05407v1](https://arxiv.org/abs/2602.05407) · [PDF](https://arxiv.org/pdf/2602.05407.pdf)  
**作者**：Jun-Min Lee, Meong Hi Son, Edward Choi  

**一句话要点**：提出H-AdminSim以解决医院行政工作流模拟的复杂性与标准化评估问题

**关键词**：医院行政工作流模拟, 多智能体仿真, FHIR集成, LLM评估, 自动化测试平台

## 3 点简述
- 核心问题：现有研究未能全面模拟医院行政工作流的复杂性，缺乏统一评估框架
- 方法要点：结合真实数据生成与多智能体模拟，集成FHIR实现跨医院环境互操作性
- 实验或效果：通过详细评分标准定量评估任务，为LLM驱动自动化提供标准化测试平台
