...
**关键词**：双足机器人运动, 故障容错学习, 强化学习, 仿真到现实迁移, 在线状态估计

## 3 点简述
- 核心问题：现有强化学习方法在双足机器人运动中未充分处理硬件故障，如关节锁定、电源丢失和外部干扰。
- 方法要点：通过模拟注入故障学习容错策略，结合在线关节状态模块实时分类关节条件，并实现仿真到现实的策略迁移。
- 实验或效果：在仿真和真实人形机器人TOCABI上验证了方法的适用性，据称是首个基于学习的双足运动容错框架。
