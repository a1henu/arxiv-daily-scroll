...
**arXiv**：[2602.05811v1](https://arxiv.org/abs/2602.05811) · [PDF](https://arxiv.org/pdf/2602.05811.pdf)  
**作者**：Zhaorui Jiang, Yingfang Yuan, Lei Hu, Wei Pang  

**一句话要点**：提出STProtein框架，利用图神经网络和多任务学习预测空间蛋白质表达以解决数据稀缺问题。

**关键词**：空间多组学, 图神经网络, 多任务学习, 蛋白质表达预测, 数据整合

## 3 点简述
- 核心问题：空间多组学数据中，空间转录组数据丰富但空间蛋白质组数据稀缺，阻碍生物研究进展。
- 方法要点：基于图神经网络和多任务学习策略，从易获取的空间多组学数据预测未知空间蛋白质表达。
- 实验或效果：未知，但声称能有效解决数据稀缺，加速空间多组学整合和生命科学突破。
