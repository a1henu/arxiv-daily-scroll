...
**一句话要点**：提出计算有界策略框架，证明增加计算可提升强化学习性能与泛化能力

**关键词**：强化学习, 计算有界策略, 泛化能力, 可变计算架构, 无模型规划

## 3 点简述
- 核心问题：强化学习中计算资源对策略学习的影响，传统方法混淆计算与参数数量
- 方法要点：形式化计算有界策略，设计可变计算架构，基于算法学习和无模型规划
- 实验或效果：在31个任务上验证，增加计算提升性能，泛化至更长时域任务优于标准网络
