...
**一句话要点**：提出尺度感知可解释性研究议程，结合重整化框架提升神经网络解释的鲁棒性和忠实性

**关键词**：尺度感知可解释性, 重整化框架, 神经网络解释, AI安全, 统计物理, 多尺度结构

## 3 点简述
- 核心问题：神经网络解释方法需匹配数据的多尺度结构，保证细粒度噪声丢弃的影响有界
- 方法要点：引入物理重整化框架，开发理论工具以跟踪特征跨分辨率组合
- 实验或效果：未知，但旨在合成跨领域研究，构建AI安全中的实用工具
