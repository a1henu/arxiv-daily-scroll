...
**关键词**：约束策略优化, 拉格朗日松弛, 优势估计, 机器人学习, 组相对策略优化, 行为约束

## 3 点简述
- 核心问题：GRPO扩展至带显式行为约束的场景未充分探索，优势估计中的多分量处理可能破坏约束学习
- 方法要点：基于拉格朗日松弛引入约束GRPO，通过标量化优势构造保持奖励与约束项的权衡
- 实验或效果：在网格世界验证优化病理，机器人任务中提升约束满足与任务成功率
