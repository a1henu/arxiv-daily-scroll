...
**关键词**：意见动力学建模, 物理信息神经网络, 扩散-对流-反应系统, 神经微分方程, 社会系统分析, 预测性能

## 3 点简述
- 现有方法基于不完整先验，难以整合局部、全局和内生动态，且惩罚约束导致优化问题与表示不透明。
- 从相互作用粒子理论出发，通过扩散-对流-反应系统解释意见动力学，并构建神经意见动力学协调神经网络与物理先验。
- 在真实和合成数据集上评估，OPINN在意见演化预测中达到先进性能，为网络-物理-社会系统融合提供新范式。
