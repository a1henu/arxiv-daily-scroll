...
**一句话要点**：提出基于大偏差理论的SGD长尾衰减分析，为非凸优化提供紧致长期保证

**关键词**：随机梯度下降, 非凸优化, 长尾衰减, 大偏差理论, 重尾噪声, 紧致分析

## 3 点简述
- 研究SGD过程的长尾衰减，填补固定误差阈值下失败概率分析的空白
- 为有界噪声SGD和重尾噪声c-SGD建立长期衰减上界，速率优于现有有限时间结果
- 提供匹配下界，证明衰减速率在多项式对数因子内紧致，强化个体运行保证
