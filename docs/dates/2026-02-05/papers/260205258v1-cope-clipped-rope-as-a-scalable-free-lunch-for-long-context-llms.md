...
**一句话要点**：提出CoPE方法，通过软截断RoPE低频分量提升大语言模型长上下文扩展能力

**关键词**：旋转位置编码, 长上下文扩展, 软截断, 分布外缓解, 语义建模, 大语言模型

## 3 点简述
- 核心问题：RoPE在长上下文扩展中面临分布外异常和语义信号不精确的挑战
- 方法要点：采用软截断策略处理RoPE低频分量，统一缓解分布外问题并优化语义建模
- 实验或效果：实验验证CoPE在长达256k上下文长度下显著提升性能，成为新SOTA
