...
**关键词**：多模态情感识别, 线索级感知, 可解释性框架, 情感数据集, 评估指标

## 3 点简述
- 核心问题：现有方法在情感线索级感知与推理上受限，因编码器不敏感及数据集监督不足
- 方法要点：引入VECB和AECB模块增强线索感知，构建EmoCue数据集支持推理
- 实验或效果：XEmoGPT在情感线索感知与推理上表现优异，并发布新评估指标与基准
