...
**一句话要点**：研究离线目标条件强化学习中超参数敏感性，揭示自举目标加剧敏感性并提供稳健设计路径

**关键词**：离线强化学习, 目标条件强化学习, 超参数敏感性, 自举学习, 梯度对齐, 稳健算法设计

## 3 点简述
- 核心问题：探究深度强化学习超参数敏感性是否固有，聚焦离线目标条件场景
- 方法要点：通过控制数据质量变化，分析HIQL和QRL算法在平稳与非平稳下的表现
- 实验或效果：发现QRL在专家数据存在时稳健，HIQL敏感，引入梯度对齐诊断解释差异
