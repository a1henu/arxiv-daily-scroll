...
**关键词**：时间序列预测, 电力需求预测, 外生特征, 基础模型评估, 地理气候影响

## 3 点简述
- 核心问题：时间序列基础模型能否有效利用外生特征进行电力需求预测尚不明确。
- 方法要点：在星澳市场对比MOIRAI等基础模型与LSTM基线，分析特征配置和架构影响。
- 实验或效果：基础模型性能高度可变，Chronos-2表现最佳，但基线在稳定气候下常更优。
