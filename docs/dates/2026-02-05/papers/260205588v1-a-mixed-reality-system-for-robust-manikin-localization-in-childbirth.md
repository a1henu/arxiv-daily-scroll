...
**一句话要点**：提出混合现实系统以解决分娩训练中触觉人偶的精准定位问题

**关键词**：混合现实, 分娩训练, 人偶定位, 触觉反馈, 医学教育, 头戴式显示器

## 3 点简述
- 核心问题：医学生分娩实践机会受限，需独立训练系统以减轻专家负担
- 方法要点：通过外部RGB-D相机校准，实现粗到精的人偶定位与虚拟引导手叠加
- 实验或效果：系统在独立头显上实现稳定定位，用户研究显示MR训练优于VR训练
