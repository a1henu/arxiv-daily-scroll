...
**arXiv**：[2602.05588v1](https://arxiv.org/abs/2602.05588) · [PDF](https://arxiv.org/pdf/2602.05588.pdf)  
**作者**：Haojie Cheng, Chang Liu, Abhiram Kanneganti, Mahesh Arjandas Choolani, Arundhati Tushar Gosavi, Eng Tat Khoo  

**一句话要点**：提出混合现实系统以解决分娩训练中因临床机会受限而需独立实践的问题

**关键词**：混合现实系统, 分娩训练, 人偶定位, 触觉反馈, 医学教育, 用户研究

## 3 点简述
- 核心问题：医学学生因临床轮转缩短、患者不情愿和分娩不可预测性，缺乏阴道分娩实践机会。
- 方法要点：通过外部RGB-D相机空间校准，实现粗到精的定位流程，结合虚拟引导与触觉人偶交互。
- 实验或效果：系统在独立头显上实现准确稳定定位；用户研究显示MR训练在分娩任务中得分显著高于VR训练。
