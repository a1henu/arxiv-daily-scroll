...
**关键词**：序列预测, 贝叶斯滤波, 流匹配模型, 实时推理, 采样加速, 概率流学习

## 3 点简述
- 核心问题：流式观测序列预测中，扩散和流匹配模型因重复采样导致高延迟和系统积压。
- 方法要点：将流式推理视为概率流学习，利用贝叶斯滤波递归更新，从前一后验初始化生成以加速采样。
- 实验或效果：在多种任务中，仅需少量采样步骤即可达到全步扩散性能，实现更快采样。
