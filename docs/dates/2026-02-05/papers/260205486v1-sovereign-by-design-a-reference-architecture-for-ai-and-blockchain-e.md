...
**arXiv**：[2602.05486v1](https://arxiv.org/abs/2602.05486) · [PDF](https://arxiv.org/pdf/2602.05486.pdf)  
**作者**：Matteo Esposito, Lodovica Marchesi, Roberto Tonelli, Valentina Lenarduzzi  

**一句话要点**：提出主权参考架构以集成区块链与生成式AI，实现数字主权在系统架构层面的操作化。

**关键词**：数字主权, 参考架构, 生成式AI, 区块链, 软件架构, 数据治理

## 3 点简述
- 核心问题：现有方案孤立处理治理与合规，缺乏在架构层面实现数字主权的指导。
- 方法要点：将主权作为首要架构属性，集成自主权身份、区块链信任和受控生成式AI。
- 实验或效果：未知，但架构为构建可审计、可演进和司法感知的AI系统提供基础。
