...
**一句话要点**：提出消息自适应图提示调优，通过注入可学习提示到消息传递步骤，以适配下游任务

**关键词**：图神经网络, 提示调优, 消息传递, 参数高效, 下游任务适配, 少样本学习

## 3 点简述
- 核心问题：预训练图神经网络在下游任务中因目标不匹配而适配困难，现有图提示方法未改变消息传递，限制邻域交互适配
- 方法要点：在消息聚合时注入可学习提示，重加权邻居消息并添加任务特定向量，保持骨干网络冻结
- 实验或效果：在节点和图级数据集上，少样本设置优于先前方法，全样本设置与微调性能相当
