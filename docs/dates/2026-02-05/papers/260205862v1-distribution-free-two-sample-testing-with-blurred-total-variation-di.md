...
**arXiv**：[2602.05862v1](https://arxiv.org/abs/2602.05862) · [PDF](https://arxiv.org/pdf/2602.05862.pdf)  
**作者**：Rohan Hore, Rina Foygel Barber  

**一句话要点**：提出模糊总变差距离以解决无分布两样本检验问题

**关键词**：两样本检验, 模糊总变差距离, 无分布推断, 高维统计, 理论保证

## 3 点简述
- 核心问题：无分布条件下两样本检验难以提供总变差距离的紧致界
- 方法要点：引入模糊总变差距离作为松弛，实现无分布推断
- 实验或效果：提供理论保证，分析高维性质，未知具体实验验证
