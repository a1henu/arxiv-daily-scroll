...
**关键词**：稀疏激活, 训练稳定性, 高斯过程, Edge-of-Chaos初始化, 能效优化, 深度神经网络

## 3 点简述
- 核心问题：稀疏激活深度网络训练不稳定，影响表达能力和能效。
- 方法要点：利用高斯过程方差控制，结合Edge-of-Chaos初始化策略优化训练。
- 实验或效果：在DNN和CNN中实现高达90%激活稀疏性，保持高精度并提升训练稳定性。
