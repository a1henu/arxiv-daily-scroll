...
**一句话要点**：提出GAS算法以增强离线安全强化学习中生成模型的奖励-成本平衡能力

**关键词**：离线安全强化学习, 生成模型, 奖励-成本平衡, 轨迹拼接, 目标函数, 数据增强

## 3 点简述
- 核心问题：生成模型辅助方法在离线安全强化学习中缺乏轨迹拼接能力和奖励-成本目标平衡能力
- 方法要点：通过数据增强和重标注提升拼接能力，引入目标函数估计最优奖励-成本目标以指导策略训练
- 实验或效果：实证结果显示GAS在平衡奖励最大化和约束满足方面优于现有方法
