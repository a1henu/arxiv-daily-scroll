...
**关键词**：可解释人工智能, 脑肿瘤检测, 卷积神经网络, 梯度加权类激活映射, 层间相关性传播, SHAP值分析

## 3 点简述
- 核心问题：深度学习模型在脑肿瘤检测中缺乏透明度和可解释性，影响医疗应用信任度。
- 方法要点：结合GRAD-CAM、LRP和SHAP三种XAI技术，提供从空间区域到像素级的层次化解释。
- 实验或效果：在BraTS 2021数据集上，CNN模型准确率达91.24%，集成方法成功识别全肿瘤和部分肿瘤，解释能力优于单一技术。
