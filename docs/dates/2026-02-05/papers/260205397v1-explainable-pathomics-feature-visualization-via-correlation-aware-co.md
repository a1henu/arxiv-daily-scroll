...
**一句话要点**：提出流形感知扩散框架以解决病理组学特征编辑中的相关性挑战

**关键词**：病理组学, 特征编辑, 扩散模型, 变分自编码器, 生物流形, 数字病理

## 3 点简述
- 核心问题：病理组学特征内在相关，传统条件扩散模型假设特征独立导致编辑时产生不真实伪影
- 方法要点：使用变分自编码器学习解缠潜在空间，正则化特征轨迹以保持生物流形内的编辑
- 实验或效果：在条件特征编辑中优于基线方法，能导航特征流形并保持结构一致性
