...
**关键词**：多模态推理, 潜在空间, 分层视觉线索, Transformer扩展, 复杂场景理解

## 3 点简述
- 核心问题：多模态大语言模型推理依赖快速思维，易产生幻觉且效率低下。
- 方法要点：在潜在空间中递归扩展Transformer块，注入从全局到局部的分层视觉线索。
- 实验或效果：评估显示结合视觉知识有效，分层信息显著增强复杂场景理解能力。
