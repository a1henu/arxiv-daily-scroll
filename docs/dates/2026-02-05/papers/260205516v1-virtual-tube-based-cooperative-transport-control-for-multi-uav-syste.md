...
**arXiv**：[2602.05516v1](https://arxiv.org/abs/2602.05516) · [PDF](https://arxiv.org/pdf/2602.05516.pdf)  
**作者**：Runxiao Liu, Pengda Mao, Xiangli Le, Shuang Gu, Yapeng Chen, Quan Quan  

**一句话要点**：提出基于虚拟管道的多无人机协同运输控制框架，用于受限环境中的电缆悬挂负载运输。

**关键词**：多无人机系统, 协同运输控制, 虚拟管道理论, 耗散系统理论, 受限环境导航, 电缆悬挂负载

## 3 点简述
- 核心问题：在受限环境中，多无人机协同运输电缆悬挂负载时，需高效导航并保持系统稳定。
- 方法要点：结合虚拟管道理论和耗散系统理论，实现低计算开销的张力分配与动态配置适应。
- 实验或效果：通过仿真和户外实验验证了方法的有效性、可扩展性和实际鲁棒性。
