...
**arXiv**：[2512.07091v1](https://arxiv.org/abs/2512.07091) · [PDF](https://arxiv.org/pdf/2512.07091.pdf)  
...
**一句话要点**：提出集成单阀的柔性漏斗形机械手，以解决毫克级粉末精确分装的实验室自动化难题。

**关键词**：实验室自动化, 粉末处理, 柔性机械手, 反馈控制, 毫克级分装, 流动模型
