...
**arXiv**：[2512.07680v1](https://arxiv.org/abs/2512.07680) · [PDF](https://arxiv.org/pdf/2512.07680.pdf)  
**作者**：P. A. Wigner, L. Romanello, A. Hammad, P. H. Nguyen, T. Lan, S. F. Armanini, B. B. Kocer, M. Kovac  

**一句话要点**：提出一种空中部署的爬行机器人，用于树冠自适应移动与操作，结合柔性微刺轨道和弹性尾部。

**关键词**：空中部署机器人, 柔性微刺轨道, 树冠操作, 自适应移动, 低功耗平台
