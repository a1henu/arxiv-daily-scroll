...
**arXiv**：[2512.07415v1](https://arxiv.org/abs/2512.07415) · [PDF](https://arxiv.org/pdf/2512.07415.pdf)  
**作者**：Gabriele Galatolo, Mirco Nanni  

**一句话要点**：提出数据驱动的移动交互模式挖掘方法，以改进人群模拟和应急管理模型。

**关键词**：移动交互模式, 数据挖掘, 人群模拟, 应急管理, 行为建模
