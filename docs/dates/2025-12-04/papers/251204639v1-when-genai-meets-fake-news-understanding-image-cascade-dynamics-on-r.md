...
**arXiv**：[2512.04639v1](https://arxiv.org/abs/2512.04639) · [PDF](https://arxiv.org/pdf/2512.04639.pdf)  
**作者**：Saumya Chauhan, Mila Hong, Maria Vazhaeparambil  

**一句话要点**：提出首个大规模分析框架，预测AI生成图像与虚假信息在Reddit社区中的传播动态。

**关键词**：虚假信息传播, AI生成图像, 社交媒体分析, 传播预测模型, Reddit社区研究

## 3 点简述
- 核心问题：研究AI生成图像和虚假信息在社交媒体中的视觉内容传播机制，填补了现有研究对视觉内容关注不足的空白。
- 方法要点：整合文本情感、视觉属性和扩散指标（如首次转发时间、社区覆盖度），构建预测模型。
- 实验或效果：在五个意识形态多样的Reddit社区中，模型准确预测了即时帖子级传播（AUC=0.83）和长期级联级传播（AUC=0.998）。
