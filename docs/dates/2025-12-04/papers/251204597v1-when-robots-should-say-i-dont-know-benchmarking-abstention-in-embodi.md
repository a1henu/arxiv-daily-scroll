...
**一句话要点**：提出AbstainEQA基准以评估具身问答中机器人何时应说“不知道”的能力

**关键词**：具身问答, 拒绝回答, 基准数据集, 人机交互, 语言理解

## 3 点简述
- 核心问题：现有具身问答基准要求回答所有问题，但机器人需知道何时信息不足而应拒绝回答
- 方法要点：基于人类查询分析和认知理论，定义五类需拒绝回答的场景，并构建包含模糊变体的数据集
- 实验或效果：评估显示前沿模型拒绝回答召回率仅42.79%，远低于人类的91.17%，且现有方法改进有限
