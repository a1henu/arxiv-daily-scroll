...
**关键词**：具身问答, 弃答基准, 机器人交互, 数据集构建, 认知理论

## 3 点简述
- 核心问题：现有具身问答基准要求回答所有问题，但机器人需知道何时信息不足而应弃答
- 方法要点：基于人类查询分析和认知理论，定义五类弃答场景，并构建包含原始与模糊变体的数据集
- 实验或效果：评估显示前沿模型弃答召回率仅42.79%，远低于人类的91.17%，且现有方法改进有限
