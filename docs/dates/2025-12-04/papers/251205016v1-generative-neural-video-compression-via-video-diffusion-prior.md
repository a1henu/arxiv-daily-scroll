...
**一句话要点**：提出GNVC-VD框架，基于视频扩散先验统一压缩与生成以解决感知闪烁问题

**关键词**：生成神经视频压缩, 视频扩散先验, 流匹配潜在细化, 序列级去噪, 感知质量提升, 低比特率压缩

## 3 点简述
- 现有感知编解码器依赖图像生成先验，缺乏时间建模导致感知闪烁
- 引入统一流匹配潜在细化模块，利用视频扩散变换器进行序列级去噪
- 实验显示在极低比特率下超越传统与学习编解码器，显著减少闪烁
