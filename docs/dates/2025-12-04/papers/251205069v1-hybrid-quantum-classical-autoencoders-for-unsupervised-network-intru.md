...
**一句话要点**：提出混合量子-经典自编码器以解决无监督网络入侵检测中的泛化问题

**关键词**：混合量子-经典自编码器, 无监督网络入侵检测, 量子机器学习, 异常检测, 泛化性能, 噪声模拟

## 3 点简述
- 核心问题：无监督异常检测需模型泛化至未见攻击模式，传统方法可能受限
- 方法要点：构建统一框架，评估量子层放置、测量方式等关键设计选择对性能影响
- 实验或效果：在基准数据集上，优化配置的混合模型可匹配或超越经典性能，零日评估中泛化更稳定
