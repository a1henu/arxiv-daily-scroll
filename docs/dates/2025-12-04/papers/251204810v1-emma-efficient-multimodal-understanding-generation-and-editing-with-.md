...
**一句话要点**：提出EMMA统一架构，以高效实现多模态理解、生成与编辑任务。

**关键词**：多模态统一架构, 视觉令牌压缩, 通道级拼接, 共享-解耦网络, 专家混合机制, 高效生成

## 3 点简述
- 核心问题：统一多模态架构中视觉令牌过多导致效率低下和任务间训练不平衡。
- 方法要点：采用32倍压缩比自动编码器、通道级拼接和共享-解耦网络，结合专家混合机制提升感知能力。
- 实验或效果：EMMA-4B在效率和性能上超越BAGEL-7B等统一方法，并与Qwen3-VL等专家模型竞争。
