...
**一句话要点**：提出控制一致性损失以在线迭代学习扩散桥，解决条件动力学模拟问题

**关键词**：扩散桥, 条件动力学, 自一致性, 在线学习, 罕见事件模拟

## 3 点简述
- 核心问题：模拟扩散过程的条件动力学，给定初始和终止状态，对罕见事件尤其困难
- 方法要点：利用条件动力学的自一致性属性，通过在线迭代方式学习扩散桥
- 实验或效果：在多种设置中展示出有前景的实证结果
