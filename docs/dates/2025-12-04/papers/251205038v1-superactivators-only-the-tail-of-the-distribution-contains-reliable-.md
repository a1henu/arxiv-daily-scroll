...
**一句话要点**：提出SuperActivator机制，利用概念分布尾部高激活token提升概念检测可靠性

**关键词**：概念向量, 模型可解释性, 激活分布, 概念检测, 特征归因

## 3 点简述
- 概念向量常因激活噪声和不一致而受限，影响模型可解释性
- 发现概念分布极端高尾部的token激活提供可靠概念信号，称为SuperActivator机制
- 在图像和文本模态中，SuperActivator token比标准方法提升高达14% F1分数
