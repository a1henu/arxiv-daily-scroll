...
**关键词**：非定常流预测, 深度算子网络, 几何感知建模, 符号距离场, 计算流体力学加速, 误差分析

## 3 点简述
- 核心问题：快速且几何泛化的非定常流代理模型仍具挑战性。
- 方法要点：使用符号距离场编码几何，CNN分支编码流历史，基于841个高保真模拟训练。
- 实验或效果：在未见形状上实现约5%相对L2单步误差，比CFD加速高达1000倍，但精细尾流中误差累积。
