...
**关键词**：视频生成, 语言建模, 流匹配, 交错生成, 可控性, 混合Transformer

## 3 点简述
- 核心问题：视频生成模型在处理需语义分支或高层推理的复杂视频时存在困难。
- 方法要点：采用混合Transformer架构，联合学习语言建模与视频流匹配，实现交错生成决策。
- 实验或效果：在视频游戏数据上验证了视觉质量与提示对齐的显著改进，并扩展至自然视频生成。
