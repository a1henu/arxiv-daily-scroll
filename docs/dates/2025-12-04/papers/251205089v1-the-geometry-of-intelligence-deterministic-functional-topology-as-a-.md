...
**arXiv**：[2512.05089v1](https://arxiv.org/abs/2512.05089) · [PDF](https://arxiv.org/pdf/2512.05089.pdf)  
**作者**：Eduardo Di Santi  

**一句话要点**：提出确定性功能拓扑框架，以解释现实世界感知中从有限观测快速泛化的几何基础。

**关键词**：确定性功能拓扑, 感知流形, 自监督学习, 泛化理论, 现实世界感知, 几何结构

## 3 点简述
- 核心问题：现实物理过程信号集中于功能空间的紧凑低变异性子集，如何数学建模以支持泛化。
- 方法要点：构建确定性功能拓扑框架，将物理现象实现集定义为紧凑感知流形，并自监督发现其边界。
- 实验或效果：在机电铁路道岔、电化学电池放电曲线和生理ECG信号三个领域验证理论，提供理论保证和边界估计器。
