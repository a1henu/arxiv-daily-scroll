...
**一句话要点**：提出SlideGen框架，通过多智能体协作解决科学论文到演示文稿的生成问题。

**关键词**：幻灯片生成, 多模态推理, 智能体协作, 视觉规划, 科学论文处理

## 3 点简述
- 核心问题：现有方法忽视视觉组件，难以生成高质量学术幻灯片。
- 方法要点：采用模块化视觉语言智能体协作，集成大纲、映射、布局和迭代优化。
- 实验或效果：在多个基准测试中超越现有方法，实现专家级幻灯片质量。
