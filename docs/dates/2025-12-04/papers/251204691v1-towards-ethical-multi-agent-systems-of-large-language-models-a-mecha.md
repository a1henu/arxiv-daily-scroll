...
**一句话要点**：提出基于机制可解释性的研究议程，以解决大语言模型多智能体系统的伦理挑战

**关键词**：大语言模型多智能体系统, 伦理行为评估, 机制可解释性, 参数高效对齐, 多智能体交互

## 3 点简述
- 核心问题：大语言模型多智能体系统在增强能力的同时，引发显著的伦理行为挑战
- 方法要点：从机制可解释性视角，开发评估框架、阐明内部机制、实施参数高效对齐技术
- 实验或效果：未知，本文为立场论文，主要概述研究议程而非具体实验
