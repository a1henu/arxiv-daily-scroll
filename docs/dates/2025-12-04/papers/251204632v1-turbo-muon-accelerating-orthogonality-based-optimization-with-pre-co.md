...
**一句话要点**：提出预条件化方法以加速基于正交性的优化器中的牛顿-舒尔茨近似收敛

**关键词**：正交性优化, 牛顿-舒尔茨近似, 预条件化, 训练加速, 大规模训练, 计算效率

## 3 点简述
- 基于正交性的优化器如Muon依赖昂贵的梯度正交化步骤，牛顿-舒尔茨近似计算成本高
- 引入预条件化程序加速牛顿-舒尔茨收敛，降低计算开销，可移除一次迭代而不影响近似质量
- 实验显示牛顿-舒尔茨近似加速达2.8倍，端到端训练运行时提升5-10%，模型性能保持或提升
