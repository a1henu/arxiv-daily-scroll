...
**arXiv**：[2512.04714v1](https://arxiv.org/abs/2512.04714) · [PDF](https://arxiv.org/pdf/2512.04714.pdf)  
**作者**：Andrew Paterson, Carl Sanders  

**一句话要点**：提出Patrick自适应扑克AI框架，通过最大化利用人类对手缺陷实现盈利。

**关键词**：自适应AI, 扑克博弈, 预测锚定学习, 人类对手建模, 最大化利用策略

## 3 点简述
- 核心问题：挑战扑克AI追求无懈可击的解法，转向利用人类对手的心理和理性缺陷。
- 方法要点：采用预测锚定学习方法，构建专门引擎以理解和攻击人类对手的不完美行为。
- 实验或效果：在64,267手牌试验中展示盈利性能，验证了自适应策略的有效性。
