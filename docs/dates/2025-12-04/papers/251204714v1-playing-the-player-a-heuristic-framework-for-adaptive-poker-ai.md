...
**一句话要点**：提出Patrick自适应扑克AI框架，通过预测锚定学习攻击人类对手的不完美性。

**关键词**：自适应AI, 扑克游戏, 预测锚定学习, 人类对手建模, 可解释性AI

## 3 点简述
- 核心问题：挑战扑克AI追求不可利用性的传统，转向最大化利用人类对手的缺陷。
- 方法要点：采用预测锚定学习方法，构建专门引擎以理解和攻击人类对手的心理和非理性行为。
- 实验或效果：在64,267手牌试验中实现盈利性能，验证了自适应策略的有效性。
