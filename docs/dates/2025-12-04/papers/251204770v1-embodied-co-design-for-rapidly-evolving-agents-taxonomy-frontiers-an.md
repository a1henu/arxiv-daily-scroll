...
**arXiv**：[2512.04770v1](https://arxiv.org/abs/2512.04770) · [PDF](https://arxiv.org/pdf/2512.04770.pdf)  
**作者**：Yuxing Wang, Zhiyu Chen, Tiantian Zhang, Qiyue Yin, Yongzhe Chang, Zhiheng Li, Liang Wang, Xueqian Wang  

**一句话要点**：提出具身协同设计范式，通过联合优化形态与控制以提升智能体性能

**关键词**：具身智能, 协同设计, 形态控制优化, 智能体演化, 机器人学, 仿真环境

## 3 点简述
- 核心问题：传统方法孤立优化控制器，忽视形态与环境的协同演化，限制智能体适应性
- 方法要点：建立分层分类法，将设计分解为大脑、形态、环境，并整合为四种协同设计框架
- 实验或效果：综述百余项研究，涵盖模拟与真实场景的基准、数据集和应用，促进领域发展
