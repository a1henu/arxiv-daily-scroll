...
**一句话要点**：提出具身协同设计综述，系统梳理智能体形态与控制器联合优化方法

**关键词**：具身协同设计, 形态控制器联合优化, 智能体演化, 机器人设计, 生物启发计算

## 3 点简述
- 核心问题：传统智能体设计常孤立优化控制器，忽略形态与环境的协同演化。
- 方法要点：建立分层分类法，将设计分解为大脑、形态、环境，并整合为四种主要框架。
- 实验或效果：综述超百项研究，涵盖模拟与真实场景的基准、数据集和应用。
