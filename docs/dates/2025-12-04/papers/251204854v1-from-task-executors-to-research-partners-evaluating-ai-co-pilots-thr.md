...
**一句话要点**：提出过程导向评估框架以解决AI在生物医学研究中作为研究协作者的有效性评估不足问题

**关键词**：AI评估框架, 生物医学研究, 研究协作, 工作流程集成, 基准测试, 过程导向评估

## 3 点简述
- 核心问题：现有基准仅评估AI的孤立组件能力，无法反映真实研究协作中的集成工作流程需求
- 方法要点：通过快速综述识别14个基准，提出包含对话质量、工作流程编排、会话连续性和研究者体验的四维评估框架
- 实验或效果：综述发现当前基准缺乏上下文记忆、自适应对话和约束传播等关键协作维度，新框架旨在填补此评估缺口
