...
**关键词**：AI评估框架, 生物医学研究, 工作流集成, 研究协作, 对话质量, 会话连续性

## 3 点简述
- 核心问题：现有基准仅评估AI孤立组件能力，无法反映真实研究协作中的集成工作流程需求
- 方法要点：通过快速综述识别14个基准，提出包含对话质量、工作流编排、会话连续性和研究者体验的四维评估框架
- 实验或效果：未知具体实验效果，但框架旨在填补评估空白，提升AI作为研究协作者的实用性
