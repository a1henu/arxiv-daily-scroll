...
**一句话要点**：提出基于分位数曲线的无模型方法，评估复杂系统模拟器的保真度

**关键词**：模拟器保真度评估, 分位数曲线, 无模型方法, 黑盒评估, 机器学习系统, 风险度量

## 3 点简述
- 核心问题：复杂机器学习系统模拟器与真实数据间的差异难以量化
- 方法要点：将模拟器视为黑盒，估计输出分布差异的分位数函数，支持置信区间构建和风险度量
- 实验或效果：应用于大型语言模型模拟保真度评估，使用WorldValueBench数据集验证
