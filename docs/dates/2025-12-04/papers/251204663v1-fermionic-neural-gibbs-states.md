...
**一句话要点**：提出费米子神经吉布斯态以模拟强相互作用费米子的有限温度性质

**关键词**：费米子神经网络, 有限温度量子态, 强关联系统, 费米-哈伯德模型, 虚时演化

## 3 点简述
- 核心问题：强相互作用费米子在有限温度下的性质难以精确计算，尤其在多维系统中。
- 方法要点：从平均场热场双重态出发，结合神经网络变换和虚时演化构建强关联。
- 实验或效果：应用于掺杂费米-哈伯德模型，准确再现热能在宽温度、相互作用强度和掺杂范围的结果。
