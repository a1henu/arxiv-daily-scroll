...
**一句话要点**：提出基于深度神经网络的灵活特征选择框架，在广义深度学习设置下近似控制假发现率。

**关键词**：特征选择, 假发现率控制, 深度学习理论, 渐近分析, 神经网络架构

## 3 点简述
- 核心问题：在深度学习中实现特征选择的理论假发现率控制，以降低Type-I错误。
- 方法要点：适用于第一层全连接的网络，支持多种架构和训练过程，基于多索引数据模型和渐近分析。
