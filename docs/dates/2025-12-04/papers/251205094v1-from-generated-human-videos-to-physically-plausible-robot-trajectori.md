...
**一句话要点**：提出GenMimic以解决从生成视频到机器人零模仿轨迹的挑战

**关键词**：视频生成模型, 机器人控制, 零模仿学习, 强化学习策略, 人体动作重定向, 物理仿真

## 3 点简述
- 核心问题：如何从噪声生成视频中零模仿执行人类动作，因形态失真和噪声阻碍直接模仿
- 方法要点：两阶段流程，先提升视频为4D人体表示并重定向形态，再训练物理感知强化学习策略GenMimic
- 实验或效果：在合成数据集GenMimicBench上验证，仿真和Unitree G1机器人上实现稳定运动跟踪
