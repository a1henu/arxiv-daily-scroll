...
**arXiv**：[2512.04771v1](https://arxiv.org/abs/2512.04771) · [PDF](https://arxiv.org/pdf/2512.04771.pdf)  
**作者**：Roberto Garrone  

**一句话要点**：提出结合计算力学与扩散模型的框架，以互补分析基于代理模型的输出结构

**关键词**：基于代理模型, 计算力学, 扩散模型, 时间序列分析, 分布表征, 机器学习框架

## 3 点简述
- 核心问题：如何全面表征基于代理模型（ABM）的输出，包括时间序列和分布结构
- 方法要点：结合ε-机器分析时间预测性，扩散模型分析高维分布和生成合成数据
- 实验或效果：使用老年护理ABM数据集验证框架，形式化数学互补性
