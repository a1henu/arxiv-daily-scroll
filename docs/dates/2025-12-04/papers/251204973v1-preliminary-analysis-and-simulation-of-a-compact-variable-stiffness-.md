...
**关键词**：变刚度驱动器, 并联手腕, 冗余弹性驱动, 机器人控制, 仿真验证, 人机交互

## 3 点简述
- 问题：变刚度驱动器在机器人应用中常导致结构笨重，限制其在假肢或人形机器人中的使用。
- 方法：设计3自由度并联手腕，仅用四个电机实现紧凑轻量化，并开发独立调节位置与刚度的控制策略。
- 效果：仿真验证显示，该设备在刚性配置下精度高、抗干扰强，在柔顺行为下能最小化交互力。
