...
**一句话要点**：提出通用工具模型GTM以模拟真实工具执行，降低AI代理训练成本与开销。

**关键词**：工具模拟, AI代理训练, 上下文感知响应生成, 多领域工具, 强化学习仿真, 成本优化

## 3 点简述
- 核心问题：直接与多样工具交互训练LLM代理成本高、速度慢且维护负担重。
- 方法要点：通过CARG管道合成多领域训练数据，GTM学习生成逻辑一致、上下文适当的工具输出。
- 实验或效果：GTM在强化学习场景中模拟速度快、输出质量高，并展现良好泛化与领域适应性。
