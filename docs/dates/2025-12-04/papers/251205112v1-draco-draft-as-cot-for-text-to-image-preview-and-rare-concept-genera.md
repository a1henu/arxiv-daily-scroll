...
**一句话要点**：提出DraCo方法，通过草稿图像作为思维链，提升文本到图像生成的预览与罕见概念生成能力。

**关键词**：文本到图像生成, 思维链推理, 草稿图像预览, 罕见概念生成, 选择性修正, 分类器自由引导

## 3 点简述
- 现有方法依赖抽象文本规划，导致文本到图像生成中规划粒度粗和罕见属性组合生成困难。
- DraCo首先生成低分辨率草稿图像作为视觉规划，然后利用模型理解能力验证语义对齐并进行选择性修正。
- 在GenEval等基准上，DraCo显著优于直接生成和其他思维链增强方法，提升达8%。
