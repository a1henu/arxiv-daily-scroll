...
**arXiv**：[2512.04910v1](https://arxiv.org/abs/2512.04910) · [PDF](https://arxiv.org/pdf/2512.04910.pdf)  
**作者**：Fang Li  

**一句话要点**：提出基于答案集编程的条板电路布局自动合成与多目标优化方法

**关键词**：条板电路布局, 答案集编程, 多目标优化, 自动化设计, 电子原型

## 3 点简述
- 核心问题：条板电路布局设计自动化，需满足几何与电气约束并优化面积与交叉
- 方法要点：利用答案集编程声明式表达约束，分两阶段求解确保可行性与优化质量
- 实验或效果：实验显示方法能生成紧凑、可制造的布局，适用于多种电路复杂度
