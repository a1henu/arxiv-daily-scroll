...
**关键词**：动态高斯溅射, 单目视频重建, 时间正则化, 冻结场景合成, Mannequin-Challenge

## 3 点简述
- 核心问题：单目Mannequin-Challenge视频中，动态高斯溅射在稀疏时间监督下易产生鬼影和模糊等伪影
- 方法要点：检测高斯基元的隐藏和缺陷状态，并应用时间锚定策略进行正则化，无需修改架构或增加推理开销
