...
**关键词**：动态高斯泼溅, 单目视频重建, 时间正则化, 冻结场景合成, Mannequin-Challenge

## 3 点简述
- 核心问题：单目Mannequin-Challenge视频重建冻结3D场景时，稀疏时间监督导致高斯原语出现鬼影和模糊伪影
- 方法要点：检测高斯原语的隐藏和缺陷状态，应用时间锚定正则化，无需修改架构或增加推理开销
- 实验或效果：显著提升视觉质量，实现高保真用户可选冻结时间渲染，获得96%用户偏好
