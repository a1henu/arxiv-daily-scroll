...
**arXiv**：[2512.04488v1](https://arxiv.org/abs/2512.04488) · [PDF](https://arxiv.org/pdf/2512.04488.pdf)  
**作者**：Nate Straub, Saara Khan, Katharina Jay, Brian Cabral, Oskar Linde  

**一句话要点**：提出基于角色的多智能体协作框架以提升头脑风暴的多样性和深度

**关键词**：多智能体协作, 角色驱动, 头脑风暴, 创意生成, 协作模式, 领域策划

## 3 点简述
- 核心问题：通用多智能体协作在头脑风暴中可能缺乏领域针对性，影响创意生成的质量和范围。
- 方法要点：开发角色选择框架，通过角色领域策划优化智能体配对，并探索不同协作模式（如分开、一起、分开后一起）。
- 实验或效果：评估显示角色选择影响创意领域，协作模式改变创意多样性，多智能体角色驱动方法提升创意深度和跨领域覆盖。
