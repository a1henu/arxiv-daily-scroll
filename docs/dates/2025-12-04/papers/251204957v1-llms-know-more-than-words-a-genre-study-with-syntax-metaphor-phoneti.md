...
**一句话要点**：提出基于多语言文学体裁分类数据集，评估大语言模型对深层语言特征的捕获能力。

**关键词**：大语言模型, 体裁分类, 句法结构, 语音特征, 多语言数据集, 文学分析

## 3 点简述
- 核心问题：大语言模型是否能从原始文本中有效学习句法、语音和韵律等深层语言特征。
- 方法要点：构建多语言体裁分类数据集，并融入句法树、隐喻计数和语音指标等显式特征集。
- 实验或效果：实验表明不同特征对分类任务贡献不均，强调训练中需整合复杂语言信号。
