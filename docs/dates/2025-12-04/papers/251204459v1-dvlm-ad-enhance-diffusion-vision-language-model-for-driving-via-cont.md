...
## 3 点简述
- 核心问题：现有自回归视觉语言模型在驾驶中因因果注意力和顺序生成，导致高层推理与低层规划间一致性和可控性不足。
- 方法要点：基于离散扩散视觉语言模型，利用双向注意力和迭代去噪，统一感知、结构化推理和低层规划，提升可控性和可靠性。
- 实验或效果：在nuScenes和WOD-E2E评估中，dVLM-AD在行为-轨迹一致性上优于自回归基线9%，长尾场景RFS提升6%，规划性能可比。
