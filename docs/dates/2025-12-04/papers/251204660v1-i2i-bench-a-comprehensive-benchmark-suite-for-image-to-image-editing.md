...
**一句话要点**：提出I2I-Bench基准套件以全面评估图像编辑模型

**关键词**：图像编辑基准, 自动化评估, 多模态模型, 任务多样性, 评估维度

## 3 点简述
- 现有图像编辑基准存在任务范围有限、评估维度不足和依赖人工标注的问题
- I2I-Bench包含10个任务类别和30个细粒度评估维度，采用自动化混合评估方法
- 基准验证了与人类偏好的一致性，并开源以促进未来研究
