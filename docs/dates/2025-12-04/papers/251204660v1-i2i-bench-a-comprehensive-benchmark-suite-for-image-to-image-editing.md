...
**arXiv**：[2512.04660v1](https://arxiv.org/abs/2512.04660) · [PDF](https://arxiv.org/pdf/2512.04660.pdf)  
**作者**：Juntong Wang, Jiarui Wang, Huiyu Duan, Jiaxiang Kang, Guangtao Zhai, Xiongkuo Min  

**一句话要点**：提出I2I-Bench基准套件以解决图像编辑模型评估的全面性挑战

**关键词**：图像编辑基准, 自动化评估, 多模态模型, 任务多样性, 细粒度维度

## 3 点简述
- 核心问题：现有图像编辑基准任务范围有限、评估维度不足且依赖人工标注，制约可扩展性和实用性。
- 方法要点：涵盖10个任务类别，提供30个解耦细粒度评估维度，结合专业工具和大规模多模态模型进行自动化混合评估。
- 实验或效果：通过基准评估主流模型，揭示不同维度间的差距和权衡，并开源所有组件以促进研究。
