...
**一句话要点**：提出奖励过滤顺序推理以优化测试时计算，提升大语言模型性能

**关键词**：测试时计算, 顺序推理, 奖励过滤, 大语言模型, 最优性分析

## 3 点简述
- 分析测试时计算范式，证明标准最佳-n采样存在固有次优性
- 引入奖励过滤顺序推理，通过选择性纳入高奖励生成来集中计算资源
- 理论证明该方法优于标准范式，实验验证在多个基准上取得一致改进
