...
**一句话要点**：提出零样本视觉-语言分割融合方法，实现恶意图像检测、元素识别与定位一体化

**关键词**：恶意图像检测, 零样本学习, 视觉-语言融合, 像素级定位, 对抗鲁棒性, 细粒度审核

## 3 点简述
- 核心问题：恶意图像检测需超越图像级标记，要求细粒度元素识别与定位
- 方法要点：结合基础分割模型与视觉语言模型，通过区域评分与融合生成恶意对象图
- 实验或效果：在790图像数据集上达到85.8%元素级召回率，对抗攻击下性能下降不超过10%
