...
**关键词**：视频超分辨率, 视频去模糊, 动态曝光建模, 运动感知恢复, 序列级架构, 合成数据训练

## 3 点简述
- 核心问题：真实视频恢复面临运动与动态曝光耦合的复杂退化，现有方法常忽视此挑战。
- 方法要点：采用序列级架构，通过曝光时间感知调制和流引导动态滤波模块，解耦退化学习与恢复。
- 实验或效果：在REDS-ME等新基准上实现最优精度与时间一致性，并提升推理速度，泛化至真实视频。
