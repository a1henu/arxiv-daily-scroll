...
**一句话要点**：提出FMA-Net++框架，以解决真实视频中运动与动态曝光耦合的联合超分辨率与去模糊问题。

**关键词**：视频修复, 超分辨率, 去模糊, 动态曝光建模, 运动感知, 序列级架构

## 3 点简述
- 核心问题：真实视频修复面临运动与动态曝光耦合的复杂退化，现有方法常忽略此挑战。
- 方法要点：采用序列级架构，通过曝光时间感知调制和流引导动态滤波模块，解耦退化学习与修复。
- 实验或效果：在REDS-ME等新基准和GoPro上实现最优精度与时间一致性，并高效泛化至真实视频。
