...
**arXiv**：[2512.04998v1](https://arxiv.org/abs/2512.04998) · [PDF](https://arxiv.org/pdf/2512.04998.pdf)  
**作者**：Giuseppe Milazzo, Giorgio Grioli, Antonio Bicchi, Manuel G. Catalano  

**一句话要点**：提出V-Soft Pro模块化平台，为经肱骨假肢提供可控刚度以增强适应性

**关键词**：经肱骨假肢, 可变刚度执行器, 模块化设计, 生物信号控制, 适应性交互, 上肢康复工程

## 3 点简述
- 现有上肢假肢在自然运动和交互能力方面存在不足，无法模拟人类手臂的适应性
- 采用可变刚度执行器(VSAs)和模块化设计，可定制化适配不同残肢形状和生物信号控制
- 集成弹性元件支持自然运动、安全交互，并适应多样化任务需求，平台功能全面展示
