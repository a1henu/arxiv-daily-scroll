...
**arXiv**：[2512.04803v1](https://arxiv.org/abs/2512.04803) · [PDF](https://arxiv.org/pdf/2512.04803.pdf)  
**作者**：Yuhao Lu, HengJian SiTu, Jie Li, Yixuan Li, Yang Liu, Wenbin Lin, Yu Wang  

**一句话要点**：提出基于深度编码-解码网络的方法，以高精度估算超大质量黑洞质量，应用于SDSS类星体。

**关键词**：超大质量黑洞质量估算, 深度编码-解码网络, 回响映射, SDSS类星体, 光学光谱分析

## 3 点简述
- 核心问题：传统单线维里估计器在估算超大质量黑洞质量时精度不足，尤其在低质量和高质量类星体中不可靠。
- 方法要点：使用深度编码-解码网络，基于849个类星体的回响映射标签训练光学光谱数据，应用于SDSS类星体。
- 实验或效果：在回响映射质量基准上，达到均方根误差0.058 dex，相对不确定性约14%，决定系数R²≈0.91，超越传统方法。
