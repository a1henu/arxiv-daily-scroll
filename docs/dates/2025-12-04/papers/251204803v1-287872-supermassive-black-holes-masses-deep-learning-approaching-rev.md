...
**一句话要点**：提出基于深度编码-解码网络的方法，以接近反响映射精度估算超大质量黑洞质量。

**关键词**：超大质量黑洞质量估算, 深度编码-解码网络, 反响映射, 光学光谱分析, SDSS类星体, 深度学习天文学

## 3 点简述
- 核心问题：传统单线维里估计器在估算超大质量黑洞质量时精度不足，尤其在低质量和高质量类星体中不可靠。
- 方法要点：使用深度编码-解码网络，基于849个类星体的反响映射标签训练光学光谱数据，应用于SDSS类星体。
- 实验或效果：在287,872个类星体上实现均方根误差0.058 dex，相对不确定性约14%，决定系数R²≈0.91，超越传统方法。
