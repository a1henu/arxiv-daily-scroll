...
**一句话要点**：提出基于LLM化学的多LLM协作框架，以提升临床药物推荐的可靠性

**关键词**：药物推荐, 多LLM协作, LLM化学, 临床决策支持, 模型集成, 可靠性提升

## 3 点简述
- 核心问题：单个LLM易产生幻觉和不一致，传统集成方法难以保证稳定可信的药物推荐
- 方法要点：利用LLM化学量化模型协作兼容性，指导多LLM交互建模以实现互补、稳定和校准的集成
- 实验或效果：在真实临床场景中评估，初步结果表明该方法能生成可信、个性化的药物推荐
