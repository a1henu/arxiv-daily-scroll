...
**关键词**：多模态大语言模型, 视频描述, 幻觉缓解, 对比对齐, 自增强学习, 轨迹-短语匹配

## 3 点简述
- 核心问题：多模态大语言模型在视频描述中产生对象和动作的事实性错误，导致幻觉。
- 方法要点：采用自增强对比对齐，通过幻觉自增强生成负样本，并实施轨迹-短语对比对齐以匹配视觉事实。
- 实验或效果：在幻觉检测基准上优于现有方法，有效缓解对象和动作幻觉。
