...
**一句话要点**：提出EvoIR框架，通过进化频率调制解决全场景图像修复中的异构退化问题。

**关键词**：全场景图像修复, 频率调制, 进化优化, 异构退化, 结构保真度

## 3 点简述
- 核心问题：现有方法缺乏显式频率建模和固定优化策略，限制了对异构退化的泛化能力。
- 方法要点：引入频率调制模块分解高低频特征，结合进化优化策略动态调整目标以平衡结构准确性和感知保真度。
- 实验或效果：在多个基准测试中优于现有全场景图像修复方法，验证了框架的有效性。
