...
**arXiv**：[2512.04405v1](https://arxiv.org/abs/2512.04405) · [PDF](https://arxiv.org/pdf/2512.04405.pdf)  
**作者**：Chenyuan Feng, Anbang Zhang, Geyong Min, Yongming Huang, Tony Q. S. Quek, Xiaohu You  

**一句话要点**：提出语义感知与智能体范式以构建6G原生AI边缘网络

**关键词**：语义通信, 智能体网络, 6G边缘网络, 多智能体强化学习, 知识图谱推理, O-RAN互操作性

## 3 点简述
- 核心问题：现有AI驱动的O-RAN方案仍以比特为中心且任务孤立，难以适应6G智能原生需求。
- 方法要点：基于语义抽象、智能体自治协调和RAN控制放置的统一分类法，整合任务导向语义编码、多智能体强化学习等技术。
- 实验或效果：分析沉浸式XR、车联网V2X等用例，展示语义-智能体融合在实际场景中的应用潜力。
