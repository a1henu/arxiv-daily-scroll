...
**一句话要点**：提出BioTUCH框架，结合视觉与生物阻抗传感优化自接触场景下的3D人体姿态估计

**关键词**：3D人体姿态估计, 生物阻抗传感, 自接触优化, 姿态精炼, 多模态融合, 数据集构建

## 3 点简述
- 核心问题：视频姿态估计在自接触场景（如手触脸）中常不准确，缺乏可靠真值数据
- 方法要点：利用生物阻抗传感测量皮肤接触真值，通过接触感知优化初始化姿态，最小化重投影误差和偏差
- 实验或效果：在同步数据集上验证，平均重建精度提升11.7%，并开发微型传感器支持大规模数据收集
