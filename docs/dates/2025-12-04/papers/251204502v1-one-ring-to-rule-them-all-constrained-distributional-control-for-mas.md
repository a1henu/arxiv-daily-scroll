...
**关键词**：集成控制, 异构机器人系统, 约束处理, 矩核变换, 信号时序逻辑, 大规模控制

## 3 点简述
- 核心问题：异构机器人群体在状态和环境约束下的集成控制，如避障和访问路径点。
- 方法要点：开发矩核变换，将参数化集成动态映射到矩空间，统一处理约束以实现安全控制。
- 实验或效果：通过仿真和硬件实验验证框架在受限环境中安全高效控制机器人群体的有效性。
