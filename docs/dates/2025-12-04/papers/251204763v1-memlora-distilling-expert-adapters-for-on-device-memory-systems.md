...
**关键词**：设备端内存系统, 知识蒸馏, 专家适配器, 视觉语言模型, 多模态推理, 本地部署

## 3 点简述
- 核心问题：设备端部署中，大语言模型成本高，小模型性能不足，且现有系统缺乏视觉能力。
- 方法要点：为小模型训练专用内存适配器，基于知识蒸馏分操作优化，并扩展至视觉语言模型。
- 实验或效果：在文本任务上超越大基线模型，视觉任务上大幅提升准确率，保持多模态性能。
