...
**关键词**：设备端内存系统, 专家适配器蒸馏, 小语言模型, 视觉语言模型, 知识蒸馏, 多模态推理

## 3 点简述
- 核心问题：LLM内存系统成本高且缺乏视觉能力，SLM性能不足，难以本地部署。
- 方法要点：为SLM和SVLM训练专用内存适配器，基于知识蒸馏实现知识提取、更新和生成操作。
- 实验或效果：在LoCoMo基准上，MemLoRA超越大10倍基线，MemLoRA-V在视觉任务上大幅提升准确性。
