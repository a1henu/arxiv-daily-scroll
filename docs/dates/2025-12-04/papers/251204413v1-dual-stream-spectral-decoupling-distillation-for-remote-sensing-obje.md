...
**一句话要点**：提出双流谱解耦蒸馏方法以解决遥感目标检测中的特征混淆问题

**关键词**：遥感目标检测, 知识蒸馏, 谱分解, 特征解耦, 轻量化模型

## 3 点简述
- 核心问题：遥感图像特征混合及细微特征差异导致知识蒸馏中的知识混淆
- 方法要点：基于谱分解整合显式和隐式蒸馏，设计密度无关尺度权重和全频/高频放大器
- 实验或效果：在DIOR和DOTA数据集上验证，RetinaNet和Faster R-CNN的AP50分别提升4.2%和3.8%
