...
**一句话要点**：提出15自由度仿生手，采用绳驱动与分布式驱动，以解决传统绳驱动系统电机数量多、结构复杂的问题。

**关键词**：仿生手, 绳驱动, 分布式驱动, 自由度, 机器人操作, 轻量化

## 3 点简述
- 核心问题：在保持人手尺寸和自由度下，减少驱动器数量是机器人手研究的关键挑战。
- 方法要点：基于人手运动学和肌肉分布，设计绳驱动机制，集成5个前臂电机和10个手掌电机，简化结构并提升性能。
- 实验或效果：系统重1.4kg，实验显示具有高灵巧性和强抓取能力，适用于机器人操作任务。
