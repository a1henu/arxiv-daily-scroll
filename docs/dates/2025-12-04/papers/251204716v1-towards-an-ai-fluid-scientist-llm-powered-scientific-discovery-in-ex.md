...
**一句话要点**：提出AI流体科学家框架，实现实验流体力学全流程自主化研究。

**关键词**：实验流体力学, 自主化实验, 多智能体系统, 人机交互, 物理定律拟合, 机器人执行

## 3 点简述
- 核心问题：AI在实验流体力学中应用局限，多集中于数值研究。
- 方法要点：集成LLM与机器人系统，自动化执行假设生成至论文撰写全流程。
- 实验或效果：在串联圆柱体振动实验中验证，发现新现象并提升物理定律拟合精度31%。
