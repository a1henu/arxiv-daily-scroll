...
**一句话要点**：提出AI流体科学家框架，实现实验流体力学全流程自动化研究

**关键词**：实验流体力学, 自动化实验, AI流体科学家, 涡激振动, 尾流诱导振动, 多智能体系统

## 3 点简述
- 核心问题：AI在实验流体力学中应用有限，多集中于数值研究，缺乏端到端自动化实验能力。
- 方法要点：构建AI流体科学家框架，集成假设生成、实验设计、机器人执行、数据分析和论文撰写全流程。
- 实验或效果：通过串联圆柱涡激振动和尾流诱导振动实验验证，自动化复现文献基准，发现新现象，提升效率。
