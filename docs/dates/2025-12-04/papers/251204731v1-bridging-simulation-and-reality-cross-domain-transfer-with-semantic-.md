...
**一句话要点**：提出语义2D高斯泼溅以解决机器人操作中仿真到现实的跨域迁移问题

**关键词**：跨域迁移, 语义2D高斯泼溅, 机器人操作, 仿真到现实, 域不变特征, 策略泛化

## 3 点简述
- 核心问题：仿真与真实环境间的域差距阻碍机器人策略泛化，现有方法需大量调优或泛化能力有限
- 方法要点：S2GS提取对象中心、域不变空间特征，通过特征级高斯泼溅构建统一3D表示，并过滤无关背景
- 实验或效果：在ManiSkill仿真和真实部署中，结合Diffusion Policy，显著提升跨域迁移性能，保持高稳定任务表现
