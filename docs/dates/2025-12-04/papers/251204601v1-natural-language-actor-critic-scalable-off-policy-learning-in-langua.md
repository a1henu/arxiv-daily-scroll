...
**关键词**：大语言模型代理, 演员-评论家算法, 稀疏奖励学习, 自然语言解释, 离策略训练, 长时任务

## 3 点简述
- 核心问题：稀疏奖励长时任务中，基于轨迹奖励的策略梯度方法训练不稳定且样本复杂度高。
- 方法要点：使用生成式大语言模型评论家输出自然语言解释，替代标量值，提供更丰富的训练信号。
- 实验或效果：在推理、网页浏览和工具使用等任务中，NLAC展现出优于现有方法的性能，提供更可扩展的训练范式。
