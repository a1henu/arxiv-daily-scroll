...
**一句话要点**：提出AutoDW框架，通过逐步和可回滚的操作编排自动化复杂文档工作流

**关键词**：文档工作流自动化, 操作编排, 回滚机制, 增量规划, 会话级任务, API执行

## 3 点简述
- 核心问题：现有代理系统难以自动化多步骤、会话级文档工作流，缺乏过程控制
- 方法要点：AutoDW基于用户指令、API候选和文档状态增量规划，支持参数和API级回滚机制
- 实验或效果：在包含250会话和1708指令的基准上，指令和会话级任务完成率分别达90%和62%
