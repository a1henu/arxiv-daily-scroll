...
**一句话要点**：提出SDG-Track异构观察者-跟随者框架，以解决嵌入式平台高分辨率无人机跟踪中的分辨率-速度冲突。

**关键词**：无人机跟踪, 异构计算, 稀疏光流, 嵌入式平台, 高分辨率图像处理, 实时系统

## 3 点简述
- 核心问题：高分辨率无人机跟踪在边缘设备上存在分辨率与速度的冲突，导致小目标特征丢失或处理速度不足。
- 方法要点：采用异构观察者-跟随者架构，结合低频GPU检测与高频CPU稀疏光流插值，并引入无训练的双空间恢复机制处理跟踪失败。
- 实验或效果：在NVIDIA Jetson Orin Nano上实现35.1 FPS系统吞吐量，保持97.2%的逐帧检测精度，成功跟踪敏捷FPV无人机。
