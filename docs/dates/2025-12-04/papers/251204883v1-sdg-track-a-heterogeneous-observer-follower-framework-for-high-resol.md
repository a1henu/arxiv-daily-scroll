...
**一句话要点**：提出SDG-Track异构观察者-跟随者框架，解决嵌入式平台高分辨率无人机跟踪中的分辨率-速度冲突。

**关键词**：无人机跟踪, 异构计算, 稀疏光流, 嵌入式平台, 高分辨率图像处理, 实时系统

## 3 点简述
- 核心问题：高分辨率无人机跟踪在边缘设备上存在分辨率与速度的冲突，导致小目标特征丢失或处理延迟。
- 方法要点：采用观察者-跟随者架构，GPU低频运行高容量检测器提供位置锚点，CPU高频执行稀疏光流插值轨迹。
- 实验或效果：在NVIDIA Jetson Orin Nano上实现35.1 FPS系统吞吐量，保持97.2%逐帧检测精度，成功跟踪敏捷FPV无人机。
