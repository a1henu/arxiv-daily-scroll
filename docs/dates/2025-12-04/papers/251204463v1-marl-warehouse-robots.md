...
**一句话要点**：比较QMIX与IPPO在仓库机器人协同任务中的性能，展示QMIX通过价值分解显著优于独立学习。

**关键词**：多智能体强化学习, 仓库机器人, 价值分解, 算法比较, Unity仿真

## 3 点简述
- 研究多智能体强化学习在仓库机器人协同搬运中的应用，聚焦算法比较。
- 评估QMIX和IPPO在RWARE和Unity 3D环境，QMIX需超参数调优如长时epsilon退火。
- 实验显示QMIX平均回报3.25优于IPPO的0.38，Unity部署成功但规模化挑战未知。
