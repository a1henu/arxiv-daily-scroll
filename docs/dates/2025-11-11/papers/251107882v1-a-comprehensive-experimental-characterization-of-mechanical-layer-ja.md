...
**arXiv**：[2511.07882v1](https://arxiv.org/abs/2511.07882) · [PDF](https://arxiv.org/pdf/2511.07882.pdf)  
**作者**：Jessica Gumowski, Krishna Manaswi Digumarti, David Howard  

**一句话要点**：提出机械层卡滞系统设计参数实验表征，以指导软机器人刚度调制应用

**关键词**：机械层卡滞, 刚度调制, 软机器人, 实验表征, 设计参数
