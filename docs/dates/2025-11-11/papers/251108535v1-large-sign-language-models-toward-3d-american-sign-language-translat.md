...
**arXiv**：[2511.08535v1](https://arxiv.org/abs/2511.08535) · [PDF](https://arxiv.org/pdf/2511.08535.pdf)  
...
**一句话要点**：提出大型手语模型框架，利用LLM处理3D美国手语以改善听障者虚拟通信

**关键词**：3D手语翻译, 大型语言模型, 多模态处理, 听障通信, 手势识别
