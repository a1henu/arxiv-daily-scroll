...
**arXiv**：[2511.08512v1](https://arxiv.org/abs/2511.08512) · [PDF](https://arxiv.org/pdf/2511.08512.pdf)  
**作者**：Leonie Bossemeyer, Samuel Heinrich, Grant Van Horn, Oisin Mac Aodha  

**一句话要点**：提出CleverBirds基准以支持细粒度视觉知识追踪研究

**关键词**：知识追踪, 细粒度视觉识别, 多选问答基准, 鸟类分类, 公民科学数据
