...
**arXiv**：[2511.08005v1](https://arxiv.org/abs/2511.08005) · [PDF](https://arxiv.org/pdf/2511.08005.pdf)  
**作者**：Huacen Wang, Hongqiang Wang  

**一句话要点**：提出双层静电薄膜致动器以提升致动应力并集成制动功能

**关键词**：静电薄膜致动器, 双层电极设计, 高致动应力, 集成制动, 机器人致动, 轻量化平台
