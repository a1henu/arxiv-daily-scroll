...
**arXiv**：[2603.08445v1](https://arxiv.org/abs/2603.08445) · [PDF](https://arxiv.org/pdf/2603.08445.pdf)  
**作者**：He-Yen Hsieh, Wei-Te Mark Ting, H. T. Kung  

**一句话要点**：提出Alfa方法，通过重加权预训练滤波器实现跨域个性化视线估计

**关键词**：视线估计, 测试时个性化, 低秩适应, 注意力机制, 跨域适应

## 3 点简述
- 核心问题：预训练视线模型对用户特定结构变化敏感，测试时个性化需高效适应
- 方法要点：利用SVD提取预训练滤波器主导空间成分，通过注意力机制重加权以适配目标用户
- 实验或效果：在四个跨数据集基准上实现最低平均视线误差，优于现有TTP和LoRA方法
