...
**arXiv**：[2603.08692v1](https://arxiv.org/abs/2603.08692) · [PDF](https://arxiv.org/pdf/2603.08692.pdf)  
**作者**：Anas ALsobeh, Raneem Alkurdi  

**一句话要点**：提出EcoAI-Resilience框架，通过多目标优化实现AI驱动的可持续创业与经济韧性

**关键词**：多目标优化, 可持续AI, 经济韧性, 环境成本, 可再生能源整合, AI部署策略

## 3 点简述
- 核心问题：AI部署在促进经济韧性的同时，面临高能耗与环境成本挑战。
- 方法要点：集成多源数据，通过数学优化平衡可持续性、经济韧性与环境成本。
- 实验效果：模型性能优异（R>0.99），识别出100%可再生能源整合等最优策略。
