...
**arXiv**：[2510.15350v1](https://arxiv.org/abs/2510.15350) · [PDF](https://arxiv.org/pdf/2510.15350.pdf)  
**作者**：Shyalan Ramesh, Scott Mann, Alex Stumpf  

**一句话要点**：提出NOAH算法以解决水下强流中自主车辆群优化不可靠问题

**关键词**：水下群机器人, 群优化算法, 流体动力学, 不可逆锚定, 群体通信, 自主水下车辆

## 3 点简述
- 核心问题：水下强流、有限声学带宽和持续感知需求使传统群优化方法不可靠
- 方法要点：结合当前感知漂移、不可逆锚定和基于群体通信，灵感来自藤壶幼体行为
- 实验或效果：验证显示永久锚定场景成功率达86%，提供统一流体约束和锚定行为公式

## 摘要（原文）

> Autonomous Underwater vehicles must operate in strong currents, limited
