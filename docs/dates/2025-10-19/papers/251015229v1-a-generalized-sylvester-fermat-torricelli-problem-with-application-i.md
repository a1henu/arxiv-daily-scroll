---
layout: default
title: A Generalized Sylvester-Fermat-Torricelli problem with application in disaster relief operations by UAVs
---

# A Generalized Sylvester-Fermat-Torricelli problem with application in disaster relief operations by UAVs
**arXiv**：[2510.15229v1](https://arxiv.org/abs/2510.15229) · [PDF](https://arxiv.org/pdf/2510.15229.pdf)  
**作者**：Sina Kazemdehbashi, Yanchao Liu, Boris S. Mordukhovich  

**一句话要点**：提出广义Sylvester-Fermat-Torricelli问题以优化无人机灾难救援中的移动基站定位

**关键词**：无人机定位, 灾难救援, Sylvester-Fermat-Torricelli问题, 风影响建模, 移动基站优化

## 3 点简述
- 核心问题：无人机在风等恶劣天气下定位移动基站，以高效收集数据和建立通信网络。
- 方法要点：扩展Sylvester问题，统一建模风影响、无人机异构性和往返运动。
- 实验或效果：实验显示可减少高达84%的操作时间浪费，提升救援效率。

## 摘要（原文）

> Natural and human-made disasters can cause severe devastation and claim
