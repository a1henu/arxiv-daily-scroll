...
**arXiv**：[2510.15639v1](https://arxiv.org/abs/2510.15639) · [PDF](https://arxiv.org/pdf/2510.15639.pdf)  
**作者**：Manuel J. Fernandez, Alejandro Suarez, Anibal Ollero, Matteo Fumagalli  

**一句话要点**：提出可变刚度连杆以增强长距离空中机械臂的适应性与安全性

**关键词**：可变刚度连杆, 空中机械臂, 长距离操作, 动态交互控制, 无人机操纵

## 3 点简述
- 传统长距离空中机械臂系统使用刚性或缆绳连接，限制精度或传递扰动
- 集成可变刚度连杆，可根据任务需求在柔性绳与刚性杆间切换
- 实验显示柔性配置减震、刚性配置提高精度，验证了可控的柔顺-精度权衡

## 摘要（原文）

> This paper presents the integration of a Variable Stiffness Link (VSL) for
