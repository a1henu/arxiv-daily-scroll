...
**arXiv**：[2510.15615v1](https://arxiv.org/abs/2510.15615) · [PDF](https://arxiv.org/pdf/2510.15615.pdf)  
**作者**：Shuchang Lyu, Qi Zhao, Zheng Zhou, Meng Li, You Zhou, Dingding Yao, Guangliang Cheng, Huiyu Zhou, Zhenwei Shi  

**一句话要点**：综述遥感中基于深度学习的域适应方法，涵盖广泛任务与系统分类

**关键词**：域适应, 遥感图像分析, 深度学习, 跨域知识迁移, 系统分类, 数据集综述

## 3 点简述
- 核心问题：遥感数据因采样距离、传感器模式等差异导致域适应挑战
- 方法要点：基于深度学习进行特征表示和跨域知识迁移，系统分类方法
- 实验或效果：回顾数据集与SOTA方法性能，识别开放挑战与未来方向

## 摘要（原文）

> Domain adaptation is a crucial and increasingly important task in remote
