...
**arXiv**：[2512.23707v1](https://arxiv.org/abs/2512.23707) · [PDF](https://arxiv.org/pdf/2512.23707.pdf)  
...
**一句话要点**：提出基于评分准则奖励的强化学习训练方法，以提升AI科研助手生成研究计划的能力。

**关键词**：AI科研助手, 研究计划生成, 强化学习, 评分准则奖励, 自评训练, 跨领域泛化

## 3 点简述
- 核心问题：语言模型生成研究计划时难以满足所有约束和隐含要求。
- 方法要点：从多领域论文自动提取研究目标和评分准则，通过自评强化学习训练模型。
- 实验或效果：人类专家偏好微调模型生成计划，在机器学习和医学领域均实现显著改进。
