...
**arXiv**：[2512.23133v1](https://arxiv.org/abs/2512.23133) · [PDF](https://arxiv.org/pdf/2512.23133.pdf)  
**作者**：Anqi Mao, Mehryar Mohri, Yutao Zhong  

**一句话要点**：提出METRO算法以优化类别不平衡或成本不对称场景下的广义度量

**关键词**：广义度量优化, 成本敏感学习, H一致性, 代理损失函数, 有限样本保证, 类别不平衡

## 3 点简述
- 核心问题：广义度量如Fβ-测度优化存在计算与统计挑战，现有方法缺乏有限样本保证
- 方法要点：将度量优化重构为广义成本敏感学习问题，设计可证明H一致性的代理损失函数
- 实验或效果：METRO算法在实验中优于基线，具有理论性能保证
