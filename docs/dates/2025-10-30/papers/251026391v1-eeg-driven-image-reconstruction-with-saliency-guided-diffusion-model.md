...
**一句话要点**：提出双条件框架结合EEG与显著图以提升脑电驱动图像重建质量

**关键词**：脑电图像重建, 扩散模型, 空间注意机制, 神经解码, 低秩适应

## 3 点简述
- 现有EEG图像重建方法忽视空间注意机制，导致保真度和语义连贯性不足
- 使用ATM提取EEG特征，LoRA微调Stable Diffusion，ControlNet分支引入显著图控制
- 在THINGS-EEG数据集上评估，显著改善图像特征质量并与人类视觉注意对齐
