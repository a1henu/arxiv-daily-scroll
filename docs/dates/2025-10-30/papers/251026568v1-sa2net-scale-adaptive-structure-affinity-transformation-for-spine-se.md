...
**一句话要点**：提出SA²Net以解决超声脊柱分割中的上下文和结构建模挑战

**关键词**：脊柱分割, 超声体积投影成像, 尺度自适应, 结构亲和变换, Transformer解码器, 特征混合损失

## 3 点简述
- 核心问题：脊柱分割中全局上下文和结构知识学习不足，影响分割准确性。
- 方法要点：采用尺度自适应策略和结构亲和变换，结合Transformer解码器增强特征学习。
- 实验或效果：SA²Net在分割性能上优于现有方法，并展示了对不同骨干网络的适应性。
