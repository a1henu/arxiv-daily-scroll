...
**arXiv**：[2510.26040v1](https://arxiv.org/abs/2510.26040) · [PDF](https://arxiv.org/pdf/2510.26040.pdf)  
**作者**：Emily Steiner, Daniel van der Spuy, Futian Zhou, Afereti Pama, Minas Liarokapis, Henry Williams  

**一句话要点**：提出强化学习代理以提升F1TENTH赛车在真实世界中的超车性能

**关键词**：强化学习, 自主赛车, 超车行为, F1TENTH平台, 轮对轮竞赛

## 3 点简述
- 核心问题：自主轮对轮赛车中超车行为在真实场景中安全性和可靠性不足
- 方法要点：开发基于强化学习的代理，学习可靠导航和超车策略
- 实验或效果：在真实F1TENTH车辆上测试，超车率达87%，优于仅训练赛车的56%

## 摘要（原文）

> While autonomous racing performance in Time-Trial scenarios has seen
