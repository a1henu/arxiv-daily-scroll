...
**关键词**：视觉语言模型, 时间箭头判断, 心理物理学基准, 视频理解, 因果推理, 模型评估

## 3 点简述
- 核心问题：视觉语言模型在视频时间信息理解上存在显著缺陷，尤其缺乏对时间箭头的判断能力。
- 方法要点：基于心理物理学方法构建基准，使用人类行为基线测试模型在自然视频中的时间方向推理。
- 实验或效果：多数模型表现接近随机，最佳模型在物理不可逆过程和因果动作任务上远逊于人类。
