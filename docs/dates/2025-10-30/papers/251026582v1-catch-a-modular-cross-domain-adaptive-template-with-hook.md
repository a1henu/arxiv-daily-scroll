...
**一句话要点**：提出CATCH框架以解决视觉问答模型跨域泛化问题

**关键词**：视觉问答, 跨域适应, 模块化框架, 轻量适配器, 动态注入

## 3 点简述
- 核心问题：VQA模型在遥感、医疗等跨域场景中泛化性能显著下降
- 方法要点：通过域分类器和双适配器模块动态注入，实现视觉与语言解耦适应
- 实验或效果：在多个VQA基准上取得性能提升，无需重训练骨干模型
