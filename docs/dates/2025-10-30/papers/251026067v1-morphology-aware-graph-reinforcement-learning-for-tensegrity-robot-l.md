...
**一句话要点**：提出形态感知图强化学习框架，以解决张拉整体机器人运动控制难题

**关键词**：张拉整体机器人, 图强化学习, 形态感知控制, 仿真到硬件迁移, 软演员-评论者算法

## 3 点简述
- 张拉整体机器人具有欠驱动和高耦合动力学，导致运动控制困难
- 将图神经网络集成到SAC算法中，利用物理拓扑图捕捉组件耦合
- 在物理机器人上验证，样本效率高、鲁棒性强，策略可直接从仿真迁移到硬件
