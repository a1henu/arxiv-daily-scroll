...
**一句话要点**：提出基于机器视觉的异常检测系统，用于钢铁轧机实时故障预测。

**关键词**：机器视觉, 异常检测, 实时监控, 深度学习, 工业自动化, 故障预测

## 3 点简述
- 核心问题：钢铁轧机设备故障和过程中断导致非计划停机成本高。
- 方法要点：集成工业摄像头和深度学习模型，实时分析视频流和传感器数据。
- 实验或效果：长期部署显示系统可预测故障位置和原因，提升可靠性和生产力。
