...
**arXiv**：[2510.26132v1](https://arxiv.org/abs/2510.26132) · [PDF](https://arxiv.org/pdf/2510.26132.pdf)  
**作者**：Nestor O. Perez-Arancibia  

**一句话要点**：提出具身智能作为微机器人设计原则，通过共设计实现智能行为。

**关键词**：具身智能, 微机器人设计, 共设计方法, 结构动力学, 物理交互, 智能行为涌现

## 3 点简述
- 核心问题：传统机器人架构将感知、计算和驱动解耦，难以在微尺度实现高效智能行为。
- 方法要点：采用共设计方法，将结构、材料、环境交互和控制策略整合以嵌入智能。
- 实验或效果：开发Bee++等机器人，智能行为从结构动力学和物理交互中涌现。
