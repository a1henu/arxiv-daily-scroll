...
**一句话要点**：提出共享责任框架以减轻儿童-机器人陪伴终止的情感伤害

**关键词**：儿童-机器人交互, 情感伤害缓解, 责任框架, 定性调查, 社交机器人, 服务终止

## 3 点简述
- 核心问题：社交机器人服务终止导致儿童情感纽带断裂，引发责任归属争议。
- 方法要点：基于Moxie案例，通过定性调查分析参与者对责任分配的认知。
- 实验或效果：调查显示责任被视为多方共享，并受政治意识形态和父母状态影响。
