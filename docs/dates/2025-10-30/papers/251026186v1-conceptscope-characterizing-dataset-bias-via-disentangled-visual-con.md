...
**一句话要点**：提出ConceptScope框架，通过解耦视觉概念自动分析数据集偏差

**关键词**：数据集偏差分析, 视觉概念解耦, 稀疏自编码器, 可解释AI, 模型诊断

## 3 点简述
- 核心问题：数据集偏差普遍存在，但缺乏细粒度标注时难以系统识别
- 方法要点：利用稀疏自编码器从视觉基础模型中提取可解释概念，并分类为目标、上下文和偏差类型
- 实验或效果：验证可捕获多种视觉概念，检测已知和未知偏差，支持数据集审计和模型诊断
