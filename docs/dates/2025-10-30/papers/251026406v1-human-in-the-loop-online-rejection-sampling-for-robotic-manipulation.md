...
**一句话要点**：提出Hi-ORS方法以解决机器人操作中强化学习不稳定和模仿学习性能不足的问题

**关键词**：机器人操作, 拒绝采样, 强化学习, 模仿学习, 人机交互, 在线微调

## 3 点简述
- 核心问题：强化学习在机器人操作中因价值估计不准和稀疏监督而不稳定，模仿学习性能不足
- 方法要点：使用拒绝采样过滤负奖励样本，结合奖励加权监督训练提供密集中间步监督
