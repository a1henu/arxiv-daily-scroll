...
**一句话要点**：提出Hi-ORS方法，通过拒绝采样和人机协同提升机器人操作策略的稳定性和鲁棒性。

**关键词**：机器人操作, 拒绝采样, 人机协同, 强化学习, 模仿学习, 在线微调

## 3 点简述
- 核心问题：强化学习微调视觉语言动作模型不稳定，模仿学习性能不足。
- 方法要点：在线拒绝采样过滤负奖励样本，采用奖励加权监督训练提供密集监督。
- 实验或效果：在真实世界任务中，1.5小时训练超越基线，实现高效错误恢复。
