...
**一句话要点**：提出MoTDiff框架，使用扩散模型从单张模糊图像估计高分辨率运动轨迹

**关键词**：运动轨迹估计, 扩散模型, 单张模糊图像, 高分辨率估计, 盲图像去模糊, 编码曝光摄影

## 3 点简述
- 核心问题：现有从单张模糊图像提取运动信息的方法质量低，轨迹粗糙不准确
- 方法要点：采用条件扩散框架，以多尺度特征图为条件，结合新训练方法提升轨迹精度
- 实验或效果：在盲图像去模糊和编码曝光摄影中优于现有方法，实现高质量轨迹估计
