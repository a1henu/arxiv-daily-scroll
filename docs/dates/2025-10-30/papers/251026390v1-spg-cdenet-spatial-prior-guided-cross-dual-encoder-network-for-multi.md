...
**一句话要点**：提出SPG-CDENet以解决多器官分割中器官尺寸和形状变化大的问题

**关键词**：多器官分割, 空间先验, 交叉双编码器, 对称交叉注意力, 流式解码器, 医学图像分析

## 3 点简述
- 多器官分割面临器官尺寸和形状变化大的挑战，影响分割准确性
- 方法包括空间先验网络生成粗定位图，交叉双编码器网络融合全局与局部特征
- 在公开数据集上实验显示性能优于现有方法，消融研究验证模块有效性
