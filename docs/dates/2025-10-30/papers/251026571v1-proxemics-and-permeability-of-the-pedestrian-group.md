...
**arXiv**：[2510.26571v1](https://arxiv.org/abs/2510.26571) · [PDF](https://arxiv.org/pdf/2510.26571.pdf)  
**作者**：Saleh Albeaik, Faisal Alsallum, Mohamad Alrished  

**一句话要点**：研究行人群体近体学与渗透性，分析群体区域和互动行为。

**关键词**：行人群体行为, 近体学分析, 社会规范, 群体区域, 自然数据研究

## 3 点简述
- 核心问题：行人群体互动如何影响人群行为和交通动态。
- 方法要点：使用自然数据研究群体区域、占用计数和人员距离。
- 实验或效果：发现除公共区外可能存在三个区域，接近行为低频短暂。
