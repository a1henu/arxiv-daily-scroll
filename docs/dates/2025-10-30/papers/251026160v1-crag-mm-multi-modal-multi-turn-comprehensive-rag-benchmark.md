...
**关键词**：多模态检索增强生成, 可穿戴设备基准, 多轮对话评估, 图像知识图谱检索, 真实场景模拟

## 3 点简述
- 核心问题：缺乏针对可穿戴设备的多模态多轮RAG综合基准，影响真实场景应用。
- 方法要点：构建包含6.5K三元组和2K多轮对话的数据集，覆盖13个领域和多种挑战。
- 实验或效果：基准测试显示现有方法真实度仅32-45%，KDD Cup 2025中基线提升28%。
