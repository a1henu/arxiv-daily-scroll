...
**arXiv**：[2512.09610v1](https://arxiv.org/abs/2512.09610) · [PDF](https://arxiv.org/pdf/2512.09610.pdf)  
**作者**：Boyin Yang, Puming Jiang, Per Ola Kristensson  

**一句话要点**：提出ImageTalk多模态文本生成系统，以解决运动神经元疾病患者传统AAC系统词汇有限和文本输入效率低的问题。

**关键词**：多模态文本生成, 图像识别, 自然语言生成, 增强替代通信, 用户中心设计, 运动神经元疾病
