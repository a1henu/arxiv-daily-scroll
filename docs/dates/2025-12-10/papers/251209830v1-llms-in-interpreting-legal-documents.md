...
**arXiv**：[2512.09830v1](https://arxiv.org/abs/2512.09830) · [PDF](https://arxiv.org/pdf/2512.09830.pdf)  
**作者**：Simone Corbo  

**一句话要点**：探索大语言模型在法律文档解释中的应用，分析其优化传统法律任务的潜力与挑战。

**关键词**：大语言模型, 法律文档解释, 法律任务优化, 算法挑战, 合规性分析, 基准评估
