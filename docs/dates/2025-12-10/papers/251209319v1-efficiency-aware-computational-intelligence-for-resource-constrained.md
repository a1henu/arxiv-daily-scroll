...
**arXiv**：[2512.09319v1](https://arxiv.org/abs/2512.09319) · [PDF](https://arxiv.org/pdf/2512.09319.pdf)  
**作者**：Qianyu Zhou  

**一句话要点**：提出效率驱动的计算智能框架，以解决资源受限制造环境中的数据稀缺与部署挑战。

**关键词**：数据高效学习, 边缘计算, 物理感知表示, 图基代理建模, 零样本推理, 制造智能
