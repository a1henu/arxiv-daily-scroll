...
**arXiv**：[2512.09817v1](https://arxiv.org/abs/2512.09817) · [PDF](https://arxiv.org/pdf/2512.09817.pdf)  
**作者**：Habiba BEN ABDERRAHMANE, Slimane Oulad-Naoui, Benameur ZIANI  

**一句话要点**：提出统一模块化管道，整合多源数据与机器学习，以支持透明可扩展的土壤质量评估。

**关键词**：土壤质量评估, 地理信息系统, 遥感技术, 机器学习, 可持续土地管理, 多源数据整合
