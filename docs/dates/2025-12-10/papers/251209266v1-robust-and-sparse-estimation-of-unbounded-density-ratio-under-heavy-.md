...
**arXiv**：[2512.09266v1](https://arxiv.org/abs/2512.09266) · [PDF](https://arxiv.org/pdf/2512.09266.pdf)  
**作者**：Ryosuke Nagumo, Hironori Fujisawa  

**一句话要点**：提出加权密度比估计方法，在重度污染下实现稀疏一致性和强鲁棒性

**关键词**：密度比估计, 鲁棒估计, 非渐近分析, 污染环境, 稀疏一致性
