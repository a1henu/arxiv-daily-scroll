...
**arXiv**：[2512.09276v1](https://arxiv.org/abs/2512.09276) · [PDF](https://arxiv.org/pdf/2512.09276.pdf)  
**作者**：Xiaochen Huang, Xiaochen Bi, Cuihua Lv, Xin Wang, Haoyan Zhang, Wenjing Jiang, Xin Ma, Yibin Li  

**一句话要点**：提出基于动态面部表情分析的帕金森病辅助诊断方法，以解决诊断效率与可及性问题。

**关键词**：动态面部表情分析, 帕金森病辅助诊断, 多模态网络, CLIP架构, LSTM分类
