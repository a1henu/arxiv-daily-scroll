...
**arXiv**：[2512.09232v1](https://arxiv.org/abs/2512.09232) · [PDF](https://arxiv.org/pdf/2512.09232.pdf)  
**作者**：Md Eimran Hossain Eimon, Juan Merlos, Ashan Perera, Hari Kalva, Velibor Adzic, Borko Furht  

**一句话要点**：提出特征编码标准FCM以支持低功耗设备高效运行AI应用

**关键词**：特征编码, MPEG-AI标准, 神经网络特征压缩, 低功耗设备AI, 远程推理优化
