...
**arXiv**：[2511.21143v1](https://arxiv.org/abs/2511.21143) · [PDF](https://arxiv.org/pdf/2511.21143.pdf)  
...
**一句话要点**：提出STAR增强现实文本输入方法，利用智能手机双拇指打字习惯提升效率。

**关键词**：增强现实, 文本输入, 虚拟键盘, 人机交互, 打字性能

## 3 点简述
- 增强现实中文本输入效率低且难用，是开放挑战。
- STAR方法在用户手部皮肤上叠加虚拟QWERTY键盘，模拟智能手机双拇指打字。
- 评估显示，30分钟练习后平均打字速度21.9 WPM，错误率0.3%。
