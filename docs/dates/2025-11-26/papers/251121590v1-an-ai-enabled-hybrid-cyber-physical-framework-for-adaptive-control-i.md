...
**arXiv**：[2511.21590v1](https://arxiv.org/abs/2511.21590) · [PDF](https://arxiv.org/pdf/2511.21590.pdf)  
**作者**：Muhammad Siddique, Sohaib Zafar  

**一句话要点**：提出基于机器学习的云数字取证框架以增强智能电网安全与可靠性

**关键词**：智能电网安全, 数字取证框架, 机器学习算法, 云数据分析, 异常检测, 实时监控

## 3 点简述
- 智能电网融合物理与网络系统，易受数据篡改等攻击威胁稳定性
- 框架集成传感器数据采集、认证通信与云分析，使用监督和无监督学习算法
- 实验显示框架在实时数据流中准确检测异常，提升对网络攻击的弹性
