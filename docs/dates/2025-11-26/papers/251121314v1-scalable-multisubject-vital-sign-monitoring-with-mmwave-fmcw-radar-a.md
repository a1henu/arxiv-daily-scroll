...
**arXiv**：[2511.21314v1](https://arxiv.org/abs/2511.21314) · [PDF](https://arxiv.org/pdf/2511.21314.pdf)  
**作者**：Jewel Benny, Narahari N. Moudhgalya, Mujeev Khan, Hemant Kumar Meena, Mohd Wajid, Abhishek Srivastava  

**一句话要点**：提出基于毫米波FMCW雷达的非接触多对象生命体征监测系统，以解决传统穿戴设备不适与感染风险问题。

**关键词**：毫米波雷达, 非接触监测, 多对象生命体征, FPGA实现, FMCW雷达, 硬件加速

## 3 点简述
- 传统生命体征监测存在穿戴不适、校准困难和感染传播风险。
- 使用毫米波FMCW雷达实现非接触多对象监测，并探索扩展到任意对象数的挑战。
- FPGA原型实现执行速度提升2.7倍，LUT使用减少18.4%，相比软件加速超7400倍。
