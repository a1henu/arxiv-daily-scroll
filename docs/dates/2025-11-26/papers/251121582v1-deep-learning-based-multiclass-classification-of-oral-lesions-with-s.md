...
**arXiv**：[2511.21582v1](https://arxiv.org/abs/2511.21582) · [PDF](https://arxiv.org/pdf/2511.21582.pdf)  
**作者**：Joy Naoum, Revana Salama, Ali Hamdi  

**一句话要点**：提出基于深度学习的口腔病变多类分类方法，结合分层增强解决数据不平衡问题。

**关键词**：口腔病变分类, 深度学习, 数据增强, 过采样, 多类分类, 计算机辅助诊断

## 3 点简述
- 核心问题：口腔癌早期诊断困难，因良性、癌前和恶性病变视觉相似度高。
- 方法要点：使用分层数据分割、数据增强和过采样技术处理有限和不平衡数据集。
- 实验或效果：模型准确率达83.33%，精确率89.12%，召回率77.31%，优于现有方法。
