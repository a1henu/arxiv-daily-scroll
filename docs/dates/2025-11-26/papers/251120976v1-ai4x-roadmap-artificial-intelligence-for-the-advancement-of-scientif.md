...
**arXiv**：[2511.20976v1](https://arxiv.org/abs/2511.20976) · [PDF](https://arxiv.org/pdf/2511.20976.pdf)  
...
**一句话要点**：提出AI4X路线图以推动科学发现，涵盖多学科AI应用与未来方向

**关键词**：人工智能科学, 多学科AI应用, 自驱动实验室, 基础模型, 数据可信性, 科学发现加速

## 3 点简述
- 核心问题：科学发现中数据可信性、模型可转移性及AI系统集成瓶颈
- 方法要点：利用基础模型、主动学习和自驱动实验室连接预测与验证
- 实验或效果：未知具体实验，强调提升AI系统透明度和加速现实环境发现
