...
**arXiv**：[2511.21034v1](https://arxiv.org/abs/2511.21034) · [PDF](https://arxiv.org/pdf/2511.21034.pdf)  
**作者**：Mahdi Saki, Justin Lipman  

**一句话要点**：提出多头注意力Transformer模型以预测奶牛群寿命

**关键词**：奶牛群寿命预测, 多头注意力Transformer, 多元时间序列分析, 农业AI应用, 畜牧管理

## 3 点简述
- 核心问题：奶牛保留或淘汰决策复杂，需客观评估其群寿命。
- 方法要点：利用多头注意力Transformer分析历史多元时间序列数据。
- 实验或效果：模型在澳大利亚7个农场数据上预测决定系数达83%。
