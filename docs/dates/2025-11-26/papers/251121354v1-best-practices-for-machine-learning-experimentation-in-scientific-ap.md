...
**arXiv**：[2511.21354v1](https://arxiv.org/abs/2511.21354) · [PDF](https://arxiv.org/pdf/2511.21354.pdf)  
**作者**：Umberto Michelucci, Francesca Venturini  

**一句话要点**：提出机器学习实验最佳实践指南，以提升科学应用中的结果可靠性与可复现性。

**关键词**：机器学习实验, 可复现性, 过拟合评估, 科学应用, 模型验证, 实验报告

## 3 点简述
- 核心问题：科学应用中机器学习实验设计不当导致结果不可靠和误导性结论。
- 方法要点：提供结构化工作流程，包括数据集准备、模型选择和评估步骤。
- 实验或效果：引入LOR和COS等指标，评估过拟合和不稳定性，支持公平比较。
