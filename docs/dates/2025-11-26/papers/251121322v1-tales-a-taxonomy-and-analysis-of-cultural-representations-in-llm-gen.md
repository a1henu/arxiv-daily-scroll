...
**arXiv**：[2511.21322v1](https://arxiv.org/abs/2511.21322) · [PDF](https://arxiv.org/pdf/2511.21322.pdf)  
**作者**：Kirti Bhagat, Shaily Bhatt, Athul Velagapudi, Aditya Vashistha, Shachi Dave, Danish Pruthi  

**一句话要点**：提出TALES评估框架以分析LLM生成故事中的文化误表示问题

**关键词**：文化表示评估, LLM生成故事, 印度文化多样性, 误表示分类法, 大规模标注研究, 模型知识评估

## 3 点简述
- 核心问题：评估AI生成故事中文化误表示，尤其在印度多元文化背景下。
- 方法要点：开发TALES-Tax分类法，结合焦点小组和调查构建文化误表示分类。
- 实验或效果：大规模标注显示88%故事含文化错误，模型知识存在但生成不准确。
