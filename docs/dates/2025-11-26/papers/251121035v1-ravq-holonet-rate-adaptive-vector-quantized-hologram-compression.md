...
**arXiv**：[2511.21035v1](https://arxiv.org/abs/2511.21035) · [PDF](https://arxiv.org/pdf/2511.21035.pdf)  
**作者**：Shima Rafiei, Zahra Nabizadeh Shahr Babak, Shadrokh Samavi, Shahram Shirani  

**一句话要点**：提出RAVQ-HoloNet框架以解决全息图压缩中的速率自适应问题

**关键词**：全息图压缩, 速率自适应, 向量量化, AR/VR应用, 深度学习

## 3 点简述
- 全息图在AR/VR应用中数据压缩需求高，现有深度学习方法缺乏速率自适应能力
- 采用速率自适应向量量化方法，在低和超低比特率下实现高保真重建
- 实验显示在低比特率下BD-Rate降低33.91%，BD-PSNR提升1.02 dB
