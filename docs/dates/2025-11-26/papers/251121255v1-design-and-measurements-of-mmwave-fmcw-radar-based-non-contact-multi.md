...
**arXiv**：[2511.21255v1](https://arxiv.org/abs/2511.21255) · [PDF](https://arxiv.org/pdf/2511.21255.pdf)  
**作者**：Jewel Benny, Pranjal Mahajan, Srayan Sankar Chatterjee, Mohd Wajid, Abhishek Srivastava  

**一句话要点**：提出基于毫米波FMCW雷达的非接触式多患者心率和呼吸率监测系统，用于高效群体监控。

**关键词**：毫米波雷达, 非接触监测, 心率测量, 呼吸率测量, 多患者监控, FMCW雷达

## 3 点简述
- 核心问题：非接触式同时监测多患者心率和呼吸率，适应大规模监控需求。
- 方法要点：结合多种处理方法，使用最小二乘解提高测量精度和泛化能力。
- 实验或效果：实验结果显示呼吸率准确率>97%，心率准确率>93%。
