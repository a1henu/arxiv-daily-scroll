...
**arXiv**：[2511.21280v1](https://arxiv.org/abs/2511.21280) · [PDF](https://arxiv.org/pdf/2511.21280.pdf)  
**作者**：Jamal Raiyn  

**一句话要点**：提出基于时间碰撞指标的碰撞避免策略以处理切入场景

**关键词**：碰撞避免, 时间碰撞指标, 切入场景, 自动驾驶, 深度学习

## 3 点简述
- 核心问题：切入场景对自动驾驶车辆碰撞避免构成挑战
- 方法要点：结合深度学习与时间碰撞指标预测碰撞并确定规避动作
- 实验或效果：与传统时间碰撞方法相比，系统性能有所改进
