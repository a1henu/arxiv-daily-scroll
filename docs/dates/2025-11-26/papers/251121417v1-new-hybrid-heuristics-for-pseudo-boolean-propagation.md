...
**arXiv**：[2511.21417v1](https://arxiv.org/abs/2511.21417) · [PDF](https://arxiv.org/pdf/2511.21417.pdf)  
**作者**：Mia Müßig, Jan Johannsen  

**一句话要点**：提出新启发式方法以提升伪布尔求解器中混合传播策略的性能

**关键词**：伪布尔求解, 单元传播, 启发式方法, 混合策略, RoundingSAT求解器

## 3 点简述
- 核心问题：伪布尔求解中混合单元传播策略的决策优化问题
- 方法要点：引入新启发式改进混合模式中的决策过程
- 实验或效果：在RoundingSAT求解器中显著超越现有方法
