...
**arXiv**：[2511.21211v1](https://arxiv.org/abs/2511.21211) · [PDF](https://arxiv.org/pdf/2511.21211.pdf)  
**作者**：Rubén Fernández-Farelo, Jorge Paz-Ruza, Bertha Guijarro-Berdiñas, Amparo Alonso-Betanzos, Alex A. Freitas  

**一句话要点**：提出Fast-mRMR特征选择方法以解决高维组学数据中基因优先排序的挑战

**关键词**：基因优先排序, 特征选择, 高维数据, 生物信息学, 机器学习

## 3 点简述
- 核心问题：高维和不完整标注的生物医学数据导致基因优先排序方法效果不佳
- 方法要点：使用Fast-mRMR特征选择保留相关且非冗余特征，构建更简单有效的分类器
- 实验或效果：在饮食限制数据集上实验，相比现有方法显著提升性能
