...
**arXiv**：[2511.21257v1](https://arxiv.org/abs/2511.21257) · [PDF](https://arxiv.org/pdf/2511.21257.pdf)  
**作者**：Sullivan Hué, Sébastien Laurent, Ulrich Aiounou, Emmanuel Flachaire  

**一句话要点**：提出Post-Double-Autometrics以解决高维线性回归中Post-Double-Lasso的有限样本偏差问题

**关键词**：高维线性回归, 参数估计, Post-Double-Autometrics, 遗漏变量偏差, 经济增长分析

## 3 点简述
- 核心问题：Post-Double-Lasso在高维线性回归中估计感兴趣参数时存在显著有限样本遗漏变量偏差
- 方法要点：基于Autometrics开发Post-Double-Autometrics，作为Post-Double-Lasso的替代方法
- 实验或效果：在经济增长标准应用中验证该方法优于Post-Double-Lasso，并重新审视收敛假设
