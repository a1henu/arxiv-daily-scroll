...
**一句话要点**：提出基于预测编码与信息瓶颈的混合框架，用于检测大语言模型幻觉

**关键词**：幻觉检测, 预测编码, 信息瓶颈, 可解释AI, 大语言模型, 轻量级模型

## 3 点简述
- 核心问题：大语言模型生成看似合理但事实不忠的幻觉，阻碍高风险部署。
- 方法要点：结合预测编码和信息瓶颈提取可解释信号，实现轻量级、高效检测。
- 实验或效果：在HaluBench上AUROC达0.8669，数据效率高，推理速度快，模型可解释。
