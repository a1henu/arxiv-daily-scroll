...
**arXiv**：[2601.15575v1](https://arxiv.org/abs/2601.15575) · [PDF](https://arxiv.org/pdf/2601.15575.pdf)  
**作者**：Jason Kim, Maria Teleki, James Caverlee  

**一句话要点**：提出PromptHelper提示推荐系统，以增强AI聊天机器人交互中的创意探索与表达。

**关键词**：提示推荐系统, AI聊天机器人, 创意交互, 用户探索, 语义多样性, 写作任务支持

## 3 点简述
- 核心问题：用户在与AI系统交互时，常难以探索替代方向、表达创意意图或理解提示变化对输出的影响。
- 方法要点：开发PromptHelper原型，集成于AI聊天机器人，提供语义多样的上下文相关提示建议，支持实时写作任务。
- 实验或效果：通过2x2完全被试内研究（N=32），在创意和学术写作任务中评估，结果显示显著提升用户感知的探索性和表达性，且不增加认知负荷。
