...
## 3 点简述
- 核心问题：长尾数据分布导致深度神经网络性能下降，尾部类别样本少，优化过程受样本置信度差异影响
- 方法要点：设计类别和置信度感知的重加权方案，在损失层面调制训练贡献，基于预测置信度和类别相对频率
- 实验或效果：在CIFAR-100-LT、ImageNet-LT和iNaturalist2018数据集上验证，不同不平衡因子下取得显著结果
