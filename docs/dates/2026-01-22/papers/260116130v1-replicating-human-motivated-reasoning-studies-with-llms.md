...
**arXiv**：[2601.16130v1](https://arxiv.org/abs/2601.16130) · [PDF](https://arxiv.org/pdf/2601.16130.pdf)  
**作者**：Neeley Pate, Adiba Mahbub Proma, Hangfeng He, James N. Druckman, Daniel Molden, Gourab Ghoshal, Ehsan Hoque  

**一句话要点**：通过复制人类动机推理研究，发现基础LLM行为与人类预期不符

**关键词**：动机推理, 大型语言模型, 行为对齐, 政治研究, 论证评估

## 3 点简述
- 核心问题：基础LLM是否模仿人类动机推理现象，即信息处理中偏向特定结论
- 方法要点：复制4项先前政治动机推理研究，比较LLM与人类行为差异
- 实验或效果：基础LLM行为未对齐人类预期，模型间行为相似，如标准差较小和论证强度评估不准确
