...
**arXiv**：[2601.15626v1](https://arxiv.org/abs/2601.15626) · [PDF](https://arxiv.org/pdf/2601.15626.pdf)  
**作者**：Lili Chen, Winn Wing-Yiu Chow, Stella Peng, Bencheng Fan, Sachitha Bandara  

**一句话要点**：提出基于二元问题的生成式AI框架，以提升工程数学评估的评分效率与反馈质量。

**关键词**：生成式AI, 标准参照评分, 工程数学评估, 二元问题框架, 自动反馈生成

## 3 点简述
- 研究生成式AI如何融入标准参照评分框架，解决人工评分效率低、反馈不完整的问题。
- 采用二元问题结构化方法，使AI能可靠识别学生错误并提供高质量反馈。
- 实验显示AI评分准确率达92.5%，与专家相当，但自主应用可靠性未知。
