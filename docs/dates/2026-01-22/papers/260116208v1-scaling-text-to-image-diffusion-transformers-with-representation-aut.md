...
**一句话要点**：提出表示自编码器框架以提升大规模文本到图像生成的性能与稳定性

**关键词**：文本到图像生成, 表示自编码器, 扩散模型, 大规模预训练, 噪声调度, 多模态表示

## 3 点简述
- 研究表示自编码器框架在大规模自由文本到图像生成中的可扩展性
- 通过实验简化框架设计，发现维度相关噪声调度是关键，而复杂结构在规模化时效益有限
- 在扩散变换器规模对比中，表示自编码器在预训练和微调中均优于变分自编码器，收敛更快且质量更好
