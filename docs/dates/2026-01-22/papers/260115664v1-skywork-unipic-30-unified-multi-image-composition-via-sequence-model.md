...
**关键词**：多图像合成, 序列建模, 人-物交互, 统一框架, 加速推理, 数据管道

## 3 点简述
- 核心问题：多图像合成在一致性与质量上挑战大，现有模型方法细节不明，人-物交互需求高。
- 方法要点：设计数据管道与序列建模训练范式，将多图像合成转化为统一序列合成，集成后训练加速推理。
- 实验或效果：在单图像编辑基准达SOTA，多图像合成超越Nano-Banana和Seedream 4.0，推理速度提升12.5倍。
