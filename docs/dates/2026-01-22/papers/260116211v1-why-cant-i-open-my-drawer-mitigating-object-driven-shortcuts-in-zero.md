...
**一句话要点**：提出RCORE框架以缓解零样本组合动作识别中的物体驱动动词捷径问题

**关键词**：零样本组合动作识别, 物体驱动捷径, 时间顺序正则化, 组合感知增强, 视频理解

## 3 点简述
- 核心问题：现有零样本组合动作识别模型因监督稀疏性和学习不对称性，过度依赖物体-动词共现统计，忽略视觉证据。
- 方法要点：RCORE通过组合感知增强和时间顺序正则化损失，强制模型基于时间结构学习动词，减少捷径行为。
