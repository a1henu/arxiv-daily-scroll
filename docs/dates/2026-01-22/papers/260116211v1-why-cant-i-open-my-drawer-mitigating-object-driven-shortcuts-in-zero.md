...
**关键词**：零样本组合动作识别, 对象驱动捷径, 视频理解, 时间正则化, 组合感知增强

## 3 点简述
- 核心问题：现有ZS-CAR模型因组合监督稀疏性和动词-对象学习难度不对称，导致对象驱动动词捷径，忽视视觉证据。
- 方法要点：RCORE通过组合感知增强和时间顺序正则化损失，强制基于时间的动词学习，减少对共现统计的依赖。
- 实验或效果：在Sth-com和EK100-com基准上，RCORE显著提升未见组合准确率，实现一致正组合差距。
