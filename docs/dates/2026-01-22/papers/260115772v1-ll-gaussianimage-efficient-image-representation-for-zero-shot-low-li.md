...
**一句话要点**：提出LL-GaussianImage，在2D高斯泼溅压缩域实现零样本低光增强

**关键词**：2D高斯泼溅, 零样本低光增强, 压缩域处理, 专家混合框架, 多目标优化

## 3 点简述
- 现有低光增强算法需在像素域处理，导致2DGS压缩图像需解压-增强-再压缩，效率低且质量受损
- 设计语义引导的专家混合增强框架，直接在2DGS稀疏属性空间应用动态自适应变换，避免全解压
- 通过多目标协同损失和两阶段优化，在保持高压缩比的同时提升视觉质量，实验验证了该范式的可行性和优越性
