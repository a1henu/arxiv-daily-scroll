...
**一句话要点**：提出RAGCRAWLER方法，以知识图谱引导爬虫攻击解决检索增强生成系统的隐私泄露问题。

**关键词**：检索增强生成系统, 隐私攻击, 知识图谱, 自适应随机覆盖, 语义查询规划, 安全漏洞

## 3 点简述
- 核心问题：RAG系统存在隐私风险，攻击者可通过多轮查询逐步窃取敏感内容，现有方法缺乏长期规划。
- 方法要点：将攻击建模为自适应随机覆盖问题，利用知识图谱估计条件边际增益，在语义空间规划查询。
- 实验或效果：在多种RAG架构和数据集上，RAGCRAWLER覆盖率达84.4%，比基线平均提升20.7%，且成本低、鲁棒性强。
