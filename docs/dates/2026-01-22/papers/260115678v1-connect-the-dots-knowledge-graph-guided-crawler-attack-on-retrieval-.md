...
**一句话要点**：提出RAGCRAWLER方法，以知识图指导爬虫攻击解决检索增强生成系统的隐私泄露问题

**关键词**：检索增强生成, 隐私攻击, 知识图, 自适应规划, 语义查询

## 3 点简述
- 核心问题：RAG系统在隐私场景下存在多轮查询攻击风险，现有方法缺乏长期规划能力
- 方法要点：将攻击建模为自适应随机覆盖问题，利用知识图估计条件边际增益并规划语义空间查询
- 实验或效果：在多种RAG架构和数据集上，RAGCRAWLER实现高达84.4%语料覆盖率，平均提升20.7%
