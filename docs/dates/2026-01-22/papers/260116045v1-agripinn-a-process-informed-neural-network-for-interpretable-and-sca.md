...
**关键词**：作物生物量预测, 过程信息神经网络, 水分胁迫, 可解释AI, 时空预测, 深度学习

## 3 点简述
- 核心问题：数据驱动模型缺乏可解释性，过程模型难以大规模部署，影响作物生物量预测。
- 方法要点：将生物物理微分方程作为可微分约束集成到深度学习框架中，实现生理一致性预测。
- 实验或效果：在德国397个区域数据上预训练，实验显示精度和计算效率优于现有方法，RMSE降低达43%。
