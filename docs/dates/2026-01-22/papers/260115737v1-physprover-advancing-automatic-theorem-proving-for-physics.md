...
**关键词**：物理定理证明, 形式化推理, 强化学习, 数据集构建, 跨领域泛化, 自动定理证明

## 3 点简述
- 核心问题：现有自动定理证明研究忽视物理领域，缺乏针对物理定理的形式化推理方法。
- 方法要点：构建PhysLeanData数据集，基于DeepSeek-Prover-V2-7B模型，采用可验证奖励的强化学习训练PhysProver。
