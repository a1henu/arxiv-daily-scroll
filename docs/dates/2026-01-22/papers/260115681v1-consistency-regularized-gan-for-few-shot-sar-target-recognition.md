...
**关键词**：少样本学习, 生成对抗网络, 合成孔径雷达, 自监督学习, 数据增强

## 3 点简述
- 核心问题：少样本SAR识别中，传统GAN训练需大量数据，与数据稀缺前提矛盾。
- 方法要点：引入双分支判别器，解耦对抗训练与表示学习，结合特征插值和双域循环一致性机制。
- 实验或效果：在MSTAR和SRSDD数据集上，8-shot设置下分别达到71.21%和51.64%准确率，显著优于基线。
