...
**关键词**：低光图像增强, 2D高斯泼溅, 增益图生成, 无监督学习, 结构感知, 零样本学习

## 3 点简述
- 核心问题：现有低光增强方法忽视图像几何结构先验，依赖像素域或隐式特征表示
- 方法要点：利用2D高斯泼溅进行高保真结构重建，通过统一增强模块生成增益图，结合结构感知能力
- 实验或效果：在无监督学习下实现优异增强性能，存储开销极低，有效保留边缘并抑制伪影
