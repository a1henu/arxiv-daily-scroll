...
**arXiv**：[2601.15671v1](https://arxiv.org/abs/2601.15671) · [PDF](https://arxiv.org/pdf/2601.15671.pdf)  
**作者**：Ziyi Wang, Yilong Dai, Duanya Lyu, Mateo Nader, Sihan Chen, Wanghao Ye, Zjian Ding, Xiang Yan  

**一句话要点**：提出StreetDesignAI系统，通过多角色评估支持包容性骑行基础设施设计

**关键词**：包容性设计, 多智能体评估, 骑行基础设施, 人机交互, 设计工具

## 3 点简述
- 核心问题：设计包容性骑行基础设施时，设计师难以平衡不同用户群体的竞争性需求。
- 方法要点：基于角色多智能体评估，通过图像和地图数据提供并行反馈，显式化体验冲突。
- 实验或效果：26名交通专业人员研究表明，系统提升设计师对用户视角的理解、需求识别能力和设计决策信心。
