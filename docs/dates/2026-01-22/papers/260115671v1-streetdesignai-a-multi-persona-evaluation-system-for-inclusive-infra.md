...
**关键词**：包容性设计, 多角色评估, 骑行基础设施, 人机交互, 设计工具

## 3 点简述
- 核心问题：设计包容性骑行设施需平衡不同用户需求，但设计师难以预见多样体验冲突。
- 方法要点：基于街景和地图数据，利用多角色智能体提供并行反馈，突出设计中的体验冲突。
- 实验或效果：26名交通专业人员研究表明，系统提升设计理解、需求识别和决策信心，促进专业采纳。
