...
**关键词**：视频扩散模型, 相机控制, 奖励反馈学习, 3D高斯表示, 几何扭曲, 像素一致性

## 3 点简述
- 核心问题：现有相机控制视频扩散模型对齐能力有限，且Reward Feedback Learning面临奖励模型不足、计算开销大和忽略3D几何信息等挑战。
- 方法要点：引入高效相机感知3D解码器，将视频潜在表示和相机姿态解码为3D高斯表示，通过渲染新视图与真实视图的像素一致性优化奖励。
- 实验或效果：在RealEstate10K和WorldScore基准测试中验证了方法的有效性，提升了相机可控性。
