...
**关键词**：人形机器人导航, 无碰撞穿越, HumanoidPF, 强化学习, 室内场景, sim-to-real迁移

## 3 点简述
- 核心问题：人形机器人需将感知的障碍物映射到穿越技能，但缺乏有效表示捕获人形-障碍物关系
- 方法要点：提出HumanoidPF编码关系为无碰撞运动方向，并设计混合场景生成方法提升泛化性
- 实验或效果：在仿真和真实世界验证有效性，实现单点击远程操作穿越，sim-to-real差距可忽略
