...
**一句话要点**：提出条件灵活性指数以利用数据驱动和上下文信息改进过程调度决策

**关键词**：条件灵活性指数, 数据驱动不确定性集, 正态化流, 过程调度, 安全约束机组组合, 上下文信息

## 3 点简述
- 传统灵活性指数使用简单不确定性集，未考虑上下文信息如预测数据
- CFI通过正态化流学习数据分布，构建条件不确定性集以更精确评估灵活性
- 应用于安全约束机组组合示例，证明CFI能通过时间信息提升调度质量
