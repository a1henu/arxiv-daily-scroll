...
**一句话要点**：提出HVD模型以解决文本-视频检索中特征交互盲目性问题，通过模拟人类视觉实现粗到细对齐。

**关键词**：文本-视频检索, 人类视觉模拟, 粗到细对齐, 帧选择, 补丁压缩, 注意力机制

## 3 点简述
- 核心问题：现有方法因文本查询稀疏性，难以从背景噪声中识别关键视觉信息，导致特征交互盲目。
- 方法要点：引入粗到细对齐机制，包括帧选择模块消除时间冗余和补丁压缩模块聚合特征为视觉实体。
- 实验或效果：在五个基准测试中验证，HVD能模拟人类视觉焦点并达到最先进性能。
