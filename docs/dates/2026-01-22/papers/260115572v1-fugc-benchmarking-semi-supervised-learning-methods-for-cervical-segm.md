...
**一句话要点**：提出FUGC基准以解决宫颈分割中标注数据稀缺问题，评估半监督学习方法。

**关键词**：宫颈分割, 半监督学习, 医学图像分析, 早产风险评估, 基准测试, 经阴道超声

## 3 点简述
- 核心问题：经阴道超声图像中宫颈结构分割对早产风险评估至关重要，但标注数据稀缺限制监督学习性能。
- 方法要点：FUGC是首个宫颈分割半监督学习基准，提供890张图像数据集，包括500张训练、90张验证和300张测试图像。
- 实验或效果：评估指标包括Dice系数、Hausdorff距离和运行时间，最佳方法分别达到90.26% mDSC、38.88 mHD和32.85 ms RT。
