...
**arXiv**：[2601.15824v1](https://arxiv.org/abs/2601.15824) · [PDF](https://arxiv.org/pdf/2601.15824.pdf)  
...
**一句话要点**：提出生成式应用防火墙（GAF）以统一保护LLM应用的安全架构。

**关键词**：生成式应用防火墙, LLM安全, 统一防御架构, 自主代理安全, 工具交互保护

## 3 点简述
- 核心问题：现有LLM应用防御措施（如提示过滤、护栏、数据掩码）分散，缺乏统一协调。
- 方法要点：GAF作为新架构层，整合多种防御机制于单一执行点，类似WAF协调网络流量防御。
- 实验或效果：未知，但覆盖自主代理及其工具交互，旨在提升安全性和管理效率。
