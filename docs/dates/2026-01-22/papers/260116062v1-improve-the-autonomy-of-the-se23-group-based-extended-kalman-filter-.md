...
**关键词**：SE2(3)群, 扩展卡尔曼滤波, 集成导航, 自主性分析, 高精度导航

## 3 点简述
- 核心问题：高精度导航中考虑地球旋转和惯性偏差时，SE2(3)群误差传播自主性难以维持
- 方法要点：分析非惯性系中速度引入的科里奥利力项，提出改进的SE2(3)群导航模型构建方法
- 实验或效果：通过理论分析，使导航模型更接近完全自主，但具体实验效果未知
