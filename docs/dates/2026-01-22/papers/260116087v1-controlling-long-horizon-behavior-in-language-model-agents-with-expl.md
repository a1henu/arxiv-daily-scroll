...
**关键词**：语言模型代理, 长时对话控制, 情感动态建模, 状态一致性, VAD情感状态, 二阶动态系统

## 3 点简述
- 核心问题：LLM代理在长时交互中因缺乏显式状态动态而出现语气突变，影响行为一致性。
- 方法要点：引入外部VAD情感子系统，通过一阶和二阶更新规则控制状态动态，无需修改模型参数。
- 实验或效果：在25轮对话中，二阶动态引入情感惯性和滞后，在稳定性和响应性间实现权衡，提升恢复能力。
