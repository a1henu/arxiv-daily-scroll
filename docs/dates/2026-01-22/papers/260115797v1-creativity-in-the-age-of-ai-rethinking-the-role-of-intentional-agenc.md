...
**arXiv**：[2601.15797v1](https://arxiv.org/abs/2601.15797) · [PDF](https://arxiv.org/pdf/2601.15797.pdf)  
**作者**：James S. Pearson, Matthew J. Dennis, Marc Cheong  

**一句话要点**：提出一致性要求以替代意向性代理条件，解决生成式AI时代创造力定义问题

**关键词**：创造力理论, 意向性代理条件, 生成式AI, 概念工程, 语料分析

## 3 点简述
- 核心问题：意向性代理条件作为创造力必要条件的普遍性在生成式AI背景下变得问题化
- 方法要点：基于语料证据和概念工程方法，论证意向性代理条件应被放弃
- 实验或效果：语料分析显示作者和记者日益将创造力归因于无意向性代理的AI
