...
**一句话要点**：提出MoRo框架，通过掩码建模从单目视频中鲁棒恢复遮挡下的人体运动

**关键词**：人体运动恢复, 掩码建模, 遮挡鲁棒性, 单目视频, 多模态先验, 实时推理

## 3 点简述
- 核心问题：单目视频中人体运动重建在遮挡下易失效，现有方法在效率与鲁棒性间存在权衡
- 方法要点：采用掩码建模构建端到端生成框架，融合轨迹、姿态和视频先验以处理遮挡
- 实验或效果：在EgoBody和RICH数据集上，遮挡下精度与运动真实感显著提升，推理速度达70 FPS
