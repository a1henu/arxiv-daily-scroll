...
**一句话要点**：提出MoRo框架，通过掩码建模解决遮挡下人体运动恢复问题

**关键词**：人体运动恢复, 掩码建模, 遮挡鲁棒性, 跨模态学习, 实时推理

## 3 点简述
- 核心问题：单目视频中遮挡导致人体运动重建困难，现有方法在效率与鲁棒性间存在权衡
- 方法要点：采用掩码建模构建端到端生成框架，结合轨迹、姿态和视频先验进行跨模态学习
- 实验或效果：在EgoBody和RICH数据集上，遮挡下精度和运动真实性显著优于SOTA，非遮挡场景性能相当，推理速度达70 FPS
