...
**arXiv**：[2601.16152v1](https://arxiv.org/abs/2601.16152) · [PDF](https://arxiv.org/pdf/2601.16152.pdf)  
**作者**：Denise M. Case  

**一句话要点**：提出六种身份与持久性机制以支持持续分歧下的问责稳定参考

**关键词**：本体设计, 中立基板, 稳定参考, 持续分歧, 问责机制, 结构约束

## 3 点简述
- 研究持续分歧下数据系统互操作性的核心问题，强调中立基板需保持稳定参考
- 基于中立性框架，分析最小本体结构约束，避免隐藏角色或上下文谓词引入不稳定
- 证明至少六种身份与持久性机制是必要条件，并展示六机制构造满足要求
