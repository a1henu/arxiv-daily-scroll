...
**arXiv**：[2601.15830v1](https://arxiv.org/abs/2601.15830) · [PDF](https://arxiv.org/pdf/2601.15830.pdf)  
**作者**：Abdul Hasib, A. S. M. Ahsanul Sarkar Akib  

**一句话要点**：提出基于物联网的智能植物监测与灌溉系统，以优化农业资源利用和植物健康管理。

**关键词**：物联网农业, 智能灌溉系统, 环境传感, 云数据分析, 精准农业, 实时监控

## 3 点简述
- 传统农业依赖人工观察和定期浇水，易导致水资源浪费和生长不一致。
- 系统集成ESP32微控制器、多传感器和云平台，实现实时数据采集、自动灌溉和远程监控。
- 实验显示系统维持土壤湿度准确率达92%，节水约40%，成本为45.20美元，适用于小规模园艺和商业农业。
