...
**一句话要点**：提出基于心智理论的学术反驳框架RebutalAgent，以解决信息不对称下的战略沟通挑战。

**关键词**：学术反驳, 心智理论, 战略沟通, 强化学习, 自动评估

## 3 点简述
- 核心问题：学术反驳是信息不对称下的战略沟通，现有方法因缺乏视角采纳而效果有限。
- 方法要点：通过心智理论-策略-响应管道建模审稿人心态，并利用合成数据集和两阶段训练优化。
- 实验或效果：在自动和人工评估中显著优于基线模型，并开发了专用评估器提升评分一致性。
