...
**一句话要点**：提出延迟分配在线非质心聚类算法，在随机到达模型中实现常数竞争比

**关键词**：在线聚类, 延迟分配, 随机到达模型, 常数竞争比, 非质心聚类

## 3 点简述
- 研究在线非质心聚类问题，允许延迟分配以平衡距离成本和延迟成本
- 针对随机到达模型，设计算法以应对未知分布，避免最坏情况下的不可能性
- 理论证明算法在期望总成本上相对于离线最优解具有常数竞争比
