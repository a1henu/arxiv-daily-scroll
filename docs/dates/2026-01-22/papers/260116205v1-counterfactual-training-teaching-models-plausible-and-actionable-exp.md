...
**一句话要点**：提出反事实训练方法，通过训练阶段整合反事实解释提升模型解释能力与对抗鲁棒性。

**关键词**：反事实解释, 模型训练, 可解释人工智能, 对抗鲁棒性, 机器学习

## 3 点简述
- 核心问题：现有反事实解释多为后处理方法，难以确保解释的合理性与可操作性。
- 方法要点：在训练阶段直接优化模型，使其学习表示与合理、可操作的反事实解释对齐。
- 实验或效果：实证与理论分析表明，该方法能生成更优反事实解释并增强对抗鲁棒性。
