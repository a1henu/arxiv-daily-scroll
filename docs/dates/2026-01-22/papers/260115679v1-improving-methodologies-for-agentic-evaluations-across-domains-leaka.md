...
**一句话要点**：提出多国协作的智能体评估方法以应对敏感信息泄露、欺诈和网络安全威胁

**关键词**：智能体评估, 敏感信息泄露, 网络安全, 多国协作, 评估方法学, 公开基准

## 3 点简述
- 核心问题：自主AI系统在跨语言文化部署中面临敏感信息泄露、欺诈和网络安全风险，评估方法尚不成熟。
- 方法要点：由多国机构联合开展第三次测试，分为共同风险和网络安全两线，使用公开基准任务评估开放和闭源模型。
- 实验或效果：聚焦评估方法学问题而非模型性能，旨在完善智能体测试的最佳实践，推动评估科学进步。
