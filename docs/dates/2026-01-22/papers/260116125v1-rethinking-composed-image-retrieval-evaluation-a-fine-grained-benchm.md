...
**一句话要点**：提出EDIR细粒度基准，通过图像编辑合成查询以解决组合图像检索评估不足问题。

**关键词**：组合图像检索, 细粒度基准, 图像编辑, 多模态嵌入模型, 评估方法

## 3 点简述
- 核心问题：现有组合图像检索基准类别有限，无法反映真实场景多样性需求。
- 方法要点：利用图像编辑精确控制修改类型和内容，构建涵盖5个主类和15个子类的5,000查询基准。
- 实验或效果：评估13个模型显示能力差距大，揭示现有基准的模态偏见和类别覆盖不足。
