...
**关键词**：多模态基础模型, 情感建模, 前馈门控投影, 参数效率, 机制分析, 门控机制

## 3 点简述
- 核心问题：大型基础模型中情感表示的位置和机制尚不明确，尤其在多模态情感场景下。
- 方法要点：系统分析多架构、训练策略和情感任务，探究情感导向监督如何重塑内部模型参数。
- 实验或效果：发现情感适应主要集中于前馈门控投影，仅调优约24.5%参数即可达到AffectGPT平均性能的96.6%。
