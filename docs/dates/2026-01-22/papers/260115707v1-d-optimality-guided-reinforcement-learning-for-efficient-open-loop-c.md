...
**关键词**：康复机器人校准, D最优性设计, 强化学习应用, 参数识别, 开环控制, 多自由度对齐

## 3 点简述
- 核心问题：多自由度康复机器人精确对齐对安全有效训练至关重要，需高效校准方法。
- 方法要点：采用两阶段框架，先基于Kronecker积线性化参数识别，再用PPO选择D最优性引导的校准姿态。
- 实验或效果：仿真与真实机器人评估显示，PPO选择姿态比随机选择信息量高两个数量级，且四姿态校准优于50姿态非结构化集。
