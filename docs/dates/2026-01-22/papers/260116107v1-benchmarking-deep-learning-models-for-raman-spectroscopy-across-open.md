...
**一句话要点**：提出首个系统基准，在开源拉曼数据集上比较五种深度学习模型

**关键词**：拉曼光谱, 深度学习基准, 分类模型, 开源数据集, 超参数调优

## 3 点简述
- 核心问题：拉曼光谱深度学习模型缺乏在共享开源数据集上的直接比较
- 方法要点：统一训练和超参数调优协议，评估五种代表性架构
- 实验或效果：在三个开源数据集上报告分类准确率和宏平均F1分数
