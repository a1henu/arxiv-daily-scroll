...
**关键词**：离策略强化学习, 演员-评论家方法, 熵正则化, 机器人学习, 样本效率, 真实世界部署

## 3 点简述
- 核心问题：真实世界强化学习面临样本效率低、奖励稀疏和视觉观测噪声等挑战，现有方法成本高或数据需求大。
- 方法要点：采用离策略演员-评论家框架，引入sigmoid有界熵项，防止负熵驱动的离分布动作优化，减少Q函数振荡。
- 实验或效果：在D4RL基准测试中显著缓解Q函数振荡，更快达到100%成功率；在四个真实机器人任务中，仅需少量交互即可学习成功策略。
