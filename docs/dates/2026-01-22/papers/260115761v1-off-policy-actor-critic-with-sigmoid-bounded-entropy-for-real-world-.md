...
**关键词**：离策略演员-评论家, 熵正则化, 机器人学习, 样本效率, 真实世界强化学习

## 3 点简述
- 核心问题：真实世界强化学习面临样本效率低、奖励稀疏和视觉观测噪声等挑战，现有方法成本高或数据需求大。
- 方法要点：设计sigmoid有界熵项，防止负熵驱动优化导致分布外动作，并减少Q函数振荡，支持从单条专家轨迹学习。
- 实验或效果：在D4RL基准测试中显著缓解Q函数振荡，更快达到100%成功率；在真实机器人任务中验证，仅需少量交互即可学习成功策略。
