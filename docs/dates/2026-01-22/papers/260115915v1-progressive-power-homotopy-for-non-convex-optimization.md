...
**一句话要点**：提出渐进幂同伦方法以解决非凸优化中的全局收敛问题

**关键词**：非凸优化, 一阶方法, 全局收敛, 相位恢复, 神经网络训练, 同伦方法

## 3 点简述
- 核心问题：非凸优化中标准一阶方法易陷入局部最优，难以找到全局最优解。
- 方法要点：通过幂变换和高斯平滑构建代理目标，并渐进调整参数以引导优化轨迹。
- 实验或效果：在相位恢复和两层神经网络训练中，该方法在样本维度比接近信息论极限或欠参数化时表现优异。
