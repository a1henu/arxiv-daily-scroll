...
**一句话要点**：评估AV-HuBERT在视听不一致刺激下的感知生物保真度，对比人类观察者揭示模型与生物系统的异同。

**关键词**：视听整合, McGurk效应, 自监督学习, 感知生物保真度, 人类对比实验, 语音感知

## 3 点简述
- 核心问题：评估自监督模型AV-HuBERT在视听整合中的感知生物保真度，特别是对McGurk效应的响应。
- 方法要点：通过对比AV-HuBERT与44名人类观察者对不一致视听刺激的反应，量化听觉主导率和语音融合率。
- 实验或效果：模型与人类听觉主导率相近（32.0% vs. 31.8%），但模型语音融合率显著更高（68.0% vs. 47.7%），且缺乏人类感知的随机性。
