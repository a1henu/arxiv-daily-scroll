...
**arXiv**：[2601.15828v1](https://arxiv.org/abs/2601.15828) · [PDF](https://arxiv.org/pdf/2601.15828.pdf)  
**作者**：Michael Farrell  

**一句话要点**：研究专业译者能否可靠识别AI生成的意大利语短篇小说，发现部分译者能基于分析技能区分，但主观印象常导致误判。

**关键词**：机器生成文本识别, 专业译者评估, AI文本检测, 合成文本编辑, 语言特征分析

## 3 点简述
- 核心问题：专业译者未经专门训练能否可靠识别AI生成的意大利语短篇小说。
- 方法要点：69名译者评估三篇匿名短篇小说（两篇由ChatGPT-4o生成，一篇由人类撰写），评估AI作者可能性并提供理由。
- 实验或效果：16.2%的译者成功区分合成与人类文本，但近等数量误判；低突发性和叙事矛盾是可靠指标，语法准确性和情感常导致误判。
