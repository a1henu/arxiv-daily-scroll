...
**arXiv**：[2601.15641v1](https://arxiv.org/abs/2601.15641) · [PDF](https://arxiv.org/pdf/2601.15641.pdf)  
**作者**：Larry Bowden, Qi Chu, Bernard Cena, Kentaro Ohno, Bob Parney, Deepak Sharma, Mitsuharu Takeori  

**一句话要点**：提出基于投影量子模型的机器故障检测算法，以提升工业监控中异常检测的精度。

**关键词**：量子计算, 故障检测, 异常检测, 时间序列分析, 工业监控, 投影量子模型

## 3 点简述
- 核心问题：工业中机器故障检测对维持效率和减少停机至关重要，需在嘈杂时间序列数据中准确识别异常。
- 方法要点：结合量子计算和统计变点检测，利用投影量子特征映射增强异常检测的精确性。
- 实验或效果：在基准多维时间序列和真实世界IoT传感器数据集上验证，并在IBM 133-qubit Heron量子处理器上执行，展示量子计算在工业维护中的可行性。
