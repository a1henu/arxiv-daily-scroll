...
**一句话要点**：提出结构化提示调度方法，在推理时提升神经定理证明器的样本效率。

**关键词**：神经定理证明, 推理时指导, 样本效率, 结构化提示, 强化学习, 定理证明基准

## 3 点简述
- 核心问题：高度训练的神经定理证明器是否仍能从推理时的简单结构指导中受益。
- 方法要点：使用固定提示调度，基于15个常见策略骨架，作为轻量级干预。
- 实验或效果：在miniF2F基准上，pass@16从15.2%提升至21.7%，相对改进43%。
