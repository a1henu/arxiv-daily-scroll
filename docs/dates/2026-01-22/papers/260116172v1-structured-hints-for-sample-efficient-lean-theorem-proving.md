...
**一句话要点**：提出结构化提示调度方法，提升推理时样本效率，用于神经定理证明

**关键词**：神经定理证明, 推理时指导, 样本效率, 结构化提示, 策略骨架, 轻量级干预

## 3 点简述
- 研究问题：高度训练的神经定理证明器在推理时是否仍受益于简单结构指导
- 方法要点：使用固定提示调度，基于15个常见策略骨架，在推理时提供轻量级干预
- 实验效果：在miniF2F基准上，pass@16从15.2%提升至21.7%，相对改进43%
