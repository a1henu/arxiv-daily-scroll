...
**关键词**：边缘计算, 音频语言模型, 条件性推理, 工具增强, 粗到细架构, 系统约束

## 3 点简述
- 核心问题：边缘部署音频语言模型时，轻量本地模型感知被动，而云卸载带来延迟、带宽和隐私风险。
- 方法要点：采用粗到细架构，本地快速感知后，云端控制器触发条件性工具增强，如时间重听和本地ASR。
- 实验或效果：在MMAR基准上，准确率从27.20%提升至53.60%，优于持续调查管道，实现更好的精度-效率权衡。
