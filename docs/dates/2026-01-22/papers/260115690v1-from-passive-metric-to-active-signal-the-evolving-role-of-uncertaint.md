...
**arXiv**：[2601.15690v1](https://arxiv.org/abs/2601.15690) · [PDF](https://arxiv.org/pdf/2601.15690.pdf)  
**作者**：Jiaxin Zhang, Wendi Cui, Zhuohang Li, Lifu Huang, Bradley Malin, Caiming Xiong, Chien-Sheng Wu  

**一句话要点**：综述不确定性量化从被动度量演变为主动控制信号，以提升大语言模型在关键领域的可靠性

**关键词**：不确定性量化, 大语言模型, 主动控制信号, 高级推理, 自主代理, 强化学习

## 3 点简述
- 核心问题：大语言模型在关键领域部署中因不可靠性面临障碍，需解决不确定性管理问题。
- 方法要点：将不确定性作为主动控制信号，应用于高级推理、自主代理和强化学习，优化模型行为。
- 实验或效果：基于贝叶斯方法和符合预测等理论框架，提供统一视角和实用设计模式，增强模型可扩展性和可信度。
