...
**一句话要点**：提出基于神经网络的阿拉伯文本自动分类方法，以解决按历史时期分类的挑战。

**关键词**：阿拉伯文本分类, 历史时期分类, 神经网络, 深度学习, 语言演变

## 3 点简述
- 核心问题：阿拉伯语言随时间演变，自动按历史时期分类文本的研究较少，尤其在非诗歌领域。
- 方法要点：采用神经网络和深度学习技术，对阿拉伯文本进行从二元到多类的时代分类。
- 实验或效果：使用OpenITI和APCD数据集评估，二元分类F1分数达0.83和0.79，多类分类分数较低。
