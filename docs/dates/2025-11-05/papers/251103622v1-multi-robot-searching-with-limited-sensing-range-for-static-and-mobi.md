...
**arXiv**：[2511.03622v1](https://arxiv.org/abs/2511.03622) · [PDF](https://arxiv.org/pdf/2511.03622.pdf)  
**作者**：Swadhin Agrawal, Sujoy Bhore, Joseph S. B. Mitchell, P. B. Sujit, Aayush Gohil  

**一句话要点**：提出基于空间填充曲线和随机搜索的多机器人算法，用于受限感知下的静态与移动入侵者搜索

**关键词**：多机器人搜索, 受限感知范围, NP难问题, 空间填充曲线, 随机搜索算法, 几何域搜索

## 3 点简述
- 核心问题：在多机器人系统中，搜索几何域内静态或移动入侵者，问题为NP难
- 方法要点：采用空间填充曲线、随机搜索和协作随机搜索算法
- 实验或效果：评估机器人数量与搜索时间权衡，考虑几何域连通性
