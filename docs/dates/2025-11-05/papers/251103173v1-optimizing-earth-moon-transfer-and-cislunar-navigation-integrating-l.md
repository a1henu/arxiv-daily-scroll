...
**一句话要点**：综述地月转移与导航优化，整合低能轨迹、AI和GNSS-R技术以支持可持续地月探索

**关键词**：地月转移优化, 人工智能导航, GNSS反射测量, 低能轨迹, 月球探索, 自主系统

## 3 点简述
- 核心问题：传统地月转移成本高、导航覆盖有限，制约地月空间自主性。
- 方法要点：比较四种转移策略，引入AI用于轨迹优化和地形识别。
- 实验或效果：GNSS-R可扩展导航，支持月球资源测绘和自主操作。
