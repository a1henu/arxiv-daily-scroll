...
**arXiv**：[2511.03194v1](https://arxiv.org/abs/2511.03194) · [PDF](https://arxiv.org/pdf/2511.03194.pdf)  
**作者**：Le Xue, Gang Feng, Wenbo Zhang, Yichi Zhang, Lanlan Li, Shuqi Wang, Liling Peng, Sisi Peng, Xin Gao  

**一句话要点**：提出PETWB-REP多癌种全身PET/CT与报告数据集以支持医学影像与AI研究

**关键词**：医学影像数据集, PET/CT扫描, 放射学报告, 多癌种研究, 多模态学习, 人工智能应用

## 3 点简述
- 核心问题：多癌种医学影像数据集稀缺，缺乏功能与解剖成像结合临床报告
- 方法要点：构建490患者多癌种全身FDG PET/CT扫描与配对放射学报告数据集
- 实验或效果：未知，数据集旨在支持影像、放射组学、AI及多模态学习研究
