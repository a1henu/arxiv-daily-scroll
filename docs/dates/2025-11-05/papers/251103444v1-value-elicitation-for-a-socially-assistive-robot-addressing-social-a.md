...
**arXiv**：[2511.03444v1](https://arxiv.org/abs/2511.03444) · [PDF](https://arxiv.org/pdf/2511.03444.pdf)  
**作者**：Vesna Poprcova, Iulia Lefter, Martijn Warnier, Frances Brazier  

**一句话要点**：通过参与式设计方法引出社交辅助机器人应对社交焦虑的核心价值

**关键词**：社交辅助机器人, 社交焦虑, 参与式设计, 价值引出, 用户中心设计, 心理健康干预

## 3 点简述
- 核心问题：社交焦虑普遍但支持不足，需探索机器人辅助干预的价值基础。
- 方法要点：与心理健康研究者进行参与式设计工作坊，系统引出设计相关价值。
- 实验或效果：发现适应性、接受度和有效性等核心价值，强调用户中心设计。
