...
**arXiv**：[2511.22937v1](https://arxiv.org/abs/2511.22937) · [PDF](https://arxiv.org/pdf/2511.22937.pdf)  
**作者**：Kushagra Pandya, Heli Hathi, Het Buch, Ravikumar R N, Shailendrasinh Chauhan, Sushil Kumar Singh  

**一句话要点**：评估YOLOv8模型在条形码和二维码检测中的性能，通过模型缩放提升准确率

**关键词**：对象检测, YOLOv8, 条形码识别, 二维码识别, 模型评估, 计算机视觉

## 3 点简述
- 核心问题：研究YOLOv8算法在条形码和二维码对象检测中的效率和准确性。
- 方法要点：使用Kaggle数据集对YOLOv8的Nano、Small和Medium版本进行训练和微调。
- 实验或效果：Nano模型准确率88.95%，Small模型97.10%，Medium模型94.10%，展示模型缩放带来的改进。
