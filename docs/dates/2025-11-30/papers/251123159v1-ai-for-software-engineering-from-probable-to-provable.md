...
**arXiv**：[2511.23159v1](https://arxiv.org/abs/2511.23159) · [PDF](https://arxiv.org/pdf/2511.23159.pdf)  
**作者**：Bertrand Meyer  

**一句话要点**：提出结合AI与形式化方法以解决软件工程中目标指定和幻觉问题

**关键词**：AI编程, 形式化规范, 程序验证, 软件工程, 幻觉问题

## 3 点简述
- 核心问题：AI编程面临目标指定困难和幻觉现象，程序需正确性保障
- 方法要点：结合AI创造力、形式化规范和程序验证，利用现代证明工具
- 实验或效果：未知，但强调从概率性转向可证明性以提升软件可靠性
