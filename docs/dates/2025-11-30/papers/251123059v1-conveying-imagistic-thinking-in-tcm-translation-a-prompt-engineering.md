...
**arXiv**：[2511.23059v1](https://arxiv.org/abs/2511.23059) · [PDF](https://arxiv.org/pdf/2511.23059.pdf)  
**作者**：Jiatong Han  

**一句话要点**：提出基于提示工程与LLM评估的框架，以解决中医翻译中意象思维传达的难题。

**关键词**：中医翻译, 提示工程, 大语言模型评估, 隐喻识别, 人机协同框架

## 3 点简述
- 核心问题：中医理论依赖隐喻和转喻的意象思维，现有英译难以重建概念网络。
- 方法要点：采用人机协同框架，通过提示引导DeepSeek识别并翻译隐喻和转喻。
- 实验或效果：模拟读者评估显示，提示调整的LLM翻译在五个认知维度表现最佳。
