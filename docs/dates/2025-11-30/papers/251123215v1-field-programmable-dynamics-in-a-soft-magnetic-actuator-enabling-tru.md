...
**arXiv**：[2511.23215v1](https://arxiv.org/abs/2511.23215) · [PDF](https://arxiv.org/pdf/2511.23215.pdf)  
...
**一句话要点**：提出可编程动态软磁执行器，实现真随机数生成与储层计算，扩展软机器人应用场景。

**关键词**：软磁执行器, 真随机数生成, 储层计算, 软机器人, 复杂动态, 随机计算

## 3 点简述
- 核心问题：传统机电系统常避免复杂动态，但软机器人中可能带来新功能。
- 方法要点：设计耐用软磁执行器，可在可调动态下运行数万次无疲劳。
- 实验或效果：实验验证真随机数生成、随机计算及Mackey-Glass时间序列预测能力。
