...
**一句话要点**：提出两阶段评估方法以优化边缘AI部署中视觉Transformer的能效。

**关键词**：视觉Transformer, 能效评估, 边缘AI部署, NetScore, Sustainable Accuracy Metric, 混合模型

## 3 点简述
- 核心问题：边缘设备部署视觉Transformer需超越准确率的能效评估。
- 方法要点：结合设备无关模型筛选与设备相关测量进行两阶段评估。
- 实验或效果：在NVIDIA Jetson TX2和RTX 3050上测试，混合模型和蒸馏模型分别显著降低能耗。
