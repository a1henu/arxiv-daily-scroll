...
**arXiv**：[2511.23372v1](https://arxiv.org/abs/2511.23372) · [PDF](https://arxiv.org/pdf/2511.23372.pdf)  
...
**一句话要点**：提出基于双羽状形状记忆合金的线性驱动器，集成液压冲程放大机制，用于高力高冲程应用。

**关键词**：形状记忆合金驱动器, 生物启发设计, 线性驱动器, 液压冲程放大, 高力应用, 性能验证

## 3 点简述
- 工业需求推动替代传统电磁驱动器，因其效率低、体积大、成本高。
- 结合双羽状生物启发架构与形状记忆合金优势，开发新型线性驱动器数学模型。
- 实验验证驱动器性能，展示高力输出、减重、节能和成本降低等效果。
