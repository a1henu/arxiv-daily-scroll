...
**arXiv**：[2511.23071v1](https://arxiv.org/abs/2511.23071) · [PDF](https://arxiv.org/pdf/2511.23071.pdf)  
...
**一句话要点**：提出Bharat场景文本数据集以解决印度语言场景文本识别缺乏高质量数据的问题

**关键词**：场景文本识别, 印度语言数据集, 多语言文本检测, 脚本识别, 端到端识别

## 3 点简述
- 核心问题：印度语言场景文本识别因脚本多样性和数据缺乏而面临挑战
- 方法要点：构建大规模多语言数据集BSTD，覆盖11种印度语言和英语
- 实验或效果：通过微调英文模型评估，揭示印度语言场景文本识别的挑战与机遇
