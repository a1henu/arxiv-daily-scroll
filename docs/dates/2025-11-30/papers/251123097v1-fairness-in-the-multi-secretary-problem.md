...
**arXiv**：[2511.23097v1](https://arxiv.org/abs/2511.23097) · [PDF](https://arxiv.org/pdf/2511.23097.pdf)  
**作者**：Georgios Papasotiropoulos, Zein Pishbin  

**一句话要点**：提出融合在线算法与社会选择规则的机制，以解决多秘书问题中的公平性挑战

**关键词**：多秘书问题, 公平性, 在线算法, 社会选择理论, 扩展合理表示, 机制设计

## 3 点简述
- 核心问题：研究多秘书问题中的公平性，分析扩展合理表示在在线领域的局限性
- 方法要点：结合在线算法与社会选择规则，如平等份额法和纳什规则，设计新机制
- 实验或效果：通过理论分析和广泛实验评估支持所提机制的有效性
