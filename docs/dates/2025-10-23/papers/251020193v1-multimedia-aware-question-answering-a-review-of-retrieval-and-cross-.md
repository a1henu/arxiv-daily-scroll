...
**一句话要点**：综述多媒体检索与跨模态推理架构以增强问答系统

**关键词**：多媒体问答, 跨模态检索, 融合架构, 语义接地, 基准评估, 延迟权衡

## 3 点简述
- 核心问题：多媒体内容增长带来检索增强问答的跨模态对齐与语义接地挑战
- 方法要点：分类检索方法、融合技术和答案生成策略，分析架构对齐视觉、语言和音频
- 实验或效果：评估基准数据集、性能权衡和延迟-准确性平衡，未报告具体性能指标
