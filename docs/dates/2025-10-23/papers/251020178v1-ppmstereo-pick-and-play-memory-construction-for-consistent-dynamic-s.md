...
**一句话要点**：提出PPMStereo方法以解决立体视频中动态深度估计的长期时间一致性问题

**关键词**：动态立体匹配, 时间一致性, 内存缓冲, 时空聚合, 高效计算

## 3 点简述
- 核心问题：立体视频深度估计中，长期时间一致性建模困难，计算成本高。
- 方法要点：采用Pick-and-Play内存模块，选择相关帧并自适应加权聚合时空信息。
- 实验或效果：在Sintel数据集上实现高精度和时间一致性，计算成本较低。
