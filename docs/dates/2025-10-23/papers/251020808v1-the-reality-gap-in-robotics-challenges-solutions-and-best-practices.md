...
**arXiv**：[2510.20808v1](https://arxiv.org/abs/2510.20808) · [PDF](https://arxiv.org/pdf/2510.20808.pdf)  
...
**一句话要点**：综述机器人仿真到现实的差距，分析原因、解决方案与评估指标

**关键词**：机器人仿真, 仿真到现实迁移, 领域随机化, 现实差距, 机器人学习, 仿真评估

## 3 点简述
- 核心问题：仿真与真实环境差异阻碍机器人系统迁移，称为现实差距
- 方法要点：采用领域随机化、真实到仿真迁移和仿真-现实协同训练等技术
- 实验或效果：未知具体实验，但强调方法在导航、运动和控制中取得进展
