...
**arXiv**：[2510.20558v1](https://arxiv.org/abs/2510.20558) · [PDF](https://arxiv.org/pdf/2510.20558.pdf)  
**作者**：Xiaohan Sun, Carol O'Sullivan  

**一句话要点**：评估不同细节层次下人群表示的感知质量，以指导优化渲染策略

**关键词**：人群渲染, 细节层次, 感知评估, 视觉保真度, 计算性能

## 3 点简述
- 核心问题：用户如何感知不同细节层次和观看距离下人群表示的视觉质量
- 方法要点：比较几何网格、图像替身、NeRF和3D高斯等表示的视觉保真度与计算性能权衡
- 实验或效果：通过定性和定量分析，提供感知优化细节层次策略的设计见解
