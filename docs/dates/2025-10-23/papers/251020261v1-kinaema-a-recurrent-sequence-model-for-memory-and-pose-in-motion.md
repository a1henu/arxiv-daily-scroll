...
**一句话要点**：提出Kinaema模型以解决机器人在连续操作中利用先前视觉信息定位自身的问题

**关键词**：机器人定位, 循环序列模型, 隐式记忆, 视觉导航, 变换器网络

## 3 点简述
- 核心问题：机器人在先前见过空间中如何高效定位自身，优化连续操作效率。
- 方法要点：使用循环变换器更新隐式潜在记忆，压缩传感器历史为紧凑表示。
- 实验或效果：在Mem-Nav任务中验证模型能导航至目标，计算效率优于传统变换器。
