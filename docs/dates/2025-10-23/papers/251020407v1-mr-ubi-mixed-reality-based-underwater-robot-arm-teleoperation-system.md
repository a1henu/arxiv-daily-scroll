...
**一句话要点**：提出混合现实水下机械臂遥操作系统，通过双边控制与反应扭矩指示器提升操作精度。

**关键词**：混合现实, 水下机器人, 双边控制, 反应扭矩指示, 遥操作, 人机交互

## 3 点简述
- 核心问题：水下机械臂遥操作中视觉与触觉反馈整合不足，影响扭矩控制稳定性。
- 方法要点：在混合现实头显中叠加颜色和长度编码的扭矩条，实现视觉与触觉反馈无缝集成。
- 实验或效果：用户研究表明，系统显著提高抓取扭矩控制精度，减少极端扭矩，提升可用性。
