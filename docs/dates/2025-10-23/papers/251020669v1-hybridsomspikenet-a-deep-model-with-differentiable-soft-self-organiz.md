...
**arXiv**：[2510.20669v1](https://arxiv.org/abs/2510.20669) · [PDF](https://arxiv.org/pdf/2510.20669.pdf)  
**作者**：Debojyoti Ghosh, Adrijit Goswami  

**一句话要点**：提出HybridSOMSpikeNet模型，结合可微分软自组织映射和脉冲动态，用于废物分类。

**关键词**：废物分类, 可微分软自组织映射, 脉冲神经网络, 卷积特征提取, 可持续废物管理

## 3 点简述
- 废物分类错误导致回收效率低和环境污染，需智能解决方案。
- 模型集成卷积特征提取、可微分软自组织映射和脉冲神经网络处理。
- 在十类废物数据集上测试准确率达97.39%，优于现有方法且计算轻量。
