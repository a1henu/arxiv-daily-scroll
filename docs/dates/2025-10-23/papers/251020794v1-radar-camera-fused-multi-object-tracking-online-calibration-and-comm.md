...
**一句话要点**：提出雷达-相机融合多目标跟踪框架，利用在线校准和共同特征提升跟踪精度。

**关键词**：多目标跟踪, 雷达-相机融合, 在线校准, 共同特征, 传感器关联, 3D定位

## 3 点简述
- 核心问题：雷达在融合跟踪中常被低估，无法充分利用其精确深度信息。
- 方法要点：通过在线校准和共同特征匹配，自主关联雷达与相机检测结果。
- 实验或效果：在受控环境和真实交通场景中验证，简化映射过程并提高跟踪精度。
