...
**一句话要点**：提出Endoshare以解决内窥镜视频去标识化和标准化管理问题

**关键词**：手术视频管理, 视频去标识化, 隐私保护, 跨平台应用, 可用性评估

## 3 点简述
- 核心问题：手术视频格式异构和隐私问题限制视频评估与共享
- 方法要点：开发跨平台应用，采用隐私设计架构，支持视频合并、标准化和去标识化
- 实验或效果：用户测试显示高可用性和易用性，处理时间受视频时长和硬件影响
