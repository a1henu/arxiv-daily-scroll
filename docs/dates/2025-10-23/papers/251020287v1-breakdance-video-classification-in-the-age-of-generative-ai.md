...
**arXiv**：[2510.20287v1](https://arxiv.org/abs/2510.20287) · [PDF](https://arxiv.org/pdf/2510.20287.pdf)  
**作者**：Sauptik Dhar, Naveen Ramakrishnan, Michelle Munson  

**一句话要点**：分析视频基础模型在霹雳舞视频分类中的适用性，比较编码器与解码器模型性能。

**关键词**：视频分类, 霹雳舞, 视频基础模型, 编码器模型, 解码器模型, 性能比较

## 3 点简述
- 核心问题：现有视觉语言模型多针对流行运动，霹雳舞等小众舞蹈运动分类研究不足。
- 方法要点：评估现代视频基础模型，包括编码器和解码器，用于霹雳舞视频分类任务。
- 实验或效果：视频编码器模型在预测任务中优于最先进的视频语言模型，提供模型选择指导。
