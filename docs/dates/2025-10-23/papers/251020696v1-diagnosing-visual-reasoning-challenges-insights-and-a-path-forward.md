...
**一句话要点**：提出基于代理的架构以解决多模态大语言模型的视觉幻觉和文本依赖问题

**关键词**：多模态大语言模型, 视觉推理, 代理架构, 链式思维提示, 视觉幻觉诊断, 轻量视觉模块

## 3 点简述
- 核心问题：多模态大语言模型存在视觉幻觉和过度依赖文本先验
- 方法要点：结合LLM推理与轻量视觉模块，实现细粒度分析和迭代优化
- 实验或效果：在MMMU和MathVista基准上显著提升，超越更大模型
