...
**一句话要点**：提出因果表示学习方法以缓解多文化图像-食谱检索中的跨模态表示偏差

**关键词**：图像-食谱检索, 跨模态表示学习, 因果推理, 多文化数据集, 表示偏差缓解

## 3 点简述
- 核心问题：图像-食谱检索中，跨模态表示偏向视觉元素，忽略食谱细节如配料和烹饪方法。
- 方法要点：预测图像中可能忽略的烹饪元素，并将其注入表示学习以减轻偏差。
- 实验或效果：在单语和多语言数据集上验证，能发现细微差异并提升检索性能。
