...
**一句话要点**：提出HyperET在双曲空间中高效训练多模态大语言模型，以解决视觉与文本多粒度对齐问题

**关键词**：多模态大语言模型, 双曲空间训练, 视觉文本对齐, 高效参数化, 多粒度学习

## 3 点简述
- 核心问题：现有视觉编码器缺乏与语言的多粒度对齐，导致MLLM训练计算资源高
- 方法要点：利用双曲空间建模层次结构，通过动态半径调整实现任意粒度对齐
- 实验或效果：在多个基准测试中，以少于1%额外参数显著提升MLLM性能
