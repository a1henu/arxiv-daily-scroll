...
**arXiv**：[2512.12922v1](https://arxiv.org/abs/2512.12922) · [PDF](https://arxiv.org/pdf/2512.12922.pdf)  
**作者**：Bangyu Li, Boping Gu, Ziyang Ding  

**一句话要点**：提出基于大语言模型和强化学习的个性化投资组合推荐框架，以优化智能投资策略。

**关键词**：个性化投资组合推荐, 大语言模型, 强化学习, 风险偏好建模, 智能投资决策
