...
**arXiv**：[2512.13361v1](https://arxiv.org/abs/2512.13361) · [PDF](https://arxiv.org/pdf/2512.13361.pdf)  
**作者**：Elizaveta Prozorova, Anton Konev, Vladimir Faerman  

**一句话要点**：提出基于孪生网络的自动化面部热图用户识别方法，用于生物特征识别系统。

**关键词**：面部热图识别, 孪生神经网络, 红外光谱分析, 生物特征识别, 热成像技术, 混合模态系统
