...
**arXiv**：[2512.12903v1](https://arxiv.org/abs/2512.12903) · [PDF](https://arxiv.org/pdf/2512.12903.pdf)  
**作者**：Ken-ichi Kitayama  

**一句话要点**：验证下一代储层计算在分类任务中的性能，扩展其应用场景

**关键词**：下一代储层计算, 分类任务, 时间序列分析, 计算范式, 基准测试
