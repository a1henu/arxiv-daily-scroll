...
**arXiv**：[2512.12970v1](https://arxiv.org/abs/2512.12970) · [PDF](https://arxiv.org/pdf/2512.12970.pdf)  
**作者**：Paola Di Maio  

**一句话要点**：提出基于开放标准和人可读工件的数字取证AI模型架构，以应对系统复杂性挑战。

**关键词**：数字取证, 人工智能, 系统复杂性, 开放标准, 人可读工件, 模型架构
