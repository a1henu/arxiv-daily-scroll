...
**arXiv**：[2512.13284v1](https://arxiv.org/abs/2512.13284) · [PDF](https://arxiv.org/pdf/2512.13284.pdf)  
...
**一句话要点**：提出SAMAY自动鸟类鸣叫记录系统，用于构建鸟类声学数据库以研究物种、分类和监测种群。

**关键词**：鸟类声学记录, 自动物种分类, 环境监测系统, STM32微控制器, 太阳能供电
