...
**arXiv**：[2511.17166v1](https://arxiv.org/abs/2511.17166) · [PDF](https://arxiv.org/pdf/2511.17166.pdf)  
**作者**：Tim Lakemann, Daniel Bonilla Licea, Viktor Walter, Martin Saska  

**一句话要点**：提出反射式相对定位方法，利用主动标记反射解决无人机编队在未知环境中的定位模糊问题。

**关键词**：相对定位, 主动标记反射, 无人机编队, 未知环境, 非平坦表面, 视觉定位
