...
**arXiv**：[2511.17393v1](https://arxiv.org/abs/2511.17393) · [PDF](https://arxiv.org/pdf/2511.17393.pdf)  
**作者**：Georgia Baltsou, Ioannis Sarridis, Christos Koutlis, Symeon Papadopoulos  

**一句话要点**：提出生成多样化合成人脸图像方法以解决人脸验证数据集偏见问题

**关键词**：人脸验证, 数据集偏见, 生成模型, 合成图像, 公平性评估
