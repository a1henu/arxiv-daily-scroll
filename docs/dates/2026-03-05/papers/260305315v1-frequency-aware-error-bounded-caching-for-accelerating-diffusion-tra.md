...
**关键词**：扩散变换器, 推理加速, 缓存优化, 误差有界, 频率分解, 非均匀性分析

## 3 点简述
- 核心问题：现有缓存方法假设扩散变换器去噪过程均匀，忽略时间、深度和特征维度的非均匀性，导致计算效率受限。
- 方法要点：基于非均匀性观察，设计Timestep-Aware Dynamic Scheduling、Cumulative Error Budgets和Frequency-Decomposed Caching组件，实现训练免费、即插即用的缓存框架。
- 实验或效果：在FLUX.1-schnell上，SpectralCache实现2.46倍加速，LPIPS 0.217和SSIM 0.727，速度优于TeaCache 16%，质量保持可比。
