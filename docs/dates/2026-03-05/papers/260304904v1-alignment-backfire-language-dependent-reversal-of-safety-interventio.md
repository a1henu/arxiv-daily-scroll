...
**关键词**：大语言模型对齐, 多智能体系统, 语言依赖性, 安全干预, 集体病理, 文化-语言分析

## 3 点简述
- 核心问题：对齐干预在非英语语言中可能导致安全性能下降或集体病理加剧，即“对齐反噬”。
- 方法要点：通过多智能体模拟，在16种语言和三个模型家族中测试对齐指令的效果。
- 实验或效果：发现语言空间（如文化-语言特性）决定对齐结果，英语安全验证无法泛化至其他语言。
