...
**一句话要点**：提出TS-BOSS以解决时间序列因果结构学习中的可扩展性与性能问题

**关键词**：时间序列因果发现, 动态贝叶斯网络, 排列搜索, 可扩展算法, 高自相关处理

## 3 点简述
- 核心问题：时间序列因果发现面临时间依赖挑战，需扩展静态方法到动态设置
- 方法要点：基于BOSS扩展，使用排列搜索和grow-shrink树缓存，保持可扩展性
- 实验或效果：在高自相关场景下优于标准约束方法，提供理论保证
