...
**arXiv**：[2603.04982v1](https://arxiv.org/abs/2603.04982) · [PDF](https://arxiv.org/pdf/2603.04982.pdf)  
**作者**：Benjamin M. Chen, Hong Bao  

**一句话要点**：研究用户培训对法律分析中生成式AI采用与生产力的影响

**关键词**：生成式AI, 用户培训, 法律分析, 随机实验, 生产力提升, 采用率

## 3 点简述
- 核心问题：用户培训能否促进专业场景中生成式AI的采用与生产力提升
- 方法要点：通过随机实验，比较无AI访问、可选访问及培训后访问三种条件
- 实验或效果：培训使AI使用率从26%升至41%，并显著提高考试成绩0.27分
