...
**关键词**：象棋引擎, 行为建模, 动态调制, 概率分布, 心理模拟, 信号处理

## 3 点简述
- 核心问题：传统象棋引擎缺乏人类棋手在压力或自信下的行为变异性，无法模拟真实对弈心理。
- 方法要点：结合静态人格与动态心理标量，通过音频信号链实时调整走棋概率分布，不依赖底层引擎。
- 实验或效果：在12,414局测试中，框架在压力下竞争得分从50.8%降至30.1%，行为模式类似人类倾斜与过度自信。
