...
**一句话要点**：提出CSV框架以解决大语言模型在语义过滤中线性调用开销高的问题

**关键词**：语义过滤, 大语言模型优化, 亚线性复杂度, 聚类采样, 投票策略, 查询处理

## 3 点简述
- 核心问题：语义过滤操作需逐元组调用LLM，导致线性扫描的延迟和令牌成本过高
- 方法要点：基于聚类-采样-投票框架，通过嵌入聚类、采样评估和投票策略实现亚线性复杂度
