...
**一句话要点**：提出Tell2Adapt框架，利用视觉基础模型解决医学图像源自由无监督域适应问题

**关键词**：源自由无监督域适应, 视觉基础模型, 医学图像分割, 伪标签生成, 多模态域适应

## 3 点简述
- 核心问题：现有方法难以处理多模态、多目标的统一域适应，限制临床应用
- 方法要点：通过上下文感知提示正则化和视觉合理性细化，生成高质量伪标签并优化预测
- 实验或效果：在10个域适应方向和22个解剖目标上验证，性能优于现有方法
