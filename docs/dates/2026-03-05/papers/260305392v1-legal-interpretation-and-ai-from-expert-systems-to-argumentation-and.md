...
**一句话要点**：综述AI与法律研究中法律解释的演进，涵盖专家系统、论证框架和语言模型方法。

**关键词**：AI与法律, 法律解释, 专家系统, 论证框架, 语言模型, 法律知识工程

## 3 点简述
- 核心问题：AI如何在不同方法下处理法律解释，从知识工程到自动生成。
- 方法要点：专家系统注重知识转移，论证框架分析结构互动，机器学习利用语言模型。
- 实验或效果：未知具体实验，但指出方法正逐步应用于法律实践。
