...
**arXiv**：[2603.05335v1](https://arxiv.org/abs/2603.05335) · [PDF](https://arxiv.org/pdf/2603.05335.pdf)  
**作者**：Nicholas G. Polson, Daniel Zantedeschi  

**一句话要点**：提出四种可容许性几何框架，用于序列和无分布预测推断的准则分离。

**关键词**：可容许性几何, 序列预测, 无分布推断, 鞅理论, 风险集, 准则分离

## 3 点简述
- 核心问题：序列和无分布预测推断中的可容许性准则分类与几何不兼容性。
- 方法要点：基于Blackwell风险支配、非负上鞅、交换性预测集和Cesàro逼近性定义四种几何框架。
- 实验或效果：证明四类可容许程序两两不嵌套，并分析鞅相干性在不同准则中的必要性。
