...
**一句话要点**：提出MADCrowner框架，通过模板变形与精化实现牙冠设计的自动化与临床可行性提升

**关键词**：牙冠设计, 模板变形, 边缘分割, 口内扫描, 网格生成, 临床工作流

## 3 点简述
- 针对牙冠自动设计中的空间分辨率不足、噪声输出和表面重建过度延伸问题
- 结合CrownDeformR模板变形与CrownSegger边缘分割，基于临床工作流优化设计流程
- 在大规模口内扫描数据集上验证，几何精度和临床可行性显著优于现有方法
