...
**关键词**：共同基础构建, 认知不对称, 多模态协作, 动态认知逻辑, 分布式信息谜题

## 3 点简述
- 核心问题：多模态多方协作中因信息差异导致共同基础构建困难
- 方法要点：引入DPIP任务并构建多模态对齐数据集，支持命题内容和信念动态推理
- 实验或效果：评估LLM与基于动态认知逻辑的管道，发现LLM在追踪任务进展和信念状态方面面临挑战
