...
**一句话要点**：提出非欧几里得梯度下降的广义锐度框架，以解释和扩展稳定性边缘现象。

**关键词**：稳定性边缘, 非欧几里得优化, 广义锐度, 梯度下降, 方向平滑性, 神经网络训练

## 3 点简述
- 核心问题：稳定性边缘现象在深度学习中广泛存在，但理论基础不完整，需统一解释。
- 方法要点：基于方向平滑性，定义任意范数下的广义锐度，涵盖多种优化器如ℓ∞-下降和块坐标下降。
- 实验或效果：在神经网络上验证非欧几里得梯度下降也呈现锐度振荡，提供几何感知的谱度量。
