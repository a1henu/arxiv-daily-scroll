...
**一句话要点**：证明卷积网络的局部性与权重共享通过耦合低维补丁流形改善隐式正则化，提升球面数据泛化能力

**关键词**：卷积神经网络, 隐式正则化, 归纳偏置, 泛化理论, 权重共享, 局部性

## 3 点简述
- 研究架构归纳偏置如何重塑梯度下降边缘稳定性现象中的隐式正则化
- 证明卷积网络在接收野相对小时能泛化球面数据，而全连接网络失败
- 分析自然图像补丁几何，解释卷积网络优于全连接基线的泛化原因
