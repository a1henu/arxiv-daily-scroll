...
**arXiv**：[2603.05396v1](https://arxiv.org/abs/2603.05396) · [PDF](https://arxiv.org/pdf/2603.05396.pdf)  
**作者**：Ahmad Abdel-Azim, Ruoyu Wang, Xihong Lin  

**一句话要点**：综述生成式AI合成数据在统计推断中的有效使用原则与风险

**关键词**：合成数据, 生成式AI, 统计推断, 模型误设, 不确定性量化, 数据泛化

## 3 点简述
- 核心问题：合成数据在统计推断中的有效性、可靠性和原则性使用条件
- 方法要点：回顾生成模型类别、用例、优势及局限性，分析常见陷阱如模型误设偏差
- 实验或效果：提出原则性使用框架，提供实用建议、开放问题和注意事项
