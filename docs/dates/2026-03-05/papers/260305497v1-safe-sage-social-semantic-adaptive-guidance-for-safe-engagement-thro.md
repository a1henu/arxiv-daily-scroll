...
**一句话要点**：提出Safe-SAGE框架，通过拉普拉斯调制泊松安全函数实现语义自适应安全导航

**关键词**：安全关键控制, 语义导航, 泊松安全函数, 控制屏障函数, 多传感器融合, 腿部机器人

## 3 点简述
- 传统安全控制方法语义盲视，对所有障碍物一视同仁，缺乏上下文感知
- 融合多传感器点云与视觉实例分割，构建语义感知环境模型，用于安全过滤
- 在动态环境中实现腿部机器人安全导航，保持严格安全保证，适应不同语义障碍
