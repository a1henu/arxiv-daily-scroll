...
**一句话要点**：提出重利用文本编码器丢失层方法以提升源自由跨域少样本学习性能

**关键词**：源自由跨域少样本学习, 文本编码器优化, 视觉-文本对齐, 域适应, 少样本学习

## 3 点简述
- 核心问题：源自由跨域少样本学习中，文本编码器中间层信息因视觉差距未充分利用，导致性能受限
- 方法要点：在层和编码器级别重利用丢失层信息，指导视觉分支在域偏移下重新学习
- 实验或效果：在多种设置、骨干网络和任务上验证有效性，代码已开源
