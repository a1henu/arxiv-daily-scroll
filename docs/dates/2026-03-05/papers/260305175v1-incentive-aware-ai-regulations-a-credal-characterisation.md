...
**arXiv**：[2603.05175v1](https://arxiv.org/abs/2603.05175) · [PDF](https://arxiv.org/pdf/2603.05175.pdf)  
**作者**：Anurag Singh, Julian Rodemann, Rajeev Verma, Siu Lun Chau, Krikamol Muandet  

**一句话要点**：提出基于机制设计的AI监管框架，通过许可证映射模型证据以激励合规。

**关键词**：AI监管, 机制设计, 不确定性建模, 许可证机制, 合规激励

## 3 点简述
- 核心问题：高风险ML应用中，策略性提供商规避监管以降低成本。
- 方法要点：将AI监管建模为不确定性下的机制设计问题，引入许可证机制。
- 实验或效果：在预测和公平性监管实验中验证机制有效性。
