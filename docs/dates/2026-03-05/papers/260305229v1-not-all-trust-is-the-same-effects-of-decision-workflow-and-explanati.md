...
**arXiv**：[2603.05229v1](https://arxiv.org/abs/2603.05229) · [PDF](https://arxiv.org/pdf/2603.05229.pdf)  
**作者**：Laura Spillner, Rachel Ringe, Robert Porzel, Rainer Malaka  

**一句话要点**：研究决策流程与解释对AI辅助决策中信任校准的影响，发现报告信任与依赖行为需分开评估。

**关键词**：AI辅助决策, 信任校准, 决策流程, 解释系统, 用户研究, 行为信任

## 3 点简述
- 核心问题：AI辅助决策中如何实现校准信任，避免过度信任与信任不足。
- 方法要点：比较一步与两步决策流程、解释的存在，并分析用户领域知识与AI经验的影响。
- 实验或效果：两步流程未减少过度依赖，解释效果受流程设置影响，报告信任与依赖行为是不同构念。
