...
**arXiv**：[2603.05015v1](https://arxiv.org/abs/2603.05015) · [PDF](https://arxiv.org/pdf/2603.05015.pdf)  
**作者**：Jorge Francisco García-Samartín, Iago López Pérez, Emirhan Yolcu, Jaime del Cerro, Antonio Barrientos  

**一句话要点**：提出基于增强现实的软体机器人遥操作界面，以解决建模困难问题。

**关键词**：增强现实, 软体机器人, 遥操作, 虚拟现实物理, 气动机械臂, 人机交互

## 3 点简述
- 核心问题：软体机器人建模困难，难以结合精确与计算高效表示。
- 方法要点：使用Microsoft HoloLens 2和中央计算机，基于虚拟现实物理估计机器人位置。
- 实验或效果：在PETER气动机械臂上验证，误差约为机器人长度的5%，增强现实促进操作员交互。
