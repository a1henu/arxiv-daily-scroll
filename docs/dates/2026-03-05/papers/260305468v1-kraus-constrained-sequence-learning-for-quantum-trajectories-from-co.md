...
## 3 点简述
- 核心问题：标准量子态重建方法依赖精确模型，无约束神经网络预测可能违反物理性，导致不稳定估计
- 方法要点：设计Kraus结构输出层，将序列模型隐藏表示转换为完全正定保迹量子操作，确保物理有效状态更新
- 实验或效果：在参数漂移轨迹上评估多种模型，Kraus-LSTM表现最佳，提升状态估计质量7%，保证非平稳区域物理有效预测
