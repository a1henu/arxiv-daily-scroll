...
**一句话要点**：提出两阶段奖励课程以解决机器人强化学习中多目标奖励设计难题

**关键词**：强化学习, 机器人控制, 奖励设计, 课程学习, 多目标优化

## 3 点简述
- 核心问题：机器人控制中多目标奖励函数设计复杂，需精确调优权重。
- 方法要点：先训练任务奖励，再引入行为奖励，并重用样本以稳定训练。
- 实验或效果：在多个环境中验证，性能优于基线，对奖励权重更鲁棒。
