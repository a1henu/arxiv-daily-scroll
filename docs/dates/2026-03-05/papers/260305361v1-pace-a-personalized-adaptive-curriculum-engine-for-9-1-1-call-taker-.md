...
**关键词**：个性化学习, 自适应课程, 技能图建模, 上下文多臂赌博机, 培训效率提升, 紧急通信培训

## 3 点简述
- 核心问题：911接线员培训需掌握上千项技能，但劳动力短缺和个性化教学负担限制了培训效率。
- 方法要点：PACE通过概率技能状态建模、学习遗忘动态分析和基于技能图的证据传播，推荐平衡新技能获取与旧技能保留的训练场景。
- 实验或效果：实证显示PACE比先进框架快19.50%达到能力，终端掌握度高10.95%，与专家教学判断对齐率达95.45%。
