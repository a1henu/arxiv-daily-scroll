...
**一句话要点**：提出Latent-Mark框架，通过潜在空间嵌入解决音频水印在神经重合成中的脆弱性问题。

**关键词**：音频水印, 神经编解码器, 潜在空间嵌入, 跨编解码器优化, 鲁棒性, 不可感知性

## 3 点简述
- 核心问题：现有音频水印技术对传统DSP攻击鲁棒，但易受神经重合成破坏，因神经编解码器丢弃波形细节。
- 方法要点：在编解码器不变潜在空间中嵌入水印，优化波形以诱导潜在表示方向性偏移，确保不可感知性。
- 实验或效果：引入跨编解码器优化，实现零样本迁移至未见神经编解码器，保持对传统DSP攻击的鲁棒性和不可感知性。
