...
**关键词**：测试时适应, 零阶优化, 提示优化, 资源受限部署, 前向计算, 模型泛化

## 3 点简述
- 核心问题：测试时适应中基于反向传播的方法计算资源高且修改权重，传统无反向传播方法适应能力有限。
- 方法要点：采用零阶优化，结合特征统计和预测熵目标，引入动态衰减扰动尺度确保稳定适应。
- 实验或效果：在ImageNet-C等数据集上表现优异，Top-1准确率达59.52%，优于基于梯度的方法和SOTA前向方法。
