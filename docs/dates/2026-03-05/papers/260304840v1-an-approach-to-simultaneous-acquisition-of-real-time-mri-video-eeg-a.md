...
**arXiv**：[2603.04840v1](https://arxiv.org/abs/2603.04840) · [PDF](https://arxiv.org/pdf/2603.04840.pdf)  
...
**一句话要点**：提出同时采集实时MRI、EEG和表面EMG的方法，以研究言语产生中的神经、肌肉和发音活动。

**关键词**：多模态采集, 伪影抑制, 言语神经科学, 脑机接口, 实时MRI

## 3 点简述
- 核心问题：言语产生涉及神经规划、运动控制等多层次过程，但声学信号无法直接揭示其神经生理基础。
- 方法要点：首次实现实时MRI、EEG和表面EMG的同时采集，并开发针对多模态设置的伪影抑制流程。
- 实验或效果：该框架有望为言语神经科学和脑机接口提供前所未有的洞察。
