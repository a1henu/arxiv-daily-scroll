...
**一句话要点**：提出周期性适应框架，用于基于姿态的实时零售盗窃检测，支持物联网边缘部署。

**关键词**：姿态检测, 视频异常检测, 物联网部署, 周期性适应, 零售安全, 边缘计算

## 3 点简述
- 核心问题：零售盗窃检测需自动化、隐私保护且资源高效，传统监控不足。
- 方法要点：将盗窃检测视为基于姿态的无监督视频异常检测，引入周期性适应框架从流式未标记数据学习。
- 实验或效果：在91.6%评估中优于离线基线，边缘硬件训练更新<30分钟，验证了物联网部署可行性。
