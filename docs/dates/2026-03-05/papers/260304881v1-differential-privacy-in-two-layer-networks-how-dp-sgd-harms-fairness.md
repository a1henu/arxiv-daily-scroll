...
**一句话要点**：提出特征中心框架分析DP-SGD在两层ReLU卷积网络中的特征学习动态，揭示隐私噪声如何损害公平性与鲁棒性。

**关键词**：差分隐私学习, 特征学习动态, 公平性分析, 对抗鲁棒性, 两层神经网络, 特征噪声比

## 3 点简述
- 核心问题：差分隐私学习在非凸神经网络中导致性能下降、公平性问题和对抗鲁棒性降低的理论机制未知。
- 方法要点：基于特征噪声比（FNR）建立测试损失界，分析噪声对特征学习的影响，包括类别间不平衡和长尾数据。
