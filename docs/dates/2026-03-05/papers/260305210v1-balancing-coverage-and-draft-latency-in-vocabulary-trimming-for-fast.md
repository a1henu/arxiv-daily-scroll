...
**关键词**：推测解码, 词汇裁剪, 优化问题, 延迟降低, 吞吐提升, 领域特定任务

## 3 点简述
- 核心问题：草稿模型词汇大小在推测解码中导致覆盖率和延迟的权衡，影响整体效率。
- 方法要点：将词汇选择建模为约束优化问题，使用树结构帕森估计器探索覆盖-延迟帕累托前沿。
- 实验效果：在领域特定任务上实现高达16%延迟降低和20%吞吐提升，词汇减少达97%。
