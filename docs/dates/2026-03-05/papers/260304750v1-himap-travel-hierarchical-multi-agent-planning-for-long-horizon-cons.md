...
**一句话要点**：提出HiMAP-Travel分层多智能体框架以解决长时程约束旅行规划中LLM智能体漂移问题

**关键词**：长时程规划, 多智能体系统, 约束优化, 并行执行, 旅行规划, 强化学习

## 3 点简述
- 核心问题：序列LLM智能体在长时程规划中因上下文增长而偏离预算和多样性等硬约束
- 方法要点：采用分层多智能体框架，通过战略协调和并行日级执行，结合事务监控、议价协议和GRPO训练策略
- 实验或效果：在TravelPlanner上，使用Qwen3-8B模型实现52.78%验证和52.65%测试最终通过率，优于多个基线
