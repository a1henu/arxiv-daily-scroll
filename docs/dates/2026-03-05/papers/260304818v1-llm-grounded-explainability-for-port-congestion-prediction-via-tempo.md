...
**关键词**：港口拥堵预测, 时空图注意力网络, 大语言模型解释, AIS数据分析, 可解释人工智能

## 3 点简述
- 核心问题：港口拥堵预测系统缺乏可操作的解释，影响供应链风险管理。
- 方法要点：基于AIS数据构建时空图，TGAT预测拥堵，LLM模块生成基于模型证据的自然语言解释。
- 实验或效果：在洛杉矶和长滩港数据上，AUC达0.761，解释方向一致性为99.6%，优于基线模型。
