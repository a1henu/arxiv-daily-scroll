...
**一句话要点**：提出条件近端策略优化以高效训练扩散策略，解决强化学习中动作对数似然计算难题。

**关键词**：扩散策略, 强化学习, 条件近端策略优化, 多模态行为, 熵正则化

## 3 点简述
- 核心问题：扩散策略在强化学习中难以高效计算动作对数似然，阻碍在线策略应用。
- 方法要点：通过策略迭代与扩散过程对齐，仅需评估简单高斯概率，实现高效训练。
- 实验或效果：在IsaacLab和MuJoCo Playground基准任务中展现多模态行为与优越性能。
