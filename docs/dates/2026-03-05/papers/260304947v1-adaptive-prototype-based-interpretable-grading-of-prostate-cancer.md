...
**关键词**：前列腺癌分级, 原型学习, 弱监督学习, 可解释人工智能, 组织病理学图像, 自适应原型

## 3 点简述
- 核心问题：前列腺癌分级自动化需求高，但深度学习模型可解释性不足，影响医学应用信任度。
- 方法要点：采用原型学习，通过补丁级预训练和原型感知损失微调，模拟病理学家比较可疑区域与临床验证示例的工作流程。
- 实验或效果：在PANDA和SICAP数据集上验证，框架可作为可靠辅助工具，提升分级性能并增强可解释性。
