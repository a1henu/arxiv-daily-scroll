...
**一句话要点**：提出视觉引导神经波束形成网络，以提升动态场景下的语音增强性能

**关键词**：语音增强, 神经波束形成, 多模态学习, 视觉语音识别, 注意力机制

## 3 点简述
- 核心问题：单通道语音增强在低信噪比、高混响或动态说话人场景中效果不佳
- 方法要点：结合麦克风阵列与深度学习，利用唇动特征进行说话人识别和活动检测
- 实验或效果：在静态和动态说话人场景中，相比基线方法表现出更好的性能和鲁棒性
