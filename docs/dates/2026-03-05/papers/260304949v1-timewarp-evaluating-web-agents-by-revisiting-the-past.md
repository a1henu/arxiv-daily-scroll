...
**关键词**：Web代理评估, 网页演变模拟, 计划蒸馏, 行为克隆, 泛化能力, 容器化环境

## 3 点简述
- 核心问题：当前Web代理在网页UI、设计和布局变化时性能下降，现有基准无法评估这种泛化能力。
- 方法要点：引入TimeWarp基准模拟网页演变，并提出TimeTraj算法通过计划蒸馏跨多版本收集轨迹以训练代理。
- 实验或效果：实验显示TimeTraj显著提升代理性能，如Qwen-3 4B从20.4%提升至37.7%，Llama-3.1 8B从0%提升至27.0%。
