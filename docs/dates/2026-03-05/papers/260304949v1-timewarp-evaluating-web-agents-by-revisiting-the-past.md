...
**一句话要点**：提出TimeWarp基准和TimeTraj算法以提升网络代理在网页变化中的鲁棒性

**关键词**：网络代理评估, 网页演变模拟, 计划蒸馏, 行为克隆, 泛化能力, 鲁棒性提升

## 3 点简述
- 核心问题：当前网络代理在网页UI、设计和布局变化时性能下降，现有基准无法评估这种泛化能力。
- 方法要点：引入TimeWarp基准模拟网页演变，并提出TimeTraj算法通过计划蒸馏跨多版本收集轨迹以训练代理。
- 实验或效果：实验显示代理对变化脆弱，TimeTraj显著提升性能，如Qwen-3 4B从20.4%提升至37.7%。
