...
**一句话要点**：提出基于LLM引导的自组织机器人团队探索方法，以增强多机器人探索的自主性与效率。

**关键词**：机器人探索, 自组织团队, LLM引导, 多机器人系统, 分散控制

## 3 点简述
- 核心问题：在机器人感知能力有限或容错性不足时，需多机器人组队探索，但传统集中控制缺乏鲁棒性与灵活性。
- 方法要点：结合自组织算法实现动态团队形成，并利用LLM引导各团队自主确定探索目标，替代经典前沿方法或深度强化学习。
- 实验或效果：通过数十至数百机器人的仿真验证了方法的有效性，提升了集体观测范围和可靠性。
