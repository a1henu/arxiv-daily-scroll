...
**arXiv**：[2603.04722v1](https://arxiv.org/abs/2603.04722) · [PDF](https://arxiv.org/pdf/2603.04722.pdf)  
**作者**：Jihoon Jeong  

**一句话要点**：提出Model Medicine框架，以临床医学方法系统理解、诊断与治疗AI模型

**关键词**：AI模型诊断, 临床模型科学, 行为遗传框架, 神经影像映射, 模型评估框架, 治疗框架

## 3 点简述
- 核心问题：AI模型缺乏系统临床实践，需从解释性研究转向全面诊断与治疗。
- 方法要点：建立学科分类、行为遗传框架、诊断工具与评估框架，连接模型结构与行为。
- 实验或效果：基于Agora-12程序数据验证框架，并通过临床案例展示诊断工具能力。
