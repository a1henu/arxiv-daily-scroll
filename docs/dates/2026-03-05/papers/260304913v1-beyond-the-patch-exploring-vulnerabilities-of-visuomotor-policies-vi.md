...
**一句话要点**：提出基于可微分渲染的视点一致3D对抗纹理优化方法，以增强移动相机下机器人视觉运动策略的鲁棒性评估。

**关键词**：3D对抗攻击, 视觉运动策略, 可微分渲染, 视点一致性, 机器人操纵, 鲁棒性评估

## 3 点简述
- 核心问题：传统2D对抗补丁在动态视点下因透视失真而失效，需探索3D对象攻击以揭示机器人策略的潜在漏洞。
- 方法要点：采用期望变换与粗到细课程，结合距离相关频率特征和显著性引导扰动，优化3D纹理以保持视点一致性。
- 实验或效果：方法在多种环境条件下有效，验证了黑盒可迁移性和实际应用可行性。
