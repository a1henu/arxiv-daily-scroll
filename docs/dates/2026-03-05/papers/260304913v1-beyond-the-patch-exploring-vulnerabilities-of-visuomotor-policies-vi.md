...
**一句话要点**：提出基于可微分渲染的视角一致3D对抗纹理优化方法，以增强移动相机下机器人视觉运动策略的鲁棒性。

**关键词**：视觉运动策略, 3D对抗攻击, 可微分渲染, 视角一致性, 机器人操纵, 黑盒迁移

## 3 点简述
- 核心问题：传统2D对抗补丁在动态视角下因透视失真而失效，需探索3D对象的潜在漏洞。
- 方法要点：采用EOT和C2F课程，结合显著性引导扰动和目标损失，优化纹理以跨距离和视角攻击策略。
