...
**关键词**：扩散模型, 气相反应动力学, 物理引导采样, 对流-反应-扩散方程, 浓度场预测

## 3 点简述
- 核心问题：物理引导采样在化学反应-传输系统中的应用有限，需解决气相反应动力学的PDE问题。
- 方法要点：基于扩散模型先验，训练对流-反应-扩散方程的解，进行引导采样以生成浓度场。
- 实验或效果：方法在未见参数值下准确预测出口浓度，展示扩散模型在反应传输推断中的潜力。
