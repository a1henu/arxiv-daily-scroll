...
**一句话要点**：提出Ara LLM代理以解决光催化共价有机框架稳定性与活性权衡的逆设计问题

**关键词**：共价有机框架, 光催化, 逆设计, 大语言模型代理, 水解稳定性, 多目标优化

## 3 点简述
- 核心问题：亚胺键光催化COFs在水中易水解，导致稳定性与活性难以兼顾。
- 方法要点：Ara代理结合化学先验知识，指导多标准搜索，包括能隙、能带边和稳定性。
- 实验或效果：在候选空间中，Ara命中率52.7%，显著优于随机搜索和贝叶斯优化。
