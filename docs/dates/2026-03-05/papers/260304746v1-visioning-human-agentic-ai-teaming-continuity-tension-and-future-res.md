...
**arXiv**：[2603.04746v1](https://arxiv.org/abs/2603.04746) · [PDF](https://arxiv.org/pdf/2603.04746.pdf)  
**作者**：Bowen Lou, Tian Lu, T. S. Raghu, Yingjie Zhang  

**一句话要点**：扩展团队情境感知理论以应对智能体AI在人类-AI协作中的结构不确定性

**关键词**：人类-AI协作, 团队情境感知, 智能体AI, 结构不确定性, 动态对齐, 异质系统

## 3 点简述
- 核心问题：智能体AI的开放行动轨迹和生成能力引入行为、认知和逻辑稳定性不确定性，挑战传统对齐方法。
- 方法要点：基于共享感知、理解和预测，重构人类和AI在开放智能体下的情境感知，包括异质系统间预测一致性的意义建构。
- 实验或效果：未知，但提出前瞻性研究议程，强调连续性vs张力分析，以支持动态对齐。
