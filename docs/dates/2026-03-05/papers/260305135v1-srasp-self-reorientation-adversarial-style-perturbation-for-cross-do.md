...
**一句话要点**：提出SRasP网络以解决跨域少样本学习中风格扰动方法的梯度不稳定和收敛尖锐问题

**关键词**：跨域少样本学习, 风格扰动, 对抗训练, 梯度稳定, 语义一致性, 模型泛化

## 3 点简述
- 核心问题：现有风格扰动方法在缓解域偏移时存在梯度不稳定和收敛到尖锐最小值的问题
- 方法要点：SRasP利用全局语义指导识别不连贯裁剪，重新定向并聚合裁剪与全局风格梯度
- 实验或效果：在多个CD-FSL基准测试中表现优于现有方法，提升模型泛化能力
