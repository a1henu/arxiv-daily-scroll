...
**关键词**：数学推理, 课程学习, 数据效率, 多智能体框架, 闭环反馈

## 3 点简述
- 核心问题：大规模数据集需求导致数学推理模型数据效率低，传统单向课程学习样本利用率不足
- 方法要点：采用多智能体生态系统动态生成数据，通过复杂化或简化问题建立闭环反馈循环
- 实验或效果：基于最优步调定理优化学习轨迹，在减少指令样本下显著超越基线并提升推理性能
