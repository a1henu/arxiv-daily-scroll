...
**一句话要点**：提出WebChain数据集以支持可复现的网页代理研究，通过大规模真实交互轨迹提供多模态监督。

**关键词**：网页代理, 多模态数据集, 真实交互轨迹, 三重对齐, Dual Mid-Training, 可复现研究

## 3 点简述
- 核心问题：现有网页代理研究缺乏大规模、真实世界交互数据，限制可复现性和性能评估。
- 方法要点：构建WebChain数据集，包含31,725条轨迹和318k步骤，通过视觉、结构和动作三重对齐提供多模态监督。
- 实验或效果：提出Dual Mid-Training方法，在WebChainBench等基准上实现最先进性能，验证数据集有效性。
