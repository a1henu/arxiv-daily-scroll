...
**一句话要点**：提出RefQuery框架，通过轻量级迁移学习解决非侵入式负载监测中的跨域泛化与可扩展性问题。

**关键词**：非侵入式负载监测, 迁移学习, 轻量级框架, 多设备分解, 边缘计算, 设备指纹

## 3 点简述
- 核心问题：非侵入式负载监测面临跨家庭设备特性、使用模式和背景负载差异导致的泛化挑战。
- 方法要点：基于紧凑设备指纹，冻结预训练网络，仅学习每设备嵌入，实现多设备多任务可扩展分解。
- 实验或效果：在三个公共数据集上验证，相比基线方法，在精度与效率间取得良好平衡，适用于资源受限边缘设备。
