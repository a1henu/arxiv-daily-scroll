...
**关键词**：非侵入式负载监测, 迁移学习, 负载分解, 边缘计算, 多任务学习, 设备指纹

## 3 点简述
- 核心问题：非侵入式负载监测中，跨家庭设备特性、使用模式和背景负载差异导致模型泛化困难。
- 方法要点：基于紧凑设备指纹，冻结预训练网络，仅学习每设备嵌入，实现多设备多任务负载分解。
- 实验或效果：在三个公开数据集上验证，相比基线方法，在精度与效率间取得良好平衡，适用于资源受限边缘设备。
