...
**arXiv**：[2603.05067v1](https://arxiv.org/abs/2603.05067) · [PDF](https://arxiv.org/pdf/2603.05067.pdf)  
**作者**：Zinaid Kapić, Aladin Crnkić, Goran Mauša  

**一句话要点**：提出基于广义Kuramoto模型的同步聚类算法，用于单位超球面上的数据聚类。

**关键词**：单位超球面聚类, 广义Kuramoto模型, 同步机制, 数据几何结构, 聚类算法

## 3 点简述
- 核心问题：单位球面数据聚类，传统方法未考虑球面几何结构。
- 方法要点：利用d维广义Kuramoto模型，通过同步机制实现聚类。
- 实验或效果：在合成和真实数据集上验证，相比传统方法准确率相似或更高。
