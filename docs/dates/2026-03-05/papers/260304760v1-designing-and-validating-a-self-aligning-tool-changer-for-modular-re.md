...
**arXiv**：[2603.04760v1](https://arxiv.org/abs/2603.04760) · [PDF](https://arxiv.org/pdf/2603.04760.pdf)  
**作者**：Mahfudz Maskur, Takuya Kiyokawa, Kensuke Harada  

**一句话要点**：提出自对准工具更换系统以解决模块化可重构机器人自动模块交换中的定位误差问题

**关键词**：模块化机器人, 工具更换系统, 自对准机制, 被动补偿, 机器人重构, 自主交换

## 3 点简述
- 核心问题：传统刚性主动耦合因定位和定向误差导致模块交换失败
- 方法要点：采用被动自对准几何结构（倒角插座和三角形引导件）补偿角度和横向偏差
- 实验或效果：通过真实自主工具拾取实验验证系统能吸收执行误差，实现高可靠工具重构
