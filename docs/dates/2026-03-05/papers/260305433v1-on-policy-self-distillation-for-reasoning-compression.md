...
**一句话要点**：提出OPSDC方法，通过自蒸馏压缩推理模型输出，提升效率与准确性。

**关键词**：推理压缩, 自蒸馏, 反向KL散度, 模型效率, 数学推理

## 3 点简述
- 核心问题：推理模型输出冗余且可能有害，导致效率低下和错误累积。
- 方法要点：基于“简洁”指令自蒸馏，最小化反向KL散度，无需额外数据或预算。
- 实验效果：在MATH-500和AIME 2024上实现显著压缩和准确性提升。
