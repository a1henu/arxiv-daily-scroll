...
**一句话要点**：提出UniM基准以评估任意组合多模态输入输出的统一理解与生成能力

**关键词**：任意到任意多模态学习, 交织多模态基准, 多模态大语言模型评估, 统一理解与生成, 多模态数据集

## 3 点简述
- 核心问题：现实多模态应用需处理任意交织的多模态输入并生成任意交织输出，现有基准不足
- 方法要点：构建首个统一任意到任意交织多模态数据集UniM，涵盖7种模态和30个领域，并设计三维评估套件
