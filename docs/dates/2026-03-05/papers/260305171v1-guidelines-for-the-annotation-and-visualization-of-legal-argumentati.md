...
**arXiv**：[2603.05171v1](https://arxiv.org/abs/2603.05171) · [PDF](https://arxiv.org/pdf/2603.05171.pdf)  
**作者**：Kun Chen, Xianglei Liao, Kaixue Fei, Yi Xing, Xinrui Li  

**一句话要点**：提出中文司法判决中法律论证结构的标注与可视化指南，以支持计算分析

**关键词**：法律论证标注, 司法决策分析, 计算法律学, 论证结构可视化, 标注指南

## 3 点简述
- 核心问题：缺乏系统化标注框架来揭示司法推理的逻辑结构，阻碍计算分析。
- 方法要点：在命题层面区分四类命题，在关系层面定义五种论证关系，并制定形式化表示规则。
- 实验或效果：建立标准化标注流程和一致性控制机制，确保数据可重复性和可靠性，支持大规模分析。
