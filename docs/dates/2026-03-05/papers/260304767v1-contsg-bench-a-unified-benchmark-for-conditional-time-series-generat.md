...
**arXiv**：[2603.04767v1](https://arxiv.org/abs/2603.04767) · [PDF](https://arxiv.org/pdf/2603.04767.pdf)  
**作者**：Shaocheng Lan, Shuqi Gu, Zhangzhi Xiong, Kan Ren  

**一句话要点**：提出ConTSG-Bench基准以解决条件时间序列生成领域缺乏标准化评估框架的问题

**关键词**：条件时间序列生成, 基准测试, 数据集构建, 生成模型评估, 结构可控性, 下游任务效用

## 3 点简述
- 核心问题：条件时间序列生成领域缺乏统一基准，阻碍模型评估与比较
- 方法要点：构建大规模对齐数据集，涵盖多种条件模态和语义抽象级别，支持系统评估
- 实验或效果：通过定量基准测试和深入分析，揭示现有方法的特性、局限及未来研究方向
