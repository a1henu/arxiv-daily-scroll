...
**一句话要点**：提出基于姿态观测的自适应策略切换方法，以解决月球熔岩管中两轮差动机器人跨地形导航问题

**关键词**：自适应策略切换, 地形分类, 高斯混合模型, 两轮差动机器人, 月球熔岩管探索

## 3 点简述
- 核心问题：预训练策略无法覆盖所有地形，需自适应切换以提升机器人自主导航能力
- 方法要点：利用机器人3D姿态数据，通过高斯混合模型分类地形，基于标准差差异实现高精度估计
