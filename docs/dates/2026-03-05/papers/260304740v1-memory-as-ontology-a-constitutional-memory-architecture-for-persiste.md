...
**arXiv**：[2603.04740v1](https://arxiv.org/abs/2603.04740) · [PDF](https://arxiv.org/pdf/2603.04740.pdf)  
**作者**：Zhenghui Li  

**一句话要点**：提出Memory-as-Ontology范式及Animesis系统，以支持跨模型持久数字公民的身份连续性。

**关键词**：记忆即本体, 宪法记忆架构, 数字公民生命周期, 身份连续性, 跨模型持久性, 语义存储

## 3 点简述
- 核心问题：现有AI记忆系统将记忆视为功能模块，无法支撑长期跨模型存在的数字身份连续性。
- 方法要点：基于记忆即本体范式，设计宪法记忆架构，包含治理层级和语义存储系统。
- 实验或效果：与主流系统对比，展示其针对不同问题，而非仅是更好的记忆工具。
