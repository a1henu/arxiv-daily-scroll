...
**关键词**：幻觉检测, 视觉语言模型, 内部表征分析, 预生成预测, 轻量级探针, 模型安全

## 3 点简述
- 核心问题：视觉语言模型常产生幻觉，现有检测方法在生成后干预成本高且不及时
- 方法要点：在单次前向传播中，探测视觉特征、视觉-令牌表征和查询-令牌表征三类内部表征
- 实验或效果：在多种任务和八个现代VLM上，轻量级探针实现高检测性能，AUROC最高达0.93
