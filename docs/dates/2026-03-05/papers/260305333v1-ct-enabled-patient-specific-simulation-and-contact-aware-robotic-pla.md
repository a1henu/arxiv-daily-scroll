...
**一句话要点**：提出基于CT的个性化模拟与接触感知机器人规划方法，以优化人工耳蜗植入手术。

**关键词**：人工耳蜗植入, 机器人手术规划, CT成像模拟, 接触力学建模, 个性化解剖重建, 可微模拟

## 3 点简述
- 核心问题：机器人植入需精确预测接触力，以减少耳蜗创伤和防止锁定/屈曲失败。
- 方法要点：开发低维可微Cosserat-rod模型，结合摩擦接触和伪动力学正则化，实现连续粘滑过渡。
- 实验或效果：模拟和实验验证了变形和力趋势，降低了锁定/屈曲风险并提高了植入深度。
