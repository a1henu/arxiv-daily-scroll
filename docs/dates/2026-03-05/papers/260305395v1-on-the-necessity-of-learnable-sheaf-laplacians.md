...
**关键词**：层束神经网络, 异质图学习, 过平滑问题, 身份层束网络, 消融研究, 图卷积网络

## 3 点简述
- 核心问题：层束神经网络通过可学习限制映射解决异质图过平滑，但复杂度高，必要性未知
- 方法要点：引入身份层束网络基线，固定限制映射为身份矩阵，与层束学习架构进行消融比较
- 实验或效果：在五个异质图基准上，身份基线性能与层束变体相当，过平滑未显著增加
