...
**arXiv**：[2603.05027v1](https://arxiv.org/abs/2603.05027) · [PDF](https://arxiv.org/pdf/2603.05027.pdf)  
**作者**：Janani Rangila, Akila Siriweera, Incheon Paik, Keitaro Naruse, Isuru Jayanada, Vishmika Devindi  

**一句话要点**：提出S5-SHB-Agent框架，以区块链和智能体协调解决智能家居在Society 5.0下的自适应治理问题。

**关键词**：智能家居, 区块链治理, 多智能体系统, 自适应共识, Society 5.0, 居民控制

## 3 点简述
- 核心问题：现有智能家居框架缺乏自适应共识、多智能体协调和居民可控治理机制。
- 方法要点：采用可互换大语言模型协调十个专业智能体，结合自适应PoW区块链和四层治理模型。
- 实验或效果：评估显示居民治理能正确分离可调舒适度与不可变安全阈值，自适应共识支持紧急区块提交。
