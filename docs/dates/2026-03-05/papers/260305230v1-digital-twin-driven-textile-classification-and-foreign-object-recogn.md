...
**一句话要点**：提出数字孪生驱动的机器人分拣系统，结合视觉语言模型和感知技术，用于现实工业环境中的纺织品分类和异物识别。

**关键词**：数字孪生, 视觉语言模型, 纺织品分类, 异物识别, 机器人分拣, 多模态感知

## 3 点简述
- 核心问题：可持续纺织品回收需自动化处理可变形衣物和在杂乱环境中检测异物。
- 方法要点：集成抓取预测、多模态感知和语义推理，利用数字孪生和MoveIt进行碰撞感知路径规划。
- 实验或效果：在223个场景数据集上评估9个VLM，Qwen模型家族达到最高87.9%准确率，Gemma3在边缘部署中提供速度-精度权衡。
