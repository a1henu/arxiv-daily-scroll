...
**一句话要点**：提出SCoUT方法，通过效用引导的时序分组解决多智能体强化学习中通信的可扩展性问题。

**关键词**：多智能体强化学习, 通信机制, 时序分组, 反事实学习, 去中心化执行

## 3 点简述
- 核心问题：部分可观测MARL中，通信时机和对象选择困难，且消息对奖励的影响难以隔离。
- 方法要点：使用Gumbel-Softmax进行软分组，结合组感知评论家和反事实通信优势实现精确信用分配。
- 实验或效果：在训练中降低评论家复杂度和方差，执行时保持去中心化，提升协调效率。
