...
**一句话要点**：提出基于单目广播视频的棒球投球损伤风险筛查方法，以替代昂贵的多相机系统。

**关键词**：单目视频分析, 生物力学恢复, 损伤风险预测, 运动学细化, 棒球投球, 广播视频处理

## 3 点简述
- 核心问题：棒球投球损伤预测依赖精确生物力学信号，但专业多相机系统成本高且难以普及。
- 方法要点：基于DreamPose3D，引入漂移控制全局提升模块和运动学细化流程，从视频恢复18个生物力学指标。
- 实验或效果：在13名职业投手数据上，16/18指标误差小于1度；损伤预测模型AUC达0.811-0.825，支持可扩展筛查。
