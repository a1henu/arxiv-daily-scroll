...
**一句话要点**：提出几何感知量化框架以解决SO(3)-等变图神经网络在离散空间中的对称性破坏问题

**关键词**：等变图神经网络, 几何感知量化, SO(3)-等变性, 分子模拟, 低比特量化, 对称性保持

## 3 点简述
- 核心问题：低比特量化破坏SO(3)-等变结构，导致高误差和守恒律违反
- 方法要点：引入幅度-方向解耦量化、对称感知训练策略和鲁棒注意力归一化
- 实验效果：在rMD17基准上，W4A8模型匹配FP32精度，推理加速2.39倍，内存减少4倍
