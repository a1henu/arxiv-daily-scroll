...
**一句话要点**：提出SURE框架，通过建模不确定性解决图像匹配中的过自信错误问题

**关键词**：图像匹配, 不确定性建模, 半稠密匹配, 特征对应, 机器人视觉, 置信度估计

## 3 点简述
- 核心问题：传统图像匹配方法依赖特征相似性，缺乏可靠性估计，在视角变化大或纹理缺失场景易产生过自信错误
- 方法要点：联合预测对应点及其置信度，引入证据头建模偶然和认知不确定性，并设计轻量空间融合模块提升局部特征精度
- 实验或效果：在多个标准基准测试中，SURE在准确性和效率上均优于现有半稠密匹配模型
