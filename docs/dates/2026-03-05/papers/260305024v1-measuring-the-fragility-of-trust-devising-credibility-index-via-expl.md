...
**一句话要点**：提出基于解释稳定性的可信度指数（CIES），以量化商业决策支持系统中AI解释的稳健性。

**关键词**：可解释人工智能, 解释稳定性, 可信度指数, 商业决策支持, 数据扰动, 树模型

## 3 点简述
- 核心问题：XAI方法在商业应用中解释的可信度未量化，稳定性受数据扰动影响未知。
- 方法要点：CIES通过秩加权距离函数衡量解释稳定性，强调关键特征变化的重要性。
- 实验或效果：在三个数据集上验证，CIES优于基线指标，提供统计显著的判别力。
