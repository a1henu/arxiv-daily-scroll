...
**一句话要点**：提出语义通信增强的U形分割联邦学习框架，以解决车联网中通信开销和隐私问题。

**关键词**：语义通信, 分割联邦学习, 车联网, 隐私保护, 通信优化, 边缘智能

## 3 点简述
- 核心问题：车联网中传统集中式学习通信开销大、隐私风险高，分割联邦学习存在通信瓶颈和标签隐私担忧。
- 方法要点：设计语义通信模块压缩传输任务相关语义信息，结合网络状态监控实时调整压缩率，本地化敏感计算增强隐私。
- 实验或效果：框架在资源受限车联网中平衡通信负载、保护隐私并保持学习性能，通过案例研究验证有效性。
