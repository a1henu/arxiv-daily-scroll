...
**一句话要点**：提出Mario框架以解决多模态图推理中的跨模态一致性与异质模态偏好问题

**关键词**：多模态图推理, 大语言模型, 跨模态对比学习, 图指令调优, 节点分类, 链接预测

## 3 点简述
- 核心问题：现有方法忽略多模态数据的图结构，面临跨模态一致性弱和异质模态偏好挑战
- 方法要点：采用图条件视觉语言模型和模态自适应图指令调优，联合优化特征并适配LLM推理
- 实验或效果：在多个多模态图基准测试中，监督和零样本场景下节点分类与链接预测均优于先进模型
