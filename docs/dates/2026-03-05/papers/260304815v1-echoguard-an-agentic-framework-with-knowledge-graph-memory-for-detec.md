...
**一句话要点**：提出EchoGuard框架，利用知识图谱记忆检测长对话中的操纵性沟通

**关键词**：知识图谱记忆, 代理AI框架, 操纵性沟通检测, 长对话分析, 心理模式识别

## 3 点简述
- 核心问题：现有AI系统缺乏结构化长时记忆，难以识别操纵性沟通如煤气灯效应
- 方法要点：基于知识图谱构建代理记忆，通过日志-分析-反思循环检测六种心理操纵模式
- 实验或效果：提出理论框架、设计评估策略，旨在验证方法以增强个人自主与安全
