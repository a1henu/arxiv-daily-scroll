...
**一句话要点**：提出基于NeRF的LWIR高光谱图像3D场景重建方法，用于气体羽流检测

**关键词**：神经辐射场, 长波红外高光谱图像, 3D场景重建, 气体羽流检测, 稀疏视图训练, 自适应损失函数

## 3 点简述
- 核心问题：LWIR高光谱图像中气体羽流的3D场景理解，通常图像稀疏且分析孤立。
- 方法要点：结合高光谱和稀疏视图NeRF技术，采用自适应加权MSE损失，减少训练图像需求。
- 实验或效果：在合成数据集上，仅需30张训练图像，PSNR达39.8 dB，气体检测AUC为0.821。
