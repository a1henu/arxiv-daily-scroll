...
**关键词**：生成式人工智能, 无代码开发, 智能城市教育, 人机协作, 设计学习, 领域知识整合

## 3 点简述
- 核心问题：学生常被动使用生成式AI输出，而非主动设计AI协作工具，如何促进向AI设计者转变。
- 方法要点：基于无代码智能城市课程，分析三个GPT项目，从设计、AI架构和领域知识三个维度构建框架。
- 实验或效果：研究发现，当三个维度协同作用时，能促进有效人机协作，增强AI素养、元认知和学习者能动性。
