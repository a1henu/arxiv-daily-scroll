...
**arXiv**：[2603.05036v1](https://arxiv.org/abs/2603.05036) · [PDF](https://arxiv.org/pdf/2603.05036.pdf)  
**作者**：Qian Huang, King Wang Poon  

**一句话要点**：提出Trilingual Triad框架，以无代码AI智能城市课程为例，解释学生如何通过整合设计、AI和领域知识学习生成式AI设计。

**关键词**：生成式人工智能, 无代码开发, 智能城市教育, 人机协作, AI素养, 设计思维

## 3 点简述
- 核心问题：学生常被动使用生成式AI输出，而非主动设计AI协作工具，需促进从工具使用到AI设计的转变。
- 方法要点：基于无代码智能城市课程，分析三个GPT项目，从设计、AI架构和领域知识三个维度构建Trilingual Triad框架。
- 实验或效果：研究发现，当设计、AI和领域知识协同作用时，能促进有效人机协作，增强AI素养、元认知和学习者能动性。
