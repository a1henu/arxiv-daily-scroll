...
**arXiv**：[2603.06321v1](https://arxiv.org/abs/2603.06321) · [PDF](https://arxiv.org/pdf/2603.06321.pdf)  
**作者**：Lixin Zhan, Jie Jiang, Tianjian Zhou, Yukun Du, Yan Zheng, Xuehu Duan  

**一句话要点**：提出P-SLCR方法，通过原型结构学习和一致性推理实现无监督点云语义分割

**关键词**：点云语义分割, 无监督学习, 原型学习, 结构学习, 一致性推理

## 3 点简述
- 核心问题：点云无监督语义分割缺乏标注和预训练，面临挑战
- 方法要点：采用一致性结构学习和语义关系一致性推理，构建原型库并保持语义一致性
- 实验或效果：在S3DIS等数据集上优于无监督方法，mIoU达47.1%，超越PointNet
