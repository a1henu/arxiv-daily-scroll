...
**关键词**：无人机预飞行规划, 多智能体路径规划, 动态空域管理, 冲突解决, 时间性禁飞区, 可扩展性

## 3 点简述
- 核心问题：大规模无人机机队在动态共享空域预飞行规划面临时间性禁飞区、异构车辆配置和严格交付期限等挑战。
- 方法要点：采用基于紧急度的任务优先级规划，结合SFIPP-ST单智能体规划器和迭代大邻域搜索进行冲突解决。
- 实验或效果：在含时间性禁飞区的基准测试中，支持多达1000架无人机，成功率近100%，运行时间减少达50%。
