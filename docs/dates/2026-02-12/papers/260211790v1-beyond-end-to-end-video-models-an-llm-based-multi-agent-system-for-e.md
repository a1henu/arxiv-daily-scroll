...
**一句话要点**：提出LAVES多智能体系统以解决教育视频生成中逻辑严谨性和知识准确性的问题

**关键词**：教育视频生成, 多智能体系统, LLM应用, 结构化视频脚本, 自动化生产

## 3 点简述
- 核心问题：现有端到端视频生成模型在需要严格逻辑和精确知识的教育场景中表现有限
- 方法要点：基于LLM的分层多智能体系统，分解生成流程为专门代理，通过质量门和迭代批判机制协调
- 实验或效果：在大规模部署中，日产量超百万视频，成本降低95%以上，保持高接受率
