...
**一句话要点**：提出RAM-Net以解决线性注意力中历史信息压缩导致表达力受限的问题

**关键词**：线性注意力, 内存网络, 长程依赖, 稀疏计算, 检索任务

## 3 点简述
- 核心问题：线性注意力将无限历史压缩到固定内存，导致信息丢失和表达力受限
- 方法要点：通过高维稀疏向量作为地址，选择性访问大规模内存状态，实现指数级状态扩展
- 实验或效果：在细粒度长程检索任务中超越基线，在语言建模和常识推理中表现竞争性
