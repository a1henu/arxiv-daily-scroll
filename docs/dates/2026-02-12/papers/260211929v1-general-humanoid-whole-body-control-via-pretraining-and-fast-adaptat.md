...
**关键词**：人形机器人控制, 快速适应, 全身运动跟踪, 平衡增强, 预训练策略

## 3 点简述
- 核心问题：人形机器人全身控制面临运动分布多样、快速适应难、高动态场景平衡挑战。
- 方法要点：引入Parseval引导残差策略适应，在正交与KL约束下学习轻量增量动作策略，提升适应效率与稳定性。
- 实验或效果：仿真与真实部署实验显示，FAST在鲁棒性、适应效率和泛化性上优于现有基线。
