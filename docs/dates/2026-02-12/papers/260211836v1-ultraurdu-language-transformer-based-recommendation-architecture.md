...
**一句话要点**：提出ULTRA框架，通过查询长度感知路由机制解决乌尔都语低资源新闻推荐中的语义匹配问题。

**关键词**：乌尔都语推荐, 查询长度感知路由, 双嵌入架构, 语义检索, 低资源语言, 变压器嵌入

## 3 点简述
- 核心问题：乌尔都语作为低资源语言，现有推荐系统依赖词汇匹配，难以捕捉语义意图，导致推荐相关性低。
- 方法要点：采用双嵌入架构，基于阈值决策将查询路由到标题级或全文级语义管道，优化语义粒度。
- 实验或效果：在大规模乌尔都语新闻语料上实验，相比单管道基线，精度提升超过90%，验证了查询自适应语义对齐的有效性。
