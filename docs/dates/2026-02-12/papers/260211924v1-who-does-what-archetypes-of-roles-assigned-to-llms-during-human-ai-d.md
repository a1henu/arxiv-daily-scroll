...
**arXiv**：[2602.11924v1](https://arxiv.org/abs/2602.11924) · [PDF](https://arxiv.org/pdf/2602.11924.pdf)  
**作者**：Shreya Chappidi, Jatinder Singh, Andra V. Krauze  

**一句话要点**：提出人-LLM原型概念以分析高风险决策中角色分配与交互模式

**关键词**：人机协作决策, LLM角色分配, 社会技术交互, 原型分析, 临床诊断评估

## 3 点简述
- 核心问题：人类与LLM在决策中角色分配的社会技术因素需反思
- 方法要点：通过文献综述定义17种人-LLM原型，描述交互模式
- 实验或效果：在临床诊断案例中评估原型对LLM输出和决策的影响
