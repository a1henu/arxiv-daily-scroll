...
**一句话要点**：提出FedGRPO框架，通过基于组相对奖励的强化学习评估，在联邦基础模型中实现隐私保护与高效通信。

**关键词**：联邦学习, 基础模型优化, 隐私保护, 强化学习评估, 通信效率, 组相对策略优化

## 3 点简述
- 核心问题：现有联邦基础模型方法存在高本地训练成本、通信开销和隐私风险。
- 方法要点：基于能力选择专家客户端，利用组相对概念聚合标量奖励信号，避免数据或模型更新交换。
- 实验或效果：在多样化领域任务中，FedGRPO在准确性和通信效率上优于传统基线。
