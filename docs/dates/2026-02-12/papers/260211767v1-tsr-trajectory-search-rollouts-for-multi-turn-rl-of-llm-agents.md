...
**关键词**：多轮强化学习, 轨迹搜索, 大语言模型智能体, 训练时优化, 树搜索方法, 性能提升

## 3 点简述
- 多轮强化学习面临奖励稀疏、环境随机性挑战，传统轨迹采样易导致模式崩溃。
- TSR在训练时进行轻量树搜索，基于任务反馈选择高分动作构建高质量轨迹，优化rollout生成。
- 结合PPO和GRPO，在Sokoban等任务上实现最高15%性能提升，学习更稳定，计算成本一次性增加。
