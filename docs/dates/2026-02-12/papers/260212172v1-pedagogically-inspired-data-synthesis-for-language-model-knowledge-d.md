...
**一句话要点**：提出基于教育原则的三阶段框架IOA，以提升大语言模型知识蒸馏的效果与效率。

**关键词**：知识蒸馏, 大语言模型, 教学原则, 数据合成, 渐进式学习, 模型压缩

## 3 点简述
- 核心问题：现有蒸馏方法缺乏教学意识，将知识转移视为一次性数据合成与训练任务。
- 方法要点：引入知识识别器、组织器和适配器三阶段，结合掌握学习原则和最近发展区理论，实现渐进式知识传递。
- 实验或效果：在LLaMA和Qwen2.5学生模型上，IOA显著优于基线方法，在复杂推理任务中提升达22.3%。
