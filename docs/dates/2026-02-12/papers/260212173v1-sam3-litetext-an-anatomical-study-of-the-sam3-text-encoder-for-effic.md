...
**一句话要点**：提出SAM3-LiteText，通过解剖分析优化文本编码器，实现高效视觉语言分割。

**关键词**：视觉语言分割, 文本编码器优化, 知识蒸馏, 轻量化模型, 分割提示分析

## 3 点简述
- 核心问题：SAM3等模型使用大型通用文本编码器处理短提示，导致计算和内存冗余。
- 方法要点：基于大规模提示分析，用知识蒸馏训练紧凑MobileCLIP学生模型替换原编码器。
- 实验或效果：在图像和视频分割基准上，参数减少达88%，性能接近原模型。
