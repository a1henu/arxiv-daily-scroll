...
**关键词**：差分隐私, 通信效率, 大语言模型推理, 随机量化, 软提示, 分割推理

## 3 点简述
- 核心问题：大语言模型本地部署受限，现有隐私保护方法通信与计算开销大
- 方法要点：嵌入投影与差分隐私随机量化降低通信开销，服务器端软提示补偿效用损失
- 实验或效果：在文本生成和自然语言理解基准测试中验证有效性，首次利用软提示优化隐私-效用权衡
