...
**关键词**：联邦学习, 梯度反演攻击, 模型可解释性, 频域分析, 隐私保护, 深度学习安全

## 3 点简述
- 核心问题：联邦学习梯度交换易受反演攻击，现有防御如差分隐私损害模型性能
- 方法要点：结合Grad-CAM和频域分析，选择性扰动高频成分以破坏图像重建细节
- 实验或效果：在基准数据集上，TIP使重建图像不可识别，同时保持模型精度优于差分隐私
