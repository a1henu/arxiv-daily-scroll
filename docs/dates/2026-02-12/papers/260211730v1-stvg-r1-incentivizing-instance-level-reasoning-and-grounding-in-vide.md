...
**一句话要点**：提出STVG-R1强化学习框架，通过视觉提示解决视频时空定位中的幻觉问题。

**关键词**：视频时空定位, 视觉语言模型, 强化学习, 视觉提示, 实例级识别, 零样本泛化

## 3 点简述
- 核心问题：视觉语言模型在视频时空定位中因文本与坐标错位导致幻觉，现有方法增加模块成本高。
- 方法要点：将坐标预测转为实例级识别，嵌入唯一ID作为视觉提示，并引入强化学习优化时空准确性与一致性。
- 实验或效果：在HCSTVG-v2基准上m_IoU提升20.9%，并在MeViS上零样本泛化达到SOTA 47.3% J&F。
