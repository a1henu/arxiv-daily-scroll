...
**关键词**：推理优化, 混合专家模型, 后训练架构搜索, KV缓存量化, 窗口注意力, 请求级效率

## 3 点简述
- 推理LLM生成长轨迹增加服务成本，需优化推理效率。
- 应用Puzzle框架进行后训练架构搜索，结合MoE剪枝、窗口注意力、FP8量化与强化学习。
- 在8XH100节点上实现最高1.63倍吞吐提升，请求级效率最高提升1.29倍，精度保持或略优。
