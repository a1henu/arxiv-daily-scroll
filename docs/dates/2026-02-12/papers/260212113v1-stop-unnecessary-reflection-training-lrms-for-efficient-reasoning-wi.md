...
**关键词**：大型推理模型, 自适应反思, 长度惩罚, 强化学习框架, 数学推理, 效率优化

## 3 点简述
- 核心问题：大型推理模型在复杂任务中生成过长思维链，包含不必要的反思，增加计算开销且不提升准确率
- 方法要点：ARLCP通过自适应反思惩罚和长度协调惩罚，动态平衡推理效率与准确性
- 实验或效果：在数学推理基准测试中，ARLCP显著减少响应长度并提高准确率，如1.5B模型长度减少53.1%，准确率提升5.8%
