...
**一句话要点**：提出LUVE框架，通过潜在空间级联与双频专家解决超高清视频生成中的运动建模与细节合成难题。

**关键词**：超高清视频生成, 潜在空间级联, 双频专家, 视频扩散模型, 运动建模, 细节合成

## 3 点简述
- 核心问题：超高清视频生成面临运动建模、语义规划和细节合成的复合挑战，现有方法难以兼顾。
- 方法要点：采用三阶段架构，包括低分辨率运动生成、潜在空间上采样和双频专家内容细化，以提升效率与质量。
- 实验或效果：实验显示LUVE在超高清视频生成中实现更优的真实感和内容保真度，消融研究验证了各组件有效性。
