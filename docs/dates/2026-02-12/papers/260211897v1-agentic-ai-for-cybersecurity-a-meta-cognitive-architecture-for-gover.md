...
**arXiv**：[2602.11897v1](https://arxiv.org/abs/2602.11897) · [PDF](https://arxiv.org/pdf/2602.11897.pdf)  
**作者**：Andrei Kojukhov, Arkady Bovshover  

**一句话要点**：提出基于元认知判断的智能体架构，以治理网络安全中的不确定性自主决策。

**关键词**：网络安全, 多智能体系统, 元认知, 自主决策治理, 负责任AI

## 3 点简述
- 核心问题：现有AI网络安全系统在对抗性不确定性下难以支持可问责的决策，缺乏治理机制。
- 方法要点：引入多智能体认知框架，通过元认知判断函数协调检测、解释和治理等异构智能体。
- 实验或效果：未知，论文为概念性框架，未报告具体实验或性能指标。
