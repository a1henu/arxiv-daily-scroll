...
**关键词**：测试时缩放, 多步代理, 动态计算分配, 不确定性估计, 网络代理, 投票聚合

## 3 点简述
- 核心问题：测试时缩放在多步代理任务中，均匀增加计算易饱和，小误差累积影响长视野性能
- 方法要点：基于投票分布的不确定性（如熵和top-1/top-2边际）动态分配计算，仅在决策有争议时增加资源
- 实验或效果：在WebArena-Lite和GoBrowse上，CATTS比React性能提升达9.1%，同时减少最多2.3倍令牌使用
