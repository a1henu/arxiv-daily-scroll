...
**一句话要点**：提出基准健康指数以系统评估大语言模型基准的可靠性

**关键词**：基准评估, 大语言模型, 数据驱动框架, 能力区分, 抗饱和性, 影响力量化

## 3 点简述
- 核心问题：大语言模型基准因分数膨胀和选择性报告而不可靠，影响评估可信度。
- 方法要点：基于数据驱动框架，从能力区分、抗饱和性和影响力三个正交维度量化基准健康。
- 实验或效果：分析2025年91个代表模型的106个基准，系统刻画评估格局，支持基准选择和生命周期管理。
