...
**一句话要点**：分析小批量随机最陡下降的隐式偏差，揭示动量与方差缩减对极限最大边距行为的影响

**关键词**：隐式偏差, 随机最陡下降, 动量优化, 方差缩减, 最大边距分类, 收敛分析

## 3 点简述
- 研究多类分类中小批量随机最陡下降的隐式偏差，关注批量大小、动量和方差缩减的作用
- 证明无动量时仅大批量收敛，动量通过批量-动量权衡实现小批量收敛但减慢速度
- 方差缩减可恢复全批量隐式偏差，但收敛率较慢，并通过数据示例揭示无动量单批量更新的局限性
