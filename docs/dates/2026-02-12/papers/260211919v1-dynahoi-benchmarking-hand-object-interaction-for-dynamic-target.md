...
**一句话要点**：提出DynaHOI基准测试平台以解决动态手-物交互场景的评估空白

**关键词**：手-物交互, 动态目标, 基准测试, 运动生成, 在线评估, 大规模数据集

## 3 点简述
- 现有手-物交互基准多关注静态对象，缺乏动态目标移动和时间协调的测试
- 引入DynaHOI-Gym在线闭环平台，集成参数化运动生成器和基于rollout的评估指标
- 发布DynaHOI-10M大规模数据集，包含10M帧和180K轨迹，并展示ObAct基线方法提升8.1%成功率
