...
**arXiv**：[2602.12196v1](https://arxiv.org/abs/2602.12196) · [PDF](https://arxiv.org/pdf/2602.12196.pdf)  
...
**一句话要点**：提出视觉推理基准以评估多模态大语言模型在小学课堂真实视觉问题上的能力

**关键词**：视觉推理基准, 多模态大语言模型评估, 小学教育, 空间推理, 真实视觉问题

## 3 点简述
- 核心问题：AI模型在空间和关系结构推理上存在瓶颈，尤其在依赖视觉的小学数学中。
- 方法要点：基于赞比亚和印度小学考试的701个问题构建基准，使用未编辑图像测试模型。
- 实验或效果：模型在静态技能上表现较好，但在动态操作如折叠和旋转上存在空间天花板。
