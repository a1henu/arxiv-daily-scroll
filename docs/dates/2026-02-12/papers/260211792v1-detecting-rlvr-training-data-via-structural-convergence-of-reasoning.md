...
**一句话要点**：提出Min-$k$NN距离方法以检测RLVR训练数据，基于推理结构收敛性

**关键词**：强化学习可验证奖励, 训练数据检测, 推理模型, 黑盒检测, 基准污染, 编辑距离

## 3 点简述
- 核心问题：RLVR训练数据未公开，导致基准污染检测困难，传统基于概率的方法失效
- 方法要点：利用RLVR诱导的生成行为特征，通过采样补全计算最小k近邻编辑距离作为黑盒检测器
