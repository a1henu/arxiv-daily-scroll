...
**一句话要点**：提出多LLM模块化流水线以解决农业仿真环境生成中领域推理、验证和可扩展性问题

**关键词**：LLM驱动3D生成, 农业仿真环境, 模块化流水线, 领域知识注入, Unreal引擎集成, 检索增强生成

## 3 点简述
- 核心问题：现有LLM驱动3D场景生成缺乏领域推理、验证机制和模块化设计，导致控制力弱和可扩展性差
- 方法要点：开发模块化多LLM流水线，集成3D资产检索、领域知识注入和Unreal引擎代码生成，采用few-shot提示、RAG等优化技术
