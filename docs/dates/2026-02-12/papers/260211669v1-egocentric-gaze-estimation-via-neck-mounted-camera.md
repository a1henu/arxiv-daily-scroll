...
**一句话要点**：提出基于颈戴相机的自我中心视线估计新任务，通过Transformer模型和辅助任务提升性能。

**关键词**：自我中心视线估计, 颈戴相机, Transformer模型, 视线越界分类, 多视角协同学习, 数据集收集

## 3 点简述
- 核心问题：现有自我中心视线估计主要基于头戴相机，颈戴视角未被充分探索，缺乏相关数据集。
- 方法要点：收集首个颈戴视角数据集，评估Transformer模型GLC，并引入视线越界分类和多视角协同学习扩展。
- 实验或效果：视线越界分类提升性能，但多视角协同学习未带来增益，分析结果并讨论颈戴视线估计的启示。
