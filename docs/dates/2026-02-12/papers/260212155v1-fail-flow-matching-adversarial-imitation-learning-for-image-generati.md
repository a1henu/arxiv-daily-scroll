...
**一句话要点**：提出FAIL框架，通过对抗模仿学习微调流匹配模型以提升图像生成质量

**关键词**：流匹配模型, 对抗模仿学习, 图像生成, 后训练优化, 策略漂移, 奖励黑客缓解

## 3 点简述
- 核心问题：流匹配模型后训练需对齐高质量目标分布，但监督微调无法纠正未见状态下的策略漂移
- 方法要点：FAIL通过对抗训练最小化策略与专家分布差异，无需显式奖励或成对比较，提供FAIL-PD和FAIL-PG两种算法
- 实验或效果：使用13,000个演示微调FLUX模型，在提示跟随和美学基准上取得竞争性性能，并推广到离散图像和视频生成
