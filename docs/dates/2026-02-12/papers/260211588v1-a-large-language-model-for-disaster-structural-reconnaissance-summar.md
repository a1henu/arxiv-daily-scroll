...
**一句话要点**：提出基于大语言模型的灾害结构侦察摘要框架，以提升灾后快速侦察效率

**关键词**：灾害结构侦察, 大语言模型, 视觉结构健康监测, 深度卷积神经网络, 摘要生成

## 3 点简述
- 问题：现有视觉结构健康监测仅输出离散损伤标签，需人工整合分析，效率低。
- 方法：结合标准侦察计划，整合文本元数据和图像数据，用深度卷积网络提取关键属性，再输入大语言模型生成摘要报告。
- 效果：实验表明该框架在灾后快速侦察中展现潜力，有助于提升建筑环境韧性。
