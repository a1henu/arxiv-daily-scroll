...
**关键词**：线性循环网络, 状态混合, 序列建模, 计算效率, 表达力提升, 结构化架构

## 3 点简述
- 线性循环网络因对角状态转移限制表达力，而密集或非线性架构计算成本高。
- 引入高阶线性循环单元和块对角线性循环单元，通过结构化状态混合增强表达力，同时保持训练稳定性和计算效率。
- 在合成序列建模和语言建模任务中，块对角线性循环单元性能优于或匹配现有基线，高阶线性循环单元在压缩任务中参数效率最高。
