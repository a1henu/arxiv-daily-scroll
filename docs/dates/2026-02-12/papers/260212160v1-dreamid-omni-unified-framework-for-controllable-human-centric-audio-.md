...
**关键词**：人中心音视频生成, 条件扩散模型, 身份-音色解耦, 多任务训练, 对称条件注入, 音频驱动动画

## 3 点简述
- 核心问题：现有方法将人中心音视频生成任务孤立处理，且多人物场景中身份与音色绑定易失败。
- 方法要点：设计对称条件扩散Transformer和双级解耦策略，实现异构信号集成与精确属性控制。
- 实验或效果：在视频、音频及音视频一致性上达到全面SOTA，超越领先商业模型。
