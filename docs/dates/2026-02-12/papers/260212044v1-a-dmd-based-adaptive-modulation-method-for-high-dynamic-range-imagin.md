...
**arXiv**：[2602.12044v1](https://arxiv.org/abs/2602.12044) · [PDF](https://arxiv.org/pdf/2602.12044.pdf)  
**作者**：Banglei Guan, Jing Tao, Liang Xu, Dongcai Tan, Pengju Sun, Jianbing Liu, Yang Shang, Qifeng Yu  

**一句话要点**：提出基于DMD的自适应调制方法，以解决高光环境下高动态范围成像问题。

**关键词**：高动态范围成像, 数字微镜器件, 自适应调制, 光学计量, 数字图像相关, 高光环境
