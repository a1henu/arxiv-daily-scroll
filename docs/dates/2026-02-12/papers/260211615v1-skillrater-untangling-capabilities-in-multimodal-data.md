...
**一句话要点**：提出SkillRater框架，通过多维能力分解提升多模态数据筛选效果

**关键词**：多模态数据筛选, 能力分解, 元学习, 视觉语言模型, 渐进选择

## 3 点简述
- 核心问题：传统数据筛选使用单一质量评分，无法同时优化模型所需的多项能力
- 方法要点：为每项能力训练专用评分器，通过渐进选择规则组合评分，早期保留多样性，后期聚焦高价值样本
- 实验或效果：在视觉语言模型中验证，分解为视觉理解、OCR和STEM推理能力，在2B参数模型上显著提升基准性能
