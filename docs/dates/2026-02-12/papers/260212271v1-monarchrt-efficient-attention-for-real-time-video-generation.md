...
**关键词**：实时视频生成, 注意力机制, 结构化参数化, 计算优化, 扩散变换器, 稀疏注意力

## 3 点简述
- 核心问题：实时视频生成中，3D自注意力的二次计算成本成为瓶颈，尤其在少步和自回归场景下，误差随时间累积。
- 方法要点：基于Monarch矩阵因子化注意力，通过块结构对齐和扩展平铺参数化，在保持计算效率的同时提高表达能力。
- 实验或效果：在Self-Forcing模型上实现高达95%的注意力稀疏性且无质量损失，优化内核在多种GPU上比FlashAttention快1.4-11.8倍，单RTX 5090实现16 FPS实时生成。
