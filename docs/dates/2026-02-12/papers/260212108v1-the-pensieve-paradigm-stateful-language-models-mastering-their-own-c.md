...
**一句话要点**：提出StateLM状态语言模型，通过内部推理循环管理自身状态以解决固定上下文窗口限制问题。

**关键词**：状态语言模型, 上下文管理, 长文档问答, 记忆工具, 内部推理循环, 主动状态控制

## 3 点简述
- 核心问题：现有语言模型缺乏主动管理上下文的能力，受限于固定窗口，无法动态调整记忆。
- 方法要点：引入内部推理循环，配备上下文修剪、文档索引等记忆工具，训练模型主动管理状态。
- 实验或效果：在长文档问答、聊天记忆和深度研究任务中，StateLM显著优于标准LLM，准确率提升最高达52%。
