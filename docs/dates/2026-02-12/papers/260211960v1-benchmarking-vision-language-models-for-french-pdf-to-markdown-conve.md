...
**关键词**：PDF转Markdown, 视觉语言模型, 法语文档解析, 基准评估, 复杂布局处理

## 3 点简述
- 核心问题：现有基准多关注英语或中文，对法语文档转换中的布局和格式错误评估不足
- 方法要点：通过模型分歧采样构建法语困难页面基准，包含手写表单和复杂表格
- 实验或效果：评估15个模型，专有模型在手写和表单上更稳健，开源模型在标准布局上具竞争力
