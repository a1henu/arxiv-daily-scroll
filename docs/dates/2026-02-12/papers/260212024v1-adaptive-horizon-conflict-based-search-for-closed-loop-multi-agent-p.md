...
**一句话要点**：提出ACCBS算法以解决闭环多智能体路径规划中扰动处理与性能保证的平衡问题

**关键词**：多智能体路径规划, 闭环规划, 冲突搜索, 时域调整, 渐近最优, 机器人部署

## 3 点简述
- 核心问题：现有开环规划器难以处理扰动，闭环启发式方法缺乏可靠性能保证，限制安全关键部署
- 方法要点：基于有限时域CBS，引入时域调整机制，重用约束树实现时域间无缝切换，动态适应计算预算
- 实验或效果：在案例研究中展示对扰动的灵活性和强性能保证，实现渐近最优和随时行为，提升大规模机器人部署的鲁棒性
