...
**一句话要点**：提出可微分模态逻辑框架，通过行为数据学习多智能体系统中的信任网络与因果链以实现神经符号调试

**关键词**：可微分模态逻辑, 神经符号调试, 多智能体系统, 模态逻辑神经网络, 知识推理

## 3 点简述
- 核心问题：多智能体系统语义故障调试需推理知识、信念等模态逻辑关系，但传统方法需手动指定未知或动态的关系结构
- 方法要点：通过模态逻辑神经网络实现可微分模态逻辑，从行为数据自动学习信任网络、因果链等关系结构
- 实验或效果：在具体多智能体场景中演示四种模态推理，包括外交游戏中的欺骗联盟检测和LLM幻觉识别
