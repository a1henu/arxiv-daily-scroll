...
**关键词**：边缘计算, 恶意软件检测, 持续学习, LoRA适配器, 参数高效微调, 轻量级Transformer

## 3 点简述
- 边缘设备恶意软件检测面临资源限制和威胁演化挑战，静态或孤立模型性能下降
- 采用LoRA适配器实现本地增量微调和全局知识共享，避免原始数据交换
- 在公开数据集上评估，LoRA交换提升跨域攻击检测准确率20-25%，模型大小增加小于1%
