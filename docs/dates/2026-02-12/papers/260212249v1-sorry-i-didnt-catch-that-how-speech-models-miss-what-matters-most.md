...
**关键词**：语音识别, 高风险转录, 合成数据生成, 微调优化, 命名实体转录

## 3 点简述
- 核心问题：语音识别系统在标准基准上表现良好，但在真实高风险短语音转录中错误率高，如美国街道名称转录错误率达44%
- 方法要点：使用开源文本转语音模型生成多样化的命名实体发音合成数据，用于微调模型
- 实验或效果：微调少于1000个合成样本，非英语母语者的街道名称转录准确率相对提升近60%
