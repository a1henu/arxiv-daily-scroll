...
**一句话要点**：量化Gemini Flash 2.5和GPT Image 1.5在性别与肤色上的偏见，揭示中性提示的默认偏差

**关键词**：图像生成偏见, 肤色量化, 中性提示分析, 算法审计, 视觉文化研究

## 3 点简述
- 研究量化了Gemini Flash 2.5和GPT Image 1.5图像生成器中的性别与肤色偏见，挑战中性提示产生中性输出的假设
- 采用混合颜色归一化、面部地标掩码和感知均匀肤色量化方法，分析3200张真实感图像
- 结果显示模型存在强烈默认白人偏见，但性别偏好相反：Gemini偏向女性，GPT偏向浅肤色男性
