...
**一句话要点**：通过高斯过程框架量化大语言模型在上下文中的函数学习能力与归纳偏好

**关键词**：上下文学习, 高斯过程, 函数学习, 归纳偏好, 大语言模型, 样本效率

## 3 点简述
- 研究大语言模型在推理时通过少量演示学习函数的能力，以高斯过程为理论框架构建受控实验。
- 评估模型预测误差随演示数量变化，并与高斯过程回归下界和1-最近邻上界比较，分析模型学习曲线。
- 使用似然分析探究模型归纳偏好，并通过强化学习和监督微调调整偏好以提高样本效率。
