...
**一句话要点**：提出ANML框架，通过质量加权训练提升专家数据场景下的模型性能与可追溯性。

**关键词**：质量加权训练, 数据溯源, 模型鲁棒性, 梯度一致性, 贡献者声誉

## 3 点简述
- 核心问题：当前训练管道平等对待所有样本，忽略专家数据质量差异。
- 方法要点：基于梯度一致性、验证状态、贡献者声誉和时间相关性加权样本。
- 实验或效果：在5个数据集上误差降低33-72%，质量加权训练数据效率高。
