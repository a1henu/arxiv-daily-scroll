...
**一句话要点**：提出对象对齐视觉对比解码以缓解多模态大语言模型中的物体幻觉问题

**关键词**：物体幻觉, 多模态大语言模型, 视觉对比解码, 对象对齐, 自监督视觉Transformer, 计算效率

## 3 点简述
- 核心问题：多模态大语言模型在视觉语言任务中易产生物体幻觉，即生成未在图像中出现的物体描述。
- 方法要点：利用自监督视觉Transformer的对象中心注意力，移除最显著视觉证据构建辅助视图，增强对比解码信号以抑制幻觉。
- 实验或效果：在两个流行物体幻觉基准上对两种MLLMs测试，方法一致提升性能，且无需额外提示、模型无关、计算开销低。
