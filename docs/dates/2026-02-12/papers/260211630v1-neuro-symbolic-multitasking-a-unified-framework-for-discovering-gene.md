...
**一句话要点**：提出神经辅助多任务符号PDE求解框架NMIPS，以解决PDE族求解中计算成本高和缺乏解析表达式的问题。

**关键词**：偏微分方程求解, 神经符号计算, 多任务学习, 解析解发现, 仿射转移, 可解释性

## 3 点简述
- 核心问题：传统数值方法需独立求解PDE族中每个实例，计算成本高；机器学习方法缺乏解析表达式，可解释性不足。
- 方法要点：采用多因子优化同时发现PDE的解析解，设计仿射转移方法在PDE族间转移学习到的数学结构以提高效率。
- 实验或效果：在多个案例中相比基线实现精度提升约35.7%，并提供可解释的解析解。
