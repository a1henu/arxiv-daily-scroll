...
**一句话要点**：提出神经辅助多任务符号PDE求解框架NMIPS，以高效发现偏微分方程族的解析解。

**关键词**：偏微分方程求解, 神经符号计算, 多任务学习, 解析解发现, 仿射转移, 可解释AI

## 3 点简述
- 核心问题：传统数值方法求解PDE族计算成本高，机器学习方法缺乏解析解的直观性。
- 方法要点：采用多因子优化同时发现解析解，设计仿射转移方法共享数学结构提升效率。
- 实验或效果：在多个案例中相比基线提升精度达约35.7%，并提供可解释的解析解。
