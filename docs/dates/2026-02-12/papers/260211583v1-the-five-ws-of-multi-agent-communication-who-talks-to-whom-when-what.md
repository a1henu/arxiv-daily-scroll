...
**一句话要点**：综述多智能体通信的五个维度，连接MARL、涌现语言与LLMs研究，以支持可扩展协作设计

**关键词**：多智能体通信, 多智能体强化学习, 涌现语言, 大型语言模型, 协作AI, 可解释性

## 3 点简述
- 核心问题：动态部分可观测环境中，多智能体通信如何减少不确定性并促进协作
- 方法要点：通过谁、与谁、何时、什么、为什么五个维度，分析MARL、涌现语言和LLMs的通信设计演变
- 实验或效果：提炼设计模式与开放挑战，为结合学习、语言和控制的混合系统提供指导
