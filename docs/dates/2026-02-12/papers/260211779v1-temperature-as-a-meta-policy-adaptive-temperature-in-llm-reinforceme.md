...
**一句话要点**：提出TAMPO框架，将温度控制作为可学习元策略，以优化LLM强化学习中的自适应探索。

**关键词**：温度控制, 元策略优化, LLM强化学习, 自适应探索, 数学推理

## 3 点简述
- 核心问题：静态或启发式温度调度在LLM强化学习中难以适应动态训练需求，限制策略改进。
- 方法要点：TAMPO通过双层循环，内环更新LLM策略，外环基于高优势轨迹奖励更新温度分布，实现在线自适应。
- 实验或效果：在五个数学推理基准上，TAMPO优于固定或启发式温度基线，验证了温度作为元策略的有效性。
