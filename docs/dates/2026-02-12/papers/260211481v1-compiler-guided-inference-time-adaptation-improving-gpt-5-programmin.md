...
**一句话要点**：提出编译器引导的推理时适应方法，以提升GPT-5在Idris编程中的性能

**关键词**：推理时适应, 编译器反馈, 低资源编程语言, 迭代提示, GPT-5, Idris

## 3 点简述
- 核心问题：GPT-5在低资源语言Idris中表现不佳，零样本提示仅解决22/56练习
- 方法要点：通过迭代提示结合本地编译错误反馈，进行结构化推理时适应
- 实验或效果：使用错误引导循环后，GPT-5解决54/56问题，性能显著提升
