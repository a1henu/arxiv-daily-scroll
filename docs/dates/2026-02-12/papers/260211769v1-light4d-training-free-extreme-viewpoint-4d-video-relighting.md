...
**一句话要点**：提出Light4D训练免费框架，实现极端视角下4D视频重照明的时域一致性

**关键词**：4D视频重照明, 训练免费框架, 时域一致性, 极端视角处理, 扩散模型应用

## 3 点简述
- 核心问题：4D重照明缺乏配对训练数据，极端视角下难以保持时域一致性
- 方法要点：引入解耦流引导注入光照控制，结合时域一致注意力消除闪烁
- 实验效果：在-90°至90°相机旋转下，实现竞争性的时域一致性与光照保真度
