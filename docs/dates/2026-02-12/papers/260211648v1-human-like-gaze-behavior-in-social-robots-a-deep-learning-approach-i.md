...
**一句话要点**：提出集成人类与非人类刺激的深度学习模型，以提升社交机器人动态模仿人类注视行为的能力。

**关键词**：社交机器人, 注视行为预测, 深度学习, 非人类刺激, 虚拟现实数据收集, 人机交互

## 3 点简述
- 核心问题：社交机器人需在包含人类与非人类刺激的复杂情境中，实现类人注视行为以增强沟通效果。
- 方法要点：使用LSTM和Transformer神经网络，基于VR收集的注视数据，预测注视方向。
