...
**一句话要点**：提出CMAB-GFN，结合组合多臂老虎机与生成流网络，以加速高奖励候选解发现。

**关键词**：生成流网络, 组合多臂老虎机, 高奖励子空间, 探索优化, 概率采样, 组合对象生成

## 3 点简述
- 核心问题：生成流网络在广阔状态空间中过度探索，导致低奖励区域过采样和收敛至次优分布。
- 方法要点：集成组合多臂老虎机框架，剪枝低质量动作，限制探索于紧凑高奖励子空间。
- 实验或效果：在多个任务中，CMAB-GFN生成比现有方法更高奖励的候选解，且不牺牲多样性。
