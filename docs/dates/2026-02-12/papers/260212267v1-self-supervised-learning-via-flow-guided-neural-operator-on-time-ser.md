...
**一句话要点**：提出流引导神经算子框架，通过动态噪声水平增强时间序列自监督学习性能

**关键词**：自监督学习, 时间序列分析, 神经算子, 流匹配, 生物医学信号处理, 特征提取

## 3 点简述
- 核心问题：传统自监督方法如掩码自编码器使用固定掩码比，限制了表示学习的灵活性。
- 方法要点：结合算子学习与流匹配，利用短时傅里叶变换统一时间分辨率，从不同网络层和噪声强度提取多层次特征。
- 实验或效果：在生物医学时间序列任务中，显著提升AUROC、RMSE和准确率，尤其在低数据场景下表现稳健。
