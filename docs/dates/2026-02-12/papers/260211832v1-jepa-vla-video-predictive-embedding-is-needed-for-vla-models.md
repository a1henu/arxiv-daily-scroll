...
**关键词**：视觉-语言-动作模型, 视频预测嵌入, 样本效率, 泛化能力, 机器人操作, 视觉表示学习

## 3 点简述
- 核心问题：现有VLA模型因视觉表示不足，导致样本效率低和泛化受限
- 方法要点：自适应集成视频预测嵌入V-JEPA 2，以编码任务相关动态并丢弃不可预测因素
- 实验或效果：在LIBERO等基准和真实机器人任务中实现显著性能提升
