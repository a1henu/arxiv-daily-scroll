...
**关键词**：大模型安全, 安全评估, 安全诊断, 开源工具包, 白盒分析, 风险评估

## 3 点简述
- 核心问题：大模型安全评估、诊断和对齐工具分离，导致评估仅定位外部风险，诊断脱离具体场景，对齐缺乏内部机制解释。
- 方法要点：通过统一任务和数据协议，连接评估与诊断阶段，实现从黑盒到白盒的安全洞察，包含评估工具DeepSafe和诊断工具DeepScan。
- 实验或效果：项目低成本、可复现、高效且高度可扩展，是首个支持前沿AI风险评估及联合安全评估与诊断的开源工具包。
