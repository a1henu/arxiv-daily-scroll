...
**关键词**：参数高效微调, 激活空间微调, 条件计算, 神经元门控, 模式切换, 可解释性

## 3 点简述
- 核心问题：权重空间参数高效微调方法如LoRA难以解释机制，且不直接揭示内部计算重用情况
- 方法要点：冻结基础权重，学习神经元阈值和增益，通过平滑门控选择激活参与，实现条件计算
- 实验或效果：在MNIST旋转任务中，Dopamine以少量参数提升准确率，相比LoRA参数更少且机制更可解释
