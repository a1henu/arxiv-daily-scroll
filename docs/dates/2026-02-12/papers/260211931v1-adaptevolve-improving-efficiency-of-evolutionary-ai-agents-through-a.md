...
**关键词**：进化代理系统, 自适应模型选择, 大语言模型, 推理效率, 置信度估计

## 3 点简述
- 核心问题：进化代理系统在推理中反复调用大语言模型，导致计算效率与推理能力间的权衡加剧
- 方法要点：在进化顺序精炼框架中，利用内在生成置信度估计实时可解性，动态选择LLM
- 实验或效果：置信度驱动选择在基准测试中平均减少37.9%推理成本，保持97.5%静态大模型基线准确率
