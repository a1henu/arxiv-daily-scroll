...
**一句话要点**：提出方差最小化策略优化以改进扩散对齐，超越KL散度目标。

**关键词**：扩散对齐, 方差最小化, 策略优化, 序列蒙特卡洛, 重要性采样

## 3 点简述
- 核心问题：扩散对齐中KL目标可能限制优化效率与多样性。
- 方法要点：基于序列蒙特卡洛视角，最小化重要性权重方差作为新目标。
- 实验或效果：理论证明方差目标与KL梯度一致，统一现有方法并启发新设计。
