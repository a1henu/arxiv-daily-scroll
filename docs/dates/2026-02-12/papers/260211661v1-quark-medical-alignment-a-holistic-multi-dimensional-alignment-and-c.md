...
**关键词**：医疗问答对齐, 多目标优化, 强化学习, 参考冻结归一化, 自适应动态加权

## 3 点简述
- 核心问题：医疗问答中传统强化学习对齐方法存在成本高、验证难和多目标冲突问题
- 方法要点：构建多维度对齐矩阵，结合参考冻结归一化和三因子自适应动态加权实现协同优化
- 实验或效果：在真实医疗场景评估中验证了有效性，为垂直领域复杂对齐建立新范式
