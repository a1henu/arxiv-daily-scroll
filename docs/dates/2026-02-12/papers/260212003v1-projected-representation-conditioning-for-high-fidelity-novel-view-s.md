...
**一句话要点**：提出ReNoV框架，利用外部表示条件提升扩散模型的新视角合成几何一致性

**关键词**：新视角合成, 扩散模型, 几何一致性, 表示条件, 注意力对应性, 图像生成

## 3 点简述
- 核心问题：扩散模型在新视角合成中几何一致性不足，影响生成质量
- 方法要点：分析外部表示的空间注意力对应性，设计投影模块注入扩散过程
- 实验或效果：在标准基准上超越先前方法，提升重建保真度和修复质量
