...
**关键词**：人形机器人控制, 动态感知世界模型, 欠驱动物体交互, 本体感知预测, 鲁棒状态估计, 多物体任务

## 3 点简述
- 核心问题：现有方法忽略欠驱动物体的独立动力学和非完整约束，导致耦合力和遮挡下的控制挑战。
- 方法要点：基于本体感知历史预测高阶物体状态，结合几何先验构建动态占用地图，支持策略推断碰撞边界和接触可能性。
- 实验效果：在人形机器人上实现高成功率敏捷任务（如滑板、推拉车）和多物体长时程任务（如搬运箱子）。
