...
**一句话要点**：提出动量最小均方算法理论，分析其在非平稳流数据中的稳定性、跟踪性能和遗憾界

**关键词**：动量最小均方算法, 非平稳流数据, 自适应识别, 时变系统, 在线学习, 稳定性分析

## 3 点简述
- 研究非平稳流数据中分布漂移和时变参数对自适应识别的挑战
- 理论推导动量最小均方算法在时变随机线性系统中的跟踪性能和遗憾界
- 实验验证算法在合成和真实数据流中快速适应和稳健跟踪
