...
**一句话要点**：提出基于度量空间的多模态状态估计方法以解决强化学习中高维噪声观测的挑战

**关键词**：强化学习, 状态估计, 度量空间, 多模态融合, 噪声鲁棒性, 潜在表示

## 3 点简述
- 核心问题：强化学习中高维多模态噪声观测导致状态估计困难，传统概率模型依赖显式噪声假设限制泛化
- 方法要点：学习结构化潜在表示，构建度量空间使状态距离与动作转换数相关，无需显式概率建模
- 实验或效果：在多模态RL任务中验证，相比基线方法提升噪声鲁棒性和状态估计性能，增强RL智能体表现
