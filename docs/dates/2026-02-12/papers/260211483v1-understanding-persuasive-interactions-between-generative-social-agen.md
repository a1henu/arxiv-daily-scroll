...
**arXiv**：[2602.11483v1](https://arxiv.org/abs/2602.11483) · [PDF](https://arxiv.org/pdf/2602.11483.pdf)  
**作者**：Stephan Vonschallen, Friederike Eyssel, Theresa Schmiedel  

**一句话要点**：提出知识驱动说服模型（KPM）以研究生成式社交代理与人类间的说服性交互

**关键词**：生成式社交代理, 说服模型, 人机交互, 知识驱动, 伦理标准, 用户福祉

## 3 点简述
- 核心问题：缺乏生成式社交代理（GSA）交互的理论框架和影响用户态度行为的研究指南
- 方法要点：KPM基于代理的自我、用户和上下文知识驱动说服行为，塑造人类响应
- 实验或效果：模型整合现有研究，支持开发负责任GSA，应用于医疗和教育等领域
