...
**一句话要点**：提出非侵入性评估协议PhyIP，以解决自适应评估在物理世界模型中的观测者效应问题。

**关键词**：世界模型评估, 自监督学习, 物理定律内部化, 线性解码, 观测者效应, 非侵入性协议

## 3 点简述
- 核心问题：自适应评估可能改变自监督学习表示，混淆物理定律的内部化程度。
- 方法要点：基于线性表示假设，从冻结表示中线性解码物理量，实现非侵入性评估。
- 实验或效果：在流体动力学和轨道力学中，PhyIP在OOD测试中恢复物理结构，而自适应评估则破坏结构。
