...
**关键词**：LLM代理安全, 事故响应框架, 自主系统, 语义检测, 规则合成, 安全机制

## 3 点简述
- 核心问题：现有LLM代理安全机制主要关注事前预防，缺乏事故后的响应、遏制和恢复能力
- 方法要点：定义领域特定语言，集成到代理执行循环中，实现检测、遏制、恢复和规则合成
- 实验或效果：在三种代理类型上评估，检测、修复和根除成功率均超过90%，规则生成接近开发者水平
