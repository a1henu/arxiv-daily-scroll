...
**关键词**：TLA+模型检查, 可视化工具, 大语言模型应用, 模型修复, 交互式调试, 状态图优化

## 3 点简述
- 核心问题：TLA+模型检查中反例解释困难、状态图理解复杂、模型修复手动成本高，现有工具可扩展性和可解释性有限
- 方法要点：集成可视化、图优化、模型摘要与修复功能，利用LLM生成解释，提供交互式工作流
- 实验或效果：工具将原始输出转化为可解释流程，提升理解并减少调试努力，支持非平凡规格
