...
**一句话要点**：提出注意力课程学习框架以解决异构无人机集群协同路径规划问题

**关键词**：异构无人机集群, 多智能体强化学习, 注意力机制, 课程学习, 路径规划, 经验回放

## 3 点简述
- 核心问题：异构无人机集群协同路径规划中，存在非对称依赖、稀疏奖励和灾难性遗忘等挑战。
- 方法要点：引入角色感知异构注意力机制建模非对称依赖，设计结构化课程策略整合知识迁移和经验回放。
- 实验或效果：在自定义多智能体仿真平台上验证，在成功率、队形保持率和任务时间加权指标上优于先进方法。
