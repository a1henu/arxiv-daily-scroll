...
**arXiv**：[2602.12089v1](https://arxiv.org/abs/2602.12089) · [PDF](https://arxiv.org/pdf/2602.12089.pdf)  
**作者**：Kehang Zhu, Lithium Thain, Vivian Tsai, James Wexler, Crystal Qian  

**一句话要点**：提出三种AI辅助模式在多方谈判中的实验，揭示偏好与绩效错位及委托模式的正外部性。

**关键词**：多方谈判, AI辅助模式, 偏好绩效错位, 委托代理, 在线行为实验, LLM应用

## 3 点简述
- 研究AI在社交场景中的代理-用户交互，关注多方谈判中不同辅助模式的影响。
- 通过在线行为实验比较顾问、教练和委托三种LLM辅助模式，参与者随机接触单一模式。
- 发现参与者偏好顾问但委托模式带来最高个人收益，委托作为做市商改善交易环境。
