...
**关键词**：流式自动语音识别, 低延迟推理, 滑动窗口自注意力, 边缘设备ASR, 实时语音应用

## 3 点简述
- 核心问题：全注意力Transformer编码器在流式ASR中导致延迟随话语长度线性增长，影响实时性。
- 方法要点：采用滑动窗口自注意力，实现有界低延迟推理，同时保持强局部上下文。
- 实验或效果：在标准基准上达到SOTA词错误率，精度与6倍大小模型相当，运行速度显著更快。
