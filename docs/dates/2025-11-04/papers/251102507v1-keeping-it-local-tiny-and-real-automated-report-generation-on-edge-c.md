...
**arXiv**：[2511.02507v1](https://arxiv.org/abs/2511.02507) · [PDF](https://arxiv.org/pdf/2511.02507.pdf)  
**作者**：Nicolas Schuler, Lea Dewald, Jürgen Graf  

**一句话要点**：提出基于边缘计算的自动化报告生成管道，用于移动机器人系统评估。

**关键词**：自动化报告生成, 边缘计算, 移动机器人, 多模态传感器, 隐私保护

## 3 点简述
- 核心问题：移动机器人系统在关键任务中需评估大量异构数据，以促进系统接受度。
- 方法要点：利用多模态传感器和本地模型，在边缘设备上生成自然语言报告，保护隐私。
- 实验或效果：在室内、室外和城市环境数据集上评估，提供定量和定性结果。
