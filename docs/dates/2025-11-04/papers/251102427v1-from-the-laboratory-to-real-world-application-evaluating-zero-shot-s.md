...
**arXiv**：[2511.02427v1](https://arxiv.org/abs/2511.02427) · [PDF](https://arxiv.org/pdf/2511.02427.pdf)  
**作者**：Nicolas Schuler, Lea Dewald, Nick Baldig, Jürgen Graf  

**一句话要点**：评估小型视觉语言模型在移动机器人边缘设备上的零样本场景解释能力

**关键词**：视觉语言模型, 零样本学习, 边缘计算, 移动机器人, 场景解释, 动作识别

## 3 点简述
- 核心问题：视觉语言模型在边缘设备部署时面临计算复杂度与精度权衡的挑战。
- 方法要点：研究小型视觉语言模型在场景解释和动作识别任务中的零样本能力。
- 实验或效果：在多样化真实世界数据集上评估模型潜力，分析挑战和偏见。
