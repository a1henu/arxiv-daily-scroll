...
**arXiv**：[2511.02495v1](https://arxiv.org/abs/2511.02495) · [PDF](https://arxiv.org/pdf/2511.02495.pdf)  
**作者**：Zixuan Liu, Siavash H. Khajavi, Guangkai Jiang  

**一句话要点**：提出DetectiumFire多模态数据集以解决火灾领域缺乏高质量标注数据的问题

**关键词**：多模态数据集, 火灾理解, 视觉语言融合, 目标检测, 图像生成, 安全系统

## 3 点简述
- 核心问题：火灾领域缺乏公开多模态数据集，限制AI模型应用
- 方法要点：构建大规模数据集，含图像和视频，标注视觉与文本信息
- 实验或效果：验证在目标检测、图像生成和视觉语言推理等任务中的实用性
