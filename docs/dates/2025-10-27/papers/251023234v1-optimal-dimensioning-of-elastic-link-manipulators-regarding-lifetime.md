...
**arXiv**：[2510.23234v1](https://arxiv.org/abs/2510.23234) · [PDF](https://arxiv.org/pdf/2510.23234.pdf)  
**作者**：Klaus Zauner, Hubert Gattringer, Andreas Mueller  

**一句话要点**：提出弹性连杆机械臂寿命估计方法，用于几何优化以平衡重量和振动。

**关键词**：弹性连杆机械臂, 寿命估计, 几何优化, 疲劳分析, Pareto优化, 振动控制
