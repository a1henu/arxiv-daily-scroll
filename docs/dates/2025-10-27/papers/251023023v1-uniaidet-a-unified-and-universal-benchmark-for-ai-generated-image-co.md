...
**arXiv**：[2510.23023v1](https://arxiv.org/abs/2510.23023) · [PDF](https://arxiv.org/pdf/2510.23023.pdf)  
**作者**：Huixuan Zhang, Xiaojun Wan  

**一句话要点**：提出UniAIDet基准以解决AI生成图像检测与定位的多样性不足问题

**关键词**：AI生成图像检测, 基准构建, 图像定位, 生成模型多样性, 图像真实性评估
