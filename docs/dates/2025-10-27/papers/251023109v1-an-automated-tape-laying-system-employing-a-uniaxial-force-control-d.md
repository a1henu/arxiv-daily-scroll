...
**arXiv**：[2510.23109v1](https://arxiv.org/abs/2510.23109) · [PDF](https://arxiv.org/pdf/2510.23109.pdf)  
**作者**：Bernhard Rameder, Hubert Gattringer, Ronald Naderer, Andreas Mueller  

**一句话要点**：提出集成单轴力控和温度控制的自动化铺带系统，用于复合材料制造。

**关键词**：自动化铺带系统, 单轴力控制, 温度控制, 复合材料制造, 机器人控制, 碳纤维增强带
