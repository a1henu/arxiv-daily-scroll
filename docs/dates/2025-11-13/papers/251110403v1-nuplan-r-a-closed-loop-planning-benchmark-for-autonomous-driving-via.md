...
**一句话要点**：提出nuPlan-R基准，通过反应式多智能体模拟解决自动驾驶规划评估中交通行为不真实的问题

**关键词**：自动驾驶规划, 闭环基准, 反应式多智能体模拟, 扩散模型, 交互感知选择, 规划评估

## 3 点简述
- 现有基准依赖规则型反应智能体，缺乏行为多样性和真实交互
- 集成学习型反应多智能体模拟，使用噪声解耦扩散模型和交互感知选择机制
- 实验显示生成更真实多样的交通行为，提升规划评估的公平性和现实性
