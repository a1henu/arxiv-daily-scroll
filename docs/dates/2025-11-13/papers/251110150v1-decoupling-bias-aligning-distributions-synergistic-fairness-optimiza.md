...
**一句话要点**：提出双机制协同优化框架以解决深度伪造检测中的公平性与准确性权衡问题

**关键词**：深度伪造检测, 公平性优化, 分布对齐, 结构解耦, 数字身份安全

## 3 点简述
- 核心问题：深度伪造检测模型存在对性别和种族等人口群体的偏见，影响公平性和准确性。
- 方法要点：集成结构公平解耦和全局分布对齐，解耦敏感通道并减少特征分布距离。
- 实验或效果：在保持整体检测精度的同时，提升了组间和组内公平性。
