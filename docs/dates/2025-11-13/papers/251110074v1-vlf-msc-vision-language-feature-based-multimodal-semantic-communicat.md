...
**一句话要点**：提出基于视觉语言特征的多模态语义通信系统，统一传输紧凑表示以支持图像和文本生成。

**关键词**：多模态语义通信, 视觉语言特征, 统一表示传输, 图像生成, 文本生成, 频谱效率

## 3 点简述
- 核心问题：现有语义通信系统需独立处理图像和文本，导致频谱效率低。
- 方法要点：使用预训练视觉语言模型编码图像为视觉语言特征，统一传输和解码。
- 实验或效果：在低信噪比下，系统优于单模态基线，语义准确度高且带宽减少。
