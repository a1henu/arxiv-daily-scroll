...
**一句话要点**：提出自一致性采样以解决多模态大模型结果奖励强化学习中的不忠实轨迹问题

**关键词**：多模态大语言模型, 结果奖励强化学习, 自一致性采样, 多模态推理, 轨迹忠实性, 基准测试

## 3 点简述
- 核心问题：多模态推理中，错误思维链猜对选项的轨迹获得相同奖励，影响训练忠实性。
- 方法要点：通过视觉扰动和轨迹截断重采样，计算一致性分数，在策略更新中降权不可靠轨迹。
