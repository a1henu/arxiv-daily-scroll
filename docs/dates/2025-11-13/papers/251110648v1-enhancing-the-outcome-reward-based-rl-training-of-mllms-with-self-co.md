...
**一句话要点**：提出自一致性采样以解决多模态大模型结果奖励强化学习中轨迹不忠实问题

**关键词**：多模态大语言模型, 结果奖励强化学习, 自一致性采样, 多模态推理, 轨迹可靠性

## 3 点简述
- 核心问题：多模态推理中，错误思维链猜对选项与真实推理获得相同奖励，影响训练效果
- 方法要点：通过视觉扰动和轨迹截断重采样，计算一致性分数以降低不可靠轨迹权重
- 实验或效果：在多个基准上提升准确率高达7.7个百分点，计算开销可忽略
