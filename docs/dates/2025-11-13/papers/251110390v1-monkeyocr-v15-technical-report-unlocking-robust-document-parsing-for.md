...
**一句话要点**：提出MonkeyOCR v1.5统一视觉语言框架以解决复杂文档解析问题

**关键词**：文档解析, 视觉语言框架, 表格结构识别, 布局理解, 强化学习, 多模态模型

## 3 点简述
- 现实文档常含复杂布局，如多级表格和跨页结构，现有OCR系统难以处理。
- 采用两阶段解析流程，先预测布局与阅读顺序，再局部识别文本、公式和表格。
- 在OmniDocBench v1.5上实现SOTA性能，优于PPOCR-VL和MinerU 2.5。
