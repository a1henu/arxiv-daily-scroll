...
**一句话要点**：提出RL-CoMM以解决多模态大语言模型在视听混淆场景中的推理偏差

**关键词**：多模态大语言模型, 视听混淆, 强化学习, 音频语言模型, 推理优化

## 3 点简述
- 核心问题：MLLMs在视觉主导下难以辨别音频缺失的混淆对象
- 方法要点：引入外部音频模型和强化学习奖励函数优化推理
- 实验效果：在视听问答任务中准确率提升10~30%
