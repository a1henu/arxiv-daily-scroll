...
**一句话要点**：提出UEPO统一生成框架以解决机器人离线到在线强化学习中的模态覆盖不足和分布偏移问题

**关键词**：离线到在线强化学习, 扩散策略, 机器人学习, 动态分歧正则化, 数据增强, D4RL基准

## 3 点简述
- 核心问题：离线到在线强化学习中多模态行为覆盖有限和在线适应时的分布偏移
- 方法要点：采用多种子动态感知扩散策略、动态分歧正则化和扩散数据增强模块
- 实验或效果：在D4RL基准上，运动任务提升5.9%，灵巧操作提升12.4%
