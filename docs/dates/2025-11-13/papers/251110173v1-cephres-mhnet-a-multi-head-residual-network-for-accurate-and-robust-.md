...
**关键词**：头影测量标志点检测, 多头残差网络, 双注意力机制, X射线图像分析, 正畸诊断

## 3 点简述
- 核心问题：2D侧位头颅X射线中头影测量标志点定位困难，手动标注耗时且易错。
- 方法要点：集成残差编码、双注意力机制和多头解码器，提升上下文推理和解剖精度。
- 实验或效果：在Aariz数据集上，平均径向误差1.23毫米，检测成功率85.5%，优于基线。
