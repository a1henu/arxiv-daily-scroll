...
**arXiv**：[2511.10023v1](https://arxiv.org/abs/2511.10023) · [PDF](https://arxiv.org/pdf/2511.10023.pdf)  
**作者**：Farzan Saeedi, Sanaz Keshvari, Nasser Shoeibi  

**一句话要点**：提出定制CNN模型以高效自动化诊断早产儿视网膜病变

**关键词**：早产儿视网膜病变诊断, 定制卷积神经网络, 投票系统, 计算效率优化, 临床部署

## 3 点简述
- 核心问题：早产儿视网膜病变诊断的精确与效率提升需求
- 方法要点：采用定制CNN模型，结合投票系统优化性能
- 实验或效果：定制模型在准确率和F1分数上优于预训练模型
