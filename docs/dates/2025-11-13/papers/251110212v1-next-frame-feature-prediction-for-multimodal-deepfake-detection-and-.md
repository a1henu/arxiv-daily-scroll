...
**一句话要点**：提出基于下一帧预测的单阶段训练框架，以提升多模态深度伪造检测的泛化能力和时间定位精度

**关键词**：多模态深度伪造检测, 下一帧预测, 时间定位, 窗口级注意力, 泛化能力

## 3 点简述
- 核心问题：现有方法泛化性差，依赖预训练，且忽略模态内伪影，导致对保持音视频对齐的伪造失效
- 方法要点：引入下一帧预测和窗口级注意力机制，捕捉预测与实际帧差异，检测局部伪影
- 实验或效果：在多个基准数据集上验证，模型展现强泛化能力和精确时间定位
