...
**一句话要点**：提出JudgeMind方法以解决空中滑雪动作质量评估中的细粒度评分问题

**关键词**：动作质量评估, 细粒度数据集, 阶段感知融合, 知识增强解码, 空中滑雪

## 3 点简述
- 核心问题：现有动作质量评估方法依赖整段视频特征，缺乏细粒度注释和可解释性。
- 方法要点：将动作视频分段评分，并融合阶段感知特征与基于知识的解码器。
- 实验或效果：在自建数据集上实现最先进性能，提升评分准确性和可靠性。
