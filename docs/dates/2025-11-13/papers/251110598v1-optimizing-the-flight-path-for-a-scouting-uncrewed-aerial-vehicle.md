...
**arXiv**：[2511.10598v1](https://arxiv.org/abs/2511.10598) · [PDF](https://arxiv.org/pdf/2511.10598.pdf)  
**作者**：Raghav Adhikari, Sachet Khatiwada, Suman Poudel  

**一句话要点**：提出基于优化的无人机路径规划方法，以在灾后环境中最大化传感器覆盖和最小化不确定性。

**关键词**：无人机路径规划, 灾后侦察, 传感器覆盖优化, 不确定性最小化, 优化方法

## 3 点简述
- 核心问题：灾后环境非结构化，导致救援车辆路径规划困难。
- 方法要点：使用优化方法规划无人机在最优高度飞行，以覆盖最大面积并减少数据不确定性。
- 实验或效果：未知具体实验，但旨在提升侦察效率和数据质量。
