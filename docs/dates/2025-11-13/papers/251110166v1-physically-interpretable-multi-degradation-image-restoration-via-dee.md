...
**一句话要点**：提出InterIR方法以解决多退化图像恢复中的可解释性问题

**关键词**：多退化图像恢复, 深度展开网络, 可解释卷积, 物理可解释性, 半光滑牛顿算法

## 3 点简述
- 核心问题：真实图像常同时存在雨、噪声和雾等多种退化，现有方法多针对单一退化且可解释性差。
- 方法要点：基于深度展开网络，将数学优化算法映射为可学习结构，并引入可解释卷积模块。
- 实验或效果：在多退化恢复中表现优异，同时在单退化任务上保持竞争力。
