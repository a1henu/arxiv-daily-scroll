...
**一句话要点**：提出InterIR方法，通过深度展开和可解释卷积解决多退化图像恢复问题

**关键词**：多退化图像恢复, 深度展开网络, 可解释卷积, 物理可解释性, 自适应参数调整

## 3 点简述
- 核心问题：现实图像常同时存在雨、噪声和雾等多退化，现有方法多针对单一退化且可解释性差
- 方法要点：基于深度展开网络映射优化算法迭代过程，结合可解释卷积模块自适应调整参数
- 实验或效果：在多退化恢复中表现优异，单退化任务也保持竞争力
