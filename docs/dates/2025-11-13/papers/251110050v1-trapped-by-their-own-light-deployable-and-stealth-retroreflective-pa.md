...
**一句话要点**：提出可部署隐形的逆向反射补丁攻击，针对交通标志识别系统。

**关键词**：交通标志识别, 逆向反射攻击, 黑盒优化, 隐形补丁, 防御策略, 自动驾驶安全

## 3 点简述
- 交通标志识别系统易受攻击，现有方法视觉可检测或实现受限。
- 利用逆向反射材料，仅在车灯照射下激活，结合黑盒优化提升攻击效果。
- 动态场景成功率≥93.4%，真实世界≥60%，用户研究显示隐形性优于以往。
