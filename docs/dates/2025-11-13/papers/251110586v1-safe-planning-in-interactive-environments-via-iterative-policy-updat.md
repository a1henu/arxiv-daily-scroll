...
**一句话要点**：提出迭代策略更新与对抗鲁棒共形预测框架，以在交互环境中实现安全规划

**关键词**：安全规划, 交互环境, 共形预测, 策略更新, 分布偏移, 对抗鲁棒性

## 3 点简述
- 核心问题：交互环境中策略更新导致数据分布偏移，违反共形预测的交换性假设
- 方法要点：使用对抗鲁棒共形预测，通过策略-轨迹敏感性分析调整安全保证
- 实验或效果：在二维车-行人案例中实证安全与收敛保证，未知是否优于现有方法
