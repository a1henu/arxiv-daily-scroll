...
**关键词**：零样本异常检测, 多模态融合, 工业视觉, 样本互评分, 3D表示学习

## 3 点简述
- 核心问题：现有零样本方法忽略正常图像块在2D/3D中相似而异常孤立的关键特性。
- 方法要点：结合迭代点分组和相似邻域聚合，构建多模态互评分机制以增强异常检测。
- 实验效果：在MVTec 3D-AD和Eyecandies数据集上AP分别提升23.7%和19.3%。
