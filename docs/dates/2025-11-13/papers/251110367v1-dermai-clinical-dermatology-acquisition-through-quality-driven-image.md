...
**一句话要点**：提出DermAI移动应用以解决皮肤病变AI分类中的数据偏见与质量不均问题。

**关键词**：皮肤病学AI, 移动图像采集, 设备端质量检查, 本地模型适应, 多样化数据集

## 3 点简述
- 核心问题：AI皮肤病学受限于数据集偏见、图像质量不一和验证不足。
- 方法要点：轻量级手机应用实现实时捕获、标注和分类，支持设备端质量检查与模型适应。
- 实验或效果：公共数据集模型泛化失败，本地数据微调提升性能，强调标准化多样数据收集。
