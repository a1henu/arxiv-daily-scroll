...
**关键词**：视频数据集, 癫痫发作检测, 实验室啮齿动物, TimeSformer, 基准评估, 非侵入监测

## 3 点简述
- 核心问题：自动检测实验室啮齿动物的癫痫发作事件，支持临床前癫痫研究。
- 方法要点：构建包含正常与发作视频片段的数据集，采用TimeSformer视频分类器进行基准实验。
- 实验或效果：五折交叉验证下，平均F1分数达97%，确保无数据泄露。
