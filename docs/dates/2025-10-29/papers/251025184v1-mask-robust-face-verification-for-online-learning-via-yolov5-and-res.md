...
**arXiv**：[2510.25184v1](https://arxiv.org/abs/2510.25184) · [PDF](https://arxiv.org/pdf/2510.25184.pdf)  
**作者**：Zhifeng Wang, Minghui Wang, Chunyan Zeng, Jialong Yao, Yang Yang, Hongmin Xu  

**一句话要点**：提出基于YOLOv5和残差网络的面部验证方法，以解决在线学习中的身份认证问题。

**关键词**：面部验证, YOLOv5, 残差网络, 在线学习, 身份认证, 深度学习

## 3 点简述
- 核心问题：在线教育中佩戴口罩等干扰下的身份认证准确性不足。
- 方法要点：使用YOLOv5检测面部，残差网络提取深层特征，欧氏距离匹配身份。
- 实验或效果：在专有数据集上训练，未知具体性能指标。

## 摘要（原文）

> In the contemporary landscape, the fusion of information technology and the
