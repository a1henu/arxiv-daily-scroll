...
**arXiv**：[2510.25479v1](https://arxiv.org/abs/2510.25479) · [PDF](https://arxiv.org/pdf/2510.25479.pdf)  
**作者**：Alexander B. Rambech, Ivar B. Saksvik, Vahid Hassani  

**一句话要点**：提出牛顿-欧拉公式结合移动质量执行器，用于水下航行器动力学建模。

**关键词**：水下航行器, 移动质量执行器, 牛顿-欧拉公式, 机动模型, 动力学建模, 仿真验证

## 3 点简述
- 核心问题：水下航行器内部移动质量执行器的动力学建模与集成。
- 方法要点：基于牛顿-欧拉公式扩展Fossen机动模型，推导科里奥利-向心效应和静水力学。
- 实验或效果：通过仿真验证模型，并与传统哈密顿方法进行比较。

## 摘要（原文）

> In this paper, we present a Newton-Euler formulation of the equations of
