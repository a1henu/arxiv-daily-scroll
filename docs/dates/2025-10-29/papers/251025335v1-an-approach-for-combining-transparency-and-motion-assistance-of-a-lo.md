...
**arXiv**：[2510.25335v1](https://arxiv.org/abs/2510.25335) · [PDF](https://arxiv.org/pdf/2510.25335.pdf)  
**作者**：Jakob Ziegler, Bernhard Rameder, Hubert Gattringer, Andreas Mueller  

**一句话要点**：提出结合透明模式和运动辅助的方法，用于下肢外骨骼步态辅助。

**关键词**：下肢外骨骼, 透明模式, 运动辅助, 自适应振荡器, 步态辅助

## 3 点简述
- 核心问题：如何在外骨骼中同时实现透明模式和运动辅助，以最小化交互力并引导运动。
- 方法要点：利用齿轮间隙实现透明模式，自适应振荡器学习准周期信号，叠加辅助扭矩。
- 实验或效果：初步实验显示该方法具有良好前景，但具体性能指标未知。
