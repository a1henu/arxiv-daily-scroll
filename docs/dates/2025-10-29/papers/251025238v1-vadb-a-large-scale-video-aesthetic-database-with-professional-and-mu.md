...
**arXiv**：[2510.25238v1](https://arxiv.org/abs/2510.25238) · [PDF](https://arxiv.org/pdf/2510.25238.pdf)  
**作者**：Qianqian Qiao, DanDan Zheng, Yihang Bo, Bao Peng, Heng Huang, Longteng Jiang, Huaye Wang, Jingdong Chen, Jun Zhou, Xin Jin  

**一句话要点**：提出VADB大规模视频美学数据库和VADB-Net双模态预训练框架以解决视频美学评估中数据集和模型不足的问题。

**关键词**：视频美学评估, 大规模视频数据库, 双模态预训练, 多维标注, 视频质量评估

## 3 点简述
- 核心问题：视频美学评估缺乏标准化数据集和鲁棒模型，图像方法难以直接应用。
- 方法要点：构建VADB数据库，含10,490视频和多维专业标注；提出VADB-Net双模态预训练框架。
- 实验或效果：VADB-Net在评分任务中优于现有视频质量评估模型，支持下游美学任务。
