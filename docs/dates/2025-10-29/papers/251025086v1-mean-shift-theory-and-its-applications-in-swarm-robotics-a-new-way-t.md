...
**arXiv**：[2510.25086v1](https://arxiv.org/abs/2510.25086) · [PDF](https://arxiv.org/pdf/2510.25086.pdf)  
**作者**：Guibin Sun, Jinhu Lü, Kexin Liu, Zhenqian Wang, Guanrong Chen  

**一句话要点**：提出均值漂移探索策略以提升多机器人集群协作效率，应用于智能仓储等领域。

**关键词**：均值漂移理论, 集群机器人协作, 形状形成, 无分配算法, 效率优化, 工业应用

## 3 点简述
- 核心问题：传统基于分配的方法在机器人集群协作中效率低、鲁棒性差，难以扩展。
- 方法要点：采用均值漂移探索策略，实现无分配协作，专注于形状形成问题。
- 实验或效果：该策略使大规模集群协作效率提升数十倍，且规模越大改进越显著。
