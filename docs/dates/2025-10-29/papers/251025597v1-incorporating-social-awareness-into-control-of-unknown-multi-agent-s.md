...
**arXiv**：[2510.25597v1](https://arxiv.org/abs/2510.25597) · [PDF](https://arxiv.org/pdf/2510.25597.pdf)  
**作者**：Siddhartha Upadhyay, Ratnangshu Das, Pushpak Jagtap  

**一句话要点**：提出实时时空管框架，在未知多智能体系统中融入社会意识以实现规定时间到达-避障-停留任务。

**关键词**：多智能体系统, 社会意识控制, 时空管框架, 规定时间控制, 分散控制, 未知动态系统

## 3 点简述
- 核心问题：未知动态多智能体系统在动态环境中实现规定时间安全任务，需处理异构社会行为。
- 方法要点：基于时空管框架，在线合成管并设计无近似控制律，确保安全与时间保证。
- 实验或效果：通过仿真和硬件实验验证框架有效性和可扩展性，计算轻量且鲁棒。

## 摘要（原文）

> This paper presents a decentralized control framework that incorporates
