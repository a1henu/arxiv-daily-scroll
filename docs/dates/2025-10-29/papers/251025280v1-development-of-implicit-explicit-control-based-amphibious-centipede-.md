...
**arXiv**：[2510.25280v1](https://arxiv.org/abs/2510.25280) · [PDF](https://arxiv.org/pdf/2510.25280.pdf)  
**作者**：Yusuke Tsunoda, Seiya Yamamoto, Kazuki Ito, Runze Xiao, Keisuke Naniwa, Koichi Osuka  

**一句话要点**：提出基于隐式-显式控制的蜈蚣型机器人，以统一控制方案解决水陆两栖移动问题。

**关键词**：多足机器人, 隐式-显式控制, 水陆两栖移动, 腿结构设计, 移动性能评估

## 3 点简述
- 核心问题：多环境移动需切换控制器，设计复杂且难以准确切换。
- 方法要点：设计柔性关节和左右腿结构，采用隐式-显式控制实现统一控制。
- 实验或效果：评估三种腿结构，确认存在适合水陆环境的统一控制方案。
