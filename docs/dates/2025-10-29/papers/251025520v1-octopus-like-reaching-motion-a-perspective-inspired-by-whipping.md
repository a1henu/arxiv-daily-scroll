...
**arXiv**：[2510.25520v1](https://arxiv.org/abs/2510.25520) · [PDF](https://arxiv.org/pdf/2510.25520.pdf)  
**作者**：Shengyao Zhang, Yiyuan Zhang, Chenrui Zhang, Yiming Li, Wenci Xin, Yuliang Liufu, Hong Wei Ng, Cecilia Laschi  

**一句话要点**：研究鞭状被动动力学在水中的运动，以模拟章鱼触手伸展的弯曲传播。

**关键词**：章鱼触手运动, 鞭状动力学, 弯曲传播, 流体动力学, 被动行为模拟

## 3 点简述
- 核心问题：章鱼触手伸展的弯曲传播是否与鞭子动力学原理相似。
- 方法要点：在水中和空气中进行平台鞭打测试，改变材料刚度和驱动速度。
- 实验或效果：Ecoflex Gel 2臂在150 rpm下重现弯曲传播，但速度曲线与生物不同。
