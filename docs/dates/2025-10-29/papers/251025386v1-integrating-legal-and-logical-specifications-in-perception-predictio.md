...
**arXiv**：[2510.25386v1](https://arxiv.org/abs/2510.25386) · [PDF](https://arxiv.org/pdf/2510.25386.pdf)  
**作者**：Kumar Manas, Mert Keser, Alois Knoll  

**一句话要点**：综述法律与逻辑规范在自动驾驶感知、预测和规划中的集成方法

**关键词**：自动驾驶系统, 法律规范集成, 神经符号方法, 逻辑驱动规则, 感知不确定性, 法规遵从

## 3 点简述
- 核心问题：感知可靠性、法律合规性和决策可解释性在动态不确定驾驶环境中的交叉挑战
- 方法要点：基于逻辑框架、计算法律推理和神经符号集成方法，确保法规遵从和可解释性
- 实验或效果：通过分类学分析现有方法，强调透明和可问责的自动驾驶操作

## 摘要（原文）

> This survey provides an analysis of current methodologies integrating legal
