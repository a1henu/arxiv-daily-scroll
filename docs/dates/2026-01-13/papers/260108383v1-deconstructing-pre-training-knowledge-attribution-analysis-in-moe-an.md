...
**arXiv**：[2601.08383v1](https://arxiv.org/abs/2601.08383) · [PDF](https://arxiv.org/pdf/2601.08383.pdf)  
**作者**：Bo Wang, Junzhuo Li, Hong Chen, Yuanlin Chu, Yuxuan Fan, Xuming Hu  

**一句话要点**：提出Gated-LPI度量以分析MoE与密集模型预训练中的知识获取差异

**关键词**：MoE架构, 知识归因分析, 预训练动态, 稀疏模型, 神经元级度量

## 3 点简述
- 核心问题：MoE与密集模型在预训练中知识获取动态的差异未知
- 方法要点：引入Gated-LPI神经元级归因度量，分解对数概率增益
- 实验或效果：发现MoE模型具有低熵骨干、早期巩固和功能鲁棒性模式
