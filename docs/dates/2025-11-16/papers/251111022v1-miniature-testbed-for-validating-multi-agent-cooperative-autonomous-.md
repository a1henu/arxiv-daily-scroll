...
**arXiv**：[2511.11022v1](https://arxiv.org/abs/2511.11022) · [PDF](https://arxiv.org/pdf/2511.11022.pdf)  
**作者**：Hyunchul Bae, Eunjae Lee, Jehyeop Han, Minhee Kang, Jaehyeon Kim, Junggeun Seo, Minkyun Noh, Heejin Ahn  

**一句话要点**：提出CIVAT微型测试台以解决协同自动驾驶验证问题

**关键词**：协同自动驾驶, 微型测试台, V2V通信, V2I通信, 智能基础设施, ROS2框架

## 3 点简述
- 现有测试台缺乏配备感知、边缘计算和通信的智能基础设施
- 设计1:15比例测试台，集成车辆、基础设施和V2V/V2I通信
- 通过基础设施感知和交叉口管理实验验证系统功能
