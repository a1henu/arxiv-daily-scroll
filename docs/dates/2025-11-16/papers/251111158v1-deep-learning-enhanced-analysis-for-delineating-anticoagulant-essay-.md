...
**arXiv**：[2511.11158v1](https://arxiv.org/abs/2511.11158) · [PDF](https://arxiv.org/pdf/2511.11158.pdf)  
**作者**：S. Shrivastava, M. Rathor, D. Yenurkar, S. K. Chaubey, S. Mukherjee, R. K. Singh  

**一句话要点**：提出深度学习增强框架以评估抗凝剂在体外血液分析中的效果

**关键词**：数字全息显微镜, 深度学习, 抗凝剂评估, 血液细胞形态分析, 无标记成像

## 3 点简述
- 核心问题：体外血液凝固影响血液学分析准确性，导致细胞特性改变。
- 方法要点：使用数字全息显微镜和深度学习进行无标记、非侵入性细胞形态分析。
- 实验或效果：KFeOx-NPs抗凝剂保持红细胞形态，而EDTA在6小时内引起显著变化。
