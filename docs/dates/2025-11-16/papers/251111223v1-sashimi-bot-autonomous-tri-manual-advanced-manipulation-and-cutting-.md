...
**arXiv**：[2511.11223v1](https://arxiv.org/abs/2511.11223) · [PDF](https://arxiv.org/pdf/2511.11223.pdf)  
...
**一句话要点**：提出Sashimi-Bot系统以自主操作和切割变形物体如三文鱼柳

**关键词**：变形物体操作, 多机器人系统, 深度强化学习, 视觉触觉反馈, 自主切割

## 3 点简述
- 核心问题：变形物体如三文鱼柳的柔韧、易变和不确定交互特性
- 方法要点：结合深度强化学习、视觉触觉反馈和多机器人协作切割
- 实验或效果：实现自主切割薄片，提升对变形物体操作的鲁棒性
