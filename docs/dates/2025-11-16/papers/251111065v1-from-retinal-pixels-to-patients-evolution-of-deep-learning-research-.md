...
**arXiv**：[2511.11065v1](https://arxiv.org/abs/2511.11065) · [PDF](https://arxiv.org/pdf/2511.11065.pdf)  
**作者**：Muskaan Chopra, Lorenz Sparrenberg, Armin Berger, Sarthak Khanna, Jan H. Terheyden, Rafet Sifa  

**一句话要点**：综述糖尿病视网膜病变筛查深度学习研究进展，提出可部署AI的实用议程

**关键词**：糖尿病视网膜病变筛查, 深度学习综述, 医学影像分析, 联邦学习, 领域泛化, 可解释AI

## 3 点简述
- 核心问题：糖尿病视网膜病变是主要致盲原因，需早期检测以减少视力损失
- 方法要点：涵盖自监督学习、领域泛化、联邦训练和混合神经符号模型
- 实验或效果：整合50+研究和20+数据集，评估性能并识别多中心验证缺口
