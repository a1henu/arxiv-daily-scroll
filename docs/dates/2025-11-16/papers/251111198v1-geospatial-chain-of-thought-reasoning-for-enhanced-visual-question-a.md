...
**arXiv**：[2511.11198v1](https://arxiv.org/abs/2511.11198) · [PDF](https://arxiv.org/pdf/2511.11198.pdf)  
**作者**：Shambhavi Shanker, Manikandan Padmanaban, Jagabondhu Hazra  

**一句话要点**：提出结合思维链与直接偏好优化的VQA框架，以增强卫星图像视觉问答在气候应用中的推理能力。

**关键词**：视觉问答, 思维链推理, 直接偏好优化, 卫星图像分析, 地理空间推理, 气候应用

## 3 点简述
- 现有卫星图像VQA模型缺乏结构化推理，难以处理复杂地理空间查询。
- 集成思维链推理生成中间理由，并使用直接偏好优化提升模型鲁棒性和准确性。
- 实验显示思维链监督使准确率提升34.9%，直接偏好优化进一步改善推理质量。
