...
**arXiv**：[2511.11392v1](https://arxiv.org/abs/2511.11392) · [PDF](https://arxiv.org/pdf/2511.11392.pdf)  
**作者**：Owen A. Maute, Blake A. Roberts, Berker Peköz  

**一句话要点**：提出RadAround被动二维测向系统，用于对抗性物联网感知和电磁态势感知。

**关键词**：被动测向系统, 物联网感知, 电磁态势感知, 机械转向天线, 现场可部署SCADA, 电磁干扰检测

## 3 点简述
- 核心问题：在对抗环境中实现低成本、高分辨率的电磁方向探测。
- 方法要点：使用机械转向窄波束天线和现场可部署SCADA软件，结合COTS或3D打印组件。
- 实验或效果：实验显示能穿墙检测计算设备、评估利用率并定位电磁干扰源。
