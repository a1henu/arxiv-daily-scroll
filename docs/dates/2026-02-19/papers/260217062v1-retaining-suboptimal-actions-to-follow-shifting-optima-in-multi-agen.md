...
**一句话要点**：提出S2Q方法以解决多智能体强化学习中价值函数漂移导致的策略收敛问题。

**关键词**：多智能体强化学习, 值分解, 策略探索, 价值函数漂移, Softmax策略, 次优动作保留

## 3 点简述
- 核心问题：现有值分解方法依赖单一最优动作，难以适应训练中价值函数漂移，易收敛至次优策略。
- 方法要点：S2Q学习多个子价值函数保留高价值替代动作，结合Softmax策略促进持续探索和快速适应。
- 实验或效果：在挑战性MARL基准测试中，S2Q一致优于多种算法，展现出更好的适应性和整体性能。
