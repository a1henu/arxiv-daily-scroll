...
**关键词**：黑盒对抗攻击, 大视觉语言模型, 梯度去噪, 迁移攻击, 多裁剪对齐, 辅助目标对齐

## 3 点简述
- 核心问题：现有迁移攻击方法因ViT平移敏感性和结构不对称导致梯度高方差，优化不稳定。
- 方法要点：通过多裁剪对齐和辅助目标对齐平滑梯度，结合补丁动量和补丁大小集成增强可迁移方向。
- 实验或效果：在Claude-4.0、Gemini-2.5-Pro和GPT-5上显著提升攻击成功率，优于先前黑盒攻击方法。
