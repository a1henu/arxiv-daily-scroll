...
**arXiv**：[2602.17116v1](https://arxiv.org/abs/2602.17116) · [PDF](https://arxiv.org/pdf/2602.17116.pdf)  
**作者**：Ilya Levin  

**一句话要点**：提出高维空间索引认识论，以解释生成式AI的知识生产机制

**关键词**：生成式AI, 认识论, 高维几何, 索引认识论, 意义流形

## 3 点简述
- 核心问题：生成式AI的知识生产机制不透明，阻碍其负责任应用
- 方法要点：基于高维几何结构，构建索引认识论，将生成模型视为意义流形导航器
- 实验或效果：未知
