...
**关键词**：多智能体强化学习, 动作协调, 分散决策, 图策略, 部分可观测环境

## 3 点简述
- 核心问题：多智能体强化学习中，分散决策需协调动作以避免冲突并满足全局约束
- 方法要点：构建动作图策略，建模智能体间动作依赖关系，通过协调上下文实现全局条件决策
- 实验或效果：在部分可观测和反协调惩罚任务中，成功率80-95%，显著优于基线方法
