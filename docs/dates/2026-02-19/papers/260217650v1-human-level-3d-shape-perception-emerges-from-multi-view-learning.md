...
**一句话要点**：提出多视图学习框架，通过视觉空间目标实现人类级三维形状感知

**关键词**：三维形状感知, 多视图学习, 视觉空间目标, 零样本评估, 人类行为预测

## 3 点简述
- 核心问题：如何建模人类从二维视觉输入推断三维结构的能力，现有方法未达人类水平。
- 方法要点：使用无对象归纳偏置的神经网络，从自然场景多视图图像学习预测相机位置和深度等空间信息。
- 实验或效果：零样本评估匹配人类三维形状推断准确度，模型响应可预测人类行为误差和反应时间。
