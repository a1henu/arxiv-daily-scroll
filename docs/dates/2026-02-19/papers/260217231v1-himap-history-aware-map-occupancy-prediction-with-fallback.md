...
**一句话要点**：提出HiMAP框架以解决多目标跟踪失败时的运动预测问题

**关键词**：运动预测, 跟踪无关预测, 历史占用地图, 自动驾驶, 多模态轨迹生成

## 3 点简述
- 核心问题：传统预测依赖多目标跟踪，跟踪失败时预测质量下降
- 方法要点：使用历史占用地图和查询模块，无需身份关联，实现跟踪无关预测
- 实验或效果：在Argoverse 2上性能媲美跟踪方法，无跟踪设置下指标提升显著
