...
**一句话要点**：提出附件锚点框架以解决结直肠手术中腹腔镜抓取点预测的挑战。

**关键词**：腹腔镜手术, 抓取点预测, 结直肠手术, 机器学习, 手术场景归一化, 自主操作

## 3 点简述
- 核心问题：结直肠手术中自主组织操作的关键挑战是准确预测抓取点，现有研究不足。
- 方法要点：引入附件锚点，编码组织与解剖附件的局部几何和力学关系，归一化手术场景。
- 实验或效果：在90例手术数据集上验证，附件锚点提升预测准确性，尤其在分布外场景中表现突出。
