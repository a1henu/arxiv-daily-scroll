...
**一句话要点**：提出附着锚点框架以解决结直肠手术中腹腔镜抓取点预测的挑战

**关键词**：腹腔镜手术, 抓取点预测, 结直肠手术, 机器学习, 结构化表示, 自主操纵

## 3 点简述
- 核心问题：结直肠手术中自主组织操纵的抓取点预测因场景复杂多变而困难，现有研究不足。
- 方法要点：引入附着锚点作为结构化表示，编码组织与解剖附着的局部几何和力学关系，归一化手术场景。
- 实验或效果：在90例手术数据集上验证，附着锚点提升预测准确性，尤其在分布外设置中表现突出。
