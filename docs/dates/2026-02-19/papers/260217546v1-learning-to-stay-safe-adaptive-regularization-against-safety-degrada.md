...
**一句话要点**：提出自适应正则化框架以解决微调中语言模型安全退化问题

**关键词**：语言模型安全, 自适应正则化, 微调防御, 安全风险估计, 指令遵循模型

## 3 点简述
- 核心问题：指令遵循语言模型在微调时安全行为可能退化，现有防御方法保护有限或需权衡安全与效用
- 方法要点：通过安全风险估计（基于评判者或激活分类器）自适应调整正则化，约束高风险更新以保持安全对齐
- 实验或效果：在多种模型和攻击场景下，降低攻击成功率，保持下游性能，无推理时开销
