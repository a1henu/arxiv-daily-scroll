...
**一句话要点**：提出自适应正则化框架以解决指令跟随语言模型微调中的安全性退化问题

**关键词**：语言模型安全, 自适应正则化, 微调防御, 安全风险估计, 指令跟随模型

## 3 点简述
- 核心问题：指令跟随语言模型在微调时安全性可能退化，现有防御方法保护有限或需权衡安全性与实用性
- 方法要点：通过安全风险估计（基于评判者或激活的预测器）自适应调整正则化，约束高风险更新以保持安全策略
- 实验或效果：在多种模型和攻击场景下，自适应正则化降低攻击成功率，保持下游性能，无推理成本
