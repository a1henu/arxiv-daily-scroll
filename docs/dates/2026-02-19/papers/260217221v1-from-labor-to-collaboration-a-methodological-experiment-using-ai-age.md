...
**arXiv**：[2602.17221v1](https://arxiv.org/abs/2602.17221) · [PDF](https://arxiv.org/pdf/2602.17221.pdf)  
**作者**：Yi-Chih Huang  

**一句话要点**：提出基于AI Agent的协作研究流程以增强台湾人文社科研究视角

**关键词**：AI Agent协作, 人文社科方法论, 模块化工作流, 人机分工, 台湾数据实证, 生成式AI应用

## 3 点简述
- 核心问题：生成式AI在人文社科领域的方法论探索不足，需验证其协作可行性
- 方法要点：设计七阶段模块化工作流，基于任务模块化、人机分工和可验证性三原则
- 实验或效果：使用台湾Claude.ai使用数据实证分析，展示工作流应用过程与输出质量
