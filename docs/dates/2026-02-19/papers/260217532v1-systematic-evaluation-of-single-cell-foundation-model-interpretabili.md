...
**一句话要点**：提出系统评估框架以揭示单细胞基础模型注意力机制捕获共表达而非独特调控信号

**关键词**：单细胞基础模型, 注意力机制, 系统评估, 基因调控网络, 可解释性, 共表达分析

## 3 点简述
- 核心问题：评估单细胞基础模型注意力机制是否编码独特生物学调控信号
- 方法要点：开发包含37项分析、153个统计测试的系统框架，应用于scGPT和Geneformer
- 实验或效果：注意力模式编码结构化信息但无增量预测价值，基因级基线表现更优
