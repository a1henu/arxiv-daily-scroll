...
**一句话要点**：提出OpenEarthAgent框架，通过工具增强的遥感代理解决多模态地理空间推理问题。

**关键词**：遥感代理, 多模态推理, 工具增强, 地理空间分析, 监督微调

## 3 点简述
- 核心问题：遥感领域需处理空间尺度、地理结构和多光谱指数，多步逻辑推理仍具挑战。
- 方法要点：基于监督微调训练统一框架，结合卫星影像、自然语言查询和结构化推理轨迹。
- 实验或效果：在14,538训练实例上实现稳定空间理解和可解释行为，性能优于基线模型。
