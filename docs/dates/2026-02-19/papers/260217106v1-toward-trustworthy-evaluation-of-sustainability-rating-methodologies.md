...
**arXiv**：[2602.17106v1](https://arxiv.org/abs/2602.17106) · [PDF](https://arxiv.org/pdf/2602.17106.pdf)  
**作者**：Xiaoran Cai, Wang Yang, Xiyu Ren, Chekun Law, Rohit Sharma, Peng Qi  

**一句话要点**：提出人机协作框架以构建可信基准数据集，用于评估可持续性评级方法。

**关键词**：可持续性评级, 基准数据集, 人机协作, 大语言模型, 评估框架

## 3 点简述
- 核心问题：可持续性评级机构间评分差异大，影响可比性和可信度。
- 方法要点：结合STRIDE准则和SR-Delta分析框架，利用大语言模型生成基准数据。
- 实验或效果：框架支持可扩展和可比较的评估，促进评级方法改进。
