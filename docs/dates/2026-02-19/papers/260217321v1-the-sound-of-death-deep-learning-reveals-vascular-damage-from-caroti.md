...
**arXiv**：[2602.17321v1](https://arxiv.org/abs/2602.17321) · [PDF](https://arxiv.org/pdf/2602.17321.pdf)  
...
**一句话要点**：提出基于深度学习的颈动脉超声视频分析框架，以高血压为弱标签提取血管损伤特征，用于心血管风险评估。

**关键词**：颈动脉超声分析, 血管损伤检测, 弱监督学习, 心血管风险评估, 可解释AI

## 3 点简述
- 核心问题：心血管疾病早期风险检测受限，颈动脉超声中丰富信息未充分利用。
- 方法要点：利用机器学习从颈动脉超声视频中学习血管损伤的生物学可解释特征，以高血压作为弱代理标签。
- 实验或效果：模型特征与心血管风险因素强相关，在心肌梗死和死亡率预测中匹配或优于传统风险模型如SCORE2。
