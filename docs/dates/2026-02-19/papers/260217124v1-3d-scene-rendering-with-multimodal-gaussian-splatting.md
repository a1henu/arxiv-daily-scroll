...
**一句话要点**：提出融合射频传感与高斯溅射的多模态框架，以提升恶劣条件下的3D场景渲染鲁棒性。

**关键词**：3D高斯溅射, 多模态渲染, 射频传感, 场景重建, 鲁棒深度预测

## 3 点简述
- 问题：传统视觉高斯溅射依赖多视角初始化，在恶劣天气或遮挡下性能受限。
- 方法：集成射频信号（如汽车雷达）提供鲁棒深度测量，高效初始化高斯函数。
- 效果：数值测试显示，该方法通过射频信息提升结构准确性，实现高保真渲染。
