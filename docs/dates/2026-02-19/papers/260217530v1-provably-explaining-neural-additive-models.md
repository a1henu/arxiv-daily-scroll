...
**一句话要点**：提出高效算法为神经加法模型生成可证明最小基数解释

**关键词**：神经加法模型, 可解释性, 可证明解释, 最小基数子集, 后验解释, 算法效率

## 3 点简述
- 核心问题：标准神经网络后验解释方法缺乏可证明保证，最小特征子集计算不可行
- 方法要点：针对神经加法模型，设计对数复杂度算法生成可证明最小基数解释
- 实验或效果：相比现有方法，提供更小解释并大幅减少计算时间，优于采样技术
