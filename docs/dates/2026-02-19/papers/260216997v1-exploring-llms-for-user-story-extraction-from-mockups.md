...
**arXiv**：[2602.16997v1](https://arxiv.org/abs/2602.16997) · [PDF](https://arxiv.org/pdf/2602.16997.pdf)  
**作者**：Diego Firmenich, Leandro Antonelli, Bruno Pazos, Fabricio Lozada, Leonardo Morales  

**一句话要点**：探索大语言模型从高保真原型中提取用户故事，结合语言扩展词典提升准确性

**关键词**：用户故事提取, 大语言模型, 高保真原型, 语言扩展词典, 需求工程, 自动化生成

## 3 点简述
- 核心问题：用户故事作为软件需求定义工具，如何从高保真原型中自动化生成以提高敏捷性
- 方法要点：利用大语言模型提取用户故事，通过提示词结合语言扩展词典来增强语义理解
- 实验或效果：案例研究表明，加入语言扩展词典能显著提高生成用户故事的准确性和适用性
