...
**arXiv**：[2602.17096v1](https://arxiv.org/abs/2602.17096) · [PDF](https://arxiv.org/pdf/2602.17096.pdf)  
**作者**：Zhaoyang Li, Xingzhi Jin, Junyu Pan, Qianqian Yang, Zhiguo Shi  

**一句话要点**：提出基于大语言模型的意图感知代理AgenCom，以支持6G物理层自主智能通信

**关键词**：6G物理层智能, 意图感知通信, 大语言模型代理, 自主决策, 可持续优化, 跨层控制

## 3 点简述
- 核心问题：6G系统需从规则控制转向意图驱动，以应对多维动态用户需求与环境变化
- 方法要点：利用大语言模型整合异构信息，实现意图感知、自主决策与网络执行的闭环管道
- 实验或效果：案例研究AgenCom代理能根据用户偏好和信道条件自适应构建通信链路
