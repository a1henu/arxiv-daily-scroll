...
**一句话要点**：提出i-PhysGaussian框架，通过隐式物理模拟解决3D高斯溅射在复杂动态场景中的稳定性问题。

**关键词**：3D高斯溅射, 隐式物理模拟, 材料点法, 动量平衡优化, 时间步长稳定性, 复杂动态场景

## 3 点简述
- 核心问题：基于3D重建的显式物理模拟对时间步长敏感，在高刚度材料或准静态运动等复杂场景下精度快速下降。
- 方法要点：将3D高斯溅射与隐式材料点法积分器耦合，通过GMRES求解器进行隐式牛顿优化，最小化动量平衡残差以获取步末状态。
