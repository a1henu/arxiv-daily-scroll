...
**一句话要点**：提出B^3-Seg，通过贝叶斯更新和解析信息增益实现无相机、免训练的3D高斯溅射分割

**关键词**：3D高斯溅射分割, 贝叶斯更新, 信息增益优化, 免训练分割, 交互式编辑, 实时处理

## 3 点简述
- 现有3DGS分割方法依赖相机视角或重训练，难以满足低延迟交互需求
- 将分割建模为Beta-Bernoulli贝叶斯序列更新，并基于解析期望信息增益主动选择视图
