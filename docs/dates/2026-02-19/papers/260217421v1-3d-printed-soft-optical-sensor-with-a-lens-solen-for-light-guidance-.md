...
**arXiv**：[2602.17421v1](https://arxiv.org/abs/2602.17421) · [PDF](https://arxiv.org/pdf/2602.17421.pdf)  
**作者**：Diana Cafiso, Petr Trunin, Carolina Gay, Lucia Beccai  

**一句话要点**：提出3D打印软光学传感器SOLen，通过透镜引导光路实现软机器人中的机械传感

**关键词**：软光学传感器, 3D打印, 透镜引导, 机械传感, 软机器人, 光波导

## 3 点简述
- 核心问题：单材料3D打印软光学传感器中光传播失控（如环境耦合、泄漏）导致性能下降
- 方法要点：在Y形波导中集成打印透镜，利用变形诱导透镜旋转和焦点平移，在分支间重新分配光功率
- 实验或效果：使用改性树脂提高柔性和透光性，旋转测试显示可重复的分支选择性信号切换
