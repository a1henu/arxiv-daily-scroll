...
**一句话要点**：提出基于接触锚定的本体感知里程计，用于无相机或激光雷达的腿式机器人，抑制长期漂移。

**关键词**：本体感知里程计, 腿式机器人, 接触锚定, IMU漂移抑制, 运动学滤波, 多平台评估

## 3 点简述
- 核心问题：腿式机器人仅依赖IMU和电机测量时，因IMU漂移和关节速度噪声导致里程计不可靠。
- 方法要点：将接触腿作为运动学锚点，通过关节扭矩估计可靠接触，利用落脚点位置提供世界坐标系约束。
- 实验或效果：在四足机器人平台上评估，水平环路误差低至0.1638米，垂直环路误差低至0.1米，验证了有效性。
