...
**一句话要点**：提出带额外预测的加权乐观梯度下降上升法，以解决延迟反馈下双线性博弈的收敛加速问题。

**关键词**：延迟反馈, 双线性博弈, 乐观梯度下降上升, 线性收敛, 额外预测, 多智能体学习

## 3 点简述
- 核心问题：现实多智能体学习中反馈延迟严重降低性能，双线性博弈的收敛率未知。
- 方法要点：将算法解释为额外近端点近似，通过预测更远未来奖励实现线性收敛加速。
- 实验或效果：实验显示额外预测驱动加速收敛，与理论定理定性一致。
