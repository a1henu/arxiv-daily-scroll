...
**一句话要点**：提出基于对比学习的相似性引导篡改文档生成方法以解决数据稀缺问题

**关键词**：篡改文档检测, 对比学习, 数据生成, 文档图像, 相似性引导, 视觉质量评估

## 3 点简述
- 核心问题：篡改文档检测因数据稀缺和现有生成方法多样性不足、视觉质量差而受限
- 方法要点：训练两个辅助网络，分别用于文本裁剪相似性比较和裁剪质量评估，以指导高质量篡改文档生成
- 实验或效果：在相同训练协议下，基于本方法生成的数据训练模型在多个开源数据集上表现优于现有方法
