...
**arXiv**：[2602.17502v1](https://arxiv.org/abs/2602.17502) · [PDF](https://arxiv.org/pdf/2602.17502.pdf)  
...
**一句话要点**：探索膝上动力配置以优化动力假肢膝关节质量分布，提升行走性能

**关键词**：动力假肢膝关节, 质量分布优化, 步态分析, 膝上配置, 行走性能, 临床可行性

## 3 点简述
- 核心问题：动力假肢膝关节的附加质量可能削弱其助行效益，需优化质量分布而非仅减重。
- 方法要点：在小型队列中比较膝上与膝下动力配置，评估其对行走速度、步频和步态对称性的影响。
- 实验或效果：膝上配置显示行走速度提升9.2%（一名参与者），步频增加3.6%，步态对称性效果不一，控制策略在斜坡和楼梯任务中稳健。
