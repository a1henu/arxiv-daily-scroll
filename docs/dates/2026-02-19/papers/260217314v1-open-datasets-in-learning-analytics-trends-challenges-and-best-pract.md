...
**arXiv**：[2602.17314v1](https://arxiv.org/abs/2602.17314) · [PDF](https://arxiv.org/pdf/2602.17314.pdf)  
**作者**：Valdemar Švábenský, Brendan Flanagan, Erwin Daniel López Zapata, Atsushi Shimada  

**一句话要点**：调查学习分析领域开放数据集现状，提出PRACTICE指南以促进数据共享实践。

**关键词**：学习分析, 开放数据集, 数据共享, 教育数据挖掘, 人工智能教育, 研究可复现性

## 3 点简述
- 核心问题：学习分析领域开放数据集的可用性及相关实践不明确，影响研究可复现性与协作。
- 方法要点：手动审查1125篇会议论文，识别并分类172个数据集，提供详细分析与分类。
- 实验或效果：发现143个数据集未被先前调查覆盖，总结领域差距并制定8项数据发布指南。
