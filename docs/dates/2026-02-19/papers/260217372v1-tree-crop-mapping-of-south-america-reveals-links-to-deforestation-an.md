...
**arXiv**：[2602.17372v1](https://arxiv.org/abs/2602.17372) · [PDF](https://arxiv.org/pdf/2602.17372.pdf)  
...
- 方法要点：基于Sentinel-1和Sentinel-2时间序列，使用多模态时空深度学习模型生成地图。
- 实验或效果：识别约1100万公顷树作物，23%与毁林相关，揭示现有监管地图误分类问题。
