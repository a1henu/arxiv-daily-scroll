...
**arXiv**：[2602.17213v1](https://arxiv.org/abs/2602.17213) · [PDF](https://arxiv.org/pdf/2602.17213.pdf)  
**作者**：Florian Pauschitz, Ben Moseley, Ghislain Fourny  

**一句话要点**：提出AI辅助确定性博弈框架以扩展量子理论并预测复杂量子实验

**关键词**：量子理论扩展, AI辅助博弈, 局部隐变量, 完美预测, 神经网络学习, EPR实验

## 3 点简述
- 核心问题：在局部隐变量理论中规避自由选择假设，以扩展量子理论。
- 方法要点：将量子实验建模为博弈，使用神经网络学习含隐变量的奖励函数，基于完美预测算法。
- 实验或效果：在EPR 2-2-2实验中验证框架，作为局部实在隐变量模型的证明概念。
