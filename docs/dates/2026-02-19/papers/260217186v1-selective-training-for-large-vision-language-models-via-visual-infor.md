...
**一句话要点**：提出视觉信息增益以选择性地训练大型视觉语言模型，缓解语言偏见并提升视觉基础能力。

**关键词**：视觉信息增益, 大型视觉语言模型, 语言偏见缓解, 选择性训练, 视觉基础

## 3 点简述
- 核心问题：大型视觉语言模型存在语言偏见，常忽略视觉证据生成答案，缺乏量化视觉贡献的指标。
- 方法要点：引入视觉信息增益，基于困惑度度量视觉输入减少预测不确定性的程度，指导选择高增益样本和令牌进行训练。
- 实验或效果：选择性训练方案改善视觉基础，减少语言偏见，在减少监督下实现更优性能。
