...
**关键词**：机器人抓取, 6D姿态估计, 3D重建, 物理模拟基准, 感知系统评估

## 3 点简述
- 核心问题：标准几何评估未反映3D重建质量对机器人抓取等下游任务的影响
- 方法要点：通过物理模拟，在真实模型上执行基于重建网格生成的抓取姿态，评估姿态误差和几何不准确性
- 实验或效果：重建伪影显著减少抓取候选姿态，但在准确姿态估计下对抓取性能影响可忽略
