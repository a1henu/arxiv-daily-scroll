...
**关键词**：通用智能评估, 游戏基准测试, LLM合成游戏, 视觉语言模型, 开放平台

## 3 点简述
- 核心问题：现有AI基准测试狭窄且易饱和，难以评估人类般的通用智能。
- 方法要点：利用LLMs和人类参与合成代表性人类游戏，构建游戏环境容器化平台。
- 实验或效果：在100个游戏中评估7个前沿VLM，多数得分低于人类平均10%，尤其在需要世界模型、记忆和规划的游戏上表现不佳。
