...
**一句话要点**：提出LMP2工具以审计LLMs对个人数据的关联，揭示模型生成个人信息的准确性与隐私风险。

**关键词**：个人数据审计, 语言模型隐私, 黑盒评估, 人类中心设计, 数据隐私权利

## 3 点简述
- 核心问题：LLMs在预训练和交互中暴露于个人数据，用户缺乏对模型如何关联信息到其身份的洞察。
- 方法要点：开发LMP2，一种以人为本、保护隐私的审计工具，通过形成性研究优化，用于评估LLMs生成个人数据的准确性。
- 实验或效果：实证显示模型对知名个体生成多类个人数据，GPT-4o对日常用户生成11个特征准确率≥60%，72%参与者寻求控制模型关联。
