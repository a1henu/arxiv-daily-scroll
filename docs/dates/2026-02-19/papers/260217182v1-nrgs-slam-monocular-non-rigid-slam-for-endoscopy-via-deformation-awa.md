...
**一句话要点**：提出NRGS-SLAM，基于变形感知3D高斯泼溅的内窥镜单目非刚性SLAM系统，以解决变形场景中的耦合模糊问题。

**关键词**：单目非刚性SLAM, 内窥镜视觉, 3D高斯泼溅, 变形感知, 贝叶斯自监督, 几何先验

## 3 点简述
- 核心问题：内窥镜场景因软组织持续变形违反刚性假设，导致相机自运动与内在变形耦合模糊，现有方法缺乏有效解耦机制和高质量场景表示。
- 方法要点：引入变形感知3D高斯地图，通过贝叶斯自监督学习变形概率；设计变形跟踪模块优先低变形区域进行姿态估计，并更新变形；结合几何先验损失缓解病态问题。
- 实验或效果：在多个公共内窥镜数据集上，相比先进方法，相机姿态估计RMSE降低达50%，实现更高质量的光照真实重建，消融研究验证关键设计有效性。
