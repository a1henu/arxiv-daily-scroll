...
**arXiv**：[2602.17536v1](https://arxiv.org/abs/2602.17536) · [PDF](https://arxiv.org/pdf/2602.17536.pdf)  
**作者**：Chris Tennant  

**一句话要点**：提出AI原生粒子加速器愿景，通过AI协同设计实现自主运行以最大化科学产出。

**关键词**：粒子加速器, AI协同设计, 自主运行, 数字孪生, 自适应学习, 安全框架

## 3 点简述
- 核心问题：传统粒子加速器依赖人工操作，难以实现高效自主运行。
- 方法要点：从设计到运行，AI协同优化加速器结构、诊断和应用，构建AI原生平台。
- 实验或效果：未知，但提出九个研究方向以指导未来AI驱动加速器发展。
