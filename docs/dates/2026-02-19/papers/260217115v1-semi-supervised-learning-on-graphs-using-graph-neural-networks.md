...
**关键词**：图神经网络, 半监督学习, 节点回归, 风险界, 图卷积, 非参数估计

## 3 点简述
- 核心问题：图神经网络在半监督节点回归中缺乏严谨理论解释其成功条件与性能缩放。
- 方法要点：研究聚合-读出模型，推导线性图卷积与深度ReLU读出的非渐近风险界，分离近似、随机和优化误差。
- 实验或效果：数值实验验证理论，提供理解图神经网络性能与局限的系统框架。
