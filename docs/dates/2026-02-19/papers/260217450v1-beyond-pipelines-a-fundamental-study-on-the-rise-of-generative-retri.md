...
**arXiv**：[2602.17450v1](https://arxiv.org/abs/2602.17450) · [PDF](https://arxiv.org/pdf/2602.17450.pdf)  
**作者**：Amirereza Abbasi, Mohsen Hooshmand  

**一句话要点**：综述大语言模型通过检索增强生成对网络研究的重塑与影响

**关键词**：大语言模型, 检索增强生成, 网络研究, 信息检索, 推荐系统

## 3 点简述
- 核心问题：传统网络任务管道向生成式解决方案的转型挑战
- 方法要点：利用检索增强生成技术增强大语言模型在信息检索等任务中的性能
- 实验或效果：未知，但讨论了大语言模型在网络分析、推荐系统等应用中的潜力
