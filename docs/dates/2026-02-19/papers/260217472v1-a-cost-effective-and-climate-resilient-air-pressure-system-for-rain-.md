...
**arXiv**：[2602.17472v1](https://arxiv.org/abs/2602.17472) · [PDF](https://arxiv.org/pdf/2602.17472.pdf)  
**作者**：Mohamed Sabry, Joseba Gorospe, Cristina Olaverri-Monreal  

**一句话要点**：提出低成本气压系统以减少雨水对自动驾驶车辆摄像头的影响

**关键词**：自动驾驶车辆, 雨水防护, 硬件系统, 成本效益, 行人检测, 可持续交通

## 3 点简述
- 核心问题：现有雨水防护方案效果有限、成本高，难以规模化部署于自动驾驶车辆。
- 方法要点：设计兼容多摄像头的气压系统，通过物理硬件提升雨水防护，支持可持续交通目标。
- 实验或效果：系统将深度学习模型的行人检测准确率从8.3%提升至41.6%。
