...
**关键词**：最大熵生成, 扩散模型, 随机微分方程, 高维采样, 小波散射矩, 负熵估计

## 3 点简述
- 核心问题：从有限信息生成样本，传统最大熵方法在高维下采样效率低，扩散模型缺乏理论保证且易过拟合。
- 方法要点：基于随机插值框架，通过随机微分方程在有限时间内引导矩至预设值，避免平衡态方法的慢混合问题。
- 实验或效果：应用于金融时间序列、湍流和宇宙学场，使用小波散射矩估计高维多尺度过程的负熵。
