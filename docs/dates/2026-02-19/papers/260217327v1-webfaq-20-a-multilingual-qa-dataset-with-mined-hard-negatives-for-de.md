...
**一句话要点**：提出WebFAQ 2.0多语言问答数据集，包含挖掘的困难负样本以支持稠密检索训练

**关键词**：多语言问答数据集, 稠密检索, 困难负样本挖掘, 对比学习, 知识蒸馏, 跨语言信息检索

## 3 点简述
- 核心问题：构建大规模多语言FAQ数据集，支持稠密检索模型训练，解决资源稀缺问题
- 方法要点：采用新数据收集策略直接爬取网页内容，扩展至108种语言，并挖掘困难负样本
- 实验或效果：发布包含1.25M查询的困难负样本数据集，支持对比学习和知识蒸馏两种微调策略
