...
**一句话要点**：提出图神经网络模型预测控制框架，以实时控制高维系统如软体机器人。

**关键词**：图神经网络, 模型预测控制, 高维系统控制, 软体机器人, 实时计算, GPU并行化

## 3 点简述
- 核心问题：高维系统控制需模型兼顾复杂动力学与计算效率。
- 方法要点：结合图神经网络动态模型与结构利用模型预测控制，通过图表示和定制压缩算法实现高效计算。
- 实验或效果：在仿真和物理软体机器人实验中，实现1000节点100Hz闭环控制，硬件跟踪精度亚厘米级，优于基线63.6%。
