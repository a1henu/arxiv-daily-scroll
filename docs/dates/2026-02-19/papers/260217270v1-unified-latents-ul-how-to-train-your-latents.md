...
**一句话要点**：提出统一潜变量框架，通过扩散先验和模型联合正则化潜变量表示，提升图像和视频生成效率与质量。

**关键词**：潜变量学习, 扩散模型, 图像生成, 视频生成, 比特率约束, 计算效率

## 3 点简述
- 核心问题：如何高效学习潜变量表示，同时保证高重建质量和低计算成本。
- 方法要点：将编码器输出噪声与先验最小噪声级关联，简化训练目标并约束潜变量比特率上界。
