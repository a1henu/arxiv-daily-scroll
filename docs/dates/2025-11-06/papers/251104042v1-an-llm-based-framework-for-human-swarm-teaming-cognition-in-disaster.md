...
**arXiv**：[2511.04042v1](https://arxiv.org/abs/2511.04042) · [PDF](https://arxiv.org/pdf/2511.04042.pdf)  
**作者**：Kailun Ji, Xiaoyu Hu, Xinyu Zhang, Jun Chen  

**一句话要点**：提出LLM-CRF框架以解决灾难搜救中人机协作的意图-行动差距问题

**关键词**：人机协作, 无人机集群, 大语言模型, 灾难搜救, 认知增强, 实时反馈

## 3 点简述
- 核心问题：灾难搜救中人机协作存在意图-行动差距，导致高认知负担和错误风险。
- 方法要点：利用LLM作为认知引擎，通过多模态交互实现意图理解、任务分解和规划。
- 实验效果：在模拟场景中，任务完成时间减少64.2%，成功率提高7%，认知负荷降低42.9%。

## 摘要（原文）

> Large-scale disaster Search And Rescue (SAR) operations are persistently
