...
**一句话要点**：提出ForeRobo生成式机器人代理，利用无限仿真数据解决3D目标驱动操作问题

**关键词**：机器人操作, 生成式仿真, 3D目标预测, 仿真到真实迁移, 状态生成模型

## 3 点简述
- 核心问题：高效利用仿真获取高级操作技能，避免端到端策略学习的低效性
- 方法要点：结合生成范式与经典控制，通过propose-generate-learn-actuate循环生成目标状态
- 实验效果：在多种任务中平均提升56.32%，真实世界零样本迁移成功率79.28%
