...
**一句话要点**：提出路径-不确定性协同优化与轻量停滞检测框架，以提升机器人探索效率

**关键词**：主动SLAM, 路径优化, 不确定性建模, 深度强化学习, 停滞检测, 机器人探索

## 3 点简述
- 现有主动SLAM方法存在探索速度慢和路径次优问题
- 结合路径-不确定性协同优化DRL和轻量停滞检测机制，平衡探索与利用
- 实验显示探索时间缩短65%，路径距离减少42%，验证了实际适用性
