---
layout: default
title: Design and Control of a Coaxial Dual-rotor Reconfigurable Tailsitter UAV Based on Swashplateless Mechanism
---

# Design and Control of a Coaxial Dual-rotor Reconfigurable Tailsitter UAV Based on Swashplateless Mechanism
**arXiv**：[2511.04251v1](https://arxiv.org/abs/2511.04251) · [PDF](https://arxiv.org/pdf/2511.04251.pdf)  
**作者**：Jinfeng Liang, Haocheng Guo, Ximin Lyu  

**一句话要点**：提出可重构尾坐式无人机设计，基于无斜盘机制解决多旋翼模式抗风性与功耗问题。

**关键词**：尾坐式无人机, 可重构机翼, 同轴双旋翼, 无斜盘机制, 垂直起降, 飞行控制

## 3 点简述
- 尾坐式VTOL无人机在多旋翼模式下易受风扰，因机身暴露面积大。
- 采用可重构机翼、同轴异构双旋翼和无斜盘机制，优化结构与控制。
- 通过飞行测试验证全包线稳定性能，降低功耗与振动。

## 摘要（原文）

> The tailsitter vertical takeoff and landing (VTOL) UAV is widely used due to
