...
**一句话要点**：提出上下文感知策略以改进机器人强化学习的模拟到真实迁移

**关键词**：模拟到真实迁移, 上下文感知策略, 领域随机化, 强化学习, 机器人控制

## 3 点简述
- 核心问题：模拟到真实迁移中环境动态差异导致策略泛化失败。
- 方法要点：集成上下文估计模块，基于动态参数条件化策略。
- 实验或效果：在控制基准和真实机器人任务中优于上下文无关基线。
