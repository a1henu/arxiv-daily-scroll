...
**一句话要点**：提出GentleHumanoid框架，集成阻抗控制实现上半身柔顺，以安全自然的人机交互。

**关键词**：人形机器人, 阻抗控制, 强化学习, 物理交互, 柔顺性, 运动跟踪

## 3 点简述
- 问题：人形机器人交互中，强化学习策略常强调刚性跟踪，抑制外力，缺乏柔顺性。
- 方法：统一弹簧模型模拟阻力和引导接触，确保肩肘腕运动一致，并设可调力阈值。
- 效果：在模拟和Unitree G1上测试，降低峰值接触力，保持任务成功，交互更平滑自然。
