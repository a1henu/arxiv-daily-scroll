...
**一句话要点**：提出统一共享自治框架，通过高层抽象整合人类输入与自主规划以解决自动驾驶在罕见场景中的脆弱性问题。

**关键词**：共享自治, 自动驾驶, 视觉语言模型, 意图推断, 语义仲裁, 基准测试

## 3 点简述
- 核心问题：自动驾驶在罕见、模糊和分布外场景中脆弱，而人类能通过上下文推理成功处理。
- 方法要点：利用视觉语言模型从多模态线索推断驾驶意图，并在语义层面仲裁人类与自主控制。
- 实验或效果：在Bench2Drive基准测试中，显著降低碰撞率并提升整体性能，人类调查显示92%参与者同意仲裁结果。
