...
**一句话要点**：提出结合合成与真实数据的YOLOv10模型以提升海洋平台检测性能

**关键词**：海洋平台检测, 合成数据增强, YOLOv10模型, 遥感图像分析, 地理迁移性

## 3 点简述
- 海洋基础设施监测中，数据稀缺导致模型性能不足，尤其对少数类对象。
- 使用合成与真实Sentinel-1图像训练YOLOv10，评估地理迁移性和合成数据影响。
- 模型在未见区域检测3529个平台，F1分数从0.85提升至0.90，验证泛化能力。
