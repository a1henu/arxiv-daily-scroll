...
**关键词**：回归分类等价性, margin最大化, 回归难度估计, 神经网络线性化, 支持向量回归

## 3 点简述
- 核心问题：回归与分类间缺乏形式化等价关系，传统方法中margin项仅作为正则化使用。
- 方法要点：证明回归问题与线性可分分类任务等价，基于此推导新回归公式和回归难度度量。
- 实验或效果：应用等价性训练神经网络学习线性化映射，提升线性回归器性能。
