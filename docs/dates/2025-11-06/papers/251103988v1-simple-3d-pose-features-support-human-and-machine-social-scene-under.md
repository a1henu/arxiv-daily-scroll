...
**一句话要点**：提出3D社交姿态特征以提升机器对人类社交场景的理解能力

**关键词**：3D姿态估计, 社交场景理解, 计算机视觉, 人类行为分析, 特征提取

## 3 点简述
- 核心问题：人类能快速理解社交互动，但AI视觉系统在此任务上表现不佳，可能因缺乏3D姿态信息。
- 方法要点：结合姿态和深度估计算法提取3D关节位置，并推导紧凑的3D社交姿态特征。
- 实验或效果：3D姿态特征优于多数AI模型，且能提升现成模型性能，匹配人类判断。
