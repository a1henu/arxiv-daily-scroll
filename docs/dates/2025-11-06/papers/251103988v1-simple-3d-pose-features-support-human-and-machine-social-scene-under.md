...
**一句话要点**：提出简单3D姿态特征以支持人类和机器社交场景理解

**关键词**：3D姿态估计, 社交互动识别, 视觉特征提取, 人类认知建模, AI视觉系统

## 3 点简述
- 核心问题：人类社交互动识别能力计算机制未知，AI视觉系统难以匹配。
- 方法要点：结合姿态和深度估计算法提取3D关节位置，并推导紧凑3D社交姿态特征。
- 实验或效果：3D姿态特征优于多数AI模型，提升模型性能并预测其匹配人类判断能力。
