...
**一句话要点**：提出SIMS-V框架，利用3D模拟器生成空间视频数据以解决多模态模型空间推理不足问题

**关键词**：空间视频理解, 模拟数据生成, 多模态语言模型, 空间推理, 指令微调

## 3 点简述
- 多模态语言模型在时空空间推理方面存在困难，真实视频数据标注稀缺是瓶颈
- 使用3D模拟器生成空间丰富视频数据，通过系统消融识别三种关键问题类型
- 在7B参数模型上仅用25K模拟数据微调，超越大基线并在真实基准上表现优异
