...
**arXiv**：[2511.20094v1](https://arxiv.org/abs/2511.20094) · [PDF](https://arxiv.org/pdf/2511.20094.pdf)  
**作者**：Giovanni Spitale, Federico Germani  

**一句话要点**：提出数字幽灵伦理框架以规范AI模拟逝者技术

**关键词**：数字幽灵, AI伦理, 逝者模拟, 哀悼技术, 数据隐私, 分类法

## 3 点简述
- 核心问题：AI模拟逝者引发伦理争议，涉及哀悼、隐私和商业化
- 方法要点：构建九维分类法，定义伦理可接受数字幽灵特征
- 实验或效果：未知，论文为概念分析，未涉及实验验证
