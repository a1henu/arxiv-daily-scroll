...
**arXiv**：[2511.20607v1](https://arxiv.org/abs/2511.20607) · [PDF](https://arxiv.org/pdf/2511.20607.pdf)  
**作者**：Nils Müller  

**一句话要点**：提出基于松弛的方法优化有限域上双变量函数和，解决NP等效问题。

**关键词**：函数优化, 双变量函数和, 松弛方法, NP等效, 线性规划, 熵正则化

## 3 点简述
- 研究有限域上多变量函数优化，函数表示为双变量函数和，复杂度为NP等效。
- 使用松弛、ℓ²近似和熵正则化方法，导出线性规划和坐标上升等可解公式。
- 实验应用于随机函数、顶点着色和信号重建，分析不同函数类建模能力。
