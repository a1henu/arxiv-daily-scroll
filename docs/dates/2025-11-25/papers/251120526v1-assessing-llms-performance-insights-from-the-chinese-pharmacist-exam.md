...
**一句话要点**：评估ChatGPT-4o与DeepSeek-R1在中国药师考试中的表现差异

**关键词**：大语言模型评估, 药师执照考试, 医疗AI, 模型性能比较, 统计检验

## 3 点简述
- 核心问题：大语言模型在药师执照等高风险专业认证任务中的能力评估
- 方法要点：使用2306道纯文本选择题，基于准确率进行统计比较
- 实验效果：DeepSeek-R1总体准确率显著高于ChatGPT-4o，达90.0%对76.1%
