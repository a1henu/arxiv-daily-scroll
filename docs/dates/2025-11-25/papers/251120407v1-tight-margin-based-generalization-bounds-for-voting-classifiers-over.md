...
**arXiv**：[2511.20407v1](https://arxiv.org/abs/2511.20407) · [PDF](https://arxiv.org/pdf/2511.20407.pdf)  
**作者**：Kasper Green Larsen, Natascha Schalburg  

**一句话要点**：提出紧致边界以解决投票分类器在有限假设集上的泛化问题

**关键词**：投票分类器, 泛化边界, 边距理论, 有限假设集, 机器学习理论

## 3 点简述
- 核心问题：投票分类器在有限假设集下的泛化边界不紧致
- 方法要点：基于边界的泛化界，考虑假设集大小、边距、训练点分数等参数
- 实验或效果：证明边界在参数权衡中渐近紧致，提升理论保证
