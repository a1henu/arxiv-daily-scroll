...
**arXiv**：[2511.20605v1](https://arxiv.org/abs/2511.20605) · [PDF](https://arxiv.org/pdf/2511.20605.pdf)  
**作者**：Xiwen Huang, Pierre Pinson  

**一句话要点**：提出主动学习市场方法以优化资源受限环境中的标签采购

**关键词**：主动学习, 标签采购, 市场机制, 预算优化, 预测模型, 数据获取

## 3 点简述
- 核心问题：如何在预算约束下高效采购标签以改进模型拟合和预测性能
- 方法要点：基于方差和查询委员会策略，结合定价机制优化标签获取过程
- 实验或效果：在房地产定价和能源预测数据集上验证，以更少标签实现更优性能
