...
**arXiv**：[2511.20540v1](https://arxiv.org/abs/2511.20540) · [PDF](https://arxiv.org/pdf/2511.20540.pdf)  
**作者**：Adam Bjorndahl  

**一句话要点**：收录第二十届理性与知识理论方面会议论文，促进跨学科研究

**关键词**：理性理论, 知识逻辑, 跨学科研究, 博弈论, 多智能体系统

## 3 点简述
- 核心问题：探讨理性、知识及相关跨学科议题，如知识语义模型和博弈论
- 方法要点：汇集计算机科学、哲学、逻辑等领域研究，推动理论模型发展
- 实验或效果：未知具体实验，但会议促进学术交流与知识传播
