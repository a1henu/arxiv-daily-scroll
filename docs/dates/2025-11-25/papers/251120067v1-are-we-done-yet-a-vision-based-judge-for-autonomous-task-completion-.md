...
**arXiv**：[2511.20067v1](https://arxiv.org/abs/2511.20067) · [PDF](https://arxiv.org/pdf/2511.20067.pdf)  
**作者**：Marta Sumyk, Oleksandr Kosovan  

**一句话要点**：提出基于视觉语言模型的自主评估框架，以提升计算机使用代理的任务完成可靠性。

**关键词**：计算机使用代理, 视觉语言模型, 任务完成评估, 自主反馈, 屏幕截图分析

## 3 点简述
- 计算机使用代理常无法可靠判断任务是否完成。
- 使用视觉语言模型从屏幕截图和任务描述直接评估任务完成。
- 在macOS应用数据集上达到73%检测准确率，反馈应用后任务成功率平均提升27%。
