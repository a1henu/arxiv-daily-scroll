...
**一句话要点**：提出LungEvaty基于Transformer的深度学习模型，用于LDCT筛查中的肺癌风险预测

**关键词**：肺癌风险预测, Transformer模型, 低剂量CT筛查, 全肺分析, 开源框架

## 3 点简述
- 核心问题：LDCT筛查中肺癌风险预测需可扩展方法，现有方法依赖像素注释或片段分析限制性能
- 方法要点：使用全肺输入Transformer框架，无需区域监督，可选AIAG损失增强解剖注意力
- 实验或效果：在超9万CT扫描上训练，匹配SOTA性能，提供开源可扩展解决方案
