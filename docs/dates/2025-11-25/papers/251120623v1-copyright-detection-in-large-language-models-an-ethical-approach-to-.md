...
**arXiv**：[2511.20623v1](https://arxiv.org/abs/2511.20623) · [PDF](https://arxiv.org/pdf/2511.20623.pdf)  
**作者**：David Szczecina, Senan Gaffori, Edmond Li  

**一句话要点**：提出开源版权检测平台以解决LLM训练数据中未经授权使用版权内容的问题

**关键词**：版权检测, 大型语言模型, 开源平台, 相似性检测, 计算优化, AI伦理

## 3 点简述
- 核心问题：大型语言模型训练数据中未经授权包含版权内容，现有检测框架计算密集且不易访问
- 方法要点：开发开源平台，优化相似性检测和数据集验证，通过高效API调用降低计算开销
- 实验或效果：计算开销减少10-30%，提供直观用户界面和可扩展后端，增强AI开发透明度
