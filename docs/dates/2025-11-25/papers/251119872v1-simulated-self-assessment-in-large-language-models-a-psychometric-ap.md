...
**一句话要点**：提出心理测量提示法以评估大语言模型在任务中的模拟自我效能

**关键词**：大语言模型, 自我效能评估, 心理测量提示, 任务性能, 人机交互, 模型可靠性

## 3 点简述
- 核心问题：大语言模型的自我评估是否可靠反映其实际能力。
- 方法要点：改编通用自我效能量表，在四种条件下测试十种模型。
- 实验效果：自我评估稳定但未校准，高自信模型总结能力弱。
