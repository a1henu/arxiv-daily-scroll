...
**arXiv**：[2511.20395v1](https://arxiv.org/abs/2511.20395) · [PDF](https://arxiv.org/pdf/2511.20395.pdf)  
**作者**：M. C. Schoppema, B. H. M. van der Velden, A. Hürriyetoğlu, M. D. Klijnstra, E. J. Faassen, A. Gerssen, H. J. van der Fels-Klerx  

**一句话要点**：提出可解释深度学习模型以预测双壳类软体动物中河豚毒素污染

**关键词**：河豚毒素污染, 可解释人工智能, 深度学习模型, 环境因素分析, 食品安全预测

## 3 点简述
- 核心问题：河豚毒素污染在双壳类软体动物中导致食品安全风险和经济损失。
- 方法要点：使用气象和水文特征构建可解释深度学习模型预测污染。
- 实验或效果：识别日出日落时间、全球辐射、水温和氯化物浓度为关键因素。
