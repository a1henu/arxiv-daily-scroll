...
**arXiv**：[2510.27307v1](https://arxiv.org/abs/2510.27307) · [PDF](https://arxiv.org/pdf/2510.27307.pdf)  
**作者**：Mingcui Zhang, Zhigang Jia  

**一句话要点**：提出基于双四元数矩阵分解的脆弱零水印方法以保护医学图像版权与检测篡改

**关键词**：零水印技术, 双四元数矩阵分解, 医学图像保护, 版权保护, 内容篡改检测

## 3 点简述
- 医学图像在传输中面临版权归属和内容篡改风险，需有效保护
- 利用双四元数标准部分与对偶部分运算关联图像与水印，构建零水印信息
- 未知实验效果，但方法旨在实现版权保护和内容篡改检测

## 摘要（原文）

> Medical images play a crucial role in assisting diagnosis, remote
