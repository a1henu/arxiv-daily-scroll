...
**arXiv**：[2510.27151v1](https://arxiv.org/abs/2510.27151) · [PDF](https://arxiv.org/pdf/2510.27151.pdf)  
**作者**：Xueliang Cheng, Kanzhong Yao, Andrew West, Ognjen Marjanovic, Barry Lennox, Keir Groves  

**一句话要点**：提出协作水下定位系统以解决受限空间水下机器人定位难题

**关键词**：水下机器人定位, 协作机器人, 传感器融合, GPS拒绝环境, 实时控制, 基础设施无关定位

## 3 点简述
- 核心问题：现有水下定位系统在工业受限环境中因覆盖差、依赖外部基础设施而性能不佳。
- 方法要点：采用协作机器人融合传感器，水面车辆作为移动领导者辅助水下机器人定位。
- 实验或效果：在大型测试池中验证，实时轨迹控制下平均欧几里得距离误差为70毫米。
