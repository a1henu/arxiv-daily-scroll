...
**arXiv**：[2510.27178v1](https://arxiv.org/abs/2510.27178) · [PDF](https://arxiv.org/pdf/2510.27178.pdf)  
**作者**：Xuan-Thuan Nguyen, Khac Nam Nguyen, Ngoc Duy Tran, Thi Thoa Mac, Anh Nguyen, Hoang Hiep Ly, Tung D. Ta  

**一句话要点**：提出MobiDock模块化自重构移动机械臂系统，以简化多机器人协作控制问题。

**关键词**：模块化机器人, 自主对接, 移动机械臂, 多机器人系统, 动态稳定性

## 3 点简述
- 多机器人系统在协作中面临控制协调和动态稳定性挑战。
- 采用基于计算机视觉的自主对接策略和螺纹锁紧机制实现物理连接。
- 实验显示对接系统在动态稳定性和任务效率上优于独立机器人。
