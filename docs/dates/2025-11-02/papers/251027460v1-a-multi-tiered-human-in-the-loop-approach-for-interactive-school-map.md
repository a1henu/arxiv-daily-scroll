...
**arXiv**：[2510.27460v1](https://arxiv.org/abs/2510.27460) · [PDF](https://arxiv.org/pdf/2510.27460.pdf)  
**作者**：Casper Fibaek, Abi Riley, Kelsey Doerksen, Do-Hyung Kim, Rochelle Schneider  

**一句话要点**：提出多层级人机交互框架以改进发展中地区学校地图的准确性和完整性

**关键词**：人机交互框架, 学校地图绘制, 地球观测, 机器学习, 高分辨率影像, 深度学习

## 3 点简述
- 核心问题：发展中地区教育设施记录稀缺且更新不及时，影响准确性和完整性。
- 方法要点：结合机器学习分析人口密度和土地覆盖，使用高分辨率影像和深度学习识别候选学校位置。
- 实验或效果：初步评估显示该策略可扩展且成本效益高，支持教育基础设施规划和资源分配。

## 摘要（原文）

> This paper presents a multi-tiered human-in-the-loop framework for
