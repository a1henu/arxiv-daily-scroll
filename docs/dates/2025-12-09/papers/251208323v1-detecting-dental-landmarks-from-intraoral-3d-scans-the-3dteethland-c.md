...
**arXiv**：[2512.08323v1](https://arxiv.org/abs/2512.08323) · [PDF](https://arxiv.org/pdf/2512.08323.pdf)  
...
**一句话要点**：提出3DTeethLand挑战赛以解决口腔内3D扫描中的牙齿标志点检测问题

**关键词**：牙齿标志点检测, 口腔内3D扫描, 深度学习, 医学图像计算, MICCAI挑战赛, 临床牙科
