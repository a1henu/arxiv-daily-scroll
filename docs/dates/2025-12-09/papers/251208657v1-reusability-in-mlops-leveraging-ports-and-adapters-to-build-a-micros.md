...
**arXiv**：[2512.08657v1](https://arxiv.org/abs/2512.08657) · [PDF](https://arxiv.org/pdf/2512.08657.pdf)  
**作者**：Renato Cordeiro Ferreira, Aditya Dhinavahi, Rowanne Trapmann, Willem-Jan van den Heuvel  

**一句话要点**：应用端口与适配器模式构建可复用的MLOps微服务架构，以支持海事领域异常检测系统。

**关键词**：MLOps, 端口与适配器模式, 微服务架构, 海事异常检测, 软件架构复用, 六边形架构
