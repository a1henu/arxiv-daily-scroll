...
**arXiv**：[2512.08481v1](https://arxiv.org/abs/2512.08481) · [PDF](https://arxiv.org/pdf/2512.08481.pdf)  
**作者**：Yixiang Lin, Tiancheng Yang, Jonathan Eden, Ying Tan  

**一句话要点**：通过概率感知实验揭示物理人机交互中人类决策的个体差异，支持累积前景理论建模。

**关键词**：物理人机交互, 概率感知, 累积前景理论, 行为建模, 不确定性决策, 自适应控制
