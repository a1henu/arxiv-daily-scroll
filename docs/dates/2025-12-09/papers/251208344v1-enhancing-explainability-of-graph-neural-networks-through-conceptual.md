...
**arXiv**：[2512.08344v1](https://arxiv.org/abs/2512.08344) · [PDF](https://arxiv.org/pdf/2512.08344.pdf)  
**作者**：Tien Cuong Bui  

**一句话要点**：提出可解释AI框架以增强图神经网络在复杂图结构中的决策透明度

**关键词**：图神经网络, 可解释人工智能, 图结构分析, 后验解释, 自解释模型
