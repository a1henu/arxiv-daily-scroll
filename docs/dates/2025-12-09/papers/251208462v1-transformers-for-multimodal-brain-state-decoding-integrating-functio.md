...
**arXiv**：[2512.08462v1](https://arxiv.org/abs/2512.08462) · [PDF](https://arxiv.org/pdf/2512.08462.pdf)  
**作者**：Danial Jafarzadeh Jazi, Maryam Hajiesmaeili  

**一句话要点**：提出基于Transformer的多模态框架，整合fMRI数据与DICOM元数据以解码脑状态。

**关键词**：脑状态解码, 多模态Transformer, fMRI数据分析, DICOM元数据, 注意力机制, 临床应用
