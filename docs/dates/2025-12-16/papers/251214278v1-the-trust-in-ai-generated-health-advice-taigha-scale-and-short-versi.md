...
**一句话要点**：提出TAIGHA与TAIGHA-S量表，专门评估用户对AI生成健康建议的信任与不信任。

**关键词**：AI生成健康建议, 信任量表, 心理测量学验证, 内容效度, 结构效度, 短量表

## 3 点简述
- 核心问题：缺乏专门测量用户对AI生成健康建议信任的有效工具。
- 方法要点：基于理论开发量表，通过专家验证、心理测量学验证和自动化项目缩减。
- 实验或效果：在385名英国参与者中验证，显示优秀内容效度、结构效度和高内部一致性。
