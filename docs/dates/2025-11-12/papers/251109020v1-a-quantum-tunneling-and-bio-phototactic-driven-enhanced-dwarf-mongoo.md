...
**arXiv**：[2511.09020v1](https://arxiv.org/abs/2511.09020) · [PDF](https://arxiv.org/pdf/2511.09020.pdf)  
**作者**：Mingyang Yu, Haorui Yang, Kangning An, Xinjian Wei, Xiaoxuan Xu, Jing Xu  

**一句话要点**：提出增强矮獴优化算法以解决无人机轨迹规划中的局部最优和多样性不足问题

**关键词**：无人机轨迹规划, 元启发优化算法, 量子隧道优化, 生物趋光搜索, 正交学习策略, 工程问题求解

## 3 点简述
- 核心问题：无人机轨迹规划中传统元启发算法易早熟收敛且解多样性不足
- 方法要点：集成量子隧道逃逸、生物趋光搜索和正交透镜学习策略
- 实验或效果：在标准测试和真实任务中优于14种算法，验证高效性和实用性
