...
**arXiv**：[2511.09028v1](https://arxiv.org/abs/2511.09028) · [PDF](https://arxiv.org/pdf/2511.09028.pdf)  
**作者**：Jinkun You, Jiaxue Li, Jie Zhang, Yicong Zhou  

**一句话要点**：提出密集跨尺度图像对齐模型以解决现有方法精度低和计算复杂的问题

**关键词**：图像对齐, 跨尺度特征, 无监督学习, 全空间相关, 恰可察觉差

## 3 点简述
- 现有无监督图像对齐方法精度有限且计算复杂度高
- 利用跨尺度特征相关性降低对齐难度，引入全空间相关模块和恰可察觉差指导
- 实验表明方法在精度和效率上优于现有先进方法
