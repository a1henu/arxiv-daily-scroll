...
**arXiv**：[2511.08897v1](https://arxiv.org/abs/2511.08897) · [PDF](https://arxiv.org/pdf/2511.08897.pdf)  
**作者**：Mehdi Fatan Serj, C. Alejandro Parraga, Xavier Otazu  

**一句话要点**：提出增强VisNet模型以提升物体识别和对称分类性能

**关键词**：物体识别, 对称检测, Hebbian学习, 径向基函数神经元, 马氏距离, 生物启发模型

## 3 点简述
- 核心问题：生物视觉系统高效物体识别在人工系统中难以复现
- 方法要点：结合径向基函数神经元、马氏距离学习和视网膜预处理
- 实验或效果：在MNIST等数据集上显著提高识别准确率
