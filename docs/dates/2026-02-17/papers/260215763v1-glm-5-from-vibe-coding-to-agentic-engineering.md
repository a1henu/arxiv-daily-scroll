...
**arXiv**：[2602.15763v1](https://arxiv.org/abs/2602.15763) · [PDF](https://arxiv.org/pdf/2602.15763.pdf)  
...
**一句话要点**：提出GLM-5基础模型，通过DSA和异步强化学习，从氛围编码转向代理工程，提升编码与推理能力。

**关键词**：基础模型, 代理工程, 异步强化学习, 长上下文保真度, 编码能力, 软件工程

## 3 点简述
- 核心问题：传统编码模型在长上下文和复杂软件工程任务中效率与性能不足，需向代理工程范式过渡。
- 方法要点：采用DSA降低训练和推理成本，保持长上下文保真度；实施异步强化学习基础设施，解耦生成与训练，提升后训练效率。
- 实验或效果：在主要开放基准测试中达到最先进性能，在真实世界编码任务中超越先前基线，处理端到端软件工程挑战。
