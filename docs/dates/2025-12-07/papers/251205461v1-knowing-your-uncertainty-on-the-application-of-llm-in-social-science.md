...
**arXiv**：[2512.05461v1](https://arxiv.org/abs/2512.05461) · [PDF](https://arxiv.org/pdf/2512.05461.pdf)  
**作者**：Bolun Zhang, Linzhuo Li, Yunqi Chen, Qinlin Zhao, Zihan Zhu, Xiaoyuan Yi, Xing Xie  

**一句话要点**：提出统一框架评估LLM不确定性，以支持社会科学研究中的严谨应用。

**关键词**：大语言模型, 不确定性量化, 社会科学研究, 任务分类, 验证框架, 方法论指南

## 3 点简述
- 核心问题：LLM的黑盒训练和随机推理元素在社会科学研究中引入不确定性挑战。
- 方法要点：基于任务类型和验证类型构建T-V分类框架，映射不确定性量化方法。
- 实验或效果：提供方法论保障和实践指南，促进LLM在社会科学中的可靠集成。
