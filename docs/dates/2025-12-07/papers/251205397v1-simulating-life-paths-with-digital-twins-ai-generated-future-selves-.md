...
**arXiv**：[2512.05397v1](https://arxiv.org/abs/2512.05397) · [PDF](https://arxiv.org/pdf/2512.05397.pdf)  
...
**一句话要点**：提出AI数字孪生模拟人生路径，以增强未来自我想象并影响决策选择。

**关键词**：数字孪生, 前瞻认知, 多模态合成, 决策支持, 随机对照研究, 未来自我

## 3 点简述
- 核心问题：人们在重大人生决策中难以想象未来自我，导致前瞻认知受限。
- 方法要点：利用多模态合成创建个性化未来自我化身，模拟不同人生路径以支持决策。
- 实验或效果：随机对照研究表明，化身能非对称影响决策，系统生成选项可扩展选择范围。
