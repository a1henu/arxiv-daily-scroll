...
**arXiv**：[2512.05453v1](https://arxiv.org/abs/2512.05453) · [PDF](https://arxiv.org/pdf/2512.05453.pdf)  
**作者**：Luc Moreau, Alfred Rossi, Sophie Stalla-Bourdillon  

**一句话要点**：提出Parajudica，一个基于RDF/SPARQL的规则系统，用于评估多框架下上下文依赖的数据合规状态。

**关键词**：数据合规评估, RDF规则系统, 上下文依赖分析, 多框架合规, SPARQL查询, 合规政策执行

## 3 点简述
- 核心问题：在多个同时适用的合规框架下实施基于策略的数据访问控制面临挑战。
- 方法要点：开发开放、模块化和可扩展的RDF/SPARQL规则系统，支持上下文依赖的合规评估。
- 实验或效果：应用于现有法律框架和行业标准，展示其在合规政策执行、监控、数据发现和风险评估中的实用性。
