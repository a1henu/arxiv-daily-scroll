...
**arXiv**：[2512.05870v1](https://arxiv.org/abs/2512.05870) · [PDF](https://arxiv.org/pdf/2512.05870.pdf)  
**作者**：Daniel Miliate, Ashlie Martini  

**一句话要点**：提出基于可解释机器学习的低挥发性空间润滑剂计算设计方法

**关键词**：空间润滑剂, 机器学习预测, 蒸汽压建模, 可解释性, 分子设计, 虚拟筛选

## 3 点简述
- 核心问题：空间机械组件需低挥发性液体润滑剂，但现有选项有限且设计受限。
- 方法要点：结合分子动力学模拟与实验数据，训练可解释机器学习模型预测蒸汽压。
- 实验或效果：模型识别化学结构与蒸汽压关系，提出候选分子用于空间润滑应用。
