...
**arXiv**：[2512.05350v1](https://arxiv.org/abs/2512.05350) · [PDF](https://arxiv.org/pdf/2512.05350.pdf)  
**作者**：Munazza Zaib, Wei Wang, Dulaji Hidellaarachchi, Isma Farah Siddiqui  

**一句话要点**：提出混合方法以支持软件工程中神经多样性女性的包容性分析

**关键词**：神经多样性, 软件工程, 性别偏见, 包容性方法, 混合方法论, 工作场所挑战

## 3 点简述
- 核心问题：神经多样性女性在软件工程中面临性别偏见与神经差异交织的独特挑战，如误诊、伪装和男性中心文化。
- 方法要点：结合InclusiveMag框架与GenderMag走查过程，设计三阶段混合方法，包括文献综述、人物角色构建和协作工作坊应用。
- 实验或效果：通过文献综述系统梳理认知、社会、组织、结构和职业发展挑战，为后续开发包容性分析方法奠定基础。
