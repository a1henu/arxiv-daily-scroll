...
**arXiv**：[2512.05808v1](https://arxiv.org/abs/2512.05808) · [PDF](https://arxiv.org/pdf/2512.05808.pdf)  
**作者**：Sushmita Bhattacharya, Ninad Jadhav, Hammad Izhar, Karen Li, Kevin George, Robert Wood, Stephanie Gil  

**一句话要点**：提出基于模型强化学习的自主无人机系统，实现实时抹香鲸海上会合跟踪。

**关键词**：自主无人机, 模型强化学习, 实时声学跟踪, 分布式决策, 鲸鱼潜水模型, 海上机器人部署

## 3 点简述
- 核心问题：在多重鲸鱼存在下实现实时声学跟踪、分布式机器人通信决策及长距离信号处理。
- 方法要点：结合现场传感器数据与经验鲸鱼潜水模型，指导导航决策。
- 实验或效果：通过海上实地会合、陆地硬件实验和基于表面观测轨迹的模拟进行评估。
