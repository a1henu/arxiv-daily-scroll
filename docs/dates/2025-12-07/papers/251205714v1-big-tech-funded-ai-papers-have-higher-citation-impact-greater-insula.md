...
**arXiv**：[2512.05714v1](https://arxiv.org/abs/2512.05714) · [PDF](https://arxiv.org/pdf/2512.05714.pdf)  
**作者**：Max Martin Gnewuch, Jan Philip Wahle, Terry Ruas, Bela Gipp  

**一句话要点**：量化大科技公司资助的AI论文在引用影响、封闭性和时效性偏见方面的表现

**关键词**：AI研究资助, 引用影响分析, 封闭性趋势, 时效性偏见, 大科技公司, 学术会议分析

## 3 点简述
- 核心问题：大科技公司资助的AI论文数量、引用影响及驱动因素未知
- 方法要点：分析1998-2022年Scopus中约49.8K篇AI论文的引用数据
- 实验或效果：发现资助论文引用影响更高、更封闭且偏好引用近期工作
