...
**arXiv**：[2512.05438v1](https://arxiv.org/abs/2512.05438) · [PDF](https://arxiv.org/pdf/2512.05438.pdf)  
...
**一句话要点**：提出扩展现实平台EXR，用于沉浸式交互式电子健康记录可视化，以支持临床决策。

**关键词**：扩展现实, 电子健康记录可视化, 沉浸式交互, 医疗数据集成, AI分割, 临床决策支持

## 3 点简述
- 核心问题：传统2D界面难以直观探索和协作处理电子健康记录中的结构化和非结构化数据。
- 方法要点：设计模块化基础设施，集成FHIR标准数据、体积医学影像和AI分割，实现共享3D环境。
- 实验或效果：使用合成EHR数据集和AI处理的CT脊柱模型演示平台能力，验证交互和协作功能。
