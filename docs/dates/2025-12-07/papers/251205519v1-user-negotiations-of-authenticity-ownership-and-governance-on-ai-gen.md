...
**arXiv**：[2512.05519v1](https://arxiv.org/abs/2512.05519) · [PDF](https://arxiv.org/pdf/2512.05519.pdf)  
**作者**：Bohui Shen, Shrikar Bhatta, Alex Ireebanije, Zexuan Liu, Abhinav Choudhry, Ece Gumusel, Kyrie Zhixuan Zhou  

**一句话要点**：通过用户评论分析揭示Sora平台中真实性、所有权与治理的协商动态

**关键词**：AI生成视频, 用户协商, 平台治理, 真实性评估, 内容分析

## 3 点简述
- 核心问题：AI生成视频平台引发的版权侵权等伦理挑战，用户如何协商真实性、作者身份和平台治理。
- 方法要点：对OpenAI Sora的用户评论进行定性内容分析，采用主题分析法识别关键动态。
- 实验或效果：识别出用户作为真实性评估者、从被动观看转向主动创作、模糊真实与合成媒体边界、争议平台治理等四个动态。
