...
**一句话要点**：提出聚类误差校正与分组4D高斯泼溅方法以提升动态场景重建精度

**关键词**：4D高斯泼溅, 动态场景重建, 误差聚类, 渲染一致性, 多视图优化

## 3 点简述
- 现有4DGS方法在动态场景重建中难以处理像素对应模糊和动态区域密度不足问题
- 引入椭圆误差聚类和误差校正泼溅添加，结合分组4D高斯泼溅提升映射一致性
- 在Neural 3D Video和Technicolor数据集上PSNR提升0.39dB，视觉质量达SOTA
