...
**一句话要点**：提出检测引导生成框架以解决电商场景中细粒度对象识别问题

**关键词**：对象检测, 生成式框架, 细粒度识别, 属性识别, 电商视觉, 层次类别预测

## 3 点简述
- 核心问题：现有方法依赖全局相似性，难以捕捉细粒度类别和属性多样性
- 方法要点：基于检测提取ROI特征，使用BART生成器预测层次类别和属性序列
- 实验或效果：在电商和开源数据集上优于相似性方法和多阶段系统，提升识别一致性
