...
**一句话要点**：提出InfoCLIP以解决CLIP微调中模态对齐退化问题，用于开放词汇语义分割

**关键词**：开放词汇语义分割, 视觉-语言预训练, 信息论对齐, 模态对齐转移, CLIP微调

## 3 点简述
- 核心问题：CLIP微调于有限类别时易过拟合，破坏预训练视觉-语言对齐
- 方法要点：基于互信息压缩对齐知识并最大化其传递，以稳定模态对齐
- 实验或效果：多基准测试验证其提升分割性能，展现适应性与优越性
