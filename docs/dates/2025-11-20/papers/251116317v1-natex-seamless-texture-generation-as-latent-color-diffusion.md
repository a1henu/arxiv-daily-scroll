...
**一句话要点**：提出NaTex框架，通过潜在颜色扩散直接在3D空间生成无缝纹理。

**关键词**：纹理生成, 潜在颜色扩散, 3D空间预测, 几何感知VAE, 多控制扩散变换器, 下游应用

## 3 点简述
- 核心问题：传统方法依赖2D多视图扩散，存在遮挡修复、纹理对齐和跨视图一致性问题。
- 方法要点：将纹理视为密集颜色点云，使用几何感知VAE和多控制扩散变换器。
- 实验或效果：在纹理一致性和对齐上显著优于先前方法，并支持多种下游应用。
