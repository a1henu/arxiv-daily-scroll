...
**一句话要点**：提出物理信息深度生成学习框架，以高效合成显微镜图像解决微机器人姿态估计数据稀缺问题

**关键词**：物理信息机器学习, 模拟到真实数据增强, 微机器人姿态估计, 生成对抗网络, 波光学渲染, 深度对齐

## 3 点简述
- 核心问题：微机器人姿态估计依赖高质量显微镜图像，但数据获取困难且成本高
- 方法要点：集成波光学物理渲染和深度对齐到GAN，合成高保真图像
- 实验或效果：合成数据训练的姿态估计器精度达93.9%/91.9%，接近真实数据训练
