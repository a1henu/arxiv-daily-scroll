...
**一句话要点**：提出Arctic-Extract模型，用于从商业文档中提取结构化数据，并支持资源受限硬件部署。

**关键词**：文档理解, 结构化数据提取, 资源受限部署, 长文档处理, 商业文档分析

## 3 点简述
- 核心问题：从扫描或数字商业文档中提取问答、实体和表格等结构化数据。
- 方法要点：模型仅6.6 GiB，可在A10 GPU等资源受限硬件上部署，处理多达125页A4文档。
- 实验或效果：评估显示在文档理解任务中性能强劲，达到当前最优水平。
