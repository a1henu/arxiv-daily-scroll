...
**一句话要点**：提出Upsample Anything框架，通过测试时优化实现特征上采样，解决像素级应用限制。

**关键词**：特征上采样, 测试时优化, 高斯核学习, 像素级重建, 边缘感知操作

## 3 点简述
- 核心问题：视觉基础模型特征下采样限制像素级应用，现有方法依赖重训练或优化，泛化性差。
- 方法要点：每图像优化学习各向异性高斯核，结合空间和范围线索，实现边缘感知上采样。
- 实验或效果：在语义分割和深度估计等任务中达到SOTA，每图像运行约0.419秒。
