...
**arXiv**：[2512.11506v1](https://arxiv.org/abs/2512.11506) · [PDF](https://arxiv.org/pdf/2512.11506.pdf)  
...
**一句话要点**：提出EmeraldMind框架，结合知识图谱与检索增强生成，以自动化检测企业漂绿行为。

**关键词**：漂绿检测, 知识图谱, 检索增强生成, ESG报告, 自动化评估, 解释性AI
