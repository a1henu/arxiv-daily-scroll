...
**arXiv**：[2512.11258v1](https://arxiv.org/abs/2512.11258) · [PDF](https://arxiv.org/pdf/2512.11258.pdf)  
...
**一句话要点**：综述多意图口语理解的方法、趋势与挑战，提供系统回顾与未来方向

**关键词**：多意图口语理解, 意图检测, 槽填充, 解码范式, 建模方法, 综述研究
