...
**arXiv**：[2512.11786v1](https://arxiv.org/abs/2512.11786) · [PDF](https://arxiv.org/pdf/2512.11786.pdf)  
...
**一句话要点**：提出基于收缩时域最优控制的决策支持系统，以优化康斯坦茨湖渡轮能效操作。

**关键词**：最优控制, 决策支持系统, 渡轮操作, 能效优化, 内河航运
