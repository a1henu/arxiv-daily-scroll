...
**arXiv**：[2512.11323v1](https://arxiv.org/abs/2512.11323) · [PDF](https://arxiv.org/pdf/2512.11323.pdf)  
**作者**：Jianyi Zhang, Ziyin Zhou, Xu Ji, Shizhao Liu, Zhangchi Zhao  

**一句话要点**：提出CAPTURE基准以评估大型视觉语言模型在验证码解析中的性能

**关键词**：大型视觉语言模型, 验证码解析, 多模态基准, 性能评估, 数据集构建
