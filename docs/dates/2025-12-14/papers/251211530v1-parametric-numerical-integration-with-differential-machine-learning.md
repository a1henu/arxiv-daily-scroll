...
**arXiv**：[2512.11530v1](https://arxiv.org/abs/2512.11530) · [PDF](https://arxiv.org/pdf/2512.11530.pdf)  
**作者**：Álvaro Leitao, Jonatan Ráfales  

**一句话要点**：提出微分机器学习方法以解决参数积分计算问题

**关键词**：参数积分计算, 微分机器学习, 统计函数, 切比雪夫展开, 微分方程积分
