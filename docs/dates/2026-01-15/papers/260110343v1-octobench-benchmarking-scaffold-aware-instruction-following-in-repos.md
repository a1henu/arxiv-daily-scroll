...
**关键词**：代理编码, 指令遵循基准, 脚手架感知, 仓库基础任务, 自动化评估, LLM评估

## 3 点简述
- 核心问题：现代编码脚手架将LLMs转化为软件代理，但其遵循脚手架指定指令的能力未充分评估，尤其在异质约束持续交互时。
- 方法要点：引入OctoBench，包括34个环境和217个任务，基于三种脚手架类型实例化，配备7,098个客观检查项和自动化观察评分工具包。
- 实验或效果：在八个代表性模型上实验，揭示任务解决与脚手架感知合规性之间的系统性差距，强调需针对性训练和评估。
