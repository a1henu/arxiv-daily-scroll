...
## 3 点简述
- 核心问题：异构机器人团队在复杂未知环境中巡检时，现有方法未充分整合场景语义理解，限制路由适应性和机器人能力利用。
- 方法要点：基于侦察飞行构建度量-语义地图，识别需巡检区域并生成能力感知路径，集成到异构车辆路由问题中联合分配任务和计算轨迹。
- 实验或效果：在仿真和真实巡检任务中验证，通过显式考虑机器人导航能力，规划出更安全高效的路径。
