...
## 3 点简述
- 核心问题：当前多模态潜在推理依赖外部监督，忽视内在视觉注意力动态，导致学生模型模仿教师文本输出但关注不同视觉区域。
- 方法要点：LaViT通过自回归重建教师的视觉语义和注意力轨迹，采用课程感官门控机制防止捷径学习，对齐潜在视觉思维。
- 实验或效果：在复杂推理任务上提升视觉基础达+16.9%，紧凑3B模型超越更大开源变体和GPT-4o等专有模型。
