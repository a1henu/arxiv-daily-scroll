...
**关键词**：多语言嵌入模型, 人物指令对齐, 印度语言基准, 检索任务, 兼容性分类

## 3 点简述
- 核心问题：现有基准未评估嵌入模型能否独立编码人物与指令的兼容性，缺乏对印度多语言场景的覆盖。
- 方法要点：构建统一基准，涵盖12种印度语言，设计四种任务评估嵌入模型在冻结编码器设置下的性能。
- 实验或效果：E5-Large-Instruct在单语检索中Recall@1达27.4%，LaBSE在分类任务中AUROC为75.3%，提供模型选择指导。
