...
**关键词**：多语言嵌入模型, 人物指令对齐, 低资源语言, 检索基准, 印度语言, 兼容性分类

## 3 点简述
- 核心问题：现有基准未评估嵌入模型能否独立编码人物与指令的兼容性，尤其在低资源印度语言中。
- 方法要点：构建统一基准，涵盖12种印度语言，包括单语和跨语言检索、反向检索及二元分类任务。
- 实验或效果：在冻结编码器设置下评估八种模型，E5-Large-Instruct在单语检索中Recall@1达27.4%，LaBSE分类AUROC为75.3%。
