...
**arXiv**：[2601.10038v1](https://arxiv.org/abs/2601.10038) · [PDF](https://arxiv.org/pdf/2601.10038.pdf)  
**作者**：Yuan-Sen Ting, André Curtis-Trudel, Siyu Yao  

**一句话要点**：提出实用理解框架以整合AI于天文学，强调哲学工具应对认知挑战

**关键词**：AI天文学, 科学哲学, 认知整合, 叙事构建, 实用理解, 跨学科研究

## 3 点简述
- 核心问题：AI在天文学中的整合被视为工程而非认知挑战，需澄清理解含义与评估角色
- 方法要点：基于跨学科研讨会，识别AI与天文学间的张力，如预测与叙事构建的差距
- 实验或效果：提出实用理解框架，将AI视为扩展人类认知的工具，需新验证规范
