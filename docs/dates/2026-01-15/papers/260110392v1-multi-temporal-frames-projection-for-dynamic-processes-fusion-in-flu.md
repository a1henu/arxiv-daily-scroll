...
**一句话要点**：提出多时态帧投影框架以融合荧光显微镜动态过程，提升图像质量与细胞计数

**关键词**：荧光显微镜, 多时态图像融合, 动态过程分析, 图像质量增强, 计算机视觉框架, 生物医学成像

## 3 点简述
- 荧光显微镜记录受噪声、时变性和信号振荡影响，限制生物样本分析
- 结合可解释计算机视觉技术，将多时态帧融合为高质量单图像，保留原始生物内容
- 在心脏细胞2D单层数据集上测试，细胞计数平均提升44%，适用于其他成像领域
