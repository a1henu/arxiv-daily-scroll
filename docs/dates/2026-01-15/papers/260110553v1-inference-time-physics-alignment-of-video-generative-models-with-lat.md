...
**关键词**：视频生成, 物理对齐, 推理时优化, 潜在世界模型, WMReward, 去噪轨迹搜索

## 3 点简述
- 问题：视频生成模型常违反物理原理，影响实用性，部分源于推理策略不佳
- 方法：使用潜在世界模型（VJEPA-2）作为奖励，搜索和引导多个去噪轨迹，实现推理时对齐
- 效果：在多种生成设置中显著提升物理合理性，在ICCV 2025挑战中获第一名，超越先前最佳7.42%
