...
**arXiv**：[2601.10696v1](https://arxiv.org/abs/2601.10696) · [PDF](https://arxiv.org/pdf/2601.10696.pdf)  
**作者**：Han Jiang, Yao Xiao, Rachel Hurley, Shichao Liu  

**一句话要点**：研究生成式AI对建筑概念设计的影响：性能、创意自我效能与认知负荷

**关键词**：生成式AI, 建筑概念设计, 创意自我效能, 认知负荷, 新手设计师, 提示策略

## 3 点简述
- 核心问题：生成式AI如何影响建筑概念设计中的性能、创意自我效能和认知负荷。
- 方法要点：36名学生参与两阶段设计任务，对比独立设计、AI辅助和在线资源控制条件。
- 实验或效果：AI对新手设计师性能提升显著，但创意自我效能下降，认知负荷无显著差异，提示策略影响认知负荷。
