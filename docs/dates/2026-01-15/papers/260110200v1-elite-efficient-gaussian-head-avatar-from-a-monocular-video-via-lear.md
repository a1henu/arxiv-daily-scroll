...
**一句话要点**：提出ELITE方法，通过学习初始化与测试时生成适应，从单目视频高效合成高斯头部化身。

**关键词**：高斯化身合成, 单目视频, 测试时适应, 扩散增强, 网格到高斯先验, 高效渲染

## 3 点简述
- 核心问题：单目视频中视觉线索缺失，现有方法泛化差或计算重且易产生身份幻觉。
- 方法要点：设计前馈网格到高斯先验模型快速初始化，并引入渲染引导单步扩散增强器进行测试时适应。
- 实验或效果：ELITE在挑战性表情下视觉质量优于先前工作，合成速度比2D生成先验方法快60倍。
