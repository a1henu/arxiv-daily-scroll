...
**一句话要点**：提出基于基础模型的提示链方法以解决老年人数字技术使用中的沟通障碍

**关键词**：基础模型应用, 老年人技术支持, 沟通障碍缓解, 提示链方法, 合成数据集生成

## 3 点简述
- 核心问题：老年人因技术术语不熟和认知变化，难以清晰表达技术问题，导致沟通障碍。
- 方法要点：使用GPT-4o进行提示链，包括提取上下文细节、重述查询和生成解决方案。
- 实验或效果：AI重述查询显著提高解决方案准确率（69% vs. 46%）和搜索效果，并创建OATS合成数据集。
