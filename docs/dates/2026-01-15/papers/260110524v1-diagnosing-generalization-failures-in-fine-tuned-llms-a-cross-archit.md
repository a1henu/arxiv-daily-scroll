...
**关键词**：大语言模型微调, 泛化失败诊断, 钓鱼检测, SHAP分析, 机制可解释性, 跨架构研究

## 3 点简述
- 核心问题：微调大语言模型在专业任务中性能优异但泛化脆弱，原因诊断是开放难题。
- 方法要点：应用SHAP分析和机制可解释性，跨架构研究Llama 3.1 8B、Gemma 2 9B和Mistral模型。
- 实验或效果：发现泛化依赖架构与数据多样性协同，Gemma 2 9B在多样化数据集上F1>91%，Mistral表现稳健。
