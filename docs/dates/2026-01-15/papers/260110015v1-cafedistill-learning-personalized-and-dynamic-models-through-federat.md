...
**关键词**：个性化联邦学习, 早期退出网络, 知识蒸馏, 动态推理, 客户端异构性

## 3 点简述
- 核心问题：现有个性化联邦学习方法产生静态模型，无法适应动态推理需求，早期退出网络在联邦学习中面临客户端异构性和退出目标冲突的挑战。
- 方法要点：采用冲突感知的联邦退出蒸馏框架，通过深度优先的学生协调机制减少退出干扰，并实现跨客户端的个性化知识转移。
