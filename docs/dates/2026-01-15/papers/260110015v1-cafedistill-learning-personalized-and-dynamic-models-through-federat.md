...
**关键词**：个性化联邦学习, 早期退出网络, 知识蒸馏, 动态推理, 联邦学习优化

## 3 点简述
- 核心问题：现有个性化联邦学习方法生成静态模型，无法适应动态推理需求，且早期退出网络在联邦学习中面临客户端异构性和深度干扰。
- 方法要点：采用冲突感知的联邦退出蒸馏框架，通过深度优先的学生协调机制，减少退出层间干扰并实现跨客户端个性化知识转移。
- 实验或效果：在评估中优于现有方法，提高准确性并减少30.79%-46.86%的推理成本，同时降低通信开销。
