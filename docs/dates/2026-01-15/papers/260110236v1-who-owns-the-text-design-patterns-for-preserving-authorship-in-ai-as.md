...
**arXiv**：[2601.10236v1](https://arxiv.org/abs/2601.10236) · [PDF](https://arxiv.org/pdf/2601.10236.pdf)  
**作者**：Bohan Zhang, Chengke Bu, Paramveer S. Dhillon  

**一句话要点**：提出五种设计模式以在AI辅助写作中保留作者所有权感

**关键词**：AI辅助写作, 作者所有权, 设计模式, 风格个性化, 认知负载, 协同编辑器

## 3 点简述
- 核心问题：AI写作助手可能削弱作者的所有权感，需平衡效率与归属
- 方法要点：测试基于角色的指导和风格个性化设计，开发所有权感知的协同编辑器
- 实验或效果：在线研究显示风格个性化部分恢复所有权感，认知负载降低，质量相似
