...
**一句话要点**：提出领域自适应框架，将大视觉语言模型转化为智能路边基础设施分析代理。

**关键词**：视觉语言模型, 领域自适应, 基础设施感知, 检索增强生成, 开放词汇检测, 智能城市

## 3 点简述
- 核心问题：通用模型难以捕捉路边基础设施的细粒度属性和工程标准，导致状态识别不可靠。
- 方法要点：结合数据高效微调与知识增强推理，包括开放词汇微调、LoRA适应和双模态检索增强生成。
- 实验或效果：在新数据集上实现58.9 mAP检测性能和95.5%属性识别准确率，验证了智能监控的鲁棒性。
