...
## 3 点简述
- 核心问题：多模态大语言模型在HD-EPIC VQA等复杂视频问答基准中表现不佳，原因包括查询/选项模糊、长程时序推理能力弱和输出非标准化。
- 方法要点：框架整合查询/选项预处理、领域特定的Qwen2.5-VL微调、新颖的时序思维链提示用于多步推理，以及鲁棒的后处理。
- 实验或效果：系统在HD-EPIC VQA上达到41.6%的准确率，突显了在苛刻视频理解任务中整体管道优化的必要性。
