...
**关键词**：机器人导航, 控制屏障函数, 运动预测, 高斯过程, 动态环境, 安全控制

## 3 点简述
- 核心问题：动态环境中移动机器人导航面临凹形移动障碍物，传统反应式安全控制器仅依赖当前状态易导致未来碰撞。
- 方法要点：使用高斯过程在线学习基于神经网络多模态运动预测的屏障函数，结合调制控制屏障函数实现无局部极小值的导航控制。
- 实验或效果：在仿真和真实实验中验证，优于基线方法，在拥挤动态环境中展现出更高的安全性和效率。
