...
**一句话要点**：提出随机补丁选择方法以提升端到端自动驾驶的分布外泛化能力

**关键词**：端到端自动驾驶, 基础模型, 随机补丁选择, 分布外泛化, 特征冗余, 策略学习

## 3 点简述
- 问题：基于基础模型提取的补丁特征存在高度冗余，导致策略过拟合虚假相关性，损害分布外鲁棒性。
- 方法：提出随机补丁选择，每帧随机掩码部分补丁描述符，保持空间布局，提供不同随机但完整的场景视图。
- 效果：在分布外场景中平均提升6.2%，闭环模拟最高提升20.4%，速度提升2.4倍，且无需调优即可迁移到真实车辆。
