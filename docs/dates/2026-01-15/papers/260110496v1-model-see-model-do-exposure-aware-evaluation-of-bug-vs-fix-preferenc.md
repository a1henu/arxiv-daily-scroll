...
**一句话要点**：提出暴露感知评估框架以量化训练数据暴露对代码大语言模型错误与修复偏好的影响

**关键词**：代码大语言模型, 错误修复偏好, 暴露感知评估, 训练数据影响, 成员测试, 概率评分

## 3 点简述
- 核心问题：代码大语言模型在生成和调试时可能偏好熟悉的错误代码而非正确修复，受训练数据暴露影响
- 方法要点：使用Data Portraits进行成员测试，基于ManySStuBs4J基准分层评估模型偏好
- 实验或效果：发现模型更常复制错误代码，暴露于错误示例时倾向加剧，而概率指标稳定偏好正确修复
