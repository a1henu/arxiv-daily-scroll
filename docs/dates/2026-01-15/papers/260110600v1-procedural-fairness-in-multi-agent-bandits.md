...
**arXiv**：[2601.10600v1](https://arxiv.org/abs/2601.10600) · [PDF](https://arxiv.org/pdf/2601.10600.pdf)  
**作者**：Joshua Caiata, Carter Blair, Kate Larson  

**一句话要点**：提出程序公平性以解决多智能体多臂老虎机中的决策权力分配问题

**关键词**：多智能体多臂老虎机, 程序公平性, 决策权力分配, 公平性理论, 实证分析

## 3 点简述
- 核心问题：传统公平性关注结果优化，忽视决策过程中的平等参与和代表性。
- 方法要点：引入程序公平性目标，确保所有智能体拥有平等的决策权力，并保持结果比例性。
- 实验或效果：实证显示程序公平政策在牺牲结果公平性目标（如平等和功利主义）方面最小，同时提升过程公平。
