...
**关键词**：时间约束翻译, 强化学习框架, 跨语言冗长偏差, 音节级时长控制, 语义保持优化

## 3 点简述
- 核心问题：LLM在翻译中存在跨语言冗长偏差，不适用于字幕配音等严格时间约束任务
- 方法要点：引入Sand-Glass基准，通过KL正则化目标和动态音节比奖励优化语义保持与时间合规性
- 实验或效果：HOMURA显著优于基线，实现精确长度控制且不损害语义充分性
