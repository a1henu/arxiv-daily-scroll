...
**一句话要点**：提出训练轨迹感知的令牌选择方法，以解决前沿推理能力蒸馏中的瓶颈问题。

**关键词**：令牌选择, 蒸馏训练, 推理能力, 训练轨迹, 模型优化, 前沿蒸馏

## 3 点简述
- 核心问题：前沿推理能力蒸馏中，学生模型已具强推理能力，但持续蒸馏常导致性能下降或增益有限。
- 方法要点：基于训练轨迹分析，识别并分离模仿锚定令牌与待学令牌，重构令牌级训练目标以清除优化路径。
- 实验或效果：在AR和dLLM设置下，使用少量示例提升模型性能，如Qwen3-8B超越DeepSeek-R1，达到16B规模无思考模型的最优水平。
