...
**一句话要点**：提出基于流引导的3D高斯泼溅方法，实现无网格的结构感知风格迁移以模拟后印象派艺术。

**关键词**：3D风格迁移, 高斯泼溅, 流引导, 几何抽象, 艺术评估, 后印象派

## 3 点简述
- 核心问题：现有3D风格迁移方法将几何视为刚性基底，无法模拟后印象派强调结构夸张的艺术原则。
- 方法要点：从2D绘画提取方向流场，引导3D高斯原语对齐形成笔触，实现几何抽象与颜色优化解耦。
- 实验或效果：引入VLM作为评判框架评估艺术真实性，避免传统像素级指标的主观性限制。
