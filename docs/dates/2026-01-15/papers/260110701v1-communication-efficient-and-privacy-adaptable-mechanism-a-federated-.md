...
**一句话要点**：提出通信高效与隐私可调机制，以解决联邦学习中的通信效率与隐私保护问题。

**关键词**：联邦学习, 通信效率, 隐私保护, 量化器, 收敛分析, 隐私可调机制

## 3 点简述
- 核心问题：联邦学习中通信效率低和隐私保护不足的挑战。
- 方法要点：利用拒绝采样通用量化器，量化误差等效于可控噪声，实现隐私可调。
- 实验或效果：理论分析隐私保证和收敛性，实验评估收敛曲线和精度-隐私权衡。
