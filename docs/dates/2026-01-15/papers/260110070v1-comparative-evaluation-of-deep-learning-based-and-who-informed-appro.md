...
**arXiv**：[2601.10070v1](https://arxiv.org/abs/2601.10070) · [PDF](https://arxiv.org/pdf/2601.10070.pdf)  
**作者**：Mohammad Abbadi  

**一句话要点**：提出基于深度学习的HuSHeM模型，用于精子形态评估，以提升预测可靠性和临床效用。

**关键词**：精子形态评估, 深度学习模型, 临床决策支持, 生物医学人工智能, 图像分析

## 3 点简述
- 核心问题：精子形态评估主观性强，存在观察者间变异和资源限制。
- 方法要点：比较深度学习模型HuSHeM与基于WHO标准增强的基线方法WHO(+SIRI)。
- 实验或效果：HuSHeM在区分性能、校准和临床净获益方面优于WHO(+SIRI)。
