...
**一句话要点**：提出SatMap方法，利用卫星地图作为先验，在线构建高精地图以解决自动驾驶中相机感知的深度模糊和遮挡问题。

**关键词**：高精地图构建, 卫星地图先验, 多视角相机融合, 自动驾驶感知, 矢量化预测, 鸟瞰视角

## 3 点简述
- 核心问题：在线高精地图构建中，基于车载相机的方案因深度感知有限和遮挡导致精度下降。
- 方法要点：整合卫星地图与多视角相机观测，直接预测矢量化高精地图，利用鸟瞰视角的卫星图像提供全局先验。
