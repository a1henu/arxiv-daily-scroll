...
**arXiv**：[2601.10122v1](https://arxiv.org/abs/2601.10122) · [PDF](https://arxiv.org/pdf/2601.10122.pdf)  
**作者**：Ye Wang, Jiaxing Chen, Hongjiang Xiao  

**一句话要点**：综述大语言模型驱动的角色扮演代理：技术演进、挑战与未来趋势

**关键词**：角色扮演代理, 大语言模型, 认知模拟, 记忆机制, 评估框架, 多模态交互

## 3 点简述
- 核心问题：系统回顾角色扮演语言代理的发展，从规则模板到认知模拟阶段。
- 方法要点：总结角色建模、记忆增强提示和行为决策控制等关键技术路径。
- 实验或效果：分析数据构建方法、评估框架及未来方向如多模态交互。
