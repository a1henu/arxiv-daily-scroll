...
**arXiv**：[2601.10421v1](https://arxiv.org/abs/2601.10421) · [PDF](https://arxiv.org/pdf/2601.10421.pdf)  
**作者**：Philip Resnik  

**一句话要点**：评估语言模型作为认知模型的合理性，基于Marr三层次分析指出其局限性

**关键词**：语言模型, 认知模型, Marr三层次分析, 模型评估, 人工智能哲学

## 3 点简述
- 核心问题：语言模型是否可作为认知模型，Futrell和Mahowald的论点被质疑
- 方法要点：应用Marr的计算理论、算法表示和实施三层次框架进行评估
- 实验或效果：在实施层次明显不成立，算法表示层次动机不足，计算理论层次存在问题
