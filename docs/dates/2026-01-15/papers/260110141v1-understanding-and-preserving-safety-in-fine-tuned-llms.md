...
**一句话要点**：提出安全保护微调方法以解决大语言模型微调中的安全-效用困境

**关键词**：大语言模型微调, 安全对齐, 梯度分析, 安全保护, 越狱攻击, 低秩子空间

## 3 点简述
- 核心问题：微调大语言模型时，安全对齐易被破坏，导致安全-效用权衡困境。
- 方法要点：基于安全梯度低秩子空间与效用梯度高维空间冲突的几何洞察，移除冲突梯度成分。
- 实验或效果：方法在对抗性微调下保持任务性能，恢复安全对齐，抵抗深度微调和越狱攻击。
