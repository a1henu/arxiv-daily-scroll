...
**关键词**：文本到SQL, 安全拒绝, 隐层激活, 可答性预测, 轻量探针, 查询-模式匹配

## 3 点简述
- 核心问题：LLM文本到SQL系统中，不可答或欠指定查询可能生成错误SQL，导致误导结果或安全风险。
- 方法要点：设计Tri-Residual Gated Encoder轻量探针，从模型隐层激活中提取查询-模式不匹配信号，预测可答性。
- 实验或效果：在四个基准测试中，平均F1提升至88.5%，探针开销仅约2毫秒，验证了方法的有效性和高效性。
