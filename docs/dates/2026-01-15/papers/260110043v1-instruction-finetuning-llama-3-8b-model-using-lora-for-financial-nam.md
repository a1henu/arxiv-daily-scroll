...
**一句话要点**：提出结合指令微调与LoRA的Llama-3-8B模型，用于金融命名实体识别，提升领域敏感性能。

**关键词**：金融命名实体识别, 指令微调, LoRA, 参数高效微调, 大语言模型, 领域适应

## 3 点简述
- 核心问题：免费大语言模型在金融NER中常混淆实体类型或忽略关键信息，如金额。
- 方法要点：将标注句子转为指令-输入-输出三元组，使用LoRA进行参数高效微调，避免全权重更新。
- 实验或效果：在1,693句语料上微F1达0.894，优于多个基线模型，实现领域敏感NER的先进性能。
