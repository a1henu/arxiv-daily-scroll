...
**一句话要点**：提出DeFlow框架，通过解耦流形建模与价值最大化以解决离线强化学习中的策略提取问题。

**关键词**：离线强化学习, 流匹配, 策略提取, 信任区域, ODE求解器, 离线到在线适应

## 3 点简述
- 核心问题：离线强化学习中，生成策略优化计算成本高，通常需通过ODE求解器反向传播。
- 方法要点：利用流匹配捕获行为流形，在信任区域内学习轻量级精炼模块，避免求解器微分和损失平衡。
- 实验或效果：在OGBench基准上表现优异，并展示高效的离线到在线适应能力。
