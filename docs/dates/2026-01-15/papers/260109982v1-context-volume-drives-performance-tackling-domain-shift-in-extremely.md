...
**一句话要点**：提出基于检索增强生成的混合框架，以缓解低资源语言翻译在领域转移下的性能下降。

**关键词**：低资源机器翻译, 领域转移, 检索增强生成, 混合框架, 性能恢复

## 3 点简述
- 核心问题：低资源语言神经机器翻译在领域转移时性能显著下降，如Dhao语从新约到旧约翻译质量降低。
- 方法要点：结合微调NMT模型生成初稿，再通过LLM利用RAG检索示例进行精炼，提升翻译质量。
- 实验或效果：系统在旧约翻译中恢复8.10 chrF++，接近原领域性能，分析显示检索示例数量是关键驱动因素。
