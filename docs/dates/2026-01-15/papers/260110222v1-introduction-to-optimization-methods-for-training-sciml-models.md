...
**关键词**：科学机器学习, 优化方法, 物理约束模型, 损失景观, 确定性优化, 二阶方法

## 3 点简述
- 核心问题：科学机器学习中物理约束导致损失景观全局耦合和强各向异性，限制标准随机方法有效性
- 方法要点：回顾一阶和二阶优化技术，讨论其在物理约束和数据驱动模型中的适应性
- 实验或效果：通过教程示例说明实用策略，并突出科学计算与科学机器学习交叉领域的研究方向
