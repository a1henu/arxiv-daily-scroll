...
**arXiv**：[2601.10244v1](https://arxiv.org/abs/2601.10244) · [PDF](https://arxiv.org/pdf/2601.10244.pdf)  
**作者**：Megha Mariam K M, C. V. Jawahar  

**一句话要点**：提出基于演讲内容自动高亮幻灯片相关区域的方法，以解决听众在演示中视觉与听觉不同步的问题。

**关键词**：幻灯片理解, 多媒体文档分析, 视听同步, 认知负荷, 教育视频

## 3 点简述
- 核心问题：听众在演示中需同时处理演讲和幻灯片，导致视觉与听觉不同步，认知负担增加。
- 方法要点：通过分析演讲内容，匹配幻灯片中的文本或图形元素，自动识别并高亮最相关区域。
- 实验或效果：探索不同解决方案，评估成功与失败案例，代码和数据集已开源。
