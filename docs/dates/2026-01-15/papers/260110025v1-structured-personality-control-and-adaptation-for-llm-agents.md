...
**arXiv**：[2601.10025v1](https://arxiv.org/abs/2601.10025) · [PDF](https://arxiv.org/pdf/2601.10025.pdf)  
**作者**：Jinpeng Wang, Xinyu Jia, Wei Wei Heng, Yuquan Li, Binbin Shi, Qianlei Chen, Guannan Chen, Junxia Zhang, Yuyu Yin  

**一句话要点**：提出基于荣格心理类型的LLM人格控制与适应框架，以增强人机交互中的自然性和适应性。

**关键词**：大语言模型, 人格控制, 人机交互, 荣格心理类型, 适应性框架, 结构化评估

## 3 点简述
- 核心问题：现有方法难以实现LLM人格的细腻表达和动态适应，影响人机交互的参与度和真实感。
- 方法要点：通过主导-辅助协调、强化-补偿和反思机制，实现人格的连贯表达、临时适应和长期演化。
- 实验或效果：使用迈尔斯-布里格斯类型指标问卷评估人格对齐，并在多样化挑战场景中进行初步结构化测试。
