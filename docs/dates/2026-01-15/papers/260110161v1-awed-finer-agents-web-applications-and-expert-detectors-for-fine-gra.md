...
**arXiv**：[2601.10161v1](https://arxiv.org/abs/2601.10161) · [PDF](https://arxiv.org/pdf/2601.10161.pdf)  
**作者**：Prachuryya Kaushik, Ashish Anand  

**一句话要点**：提出AWED-FiNER生态系统，为36种语言提供细粒度命名实体识别解决方案，覆盖66亿使用者。

**关键词**：细粒度命名实体识别, 多语言处理, 低资源语言, 专家模型, 开源生态系统, 边缘部署

## 3 点简述
- 核心问题：大语言模型在低资源语言和细粒度NLP任务中表现不佳，缺乏广泛覆盖。
- 方法要点：集成代理工具、Web应用和专家模型，支持多语言路由和快速离线部署。
- 实验或效果：覆盖包括脆弱语言在内的36种语言，提供开源工具和模型，便于资源受限场景使用。
