...
**arXiv**：[2601.10089v1](https://arxiv.org/abs/2601.10089) · [PDF](https://arxiv.org/pdf/2601.10089.pdf)  
**作者**：Ashley Klein, Edward Raff, Marcia DesJardin  

**一句话要点**：提出贝叶斯元分析方法以解决剖宫产后试产评估中关键变量缺失问题

**关键词**：贝叶斯元分析, 医学决策支持, 剖宫产后试产, 变量缺失处理, 效应大小评估

## 3 点简述
- 核心问题：医学元分析因未捕获影响医生决策的关键变量，导致效应大小未知和结论不可靠。
- 方法要点：采用贝叶斯方法，允许在变量缺失情况下评估阳性效应主张是否成立。
- 实验或效果：应用于剖宫产后试产场景，辅助产科医生评估患者护理，提升决策支持。
