...
**关键词**：多模态推理, 自改进学习, 无监督训练, 视觉语言模型, 策略优化

## 3 点简述
- 核心问题：现有多模态模型依赖大规模人工标注，成本高且耗时。
- 方法要点：采用提问者与解答者角色，通过双轨推理奖励和多数投票伪标签进行迭代优化。
- 实验或效果：在Qwen2.5-VL-7B-Instruct上，视觉数学推理提升+1.7，通用视觉中心任务提升+2.6。
