...
## 3 点简述
- 核心问题：在严格时间分割和无前瞻特征约束下，如何有效利用历史数据提升点击率预测准确性。
- 方法要点：比较时间感知目标编码基线与多种窗口设计（如拖尾窗口、事件计数窗口）的实体历史时间聚合特征。
- 实验或效果：拖尾窗口在ROC AUC和PR AUC上分别提升约0.0066-0.0082和0.0084-0.0094，事件计数窗口提供小幅额外增益。
