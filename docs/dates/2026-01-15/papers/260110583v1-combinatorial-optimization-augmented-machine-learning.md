...
**arXiv**：[2601.10583v1](https://arxiv.org/abs/2601.10583) · [PDF](https://arxiv.org/pdf/2601.10583.pdf)  
**作者**：Maximilian Schiffer, Heiko Hoppe, Yue Su, Louis Bouvier, Axel Parmentier  

**一句话要点**：综述组合优化增强机器学习，提供统一框架与分类以整合预测与决策。

**关键词**：组合优化增强机器学习, 预测与决策整合, 统一框架, 分类法, 调度应用, 车辆路径优化

## 3 点简述
- 核心问题：整合预测模型与组合决策，确保数据驱动且保持可行性。
- 方法要点：引入COAML统一框架，基于不确定性和决策结构建立分类法。
- 实验或效果：综述静态与动态问题算法，应用于调度、车辆路径等领域。
