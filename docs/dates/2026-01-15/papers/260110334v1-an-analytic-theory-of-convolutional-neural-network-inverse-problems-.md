...
**关键词**：卷积神经网络, 逆问题求解, 最小均方误差, 平移等变性, 局部性约束, 理论分析

## 3 点简述
- 核心问题：监督卷积神经网络在成像逆问题中缺乏理论理解，常被视为黑箱
- 方法要点：基于最小均方误差估计器，引入平移等变性和局部性约束，推导出解析公式LE-MMSE
- 实验或效果：通过多实验验证理论输出与神经网络匹配，并分析物理感知与物理无关估计器差异
