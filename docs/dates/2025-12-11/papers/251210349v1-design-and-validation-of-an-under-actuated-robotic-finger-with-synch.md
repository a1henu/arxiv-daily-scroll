...
**一句话要点**：提出同步腱绳驱动的欠驱动机器人手指，以单执行器实现高负载与自适应柔顺性。

**关键词**：欠驱动机器人手指, 腱绳驱动, 同步路由, 单执行器控制, 结构刚度建模, 机器人手抓取

## 3 点简述
- 核心问题：紧凑型欠驱动手指难以同时实现高负载能力和自适应柔顺性。
- 方法要点：采用同步腱绳路由，机械耦合所有关节，固定角速度比，减少执行器数量。
