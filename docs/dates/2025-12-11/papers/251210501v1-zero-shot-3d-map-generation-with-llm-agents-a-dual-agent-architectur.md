...
**关键词**：零样本学习, 过程内容生成, 大语言模型智能体, 3D地图生成, 参数配置, 双智能体架构

## 3 点简述
- 核心问题：现有PCG工具依赖不透明技术参数，LLM难以直接映射抽象指令到精确配置
- 方法要点：采用无训练的双智能体架构，通过Actor-Critic迭代推理优化参数配置
- 实验或效果：在3D地图生成上超越单智能体基线，实现多样且结构有效的环境生成
