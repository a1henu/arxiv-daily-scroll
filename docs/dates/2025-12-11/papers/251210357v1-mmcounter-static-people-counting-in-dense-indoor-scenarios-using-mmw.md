...
**一句话要点**：提出mmCounter以解决毫米波雷达在密集静态人群计数中的挑战

**关键词**：毫米波雷达, 静态人群计数, 密集室内场景, 超低频信号处理, 呼吸检测, 微动分析

## 3 点简述
- 核心问题：毫米波雷达在密集静态场景中因空间分辨率限制和依赖运动检测而难以准确计数。
- 方法要点：通过提取超低频呼吸和微动信号，结合多阶段信号处理技术区分个体并映射到空间位置。
- 实验或效果：在熟悉环境中平均F1分数达87%，平均绝对误差0.6；可计数最多7人于3平方米空间。
