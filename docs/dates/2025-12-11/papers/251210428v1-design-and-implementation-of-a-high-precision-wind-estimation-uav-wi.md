...
**关键词**：无人机风估计, 扰动观测器, 薄板样条模型, 机载传感器, 实时估计, 气动增强

## 3 点简述
- 核心问题：传统风估计依赖外部传感器或简化动力学，限制敏捷飞行和资源受限平台应用。
- 方法要点：使用扰动观测器估计气动力，薄板样条模型映射至风向量，并设计风桶增强气动敏感性。
- 实验效果：在风洞、室内外飞行中验证，速度RMSE低至0.06 m/s，方向RMSE低于7.3°，优于基线。
