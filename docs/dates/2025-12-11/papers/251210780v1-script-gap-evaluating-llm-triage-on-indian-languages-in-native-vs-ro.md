...
**一句话要点**：评估LLM在印度语言原生与罗马化脚本下的分诊性能，揭示罗马化导致可靠性下降

**关键词**：大语言模型评估, 临床分诊, 罗马化文本, 印度语言处理, 真实世界数据

## 3 点简述
- 核心问题：LLM在印度临床应用中处理罗马化文本时性能下降，可能引发安全风险。
- 方法要点：基于真实世界数据集，比较LLM在五种印度语言和尼泊尔语原生与罗马化脚本下的表现。
- 实验或效果：罗马化消息的F1分数比原生脚本低5-12点，可能导致近200万额外分诊错误。
