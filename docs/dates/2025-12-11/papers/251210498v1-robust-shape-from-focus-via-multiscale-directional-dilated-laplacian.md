...
**关键词**：聚焦形状恢复, 多尺度特征提取, 循环神经网络, 深度估计, 鲁棒性优化, 手工核设计

## 3 点简述
- 聚焦形状恢复中，传统深度学习方法依赖重编码器提取聚焦体积，导致深度图伪影和噪声放大。
- 采用手工多尺度方向性扩张拉普拉斯核提取鲁棒聚焦体积，结合轻量级多尺度GRU模块迭代优化深度估计。
- 在合成和真实数据集上验证，方法在精度和泛化性上优于现有技术，适应多样聚焦条件。
