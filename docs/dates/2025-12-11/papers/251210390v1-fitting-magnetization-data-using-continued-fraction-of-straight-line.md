...
**arXiv**：[2512.10390v1](https://arxiv.org/abs/2512.10390) · [PDF](https://arxiv.org/pdf/2512.10390.pdf)  
**作者**：Vijay Prakash S  

**一句话要点**：提出直线连分数法拟合磁化数据，以解释铁磁物质非线性行为

**关键词**：磁化数据拟合, 直线连分数, 非线性回归, 铁磁物质, 磁畴行为

## 3 点简述
- 核心问题：铁磁物质磁化随外磁场增强的非线性响应，源于磁畴对齐的微观机制。
- 方法要点：使用直线连分数作为代数表达式，通过非线性回归近似磁化非线性函数。
- 实验或效果：拟合结果用于解释磁畴生长和收缩过程中的非线性行为，参数估计未知。
