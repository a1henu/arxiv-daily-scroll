...
**关键词**：医学视觉语言模型, 强化学习, 胸部X光报告生成, 视觉定位, 分组相对策略优化, 监督微调

## 3 点简述
- 核心问题：医学视觉语言模型依赖监督微调，缺乏任务质量反馈，影响报告生成与视觉定位效果
- 方法要点：在监督微调基础上，应用分组相对策略优化，结合临床任务奖励进行强化学习训练
- 实验或效果：强化学习在报告生成和视觉定位任务上带来额外增益，模型达到最先进性能
