...
**一句话要点**：提出PMB-NN混合AI方法，结合深度学习与生理模型，用于可解释的个性化血流动力学监测。

**关键词**：血流动力学监测, 混合人工智能, 生理模型约束, 可解释性, 光电容积描记术, 个性化建模

## 3 点简述
- 核心问题：现有基于PPG的血压估计方法缺乏可解释性，难以监测血流动力学参数。
- 方法要点：将深度学习与基于R和C参数的2元素Windkessel生理模型结合，作为物理约束进行训练。
- 实验或效果：在10名健康成人中验证，血压估计准确性与深度学习基准相当，生理合理性更高，能估计外周阻力和动脉顺应性。
