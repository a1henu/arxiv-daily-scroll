...
**一句话要点**：提出RobustSora基准以评估AI生成视频检测中的水印鲁棒性

**关键词**：AI生成视频检测, 水印鲁棒性, 基准评估, Transformer模型, 多模态大语言模型

## 3 点简述
- 核心问题：现有AI生成视频检测基准忽略数字水印影响，可能高估检测器性能
- 方法要点：构建包含真实与生成视频的6500个视频数据集，引入水印移除和伪造水印评估任务
- 实验或效果：测试十种模型，发现水印操作导致性能变化2-8个百分点，揭示部分水印依赖性
