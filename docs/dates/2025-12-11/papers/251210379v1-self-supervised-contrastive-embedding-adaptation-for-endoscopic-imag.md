...
**一句话要点**：提出自监督对比嵌入适应方法，以解决内窥镜图像匹配中的特征对应问题。

**关键词**：内窥镜图像匹配, 自监督学习, 对比学习, Transformer优化, 新视图合成, DINOv2骨干

## 3 点简述
- 核心问题：内窥镜图像匹配因弱透视、非朗伯反射和可变形解剖结构而困难，传统方法性能受限。
- 方法要点：利用新视图合成生成真实对应，通过对比学习优化Transformer层，增强DINOv2骨干以产生直接匹配的嵌入。
