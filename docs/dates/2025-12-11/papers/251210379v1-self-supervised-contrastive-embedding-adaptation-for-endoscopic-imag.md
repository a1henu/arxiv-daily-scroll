...
**一句话要点**：提出自监督对比嵌入适应方法，以解决内窥镜图像匹配中的弱透视和变形挑战。

**关键词**：内窥镜图像匹配, 自监督学习, 对比嵌入适应, 新视图合成, Transformer优化, 手术计算机视觉

## 3 点简述
- 核心问题：内窥镜图像存在弱透视、非朗伯反射和变形解剖，导致传统计算机视觉方法性能下降。
- 方法要点：利用新视图合成生成真实对应，通过对比学习优化Transformer层，增强DINOv2骨干的嵌入匹配能力。
- 实验或效果：在SCARED数据集上超越现有方法，匹配精度更高，极线误差更低。
