...
**arXiv**：[2512.10365v1](https://arxiv.org/abs/2512.10365) · [PDF](https://arxiv.org/pdf/2512.10365.pdf)  
**作者**：Hangyu Mao, Guangting Dong, Zhicheng Dou  

**一句话要点**：提出广义策略梯度定理，专为Transformer策略设计，统一标准策略梯度和GRPO。

**关键词**：策略梯度定理, Transformer策略, 大语言模型训练, 策略优化, 强化学习理论

## 3 点简述
- 核心问题：Transformer策略的策略梯度优化缺乏统一理论框架。
- 方法要点：提出广义策略梯度定理，将标准策略梯度和GRPO作为特例纳入。
- 实验或效果：应用于大语言模型训练，提供高效策略优化的新见解。
