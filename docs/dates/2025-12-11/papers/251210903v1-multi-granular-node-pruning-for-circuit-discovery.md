...
**关键词**：电路发现, 节点剪枝, 多粒度优化, 大语言模型, 稀疏惩罚, 内存效率

## 3 点简述
- 电路发现旨在识别大语言模型中负责特定行为的最小子网络，现有方法依赖迭代边剪枝，计算成本高且粒度粗
- 提出节点级剪枝框架，引入多粒度可学习掩码和粒度特定稀疏惩罚，在统一优化目标中实现从块到神经元的全面压缩
- 实验显示该方法发现节点更少的电路，内存占用降低5-10倍，同时保持任务性能，揭示粗粒度方法中许多神经元无关
