...
**一句话要点**：提出机器间视频编码标准VCM和FCM，以优化带宽、隐私和计算卸载。

**关键词**：机器间视频编码, 特征编码, 任务感知编码, 比特率优化, 隐私保护, 计算卸载

## 3 点简述
- 核心问题：机器间系统依赖人类感知优化的编解码器，导致带宽高、扩展差和隐私风险。
- 方法要点：VCM在像素域应用任务感知编码，FCM压缩神经特征以降低比特率并保护隐私。
- 实验效果：FCM保持接近边缘推理的准确性，显著减少比特率；H.265和H.266性能相近，H.264较差。
