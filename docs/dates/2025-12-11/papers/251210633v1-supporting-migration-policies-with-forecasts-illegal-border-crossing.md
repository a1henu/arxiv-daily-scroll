...
**arXiv**：[2512.10633v1](https://arxiv.org/abs/2512.10633) · [PDF](https://arxiv.org/pdf/2512.10633.pdf)  
**作者**：C. Bosco, U. Minora, D. de Rigo, J. Pingsdorf, R. Cortinovis  

**一句话要点**：提出混合方法预测欧洲非法越境，以支持欧盟移民政策决策

**关键词**：非法移民预测, 混合方法, 机器学习, 专家判断, 欧盟政策支持, 移民治理

## 3 点简述
- 核心问题：预测欧洲五条关键移民路线的非法越境，应对模式突变和数据限制。
- 方法要点：结合机器学习与专家定性洞察，引入人工评估协变量提升预测能力。
- 实验或效果：用已知数据测试验证，为欧盟移民治理提供政策相关预测工具。
