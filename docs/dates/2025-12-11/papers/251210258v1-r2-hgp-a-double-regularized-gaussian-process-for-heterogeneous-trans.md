...
**一句话要点**：提出双正则化高斯过程R^2-HGP以解决异构输入下的多源迁移学习问题

**关键词**：异构迁移学习, 高斯过程, 条件变分自编码器, 物理正则化, 稀疏迁移, 多源学习

## 3 点简述
- 核心问题：异构输入、忽略物理先验和负迁移阻碍多源迁移学习效果
- 方法要点：通过可训练先验映射对齐输入，结合物理正则化和稀疏惩罚优化迁移
- 实验或效果：仿真和工程案例验证R^2-HGP在多种指标上优于现有基准
