...
**一句话要点**：提出图拉普拉斯注意力变换器与迭代精炼模块，以提升前列腺癌分级中全切片图像的分析性能。

**关键词**：前列腺癌分级, 全切片图像分析, 图拉普拉斯变换器, 迭代补丁选择, 空间一致性建模

## 3 点简述
- 核心问题：全切片图像规模大、组织异质性强，现有方法因随机或静态补丁选择导致冗余区域影响性能。
- 方法要点：集成图拉普拉斯注意力变换器建模组织连通性，迭代精炼模块基于预训练模型动态选择相关补丁。
