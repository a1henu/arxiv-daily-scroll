...
**一句话要点**：提出图拉普拉斯注意力Transformer与迭代细化模块，以提升前列腺癌分级中全切片图像的分析性能。

**关键词**：前列腺癌分级, 全切片图像分析, 图拉普拉斯注意力, 迭代细化模块, 空间一致性建模

## 3 点简述
- 核心问题：全切片图像规模大、组织异质性强，现有方法因随机或静态补丁选择导致性能下降。
- 方法要点：集成迭代细化模块动态选择相关区域，图拉普拉斯Transformer建模组织连通性以增强空间一致性。
- 实验或效果：在多个数据集上超越先进方法，实现更高性能和计算效率。
