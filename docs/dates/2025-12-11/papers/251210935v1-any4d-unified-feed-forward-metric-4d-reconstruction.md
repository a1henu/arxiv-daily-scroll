...
**关键词**：4D重建, 多视图Transformer, 模块化表示, 多模态融合, 度量尺度重建, 前馈网络

## 3 点简述
- 核心问题：现有方法多专注于2视图密集场景流或稀疏3D点跟踪，缺乏统一、可扩展的4D重建框架
- 方法要点：采用模块化4D场景表示，结合自我中心与异我中心因素，通过多视图Transformer直接生成逐像素运动与几何预测
- 实验或效果：在多样设置下实现更高精度（误差降低2-3倍）和计算效率（快15倍），支持下游应用
