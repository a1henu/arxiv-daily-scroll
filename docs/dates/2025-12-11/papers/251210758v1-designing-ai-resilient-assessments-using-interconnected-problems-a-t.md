...
**一句话要点**：提出基于互联问题的AI弹性评估框架，以应对生成式AI对计算教育评估的冲击。

**关键词**：AI弹性评估, 互联问题设计, 计算教育, 学术诚信, 实证验证, 评估框架

## 3 点简述
- 核心问题：生成式AI削弱传统模块化评估，导致学术评估与行业实践脱节。
- 方法要点：设计互联问题和半结构化问题，增强AI弹性，挑战开放评估作为学术诚信主要保障的常见政策。
- 实验或效果：通过四年实证验证，互联项目与模块评估强相关，监考考试显示AI分数膨胀约30个百分点。
