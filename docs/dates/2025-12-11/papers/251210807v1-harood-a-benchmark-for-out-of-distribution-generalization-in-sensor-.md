...
**一句话要点**：提出HAROOD基准以评估传感器活动识别在分布外场景下的泛化性能

**关键词**：传感器活动识别, 分布外泛化, 基准测试, 时间序列分析, 深度学习

## 3 点简述
- 核心问题：传感器活动识别面临个体、设备、环境和时间变化导致的分布偏移，现有方法缺乏全面评估
- 方法要点：定义四种分布外场景，构建包含6个数据集和16种方法的测试平台，支持模块化扩展
- 实验或效果：实验表明无单一方法始终最优，为未来研究提供基准和代码库
