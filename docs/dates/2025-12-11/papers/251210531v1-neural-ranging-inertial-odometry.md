...
**关键词**：超宽带定位, 神经惯性里程计, 图注意力网络, 多径干扰, GPS缺失环境, 传感器融合

## 3 点简述
- 核心问题：UWB定位在真实场景中因传感器布置敏感性和多径干扰导致精度受限，尤其在长隧道等典型应用中。
- 方法要点：使用图注意力网络学习场景相关测距模式，适应任意锚点或标签数，无需校准；结合最小二乘和名义帧提升性能与可扩展性。
