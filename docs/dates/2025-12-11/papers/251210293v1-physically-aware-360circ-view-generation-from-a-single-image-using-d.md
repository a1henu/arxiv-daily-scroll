...
**一句话要点**：提出Disentangled360，通过解耦场景嵌入从单图像生成物理感知的360度视图

**关键词**：单图像视图合成, 解耦渲染, Gaussian Splatting, 360度生成, 医学成像, 物理感知

## 3 点简述
- 核心问题：现有方法简化各向异性光行为或缺乏跨场景泛化能力
- 方法要点：在Gaussian Splatting中区分各向同性与各向异性贡献，采用双分支条件框架
- 实验或效果：在Mip-NeRF 360等数据集上SSIM和LPIPS表现优异，支持交互应用
