...
**arXiv**：[2512.10637v1](https://arxiv.org/abs/2512.10637) · [PDF](https://arxiv.org/pdf/2512.10637.pdf)  
**作者**：Neha, Tarunpreet Bhatia  

**一句话要点**：提出基于对抗训练和动态神经网络的入侵检测系统，以增强5G/6G网络安全。

**关键词**：入侵检测系统, 对抗训练, 动态神经网络, 5G/6G网络, 增量学习, 网络安全

## 3 点简述
- 核心问题：传统入侵检测系统难以检测新型和演化攻击，且更新成本高。
- 方法要点：集成对抗训练和增量学习，减少重训练需求，并利用统计特性提升效率。
- 实验或效果：在NSL-KDD数据集上实现82.33%的多类攻击分类准确率，并抵抗数据中毒。
