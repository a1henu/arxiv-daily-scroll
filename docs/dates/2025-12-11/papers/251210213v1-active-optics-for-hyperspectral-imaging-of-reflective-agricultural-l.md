...
**arXiv**：[2512.10213v1](https://arxiv.org/abs/2512.10213) · [PDF](https://arxiv.org/pdf/2512.10213.pdf)  
**作者**：Dexter Burns, Sanjeev Koppal  

**一句话要点**：提出主动光学系统以解决农业叶片传感器的高光谱成像定位难题

**关键词**：主动光学, 高光谱成像, 农业传感器, LiDAR, 快速转向镜, 液体透镜

## 3 点简述
- 核心问题：复杂农业环境中叶片传感器的实时定位与光谱数据采集效率低
- 方法要点：集成LiDAR、快速转向镜和液体透镜，实现自适应检测与高光谱成像
- 实验或效果：室内验证显示系统能准确检测传感器并获取光谱数据
