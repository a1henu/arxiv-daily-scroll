...
**一句话要点**：提出OmniView统一框架，通过分离空间、时间和视角条件实现多种4D一致性任务

**关键词**：4D一致性任务, 视角合成, 扩散模型, 相机控制, 统一框架, 视频生成

## 3 点简述
- 核心问题：现有方法针对特定4D任务训练，数据利用分散，缺乏统一性。
- 方法要点：独立表示空间、时间和视角条件，支持灵活组合输入以处理静态、动态和多视角合成。
