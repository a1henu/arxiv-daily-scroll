...
**一句话要点**：提出V-OCBF框架，从离线数据学习神经控制屏障函数以保障自主系统安全

**关键词**：离线强化学习, 控制屏障函数, 安全控制, 无模型学习, 期望分位数优化, 二次规划

## 3 点简述
- 核心问题：现有离线安全强化学习方法无法保证前向不变性，而控制屏障函数通常依赖专家设计或系统动力学知识
- 方法要点：通过递归有限差分屏障更新实现无模型学习，结合期望分位数目标避免分布外动作查询
