...
**一句话要点**：提出UACER框架，通过不确定性感知的评论家集成，解决对抗强化学习中的训练不稳定问题。

**关键词**：对抗强化学习, 评论家集成, 不确定性感知, 训练稳定性, 马尔可夫博弈

## 3 点简述
- 核心问题：对抗强化学习中可训练对手导致学习动态非平稳，加剧训练不稳定和收敛困难。
- 方法要点：采用多样化评论家集成和基于方差的Q值聚合策略，动态调节探索-利用权衡。
- 实验或效果：在多个MuJoCo控制问题上验证，UACER在性能、稳定性和效率上优于现有方法。
