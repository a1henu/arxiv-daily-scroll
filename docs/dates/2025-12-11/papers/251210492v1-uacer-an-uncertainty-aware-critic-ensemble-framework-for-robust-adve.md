...
**一句话要点**：提出UACER框架以解决对抗强化学习中训练不稳定问题

**关键词**：对抗强化学习, 评论家集成, 不确定性感知, 训练稳定性, MuJoCo控制

## 3 点简述
- 核心问题：对抗强化学习中对手可训练性导致学习动态非平稳，加剧训练不稳定和收敛困难。
- 方法要点：采用多样化评论家集成和时变衰减不确定性机制，动态调节探索-利用平衡并稳定训练。
- 实验或效果：在多个MuJoCo控制问题中验证，UACER在性能、稳定性和效率上优于现有方法。
