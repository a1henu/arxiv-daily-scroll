...
**一句话要点**：提出RaLiFlow框架，通过4D雷达与激光雷达融合解决场景流估计问题。

**关键词**：场景流估计, 多模态融合, 4D雷达, 激光雷达, 动态感知, 跨模态学习

## 3 点简述
- 核心问题：4D雷达与激光雷达融合在场景流估计中未探索，雷达数据噪声大、分辨率低且稀疏。
- 方法要点：设计动态感知双向跨模态融合模块和损失函数，实现雷达动态信息与激光雷达的互补融合。
- 实验或效果：在构建的数据集上显著优于单模态方法，提升动态前景区域的实例级一致性。
