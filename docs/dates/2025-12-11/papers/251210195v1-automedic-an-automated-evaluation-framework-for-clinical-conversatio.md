...
**一句话要点**：提出AutoMedic框架，通过多代理模拟自动评估临床对话代理，解决动态交互场景标准化评估难题。

**关键词**：临床对话代理, 自动评估框架, 多代理模拟, 医疗数据集, CARE指标, LLM评估

## 3 点简述
- 核心问题：现有静态医疗问答基准难以评估LLM在动态交互临床对话中的表现，缺乏标准化方法。
- 方法要点：将静态QA数据集转化为虚拟患者档案，模拟多轮临床对话，基于CARE指标进行多维度评估。
- 实验或效果：框架经专家验证有效，为临床对话代理开发提供实用指南，提升评估的自动化和全面性。
