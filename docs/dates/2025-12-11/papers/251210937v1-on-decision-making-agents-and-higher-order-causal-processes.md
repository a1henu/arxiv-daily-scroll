...
**一句话要点**：建立部分可观测马尔可夫决策过程与高阶量子操作经典极限间的精确对应关系

**关键词**：部分可观测马尔可夫决策过程, 高阶量子操作, 过程函数, 多智能体系统, 因果过程

## 3 点简述
- 核心问题：连接决策智能体与高阶因果过程，探索物理与AI视角的对应
- 方法要点：将智能体策略和记忆更新识别为过程函数，通过链接积与环境交互
- 实验或效果：扩展至多智能体系统，识别观察独立分散POMDP为多输入过程函数自然域
