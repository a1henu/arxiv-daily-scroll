...
**一句话要点**：提出基于图神经网络的云身份与访问管理日志自适应威胁检测框架，以应对传统方法不足。

**关键词**：图神经网络, 云安全, 身份与访问管理, 威胁检测, 自适应学习, 零信任分析

## 3 点简述
- 核心问题：云身份与访问管理日志中新颖或演化威胁检测困难，传统规则或签名方法常失效。
- 方法要点：将IAM日志建模为异构动态图，利用图神经网络捕获实体间时空和上下文依赖，实现自适应学习。
- 实验或效果：在合成和真实数据集上，相比LSTM和GCN基线，本方法获得更高检测精度和召回率，并保持可扩展性。
