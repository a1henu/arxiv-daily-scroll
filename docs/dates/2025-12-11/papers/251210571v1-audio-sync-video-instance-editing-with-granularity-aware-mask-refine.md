...
**一句话要点**：提出AVI-Edit框架，通过粒度感知掩码精炼器和自反馈音频代理实现音频同步的视频实例编辑。

**关键词**：视频实例编辑, 音频-视觉同步, 掩码精炼, 细粒度控制, 数据集构建

## 3 点简述
- 现有视频编辑方法忽视音频-视觉同步，缺乏实例级编辑的细粒度时空控制。
- 引入粒度感知掩码精炼器迭代优化用户掩码，并设计自反馈音频代理提供高质量音频引导。
- 实验表明AVI-Edit在视觉质量、条件遵循和音频-视觉同步方面优于现有方法。
