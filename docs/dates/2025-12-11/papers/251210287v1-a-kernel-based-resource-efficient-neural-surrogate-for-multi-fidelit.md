...
**关键词**：多保真度预测, 核基神经代理, 气动场模拟, 资源效率, 张量分解

## 3 点简述
- 核心问题：传统气动模拟成本高，需高效代理模型平衡精度与资源消耗。
- 方法要点：基于变分原理、插值理论和张量分解，融合稀疏高保真与低保真数据。
- 实验或效果：在AirfRANS数据集上，KHRONOS在参数少、训练快方面优于MLP、GNN和PINN。
