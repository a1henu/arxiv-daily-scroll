...
**一句话要点**：提出基于证据中心设计的大语言模型反馈系统，以支持物理问题解决并评估其性能。

**关键词**：大语言模型反馈系统, 证据中心设计, 物理问题解决, 教育技术评估, 生成式人工智能

## 3 点简述
- 核心问题：大语言模型在需要高级领域知识（如物理问题解决）的任务中提供高质量反馈仍具挑战。
- 方法要点：基于证据中心设计构建大语言模型反馈系统，针对德国物理奥林匹克竞赛进行定制。
- 实验或效果：参与者认为反馈有用且准确，但深入分析显示20%的案例存在事实错误，常被学生忽视。
