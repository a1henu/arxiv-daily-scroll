...
**关键词**：AI规划语言, 上下文隔离, 工作流可审计性, 语义-语法分离, 渐进形式化, LLM工作流

## 3 点简述
- 核心问题：多步LLM调用工作流中信息积累导致上下文污染，引发幻觉和任务约束丢失
- 方法要点：设计NormCode语言，通过数据隔离和语义-语法操作分离消除跨步污染，支持渐进形式化
- 实验或效果：验证包括加法算法100%准确性和自托管编译器管道，提供可审计工作流
