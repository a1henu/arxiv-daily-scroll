...
**一句话要点**：比较编码器与解码器模型在因果推理中的性能，发现编码器架构更稳健

**关键词**：因果推理, 上下文学习, 编码器解码器架构, 微调, 分布偏移, 多跳推理

## 3 点简述
- 研究因果推理中上下文学习的不足，强调多跳组合和严格合取控制的需求
- 假设编码器架构因潜在空间投影能力更优，通过微调实验验证其稳健性
- 实验显示解码器模型对分布偏移脆弱，编码器模型在非自然语言场景中泛化更强
