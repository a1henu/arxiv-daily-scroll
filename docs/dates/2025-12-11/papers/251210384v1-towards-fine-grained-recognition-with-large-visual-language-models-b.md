...
**一句话要点**：提出FROW基准与优化策略以提升大视觉语言模型在细粒度识别任务中的性能

**关键词**：细粒度识别, 大视觉语言模型, 开放世界基准, 数据优化, 训练策略, GPT-4o评估

## 3 点简述
- 现有基准忽视细粒度识别，提出FROW基准评估LVLMs在开放世界中的表现
- 从数据构建和训练过程两方面优化，包括马赛克数据和开放世界数据
- 实验显示优化策略显著提升识别准确率，预训练加入细粒度数据可提高10%
