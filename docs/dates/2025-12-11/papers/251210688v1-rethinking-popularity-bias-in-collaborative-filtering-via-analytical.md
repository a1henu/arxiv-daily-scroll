...
**一句话要点**：提出方向性分解与校正框架，通过几何修正解决协同过滤中的流行度偏差问题。

**关键词**：协同过滤, 流行度偏差, 嵌入几何, 贝叶斯成对排序, 方向性分解, 推荐系统

## 3 点简述
- 揭示流行度偏差是贝叶斯成对排序优化的内在几何伪影，导致嵌入沿流行方向扭曲。
- 提出DDC框架，通过非对称方向更新分离偏好与流行度，修正嵌入几何。
- 实验显示DDC显著优于现有去偏方法，降低训练损失并提升推荐质量与公平性。
