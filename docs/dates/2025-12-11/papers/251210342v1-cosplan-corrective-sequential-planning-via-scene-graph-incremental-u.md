...
**一句话要点**：提出基于场景图增量更新的免训练方法SGI，以增强视觉语言模型在纠错式视觉顺序规划任务中的性能。

**关键词**：视觉顺序规划, 纠错规划, 场景图推理, 视觉语言模型, 基准评估

## 3 点简述
- 核心问题：视觉语言模型在易出错的视觉顺序规划任务中，难以检测和纠正非最优步骤。
- 方法要点：通过场景图增量更新引入中间推理步骤，帮助模型进行序列推理。
- 实验效果：在CoSPlan基准上平均提升5.2%，并泛化至传统规划任务。
