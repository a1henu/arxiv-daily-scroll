...
**一句话要点**：提出基于场景图增量更新的无训练方法SGI，以提升视觉语言模型在纠错式视觉顺序规划任务中的性能。

**关键词**：视觉顺序规划, 纠错规划, 场景图推理, 视觉语言模型, 基准评估, 无训练方法

## 3 点简述
- 核心问题：视觉语言模型在视觉顺序规划中难以检测和纠正非最优步骤，缺乏纠错能力。
- 方法要点：引入场景图增量更新SGI，在初始与目标状态间添加中间推理步骤，增强序列推理。
- 实验或效果：在CoSPlan基准上，SGI使VLMs平均性能提升5.2%，并泛化至传统规划任务。
