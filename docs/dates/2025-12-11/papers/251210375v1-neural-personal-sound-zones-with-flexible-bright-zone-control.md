...
**一句话要点**：提出基于3D卷积神经网络的个人声区系统，实现灵活控制点网格和替代重建目标

**关键词**：个人声区系统, 3D卷积神经网络, 声学控制, 虚拟现实, 灵活控制点网格, 稀疏采样

## 3 点简述
- 核心问题：传统个人声区系统需固定接收阵列测量重建目标，导致不便和成本高
- 方法要点：设计3D CNN，以虚拟目标场景为输入，输出个人声区预滤波器，支持灵活控制点网格
- 实验或效果：相比传统方法，仅需一次训练即可处理灵活控制点网格和不同重建目标，并能从稀疏采样点学习全局空间信息
