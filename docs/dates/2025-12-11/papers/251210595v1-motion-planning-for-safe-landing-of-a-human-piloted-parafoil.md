...
**一句话要点**：提出基于采样运动规划的算法以生成人控翼伞安全着陆轨迹，提升训练模拟效果。

**关键词**：运动规划, 翼伞着陆, 安全轨迹, 采样算法, 训练模拟器

## 3 点简述
- 研究人控翼伞着陆阶段的安全轨迹规划问题，以弥补训练模拟器不足。
- 采用改进的Stable Sparse RRT算法，最小化倾斜角作为安全代理，生成平滑下降轨迹。
- 实验显示算法相比人类飞行员成本降低20%-80%，可集成到模拟器辅助训练。
