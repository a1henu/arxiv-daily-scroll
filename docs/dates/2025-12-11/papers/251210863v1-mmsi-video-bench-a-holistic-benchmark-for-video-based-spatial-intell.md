...
**一句话要点**：提出MMSI-Video-Bench基准以全面评估多模态大语言模型的视频空间智能

**关键词**：视频空间智能, 多模态大语言模型, 基准评估, 几何推理, 跨视频推理, 人工标注

## 3 点简述
- 核心问题：缺乏全面评估视频空间智能的基准，阻碍MLLMs在物理环境中的发展。
- 方法要点：基于四层框架（感知、规划、预测、跨视频推理），构建包含1,106个问题的全人工标注基准。
- 实验或效果：评估25个模型，揭示显著人机差距，最佳模型落后人类近60%，并暴露系统推理失败。
