...
**关键词**：视频生成模型, 机器人策略评估, 分布外泛化, 多视图一致性, 安全测试, 生成世界模型

## 3 点简述
- 核心问题：视频模型在机器人学中主要用于分布内评估，缺乏对分布外泛化和安全性的全面测试
- 方法要点：构建基于前沿视频基础模型Veo的生成评估系统，优化动作条件化和多视图一致性，集成图像编辑与多视图补全
- 实验或效果：通过1600+真实世界评估验证系统能准确预测策略性能，支持泛化轴分析和红队测试
