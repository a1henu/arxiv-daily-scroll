...
**一句话要点**：提出InfoCom框架，基于信息瓶颈理论实现千字节级通信高效的协同感知

**关键词**：协同感知, 信息瓶颈, 通信效率, 信息净化, 自动驾驶

## 3 点简述
- 核心问题：协同感知面临通信与性能的权衡，现有方法假设兆字节级传输，不适用于实际网络限制
- 方法要点：引入信息净化范式，通过信息感知编码、稀疏掩码生成和多尺度解码提取最小充分任务关键信息
- 实验或效果：在多个数据集上实现近无损感知，通信开销从兆字节降至千字节级，相比基准方法减少数十至数百倍
