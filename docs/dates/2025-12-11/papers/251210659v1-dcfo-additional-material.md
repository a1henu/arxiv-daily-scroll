...
**一句话要点**：提出DCFO方法，为LOF算法生成反事实解释以提升异常检测可解释性。

**关键词**：异常检测, 反事实解释, LOF算法, 可解释性, 梯度优化

## 3 点简述
- 核心问题：LOF等经典异常检测算法缺乏可解释性，现有反事实解释方法未针对其独特挑战。
- 方法要点：DCFO将数据空间分区，使LOF行为平滑，基于梯度优化生成最小改变的反事实。
- 实验或效果：在50个OpenML数据集上验证，DCFO在邻近性和有效性上优于基准方法。
