...
**一句话要点**：提出自集成后学习方法以解决带噪声标签的领域泛化问题

**关键词**：领域泛化, 噪声标签, 特征探测, 集成学习, 半监督训练, 伪特征放大

## 3 点简述
- 核心问题：领域泛化中噪声标签加剧深层伪特征放大，导致算法性能下降
- 方法要点：利用模型中间特征训练多个探测分类器，通过集成推理提升特征多样性
- 实验或效果：实验评估显示方法增强现有方法鲁棒性，具有高灵活性的实际应用潜力
