...
**一句话要点**：提出XDen-1K数据集以解决真实物体内部物理属性数据缺失问题

**关键词**：体积密度估计, 多模态数据集, 物理属性恢复, 机器人操作, X射线扫描, 3D几何模型

## 3 点简述
- 核心问题：现有模型忽略物体内部物理属性，如体积密度，影响机器人操作和物理模拟。
- 方法要点：构建包含1000个真实物体的多模态数据集，提供高分辨率3D模型和X射线扫描，并开发优化框架恢复密度场。
- 实验或效果：利用数据集改进质心估计精度和机器人操作成功率，验证其实际应用价值。
