...
**关键词**：联邦学习, 域泛化, 隐私保护, 模型聚合, 潜在空间反转, 异构客户端

## 3 点简述
- 核心问题：联邦域泛化中现有方法通过共享客户端数据统计危及隐私，且非独立同分布客户端聚合可能丢弃本地适配
- 方法要点：使用潜在空间反转增强本地模型训练以保护隐私，并提出重要权重聚合策略优先关键参数
- 实验或效果：实验显示方法在减少通信开销下优于现有技术，提升泛化能力
