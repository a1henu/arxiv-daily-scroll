...
**一句话要点**：提出基于矩模糊集的分布鲁棒遗憾最优控制方法，以解决线性二次随机控制中的分布不确定性。

**关键词**：分布鲁棒控制, 线性二次随机控制, 矩模糊集, 遗憾最小化, 凸优化, 可扩展算法

## 3 点简述
- 研究有限时域线性二次随机控制问题，噪声分布未知但属于基于均值和协方差的矩模糊集。
- 设计因果仿射控制策略，最小化最坏情况期望遗憾，问题可转化为易处理的凸规划。
- 提出可扩展的双投影次梯度方法计算最优控制器，并通过数值实验与先进方法对比。
