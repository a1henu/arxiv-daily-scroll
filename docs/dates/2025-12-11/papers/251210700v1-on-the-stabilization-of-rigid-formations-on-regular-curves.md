...
**关键词**：多智能体系统, 刚性编队, 曲线稳定, 牛顿类算法, 连续反馈控制, 路径规划

## 3 点简述
- 核心问题：稳定多智能体刚性编队在平面可微闭曲线上的形成，确保路径扫描和智能体间避碰。
- 方法要点：使用随机多启动牛顿类算法寻找内接正多边形，设计连续反馈律实现收敛和扫描。
- 实验或效果：通过数值模拟验证方法在不同曲线和编队中的有效性，代码已开源。
