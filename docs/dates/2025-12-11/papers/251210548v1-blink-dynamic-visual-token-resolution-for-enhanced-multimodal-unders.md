...
**一句话要点**：提出Blink动态视觉令牌分辨率框架以增强多模态大语言模型的视觉感知能力

**关键词**：多模态大语言模型, 视觉令牌分辨率, 动态注意力机制, 令牌超分辨率, 视觉感知增强

## 3 点简述
- 核心问题：多模态大语言模型视觉感知受限，缺乏人类动态扫描和聚焦的机制
- 方法要点：基于注意力图估计令牌显著性，通过令牌超分辨率模块动态扩展和丢弃令牌
- 实验或效果：广泛实验验证Blink能有效提升视觉感知和多模态理解，实现自适应高效增强
