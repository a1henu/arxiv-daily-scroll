...
**一句话要点**：提出基于可设计球面格林函数的广义球面神经算子框架，以解决球面域上参数偏微分方程建模的几何失真与灵活性不足问题。

**关键词**：球面神经算子, 格林函数, 谱学习, 旋转等变性, 参数偏微分方程, 球面域建模

## 3 点简述
- 核心问题：现有球面神经算子难以在保持旋转等变性同时适应现实复杂系统，导致几何失真和灵活性受限。
- 方法要点：基于球面格林函数及其谐波展开，设计绝对与相对位置依赖的格林函数，平衡等变性与不变性，并开发谱学习方法。
- 实验或效果：在扩散MRI、浅水动力学和全球天气预报任务中，GSNO和GSHNet架构均优于现有方法，验证了框架的有效性。
