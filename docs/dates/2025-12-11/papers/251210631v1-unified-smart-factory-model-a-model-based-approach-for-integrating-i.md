...
**一句话要点**：提出统一智能工厂模型，以模型为基础整合工业4.0与可持续性，支持制造业系统目标实现。

**关键词**：智能工厂模型, 可持续制造, 模型基系统工程, 关键绩效指标, 工业4.0集成, 数据映射

## 3 点简述
- 核心问题：制造业中可持续性目标与工厂级实施之间存在信息鸿沟，缺乏系统化映射方法。
- 方法要点：基于对象过程方法论构建统一框架，集成制造过程、数据流程和KPI评估，减少冗余和遗漏风险。
- 实验或效果：通过PCB组装工厂案例研究，展示如何建模和映射环境可持续性KPI，提升数据收集效率。
