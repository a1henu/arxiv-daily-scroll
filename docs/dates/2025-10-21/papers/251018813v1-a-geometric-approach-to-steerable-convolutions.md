...
**arXiv**：[2510.18813v1](https://arxiv.org/abs/2510.18813) · [PDF](https://arxiv.org/pdf/2510.18813.pdf)  
**作者**：Soumyabrata Kundu, Risi Kondor  

**一句话要点**：提出基于几何方法的可操纵卷积网络，改进实现并增强噪声鲁棒性。

**关键词**：可操纵卷积网络, 几何方法, Clebsch-Gordan分解, 插值核, 噪声鲁棒性

## 3 点简述
- 核心问题：现有可操纵卷积网络推导抽象，缺乏直观性。
- 方法要点：使用几何论证和模式匹配原理，直观解释Clebsch-Gordan分解。
- 实验或效果：通过插值核改进实现，提升对噪声数据的鲁棒性。
