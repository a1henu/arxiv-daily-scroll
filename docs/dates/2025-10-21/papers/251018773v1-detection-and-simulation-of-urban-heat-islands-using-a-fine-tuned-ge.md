...
**arXiv**：[2510.18773v1](https://arxiv.org/abs/2510.18773) · [PDF](https://arxiv.org/pdf/2510.18773.pdf)  
**作者**：Jannis Fleckenstein, David Kreismann, Tamara Rosemary Govindasamy, Thomas Brunschwiler, Etienne Vos, Mattia Rigotti  

**一句话要点**：提出微调地理空间基础模型以预测城市热岛效应，支持数据稀缺区域的缓解策略评估。

**关键词**：城市热岛检测, 地理空间基础模型, 微调预测, 气候模拟, 数据稀缺区域, 缓解策略评估

## 3 点简述
- 核心问题：城市化与气候变化加剧城市热岛效应，传统模型在数据有限时预测不准确。
- 方法要点：利用全球数据训练的地理空间基础模型，通过微调预测地表温度。
- 实验或效果：建立真实热模式基准，模拟未来气候场景，验证模型对缓解策略的支持作用。
