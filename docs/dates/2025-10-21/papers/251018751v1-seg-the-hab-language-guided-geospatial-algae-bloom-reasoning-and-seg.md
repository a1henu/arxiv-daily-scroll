...
**arXiv**：[2510.18751v1](https://arxiv.org/abs/2510.18751) · [PDF](https://arxiv.org/pdf/2510.18751.pdf)  
**作者**：Patterson Hsieh, Jerry Yeh, Mao-Chi He, Wen-Han Hsieh, Elvis Hsieh  

**一句话要点**：提出ALGOS系统以解决有害藻华监测中的分割与严重性估计问题

**关键词**：有害藻华监测, 遥感图像分割, 视觉语言模型, 严重性估计, 自动化系统

## 3 点简述
- 核心问题：气候变化加剧有害藻华，传统监测方法劳动密集且覆盖有限
- 方法要点：结合遥感图像理解与视觉语言模型，进行分割和严重性预测
- 实验或效果：在分割和严重性估计上表现稳健，支持自动化监测系统
