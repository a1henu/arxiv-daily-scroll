...
**arXiv**：[2510.18600v1](https://arxiv.org/abs/2510.18600) · [PDF](https://arxiv.org/pdf/2510.18600.pdf)  
...
**一句话要点**：在活火山测试四足机器人自适应最优控制算法以验证行星探索应用

**关键词**：四足机器人, 行星探索, 自适应控制, 最优控制, 实地测试, 火山环境

## 3 点简述
- 核心问题：轮式漫游车难以穿越行星崎岖地形，需开发腿式机器人提升探索能力。
- 方法要点：开发自适应最优控制算法，优化四足机器人在复杂环境中的运动性能。
- 实验或效果：在意大利Vulcano活火山进行实地测试，验证算法在月球和火星模拟环境中的有效性。
