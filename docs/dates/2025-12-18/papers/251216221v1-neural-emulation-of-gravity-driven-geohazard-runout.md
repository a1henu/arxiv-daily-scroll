...
**一句话要点**：提出基于神经仿真的重力驱动地质灾害运移预测模型，实现高效准确预测

**关键词**：地质灾害预测, 神经仿真, 机器学习模型, 数值模拟, 运移预测, 计算效率

## 3 点简述
- 核心问题：地质灾害运移预测面临物理真实性与计算效率的权衡，现有方法难以兼顾。
- 方法要点：训练机器学习模型，基于超过10万次数值模拟数据，预测流场范围和沉积厚度。
- 实验或效果：模型预测准确度高，计算速度比数值求解器快100至10,000倍，能泛化不同流型和地形。
