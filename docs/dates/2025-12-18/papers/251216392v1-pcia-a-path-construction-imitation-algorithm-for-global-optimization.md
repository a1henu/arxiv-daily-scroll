...
**arXiv**：[2512.16392v1](https://arxiv.org/abs/2512.16392) · [PDF](https://arxiv.org/pdf/2512.16392.pdf)  
**作者**：Mohammad-Javad Rezaei, Mozafar Bag-Mohammadi  

**一句话要点**：提出路径构建模仿算法PCIA以解决全局优化问题

**关键词**：元启发式算法, 全局优化, 路径构建模仿, 随机种群, 约束优化, 数学优化

## 3 点简述
- 核心问题：全局优化问题，需高效搜索最优解。
- 方法要点：模仿人类路径构建行为，通过随机种群和路径混合策略进行优化。
- 实验或效果：在66个数学和约束优化问题上测试，显示与流行及最新元启发式算法竞争性强。
