...
**一句话要点**：提出共识瓶颈资产定价模型，通过可解释深度学习预测股票收益并揭示信念驱动结构。

**关键词**：资产定价, 可解释深度学习, 共识形成, 股票收益预测, 信念驱动结构

## 3 点简述
- 核心问题：传统因子模型未完全捕捉信念驱动收益结构，需可解释方法预测股票风险溢价。
- 方法要点：设计部分可解释神经网络，模拟分析师共识形成过程，压缩分散信念为资产价格。
- 实验或效果：模型提升长期预测准确性，产生经济显著收益，并揭示超越传统因子的定价信息。
