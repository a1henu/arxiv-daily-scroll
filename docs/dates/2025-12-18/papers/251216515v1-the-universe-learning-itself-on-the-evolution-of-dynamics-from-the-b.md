...
**arXiv**：[2512.16515v1](https://arxiv.org/abs/2512.16515) · [PDF](https://arxiv.org/pdf/2512.16515.pdf)  
**作者**：Pradeep Singh, Mudasani Rushikesh, Bezawada Sri Sai Anurag, Balasubramanian Raman  

**一句话要点**：提出统一动力学叙事框架，从宇宙大爆炸到人工智能，解读结构形成的连续演化链。

**关键词**：动力学系统, 跨尺度演化, 结构形成, 相变, 涌现吸引子, 人工智能理论

## 3 点简述
- 核心问题：如何统一解释从宇宙起源到人工智能的跨尺度结构形成过程。
- 方法要点：基于动力学系统理论，通过相变、对称破缺和涌现吸引子连接不同领域。
- 实验或效果：提供理论视角，强调不稳定性、分岔和多尺度耦合等数学主题，无新模型。
