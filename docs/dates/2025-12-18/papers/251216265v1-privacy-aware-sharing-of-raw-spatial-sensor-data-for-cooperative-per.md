...
**arXiv**：[2512.16265v1](https://arxiv.org/abs/2512.16265) · [PDF](https://arxiv.org/pdf/2512.16265.pdf)  
**作者**：Bangya Liu, Chengpo Yan, Chenghao Jiang, Suman Banerjee, Akarsh Prabhakara  

**一句话要点**：提出SHARP框架以解决车辆协同感知中原始空间传感器数据共享的隐私问题

**关键词**：协同感知, 隐私保护, 传感器数据共享, 车辆网络, 空间数据处理

## 3 点简述
- 核心问题：原始空间传感器数据共享引发新隐私担忧，阻碍汽车制造商采用协同感知技术
- 方法要点：SHARP框架旨在最小化隐私泄露，推动基于原始数据的协同感知目标
