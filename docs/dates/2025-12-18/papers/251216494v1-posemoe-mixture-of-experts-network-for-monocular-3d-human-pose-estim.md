...
**关键词**：单目3D人体姿态估计, 混合专家网络, 特征解纠缠, 深度估计, 跨专家聚合, 提升方法

## 3 点简述
- 核心问题：基于提升的方法中，深度特征与2D姿态特征在纠缠特征空间中编码，深度不确定性限制了整体估计精度。
- 方法要点：设计混合专家网络，分离2D姿态和深度特征编码，减少不确定深度对2D特征的影响，并引入跨专家知识聚合模块增强特征。
