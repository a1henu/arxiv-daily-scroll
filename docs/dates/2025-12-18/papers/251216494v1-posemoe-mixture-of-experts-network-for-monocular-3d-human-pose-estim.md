...
**关键词**：单目3D人体姿态估计, 混合专家网络, 特征解耦, 深度估计, 姿态提升, 时空上下文聚合

## 3 点简述
- 核心问题：基于提升的方法中，深度特征与2D姿态特征在编码时纠缠，深度不确定性影响2D姿态，限制整体估计精度。
- 方法要点：设计混合专家网络，专家模块分别精炼2D姿态特征和学习深度特征，解耦特征编码过程，减少不确定深度对2D姿态的显式影响。
- 实验或效果：在Human3.6M、MPI-INF-3DHP和3DPW数据集上，PoseMoE优于传统基于提升的方法。
