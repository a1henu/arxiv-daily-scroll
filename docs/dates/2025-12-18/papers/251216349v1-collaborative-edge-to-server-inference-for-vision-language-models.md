...
**一句话要点**：提出协作边缘到服务器推理框架，以降低视觉语言模型通信成本并保持精度

**关键词**：视觉语言模型, 边缘计算, 协作推理, 通信优化, 兴趣区域检测

## 3 点简述
- 核心问题：边缘设备传输全局图像至服务器时，分辨率调整导致细节丢失，影响推理精度
- 方法要点：服务器先推理全局图像，基于注意力识别兴趣区域，通过最小熵置信度决定是否请求局部图像重传
- 实验或效果：多架构实验显示，该框架显著减少通信成本，同时维持推理精度
