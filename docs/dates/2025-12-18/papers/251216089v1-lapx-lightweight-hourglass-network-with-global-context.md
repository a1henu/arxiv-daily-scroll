...
**关键词**：人体姿态估计, 轻量级网络, 自注意力, 边缘计算, 沙漏网络

## 3 点简述
- 核心问题：现有姿态估计方法在边缘设备部署时，常面临模型过大或精度不足的挑战。
- 方法要点：基于LAP改进，引入自注意力模块优化阶段设计，增强全局信息捕获能力。
- 实验或效果：在MPII和COCO数据集上取得竞争性结果，参数仅2.3M，实现实时性能，适合边缘设备。
