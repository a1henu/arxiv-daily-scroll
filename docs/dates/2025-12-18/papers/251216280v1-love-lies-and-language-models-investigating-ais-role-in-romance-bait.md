...
**一句话要点**：调查大型语言模型在浪漫诱饵诈骗中的自动化作用，揭示其广泛部署与防御不足

**关键词**：浪漫诱饵诈骗, 大型语言模型, 自动化犯罪, 对话研究, 安全过滤器

## 3 点简述
- 核心问题：浪漫诱饵诈骗基于文本对话，引发大型语言模型在诈骗自动化中的角色担忧
- 方法要点：通过访谈、盲法对话研究和安全过滤器评估，分析诈骗组织与LLM的交互
- 实验或效果：LLM代理在信任和请求遵从度上优于人类操作员，安全过滤器检测率为0.0%
