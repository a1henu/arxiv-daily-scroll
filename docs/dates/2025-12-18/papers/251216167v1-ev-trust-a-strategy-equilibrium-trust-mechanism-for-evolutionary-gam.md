...
**arXiv**：[2512.16167v1](https://arxiv.org/abs/2512.16167) · [PDF](https://arxiv.org/pdf/2512.16167.pdf)  
**作者**：Shiduo Yang, Jiye Wang, Jiayu Qin, Jianbin Li, Yu Wang, Yuanhe Zhao, Kenan Guo  

**一句话要点**：提出Ev-Trust信任机制，基于演化博弈论解决LLM多智能体服务中的欺骗与信任挑战。

**关键词**：多智能体系统, 演化博弈论, 信任机制, LLM驱动服务, 策略均衡, 去中心化交互

## 3 点简述
- 核心问题：LLM多智能体系统的开放性和异构性加剧欺骗、欺诈和虚假信息风险，威胁信任建立与系统鲁棒性。
- 方法要点：整合直接信任、间接信任和预期收益，通过动态反馈结构引导智能体行为演化至均衡状态。
- 实验或效果：理论证明局部演化均衡存在且稳定，实验显示能有效反映信任度、减少恶意策略并提升集体收益。
