...
**arXiv**：[2512.16447v1](https://arxiv.org/abs/2512.16447) · [PDF](https://arxiv.org/pdf/2512.16447.pdf)  
...
**一句话要点**：提出TIB AIssistant平台以支持跨学科研究，通过模块化组件和AI助手增强科研工作流。

**关键词**：AI辅助研究, 人机协作平台, 模块化组件, 科研工作流增强, 生成AI集成

## 3 点简述
- 核心问题：AI集成研究面临领域差异、AI素养不足、工具协调复杂和生成AI准确性不明确等挑战。
- 方法要点：设计领域无关的人机协作平台，包含提示库、工具库、共享数据存储和灵活编排框架。
- 实验或效果：开发早期原型，展示平台在科学发现、文献分析、方法开发、数据分析和学术写作中的可行性和潜在影响。
