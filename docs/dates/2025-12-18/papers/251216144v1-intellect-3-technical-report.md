...
**关键词**：混合专家模型, 大规模强化学习, 开源基础设施, 多领域基准, 异步训练框架

## 3 点简述
- 核心问题：未知，但聚焦于开发高效大规模强化学习模型以提升多领域基准性能。
- 方法要点：基于GLM-4.5-Air-Base，采用混合专家架构和prime-rl框架进行端到端强化学习训练。
- 实验或效果：在数学、代码、科学和推理基准上达到同规模最优，开源模型与完整基础设施。
