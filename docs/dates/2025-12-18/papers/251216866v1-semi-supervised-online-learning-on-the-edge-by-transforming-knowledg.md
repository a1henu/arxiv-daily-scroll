...
**一句话要点**：提出知识转换方法以解决边缘在线学习中未来未见数据的标签确定问题

**关键词**：边缘机器学习, 在线学习, 知识蒸馏, 主动学习, 伪标签生成, 因果推理

## 3 点简述
- 核心问题：边缘在线学习需为未来未见数据生成标签，传统静态模型方法无效
- 方法要点：结合知识蒸馏、主动学习和因果推理，通过教师模型知识转换生成伪标签训练学生模型
- 实验或效果：模拟实验显示，稳定教师模型下学生模型可达到预期最大性能，适用于教师任务通用或学生标签获取困难场景
