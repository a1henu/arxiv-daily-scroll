...
**一句话要点**：提出基于YOLOv8的优化车牌检测与识别系统，以提升智能交通系统中的实时准确性。

**关键词**：车牌检测, 字符识别, YOLOv8, 智能交通系统, 实时处理, 边缘设备

## 3 点简述
- 核心问题：车牌检测与识别在多样化环境中实时准确性不足。
- 方法要点：采用YOLOv8 Nano进行车牌检测，YOLOv8 Small进行字符识别，并引入自定义字符排序方法。
- 实验或效果：YOLOv8 Nano在车牌检测任务中精度达0.964，YOLOv8 Small在字符识别任务中精度达0.92。
