...
**一句话要点**：提出CRONOS框架以解决医学3D扫描在连续时间下的体素级预测问题

**关键词**：医学图像预测, 连续时间建模, 时空速度场, 多上下文学习, 体素级预测

## 3 点简述
- 核心问题：现有模型依赖单次扫描或固定时间网格，限制了不规则采样下的体素级预测。
- 方法要点：学习时空速度场，支持离散和连续时间戳，实现多上下文到单图像的连续预测。
- 实验或效果：在三个公共数据集上超越基线，计算效率高，代码将开源以促进可复现基准测试。
