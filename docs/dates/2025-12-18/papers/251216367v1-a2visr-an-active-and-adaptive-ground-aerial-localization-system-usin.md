...
**一句话要点**：提出A2VISR系统，通过主动视觉与单测距融合增强杂乱环境中飞行机器人定位鲁棒性

**关键词**：地面-空中协同定位, 主动视觉系统, 单测距融合, 自适应置信度评估, 降维估计器, 视觉惯性里程计

## 3 点简述
- 核心问题：传统固定相机定位在视觉退化时受限，易受距离和捕获失败影响
- 方法要点：集成主动视觉、单测距、惯性里程计和光流，采用降维估计器和自适应置信度评估
- 实验或效果：在烟雾、光照变化等条件下，平均定位误差约0.09米，保持对捕获丢失和传感器故障的韧性
