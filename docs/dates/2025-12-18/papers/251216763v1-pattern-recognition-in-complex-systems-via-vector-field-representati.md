...
**arXiv**：[2512.16763v1](https://arxiv.org/abs/2512.16763) · [PDF](https://arxiv.org/pdf/2512.16763.pdf)  
...
**一句话要点**：提出基于离散测度空间向量场的几何框架，以分析复杂系统的时空数据

**关键词**：复杂系统分析, 时空数据处理, 向量场表示, 几何框架, 度量学习, 多维缩放

## 3 点简述
- 核心问题：复杂系统的高维非线性时空数据难以建模和分类，传统方法受限
- 方法要点：引入两参数度量族，支持图像、梯度和图/单纯复形上的函数分析
- 实验或效果：在生物和物理模拟数据上验证，结合多维缩放实现降维和相空间重构
