...
**关键词**：上下文扩散模型, 图像编辑防御, 注意力扰动, 隐私保护, 多模态注意力

## 3 点简述
- 核心问题：上下文扩散模型易被滥用，导致个人图像被恶意编辑，引发隐私担忧
- 方法要点：通过注入微小扰动削弱多模态注意力层，阻断输入到输出的上下文传播
- 实验或效果：在Flux Kontext和Step1X-Edit上验证，能有效阻止不必要编辑并保持视觉质量
