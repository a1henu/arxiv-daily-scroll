...
**一句话要点**：提出基于高斯溅射的统一面部重建方法，从少量图像生成高质量几何与纹理

**关键词**：高斯溅射, 面部重建, 神经纹理, 语义对齐, 三角网格约束, 纹理解耦

## 3 点简述
- 核心问题：从少量未标定图像重建一致的面部几何与纹理，避免依赖长视频或校准数据
- 方法要点：利用高斯溅射结合语义分割对齐，软约束于三角网格，实现结构化重建与纹理转换
- 实验或效果：仅需11张图像生成中性姿态，支持标准图形管线，应用于文本驱动资产创建
