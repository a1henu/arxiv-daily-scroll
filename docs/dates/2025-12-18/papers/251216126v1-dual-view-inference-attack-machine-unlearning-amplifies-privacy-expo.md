...
**关键词**：机器遗忘, 隐私攻击, 双视图推理, 成员推理攻击, 信息增益, 黑盒查询

## 3 点简述
- 核心问题：机器遗忘技术虽保护被遗忘数据隐私，但保留数据的隐私风险未知，双视图设置可能加剧泄露
- 方法要点：DVIA通过黑盒查询原始与遗忘模型，利用轻量似然比推理模块提取保留数据成员信息，无需训练攻击模型
- 实验或效果：跨数据集和模型架构验证DVIA有效性，突显双视图设置固有隐私风险
