...
**arXiv**：[2512.16071v1](https://arxiv.org/abs/2512.16071) · [PDF](https://arxiv.org/pdf/2512.16071.pdf)  
**作者**：Yixuan Gao, Tanvir Ahmed, Mikhail Mohammed, Zhongqi Cheng, Rajalakshmi Nandakumar  

**一句话要点**：提出SoilScanner无线系统，基于射频信号检测土壤铅污染，以解决传统方法成本高、劳动密集的问题。

**关键词**：无线传感, 土壤污染检测, 射频信号, 铅污染, 机器学习分类

## 3 点简述
- 核心问题：城市土壤铅污染影响食品安全和公共健康，现有检测技术劳动密集且成本高。
- 方法要点：利用不同盐类（如NaCl和Pb(NO3)2）对射频信号传播的影响差异，通过无线系统检测铅污染。
- 实验或效果：在受控和野外实验中，系统能以72%准确率分类低铅和高铅土壤（阈值200 ppm），无高污染样本误分类。
