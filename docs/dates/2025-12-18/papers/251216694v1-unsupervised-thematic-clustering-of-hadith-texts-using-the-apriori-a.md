...
**一句话要点**：提出基于Apriori算法的无监督主题聚类方法，以自动化处理圣训文本的数字化分组问题。

**关键词**：无监督学习, Apriori算法, 文本挖掘, 圣训分析, 关联规则挖掘, 数字化伊斯兰研究

## 3 点简述
- 核心问题：圣训文本数字化背景下，需自动化主题分组以支持伊斯兰研究。
- 方法要点：采用Apriori算法挖掘关联规则，结合预处理步骤如词干提取和停用词移除。
- 实验或效果：在布哈里圣训印尼语译本上，成功识别出如礼拜-祈祷等语义关联模式。
