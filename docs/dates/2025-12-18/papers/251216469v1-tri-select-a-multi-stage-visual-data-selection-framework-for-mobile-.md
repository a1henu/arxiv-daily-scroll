...
**关键词**：移动视觉众包, 数据选择框架, 多阶段筛选, 图像冗余处理, 视觉特征引导

## 3 点简述
- 核心问题：移动视觉众包采集的图像存在冗余、异质性，影响环境监测效率与质量
- 方法要点：通过元数据过滤、空间相似性聚类和视觉特征引导选择三阶段框架筛选高质量代表性图像
- 实验或效果：在真实世界和公共数据集上验证，提升选择效率和数据集质量，适用于可扩展众包应用
