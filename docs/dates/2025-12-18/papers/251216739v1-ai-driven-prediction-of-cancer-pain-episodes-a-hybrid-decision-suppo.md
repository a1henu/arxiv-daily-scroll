...
**arXiv**：[2512.16739v1](https://arxiv.org/abs/2512.16739) · [PDF](https://arxiv.org/pdf/2512.16739.pdf)  
...
**一句话要点**：提出混合机器学习与大语言模型方法，预测肺癌患者住院期间疼痛发作，以支持主动疼痛管理。

**关键词**：癌症疼痛预测, 混合机器学习, 大语言模型, 电子健康记录分析, 临床决策支持

## 3 点简述
- 核心问题：肺癌患者突破性疼痛发作频繁，高达91%需及时干预，现有方法可能缺乏敏感性和可解释性。
- 方法要点：结合结构化与非结构化电子健康记录数据，机器学习模块捕捉时间用药趋势，大语言模型解析模糊剂量记录和自由文本临床笔记。
- 实验或效果：在266名住院患者回顾性队列中，48小时和72小时预测准确率分别为0.874和0.917，大语言模型增强使敏感性提升8.6%和10.4%。
