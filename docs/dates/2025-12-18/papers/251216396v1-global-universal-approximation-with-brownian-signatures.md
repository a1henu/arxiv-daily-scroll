...
**arXiv**：[2512.16396v1](https://arxiv.org/abs/2512.16396) · [PDF](https://arxiv.org/pdf/2512.16396.pdf)  
**作者**：Mihriban Ceylan, David J. Prömel  

**一句话要点**：提出基于布朗运动签名的L^p型全局通用逼近定理，用于逼近适应布朗滤波的随机过程。

**关键词**：粗糙路径理论, 通用逼近定理, 布朗运动签名, 随机过程逼近, L^p距离

## 3 点简述
- 核心问题：在粗糙路径空间中逼近非预期泛函，特别是布朗运动相关过程。
- 方法要点：利用时间扩展粗糙路径的签名线性泛函，证明其在L^p距离下稠密。
- 实验或效果：定理适用于布朗运动，可逼近随机微分方程解等p可积过程。
