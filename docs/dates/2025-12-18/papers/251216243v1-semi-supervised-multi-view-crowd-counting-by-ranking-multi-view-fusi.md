...
**一句话要点**：提出基于多视图融合模型排序的半监督多视角人群计数方法以解决数据有限问题

**关键词**：多视角人群计数, 半监督学习, 模型排序, 数据增强, 不确定性估计

## 3 点简述
- 核心问题：多视角人群计数数据有限，标注困难，影响模型性能。
- 方法要点：通过排序多视图融合模型的预测或不确定性，引入半监督约束，减少对标注数据的需求。
- 实验或效果：实验表明，该方法优于其他半监督计数方法，提升了多视角计数的准确性。
