...
**关键词**：提示注入攻击, 小型开源LLMs, 边缘计算, 防御框架, 目标劫持检测, 迭代优化

## 3 点简述
- 核心问题：提示注入攻击对小型开源LLMs构成安全风险，尤其在资源受限的边缘部署场景。
- 方法要点：引入新框架，利用种子防御（如思维链）迭代优化防御提示，自动生成防御机制。
- 实验或效果：系统评估显示，该方法显著降低攻击成功率与误检率，有效检测目标劫持漏洞。
