...
**关键词**：选择性状态空间模型, 卡尔曼滤波, 长期序列建模, 上下文感知选择, 理论推导, 实际应用验证

## 3 点简述
- 现有选择性状态空间模型如Mamba缺乏理论支撑，无法实现上下文感知选择
- KOSS基于估计理论，通过卡尔曼增益最小化潜在状态不确定性，实现闭环上下文感知选择
- 在选择性复制任务和长期预测基准测试中，KOSS显著优于现有模型，并验证了实际应用有效性
