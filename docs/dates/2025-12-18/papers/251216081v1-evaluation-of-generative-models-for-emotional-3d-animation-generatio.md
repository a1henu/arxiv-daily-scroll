...
**arXiv**：[2512.16081v1](https://arxiv.org/abs/2512.16081) · [PDF](https://arxiv.org/pdf/2512.16081.pdf)  
**作者**：Kiran Chhatre, Renan Guarese, Andrii Matviienko, Christopher Peters  

**一句话要点**：在VR环境中评估情感3D动画生成模型，强调用户感知指标以弥补统计评估不足。

**关键词**：情感3D动画生成, 虚拟现实评估, 用户中心指标, 语音驱动动画, 面部表情重建, 人机交互质量

## 3 点简述
- 核心问题：现有2D统计评估无法充分捕捉用户对情感动画的感知，限制模型效果理解。
- 方法要点：在VR环境中，通过用户研究评估三种先进语音驱动3D动画方法的情感质量，包括真实感和自然度。
- 实验或效果：用户研究显示，显式建模情感的方法识别准确率更高，但生成模型在面部表达和交互质量上表现不足。
