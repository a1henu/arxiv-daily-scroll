...
**arXiv**：[2512.16235v1](https://arxiv.org/abs/2512.16235) · [PDF](https://arxiv.org/pdf/2512.16235.pdf)  
**作者**：Satya Narayana Panda, Vaishnavi Kukkala, Spandana Iyer  

**一句话要点**：提出多模态AI框架，整合家族史与临床影像以提升皮肤病诊断准确性和可解释性。

**关键词**：皮肤病诊断, 多模态AI, 可解释模型, 家族史整合, 临床决策树, 深度学习

## 3 点简述
- 核心问题：全球皮肤病诊断面临专家短缺和复杂临床表现，家族史数据在诊断中未充分利用。
- 方法要点：结合深度学习图像分析和结构化临床数据，采用可解释卷积神经网络与临床决策树整合遗传风险因素。
- 实验或效果：验证显示整合家族史数据可提高诊断准确性，尤其对遗传性皮肤病；专家反馈支持早期检测和个性化推荐潜力。
