...
**关键词**：文本到图像评估, 基准漂移, GenEval 2, Soft-TIFA, 视觉基元, 自动化模型评估

## 3 点简述
- 核心问题：GenEval基准随时间漂移，导致静态评估模型与人类判断偏差高达17.7%，表明基准已饱和。
- 方法要点：引入GenEval 2基准，增强视觉基元覆盖和组合性，并开发Soft-TIFA评估方法，结合基元判断以更好对齐人类。
- 实验或效果：通过大规模人类研究验证漂移，显示GenEval 2对当前模型更具挑战性，Soft-TIFA更稳定且对齐人类判断。
