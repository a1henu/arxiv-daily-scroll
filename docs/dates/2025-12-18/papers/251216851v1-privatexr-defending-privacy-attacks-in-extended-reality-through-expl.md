...
**关键词**：扩展现实隐私, 差分隐私, 可解释AI, 成员推理攻击, 实时部署, 特征选择

## 3 点简述
- AI XR系统面临成员推理和重识别攻击，差分隐私应用可能降低模型精度和实时性。
- 利用后验解释识别关键特征，选择性应用差分隐私，减少噪声并保护隐私。
- 实验显示攻击成功率降低达43%，模型精度保持97%，推理时间提升约2倍，并在头显上部署验证。
