...
**一句话要点**：提出AMUSE基准与RAFT框架以提升多模态模型在多说话人音频-视频场景中的代理推理能力

**关键词**：多模态大语言模型, 音频-视频理解, 多说话人对话, 代理推理, 基准评估, 对齐框架

## 3 点简述
- 当前MLLMs在多说话人对话场景中表现不佳，缺乏代理推理能力
- AMUSE基准包含六类代理任务，评估模型在零样本、引导和代理模式下的表现
- RAFT框架通过奖励优化和选择性参数适应，在基准上实现最高39.52%的相对准确率提升
