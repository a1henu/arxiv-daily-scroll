...
**arXiv**：[2512.16425v1](https://arxiv.org/abs/2512.16425) · [PDF](https://arxiv.org/pdf/2512.16425.pdf)  
**作者**：Allard Oelen, Mohamad Yaser Jaradeh, Sören Auer  

**一句话要点**：提出ASK系统，采用神经符号方法辅助研究者搜索和探索学术文献

**关键词**：学术文献搜索, 神经符号方法, 检索增强生成, 知识图谱, 大语言模型

## 3 点简述
- 核心问题：学术文献量增长导致相关文献查找困难
- 方法要点：结合向量搜索、大语言模型和知识图谱，支持自然语言查询和检索增强生成
- 实验或效果：评估显示系统用户友好，用户满意度高
