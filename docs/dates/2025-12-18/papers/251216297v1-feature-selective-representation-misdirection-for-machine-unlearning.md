...
**关键词**：机器遗忘, 大语言模型安全, 激活编辑, 特征选择, 分布纠缠, 隐私合规

## 3 点简述
- 核心问题：现有遗忘方法假设遗忘与保留数据集清晰分离，难以处理高度纠缠分布的实际场景。
- 方法要点：基于激活编辑，使用特征感知和方向可控的扰动，选择性抑制有害表示并保留良性效用。
- 实验或效果：在WMDP基准测试中，SRMU在低高纠缠配置下实现最优遗忘性能，且效用损失最小，在20-30%重叠下仍有效。
