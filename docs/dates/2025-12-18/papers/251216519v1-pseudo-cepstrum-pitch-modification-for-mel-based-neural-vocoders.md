...
**关键词**：基频修改, 伪倒谱, 梅尔谱声码器, 倒谱域处理, 神经声码器兼容性

## 3 点简述
- 核心问题：传统基频修改方法可能不兼容梅尔谱声码器，需额外训练或修改模型。
- 方法要点：通过伪逆梅尔变换和DCT转换到倒谱域，直接移动倒谱峰以修改基频，无需估计峰位置。
- 实验或效果：在多种先进神经声码器上验证，客观和主观指标优于传统方法，无需额外训练。
