...
**一句话要点**：提出E-SDS框架，通过环境感知自动生成奖励函数以解决人形机器人复杂地形导航问题。

**关键词**：人形机器人运动控制, 环境感知强化学习, 视觉语言模型, 自动奖励设计, 复杂地形导航

## 3 点简述
- 核心问题：现有基于视觉语言模型的奖励设计方法缺乏环境感知，难以处理复杂地形。
- 方法要点：集成视觉语言模型与实时地形传感器分析，自动生成基于示例视频的奖励函数。
- 实验或效果：在Unitree G1人形机器人上测试，E-SDS成功实现楼梯下降，速度跟踪误差降低51.9-82.6%。
