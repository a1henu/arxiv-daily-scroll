...
**arXiv**：[2512.16448v1](https://arxiv.org/abs/2512.16448) · [PDF](https://arxiv.org/pdf/2512.16448.pdf)  
**作者**：Shabnam Bagheri Marzijarani, Mohammad Zolfaghari, Hedieh Sajedi  

**一句话要点**：提出基于CNN与高阶奇异值分解的IoMT白血病分类方法，实现高精度细胞识别。

**关键词**：医学图像分类, 卷积神经网络, 高阶奇异值分解, IoMT应用, 白血病诊断

## 3 点简述
- 核心问题：急性淋巴细胞白血病（ALL）的早期诊断依赖人工显微镜检查，易出错且耗时。
- 方法要点：结合卷积神经网络（CNN）与高阶奇异值分解（HOSVD）分类器，从血液显微图像中区分癌细胞与正常细胞。
- 实验或效果：在ALL-IDB2数据集上测试，平均准确率达98.88%，集成于IoMT框架支持实时通信。
