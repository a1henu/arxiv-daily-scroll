...
**arXiv**：[2512.16555v1](https://arxiv.org/abs/2512.16555) · [PDF](https://arxiv.org/pdf/2512.16555.pdf)  
**作者**：Marcelo Rosa, José E. R. Cury, Fabio L. Baldissera  

**一句话要点**：提出基于监督控制理论的模块化合成方法，以协调多机器人自主构建3D结构。

**关键词**：多机器人协调, 3D结构构建, 监督控制理论, 模块化合成, 响应式控制器

## 3 点简述
- 核心问题：协调多移动机器人自主构建预定义3D结构，涉及机器人间交互。
- 方法要点：基于监督控制理论，从单机器人和目标结构模型合成正确构造的响应式控制器（监督器）。
- 实验或效果：监督器复制到其他机器人后，所有机器人能协同完成目标结构，实现未知具体性能指标。
