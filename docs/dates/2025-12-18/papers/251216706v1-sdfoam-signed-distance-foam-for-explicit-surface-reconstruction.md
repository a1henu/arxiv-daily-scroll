...
**一句话要点**：提出SDFoam，通过联合学习显式Voronoi图和隐式符号距离场，改进神经辐射场中的精确网格重建。

**关键词**：表面重建, 符号距离场, Voronoi图, 神经辐射场, 光线追踪, 网格优化

## 3 点简述
- 核心问题：现有方法如NeRF和3DGS在精确网格重建方面仍存在困难，导致表面模糊和拓扑错误。
- 方法要点：结合显式Voronoi图和隐式SDF，通过光线追踪优化和Eikonal正则化，使Voronoi单元面与零水平集对齐。
- 实验或效果：在多种场景中，SDFoam显著提升网格重建精度（Chamfer距离），保持渲染质量和训练速度，减少漂浮物。
