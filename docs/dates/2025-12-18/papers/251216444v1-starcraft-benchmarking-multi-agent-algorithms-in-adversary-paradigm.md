...
**关键词**：多智能体强化学习, 对抗范式, 基准测试, 星际争霸II, 算法评估, 开源环境

## 3 点简述
- 核心问题：现有基准如SMAC使用固定内置AI对手，导致算法评估多样性不足。
- 方法要点：建立SC2BA环境，支持算法间对抗，并开发APyMARL库以提升公平性和可定制性。
- 实验或效果：在双算法配对和多算法混合对抗模式下基准测试经典算法，揭示算法在有效性、敏感性和可扩展性方面的问题。
