...
**一句话要点**：提出BUILD算法，基于精度矩阵结构从观测数据中精确推断线性高斯DAG

**关键词**：有向无环图学习, 因果发现, 精度矩阵, 结构方程模型, 确定性算法, 图结构推断

## 3 点简述
- 核心问题：从观测数据学习有向无环图结构，在因果发现和机器学习中至关重要
- 方法要点：利用等噪声方差线性高斯SEM下精度矩阵的独特结构，设计确定性逐步算法识别叶节点和父节点
- 实验或效果：在合成基准测试中表现优于现有方法，通过定期重估精度矩阵增强鲁棒性
