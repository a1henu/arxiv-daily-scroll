...
**一句话要点**：提出多阶段边缘服务器升级框架以优化预算约束下的延迟感知任务卸载

**关键词**：边缘计算, 多阶段升级, 延迟优化, 预算约束, 任务卸载, 启发式算法

## 3 点简述
- 核心问题：在预算约束下，多阶段升级边缘服务器以最大化满足延迟要求的任务数
- 方法要点：结合MILP模型和启发式算法M-ESU/H，决策服务器部署、升级和任务卸载
- 实验或效果：M-ESU/H在小网络中接近最优解，在大网络中任务满意度提升高达21.57%
