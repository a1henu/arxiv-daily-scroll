...
**arXiv**：[2512.16532v1](https://arxiv.org/abs/2512.16532) · [PDF](https://arxiv.org/pdf/2512.16532.pdf)  
**作者**：Himanshu Gharat, Himanshi Agrawal, Gourab K. Patro  

**一句话要点**：揭示记忆增强AI代理在招聘中通过个性化引入和放大偏见

**关键词**：记忆增强AI代理, 偏见与歧视, 招聘应用, 个性化风险, LLM安全

## 3 点简述
- 核心问题：记忆增强个性化AI代理在招聘场景中可能引入和强化偏见，风险未被充分探索。
- 方法要点：模拟记忆增强代理行为，分析偏见在操作各阶段的引入和放大机制。
- 实验或效果：基于安全训练LLM的代理实验显示，个性化系统性导致偏见，需额外保护措施。
