...
**关键词**：第一人称视觉, 触觉感知, 多模态数据集, 野外交互, 抓取理解, 跨模态检索

## 3 点简述
- 核心问题：缺乏野外同步视频-触觉-姿态数据，限制视觉与物理交互的融合
- 方法要点：构建首个野外第一人称全手触觉数据集，包含5.1小时同步数据和2900个标注片段
- 实验或效果：触觉信号增强抓取理解、跨模态对齐，并能从野外视频中可靠检索
