...
**关键词**：无人系统调度, 移动性预测, 行为分类, 动态优先级, 实时任务分配, 空地协同

## 3 点简述
- 核心问题：空地无人系统在紧急响应等应用中，高效招募设备执行时效性任务面临挑战
- 方法要点：集成行为感知KNN分类器、时变马尔可夫移动预测模型和动态优先级调度机制
- 实验或效果：在GeoLife数据集上验证，显著提升任务完成效率和资源利用率
