...
**arXiv**：[2512.02910v1](https://arxiv.org/abs/2512.02910) · [PDF](https://arxiv.org/pdf/2512.02910.pdf)  
**作者**：Enrico Cipriani, Pavel Okopnyi, Danilo Menicucci, Simone Grassini  

**一句话要点**：评估大语言模型模拟心理测量数据可行性，支持群体级原型开发但非个体级验证

**关键词**：心理测量学, 大语言模型, 数据模拟, 因子分析, 测量不变性, 伦理风险

## 3 点简述
- 核心问题：心理测量量表开发需大量样本和资源，LLM模拟数据能否替代真实数据？
- 方法要点：通过四项预注册研究，比较LLM生成数据与真实数据的潜在结构和测量属性。
- 实验或效果：模拟数据在多数研究中复制因子结构，但个体级属性差异显著，适用于早期群体级原型。
