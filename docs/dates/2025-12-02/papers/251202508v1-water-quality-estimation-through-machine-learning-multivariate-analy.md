...
**arXiv**：[2512.02508v1](https://arxiv.org/abs/2512.02508) · [PDF](https://arxiv.org/pdf/2512.02508.pdf)  
**作者**：Marco Cardia, Stefano Chessa, Alessio Micheli, Antonella Giuliana Luminare, Francesca Gambineri  

**一句话要点**：提出基于紫外-可见光谱与机器学习的集成方法，用于快速、准确、可解释的水质评估。

**关键词**：水质评估, 紫外-可见光谱, 机器学习, SHAP解释, 农业数字化, 多变量分析

## 3 点简述
- 核心问题：农业和食品行业水质自动评估需求，确保水安全和法规合规。
- 方法要点：结合紫外-可见光谱与机器学习，利用SHAP增强模型可解释性。
- 实验或效果：实现关键水质参数的快速、准确评估，强调模型实用性。
