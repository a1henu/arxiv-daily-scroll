...
**arXiv**：[2512.02648v1](https://arxiv.org/abs/2512.02648) · [PDF](https://arxiv.org/pdf/2512.02648.pdf)  
**作者**：Dong Li, Jiahao Xiong, Yingda Huang, Le Chang  

**一句话要点**：提出PoreTrack3D基准，用于动态3D高斯泼溅在毛孔尺度面部轨迹跟踪

**关键词**：动态3D高斯泼溅, 毛孔尺度跟踪, 面部轨迹基准, 非刚性运动分析, 高保真面部捕捉

## 3 点简述
- 核心问题：缺乏毛孔尺度非刚性3D面部轨迹跟踪的基准数据集。
- 方法要点：创建包含超44万轨迹的数据集，支持细粒度面部运动分析。
- 实验或效果：系统评估动态3D高斯泼溅方法，建立性能基线。
