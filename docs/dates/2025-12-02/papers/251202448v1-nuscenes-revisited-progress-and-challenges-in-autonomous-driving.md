...
**arXiv**：[2512.02448v1](https://arxiv.org/abs/2512.02448) · [PDF](https://arxiv.org/pdf/2512.02448.pdf)  
**作者**：Whye Kit Fong, Venice Erin Liong, Kok Seang Tan, Holger Caesar  

**一句话要点**：回顾nuScenes数据集，分析其在自动驾驶发展中的贡献与挑战

**关键词**：自动驾驶数据集, 多模态传感器融合, 标准化基准, 感知与规划, 数据驱动方法

## 3 点简述
- 核心问题：自动驾驶依赖大规模标注数据，nuScenes作为关键数据集推动技术发展
- 方法要点：首次整合雷达数据、多模态传感器融合，覆盖感知、定位、预测等任务
- 实验或效果：影响后续数据集标准，提供官方与第三方任务基准，促进方法创新
