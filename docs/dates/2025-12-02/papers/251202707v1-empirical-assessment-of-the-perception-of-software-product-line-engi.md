...
**arXiv**：[2512.02707v1](https://arxiv.org/abs/2512.02707) · [PDF](https://arxiv.org/pdf/2512.02707.pdf)  
**作者**：Thomas Georges, Marianne Huchard, Mélanie König, Clémentine Nebut, Chouki Tibermacine  

**一句话要点**：评估中小企业迁移代码库至软件产品线前的感知与风险缓解策略

**关键词**：软件产品线工程, 代码迁移, 中小企业, 利益相关者感知, 风险缓解, 定性评估

## 3 点简述
- 核心问题：中小企业迁移软件变体至产品线时，对开发流程和开发者实践的潜在影响与挑战。
- 方法要点：通过访谈关键利益相关者，评估当前开发实践、迁移预期效益和风险感知。
- 实验或效果：发现参与者均识别迁移效益，有效风险缓解需保持信息透明、保留良好实践并积极参与迁移。
