...
**一句话要点**：提出基于扩展现实和基础模型的虚拟机器人，以重塑人机交互为更安全、智能和共情的范式

**关键词**：扩展现实, 人机交互, 基础模型, 虚拟机器人, 共情交互, 伦理设计

## 3 点简述
- 核心问题：物理机器人受硬件限制，难以实现灵活、共情的人机交互
- 方法要点：利用扩展现实和基础模型构建虚拟机器人，支持情境感知推理和长期适应
- 实验或效果：未知，但讨论其在安全关键场景、跨领域共情交互和扩展物理能力中的应用潜力
