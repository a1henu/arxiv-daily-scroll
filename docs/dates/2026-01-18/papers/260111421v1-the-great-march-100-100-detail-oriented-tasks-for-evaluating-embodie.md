...
**arXiv**：[2601.11421v1](https://arxiv.org/abs/2601.11421) · [PDF](https://arxiv.org/pdf/2601.11421.pdf)  
...
**一句话要点**：提出GM-100数据集以系统评估具身智能代理能力，促进机器人学习任务设计的多样性。

**关键词**：具身智能评估, 机器人学习数据集, 任务设计多样性, 长尾行为, 视觉语言动作模型

## 3 点简述
- 当前机器人学习数据集缺乏系统性设计，难以准确评估方法性能。
- 基于现有任务扩展和交互原语分析，构建100个涵盖广泛交互和长尾行为的任务。
- 实验验证任务可行且具挑战性，能有效区分当前视觉语言动作模型的性能。
