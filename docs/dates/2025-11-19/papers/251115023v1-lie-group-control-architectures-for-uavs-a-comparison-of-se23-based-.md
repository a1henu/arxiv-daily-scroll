...
**一句话要点**：提出SE2(3)模型预测控制器，用于四旋翼无人机控制，在仿真和硬件中验证性能。

**关键词**：李群控制, 模型预测控制, 四旋翼无人机, 轨迹跟踪, SE2(3)控制器

## 3 点简述
- 核心问题：基于李群的无人机控制器在真实环境中的性能验证与比较。
- 方法要点：结合SE2(3)几何性质与模型预测控制，处理约束并优化轨迹。
- 实验或效果：在Quanser QDrone平台上测试，SE2(3) MPC在轨迹跟踪和鲁棒性上表现优越。
