...
**arXiv**：[2511.15586v1](https://arxiv.org/abs/2511.15586) · [PDF](https://arxiv.org/pdf/2511.15586.pdf)  
...
**一句话要点**：提出MHR参数化人体模型，结合ATLAS骨架/形状解耦与Momentum库灵活绑定，支持AR/VR和图形管线。

**关键词**：参数化人体模型, 骨架解耦, 姿态校正, AR/VR集成, 动画系统

## 3 点简述
- 核心问题：传统人体模型在动画表达和解耦骨架/形状方面存在局限。
- 方法要点：结合ATLAS的解耦范式与Momentum库的灵活绑定和姿态校正系统。
- 实验或效果：实现表达性强、解剖合理的人体动画，支持非线性姿态校正。
