---
layout: default
title: A Class of Dual-Frame Passively-Tilting Fully-Actuated Hexacopter
---

# A Class of Dual-Frame Passively-Tilting Fully-Actuated Hexacopter
**arXiv**：[2511.15225v1](https://arxiv.org/abs/2511.15225) · [PDF](https://arxiv.org/pdf/2511.15225.pdf)  
**作者**：Jiajun Liu, Yimin Zhu, Xiaorui Liu, Mingye Cao, Mingchao Li, Lixian Zhang  

**一句话要点**：提出双框架被动倾斜全驱动六旋翼无人机，以提升飞行效率和续航能力。

**关键词**：全驱动无人机, 双框架结构, 被动倾斜, 飞行控制, 动态建模, 仿真验证

## 3 点简述
- 核心问题：传统全驱动无人机存在内力抵消，导致飞行效率低和续航短。
- 方法要点：采用双框架被动倾斜结构，实现平移和姿态独立控制，减少执行器数量。
- 实验或效果：仿真验证了全驱动运动能力和控制策略的有效性，效率优于以往设计。
