...
**arXiv**：[2511.15117v1](https://arxiv.org/abs/2511.15117) · [PDF](https://arxiv.org/pdf/2511.15117.pdf)  
**作者**：Jun-Yi Liu, Chung-Hao Chen, Ya-Chi Tsao, Ssu-Yao Wu, Yu-Ting Tsao, Lyn Chao-ling Chen  

**一句话要点**：提出事件触发系统以解决老年家庭监护中的社交劝导与危险警报问题

**关键词**：事件触发系统, GMM背景建模, SVM机器学习, 老年监护, 社交劝导, 危险检测

## 3 点简述
- 核心问题：监测老年人身体与心理状态，提供危险警报和社交互动支持。
- 方法要点：采用GMM背景建模检测访客和老人运动行为，SVM分析图像。
- 实验或效果：在5个家庭场景中测试，检测看门狗、危险通知和照片链接事件。
