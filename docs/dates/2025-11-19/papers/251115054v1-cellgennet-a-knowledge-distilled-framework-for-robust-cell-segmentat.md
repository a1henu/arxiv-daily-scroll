...
**一句话要点**：提出CellGenNet知识蒸馏框架以解决癌症组织细胞分割的鲁棒性问题

**关键词**：细胞分割, 知识蒸馏, 师生架构, 混合损失函数, 全切片图像, 癌症组织分析

## 3 点简述
- 核心问题：显微镜全切片图像中细胞核分割因染色、成像和组织形态变异而困难
- 方法要点：采用师生架构，教师生成软伪标签，学生结合真实标签和混合损失优化
- 实验或效果：在多种癌症组织WSI上，CellGenNet提升分割准确性和泛化能力
