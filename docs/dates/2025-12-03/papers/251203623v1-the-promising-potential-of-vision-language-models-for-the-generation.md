...
**arXiv**：[2512.03623v1](https://arxiv.org/abs/2512.03623) · [PDF](https://arxiv.org/pdf/2512.03623.pdf)  
...
**一句话要点**：提出基于视觉语言模型从视频编码网格天气数据生成航运预报文本的方法，以提升气象服务效率。

**关键词**：视觉语言模型, 气象预报生成, 多模态基础模型, 航运预报, 视频编码数据

## 3 点简述
- 核心问题：多模态基础模型在气象产品生成中的应用尚不成熟，需加速探索。
- 方法要点：利用视觉语言模型直接从视频编码的网格天气数据生成航运预报文本。
- 实验或效果：早期结果显示该方法具有提升生产效率和促进服务创新的潜力。
