...
**arXiv**：[2512.03744v1](https://arxiv.org/abs/2512.03744) · [PDF](https://arxiv.org/pdf/2512.03744.pdf)  
**作者**：Xuhui Lin, Qiuchen Lu  

**一句话要点**：提出物理约束哈密顿学习算法以解决极端天气下城市交通隐藏结构损伤的检测问题

**关键词**：城市交通系统, 极端天气, 哈密顿学习, 结构损伤检测, 能量景观重建, 物理约束优化

## 3 点简述
- 核心问题：现有方法依赖表面恢复指标，无法区分真实恢复与隐藏结构损伤导致的虚假恢复
- 方法要点：结合结构不可逆性检测和能量景观重建，通过物理约束优化提取低维状态表示
- 实验或效果：分析伦敦2021年极端降雨，检测到64.8%传统监测遗漏的结构损伤
