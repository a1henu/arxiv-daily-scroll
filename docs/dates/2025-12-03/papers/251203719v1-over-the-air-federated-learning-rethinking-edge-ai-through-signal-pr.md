...
**arXiv**：[2512.03719v1](https://arxiv.org/abs/2512.03719) · [PDF](https://arxiv.org/pdf/2512.03719.pdf)  
**作者**：Seyed Mohammad Azimi-Abarghouyi, Carlo Fischione, Kaibin Huang  

**一句话要点**：提出空中联邦学习，通过信号处理集成无线通信与模型聚合以优化边缘AI效率。

**关键词**：空中联邦学习, 边缘AI, 无线信号处理, 模型聚合, 通信效率, 分布式机器学习

## 3 点简述
- 核心问题：边缘AI中通信延迟、带宽和能耗高，限制联邦学习可扩展性。
- 方法要点：利用无线信号叠加特性，同时进行通信和模型聚合，分为CSIT感知、盲和加权三类设计。
- 实验或效果：显著降低延迟、带宽和能耗，提供理论基础、性能分析和实践指南。
