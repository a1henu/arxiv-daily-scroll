...
**arXiv**：[2512.03828v1](https://arxiv.org/abs/2512.03828) · [PDF](https://arxiv.org/pdf/2512.03828.pdf)  
**作者**：Dominykas Strazdas, Magnus Jung, Jan Marquenie, Ingo Siegert, Ayoub Al-Hamadi  

**一句话要点**：提出IM HERE框架，基于努力建模双边关系以提升人机交互中的参与度分析

**关键词**：人机交互, 参与度建模, 双边关系分析, 社会规范集成, 自主系统行为

## 3 点简述
- 核心问题：现有参与度模型模糊或缺乏跨场景泛化能力，影响人机交互效果
- 方法要点：采用努力描述双边关系，简化关系模式为焦点位置和四个关键状态
- 实验或效果：模型整合主客观状态，精确识别误沟通，支持自主系统遵循社会规范
