...
**arXiv**：[2512.03639v1](https://arxiv.org/abs/2512.03639) · [PDF](https://arxiv.org/pdf/2512.03639.pdf)  
**作者**：Kilian Schweppe, Anne-Kathrin Schmuck  

**一句话要点**：提出上下文触发应急博弈，以解决自主多智能体系统中长期战略与短期动态适应的平衡问题。

**关键词**：多智能体系统, 战略博弈, 应急博弈, 时序逻辑, 模型预测控制, 自主驾驶

## 3 点简述
- 核心问题：自主多智能体系统需在不确定交互环境中平衡长期战略目标与短期动态适应，确保安全与进展。
- 方法要点：集成基于时序逻辑的战略博弈与实时动态应急博弈，采用双层架构和因子图求解器实现可扩展实时控制。
- 实验或效果：通过自动驾驶和机器人导航的仿真与硬件实验验证，展示高效、可靠和自适应的多智能体交互。
