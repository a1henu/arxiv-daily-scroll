...
**arXiv**：[2512.04065v1](https://arxiv.org/abs/2512.04065) · [PDF](https://arxiv.org/pdf/2512.04065.pdf)  
**作者**：Ashlesha Gopinath Sawant, Sahil S. Jadhav, Vidhan R. Jain, Shriraj S. Jagtap, Prachi Jadhav, Soham Jadhav, Ichha Raina  

**一句话要点**：提出基于Python的网约车比价Web应用，以解决用户选择高效低成本出行服务的难题。

**关键词**：网约车比价, Web应用开发, API数据获取, Python后端, 出行服务优化

## 3 点简述
- 核心问题：用户难以在Ola、Uber和Rapido间选择成本效益高且快速的出行服务。
- 方法要点：通过后端API获取数据，实现网约车费用比较，并推荐最佳选项。
- 实验或效果：未知具体实验细节，但应用旨在提升服务透明度和用户体验。
