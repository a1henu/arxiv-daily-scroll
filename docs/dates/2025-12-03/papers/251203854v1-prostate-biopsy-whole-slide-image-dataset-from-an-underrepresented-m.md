...
**arXiv**：[2512.03854v1](https://arxiv.org/abs/2512.03854) · [PDF](https://arxiv.org/pdf/2512.03854.pdf)  
...
**一句话要点**：发布中东地区前列腺活检全切片图像数据集，支持病理AI模型跨人群验证。

**关键词**：前列腺活检, 全切片图像, 中东人群数据集, 病理AI验证, 跨扫描仪鲁棒性, Gleason评分

## 3 点简述
- 问题：现有病理数据集多代表西方人群，AI模型在中东等欠数字化地区的泛化性未知。
- 方法：收集伊拉克185名患者的339张前列腺活检全切片图像，提供Gleason评分和病理分级。
- 效果：数据集支持分级一致性分析、颜色归一化和跨扫描仪鲁棒性评估，促进全球多样化人群的AI模型开发。
