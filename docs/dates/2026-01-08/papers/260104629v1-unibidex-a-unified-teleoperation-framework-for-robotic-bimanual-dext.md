...
**一句话要点**：提出UniBiDex统一遥操作框架，支持VR和主从输入，实现机器人双手灵巧操作。

**关键词**：双手灵巧操作, 遥操作框架, 零空间控制, VR输入, 主从输入, 开源系统

## 3 点简述
- 核心问题：机器人双手灵巧操作需统一遥操作框架，整合异构输入并保证安全。
- 方法要点：采用零空间控制优化双手配置，确保平滑、无碰撞、避奇异点运动。
- 实验或效果：在厨房整理任务中验证，相比基线提高成功率、轨迹平滑性和鲁棒性。
