...
**一句话要点**：提出子目标可验证奖励框架以解决多模态大语言模型在几何推理中的黑箱监督问题

**关键词**：几何推理, 子目标验证, 多模态大语言模型, 奖励框架, 形式验证, 泛化能力

## 3 点简述
- 核心问题：基于结果的监督无法区分幸运猜测与严谨推理，导致几何推理性能受限
- 方法要点：构建GeoGoal基准，通过形式验证数据引擎将抽象证明转化为可验证数值子目标
- 实验或效果：SGVR提升几何性能9.7%，并泛化至数学和其他推理任务，显示广泛适用性
