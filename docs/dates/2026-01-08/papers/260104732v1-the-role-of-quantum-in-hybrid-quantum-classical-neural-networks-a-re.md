...
**arXiv**：[2601.04732v1](https://arxiv.org/abs/2601.04732) · [PDF](https://arxiv.org/pdf/2601.04732.pdf)  
**作者**：Dominik Freinberger, Philipp Moser  

**一句话要点**：评估量子组件在混合量子-经典神经网络中的实际贡献，基于医学信号和图像数据

**关键词**：混合量子-经典神经网络, 量子机器学习, 性能评估, 医学信号处理, 图像分析, 统计研究

## 3 点简述
- 核心问题：量子组件在混合模型中的具体贡献尚不明确，需量化其影响
- 方法要点：通过统计研究系统评估编码方案、纠缠和电路大小等量子与经典方面
- 实验或效果：在最佳情况下性能与经典模型相当，但多数情况下量子组件导致性能下降
