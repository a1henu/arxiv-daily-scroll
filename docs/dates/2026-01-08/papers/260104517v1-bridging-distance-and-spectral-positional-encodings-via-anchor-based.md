...
**关键词**：分子图学习, 位置编码, 扩散几何, 距离编码, 谱编码, 图神经网络

## 3 点简述
- 核心问题：分子图学习中距离编码与谱编码的关系不明确，影响位置信号的有效利用。
- 方法要点：将距离编码解释为扩散几何的低秩近似，推导显式三角测量映射以重建扩散坐标。
- 实验或效果：在DrugBank分子图上，距离编码方案能近似扩散几何，两种编码均显著优于无编码基线。
