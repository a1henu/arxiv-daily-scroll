...
**关键词**：检索增强生成, 图神经网络, 层次检索, 语义结构熵, 自适应压缩, 文本图

## 3 点简述
- 核心问题：现有图RAG方法在层次信息管理中面临刚性压缩配额损害局部结构和忽视语义内容的限制
- 方法要点：采用语义与结构引导的编码树，结合自适应压缩编码和语义结构熵进行全局优化
- 实验或效果：在多个图推理基准测试中显著优于先进RAG方法，提供更连贯和上下文相关的响应
