...
**arXiv**：[2601.05014v1](https://arxiv.org/abs/2601.05014) · [PDF](https://arxiv.org/pdf/2601.05014.pdf)  
...
**一句话要点**：提出RoboSense 2025挑战赛以评估机器人感知在开放动态环境中的鲁棒性与适应性

**关键词**：机器人感知, 鲁棒性评估, 跨平台适应, 多模态对应, 导航决策, 传感器配置

## 3 点简述
- 核心问题：现有感知方法在传感器噪声、环境变化和平台差异下性能下降，需提升鲁棒性和泛化性。
- 方法要点：通过五个互补研究赛道，涵盖语言决策、导航、传感器配置、跨视图模态和跨平台3D感知，构建综合基准。
- 实验或效果：吸引了143个团队参与，提供标准化数据集和基线模型，促进大规模可复现比较，并总结获胜方案趋势。
