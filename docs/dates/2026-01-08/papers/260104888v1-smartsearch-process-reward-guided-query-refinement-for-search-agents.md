...
**一句话要点**：提出SmartSearch框架，通过过程奖励和查询优化提升搜索代理的查询质量与效率。

**关键词**：搜索代理, 查询优化, 过程奖励, 课程学习, 信息检索

## 3 点简述
- 核心问题：现有搜索代理在推理过程中生成的中间查询质量不佳，影响检索结果和整体效果。
- 方法要点：引入过程奖励机制进行细粒度监督，结合查询优化策略选择性改进低质量查询。
- 实验或效果：实验显示SmartSearch超越基线，在搜索效率和查询质量上均有显著提升。
