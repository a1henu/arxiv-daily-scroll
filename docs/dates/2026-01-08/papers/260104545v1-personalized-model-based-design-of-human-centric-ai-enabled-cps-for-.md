...
**arXiv**：[2601.04545v1](https://arxiv.org/abs/2601.04545) · [PDF](https://arxiv.org/pdf/2601.04545.pdf)  
**作者**：Bernard Ngabonziza, Ayan Banerjee, Sandeep K. S. Gupta  

**一句话要点**：提出个性化模型方法以解决AI赋能人本系统长期使用中的安全与性能不确定性

**关键词**：人本系统, AI赋能, 长期使用, 安全分析, 个性化模型, 极端情况

## 3 点简述
- 核心问题：AI赋能人本系统长期运行可能面临未测试的极端情况，导致安全、可持续性和安全性要求被违反。
- 方法要点：分析现有安全、可持续性和安全性分析技术的局限性，并提出基于个性化模型的解决方案。
- 实验或效果：未知，论文未具体说明实验或效果细节。
