...
**关键词**：晶体生成, 可微管道, 潜在空间优化, 对称条件变分自编码器, SO(3)功率谱, 材料结构设计

## 3 点简述
- 核心问题：在晶体学约束下生成具有指定局部环境的材料结构。
- 方法要点：结合对称条件变分自编码器与可微SO(3)功率谱目标，实现直接和潜在表示的双层优化。
- 实验或效果：GPU加速实现约五倍速度提升，双级松弛策略提高复杂结构生成成功率。
