...
**一句话要点**：提出基于双注意力机制的通用神经骨干网络，以增强混合整数线性优化的表示学习能力。

**关键词**：混合整数线性规划, 注意力机制, 图神经网络, 组合优化, 深度学习, 表示学习

## 3 点简述
- 针对混合整数线性规划（MILP）计算挑战，现有图神经网络方法受限于局部机制，表示能力不足。
- 设计双注意力机制，在变量和约束间并行执行自注意力和交叉注意力，实现全局信息交换。
- 在多个基准测试中，该方法在实例、元素和求解状态层面任务上优于现有基线，验证了其有效性。
