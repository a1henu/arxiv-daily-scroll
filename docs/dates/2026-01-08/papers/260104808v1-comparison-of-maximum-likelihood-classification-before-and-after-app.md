...
**arXiv**：[2601.04808v1](https://arxiv.org/abs/2601.04808) · [PDF](https://arxiv.org/pdf/2601.04808.pdf)  
**作者**：Muhammad Shoaib, Zaka Ur Rehman, Muhammad Qasim  

**一句话要点**：比较应用Weierstrass变换前后最大似然分类在高分辨率Quickbird卫星图像上的准确性差异

**关键词**：最大似然分类, Weierstrass变换, 遥感图像分类, 主成分分析, 高分辨率卫星图像

## 3 点简述
- 核心问题：评估Weierstrass变换对最大似然分类在遥感图像分类中准确性的影响。
- 方法要点：使用最大似然分类结合Weierstrass变换，并采用主成分分析进行降维和波段变异检查。
- 实验或效果：结果显示，应用Weierstrass变换后，类间均值分离度提高，分类准确性优于未应用变换的情况。
