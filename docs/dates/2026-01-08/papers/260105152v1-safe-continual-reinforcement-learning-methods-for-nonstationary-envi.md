...
**arXiv**：[2601.05152v1](https://arxiv.org/abs/2601.05152) · [PDF](https://arxiv.org/pdf/2601.05152.pdf)  
**作者**：Timofey Tomashevskiy  

**一句话要点**：综述非平稳环境下安全持续强化学习方法的现状与分类

**关键词**：安全强化学习, 非平稳环境, 持续学习, 在线学习, 约束马尔可夫决策过程, 部分可观测马尔可夫决策过程

## 3 点简述
- 核心问题：非平稳环境中的安全持续在线强化学习，涉及理论挑战与开放问题
- 方法要点：基于安全学习机制类型分类方法，考虑适应非平稳性
- 实验或效果：未知，本文为综述性工作，未报告具体实验
