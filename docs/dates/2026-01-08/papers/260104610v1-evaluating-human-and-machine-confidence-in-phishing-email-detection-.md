...
**关键词**：钓鱼邮件检测, 置信度评估, 可解释机器学习, 人机协作, 语义分析

## 3 点简述
- 研究人类认知与机器学习模型在钓鱼邮件检测中的协作机制，聚焦置信度评估。
- 采用逻辑回归、决策树和随机森林等可解释算法，结合TF-IDF和语义嵌入特征进行训练。
- 实验显示机器学习准确率高但置信度波动大，人类则语言信号多样且置信度更一致，年龄影响检测性能。
