...
**arXiv**：[2601.04800v1](https://arxiv.org/abs/2601.04800) · [PDF](https://arxiv.org/pdf/2601.04800.pdf)  
**作者**：Bapu D. Chendage, Rajivkumar S. Mente  

**一句话要点**：提出基于二值化和互补预处理的图像增强框架，以提升古代马拉地语铭文图像的可读性。

**关键词**：图像增强, 二值化, 古代铭文处理, 分类准确率, 预处理技术, 马拉地语铭文

## 3 点简述
- 核心问题：古代铭文图像常受背景噪声、低对比度和退化影响，前景与背景相似，难以阅读。
- 方法要点：采用二值化和互补预处理技术去除污渍并增强模糊文本，适用于石头、金属板和纸质文档。
- 实验或效果：使用K-NN和SVM分类器评估，在石头、金属板和文档上分别达到最高65.6%和67.8%的分类准确率。
