...
**关键词**：开放词汇3D场景理解, 3D高斯泼溅, 跨视图上下文融合, 高效语义附着, 密集对应预注册

## 3 点简述
- 核心问题：开放词汇3D高斯泼溅场景理解中跨视图一致性和掩码内聚性不足，且现有方法效率低。
- 方法要点：引入密集对应引导预注册阶段，构建3D上下文提案并通过加权聚合特征融合到高斯泼溅，无需额外优化。
- 实验或效果：在保持几何精度的同时，语义附着速度比SOTA快两倍，每场景约五分钟完成。
