...
**一句话要点**：提出两层级块更新框架以改进分布式在线凸优化中的通信效率与遗憾界

**关键词**：分布式在线优化, 压缩通信, 遗憾界分析, 共识算法, 下界证明, bandit反馈

## 3 点简述
- 研究分布式在线凸优化中的压缩通信问题，旨在降低对压缩质量因子和节点数的依赖
- 设计两层级块更新框架，结合在线gossip策略和误差补偿方案，提升学习者间共识
- 建立首个下界证明结果最优性，并扩展至bandit反馈场景以增强现有遗憾界
