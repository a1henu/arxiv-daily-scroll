...
**arXiv**：[2601.04919v1](https://arxiv.org/abs/2601.04919) · [PDF](https://arxiv.org/pdf/2601.04919.pdf)  
**作者**：Yildiz Uzun, Andrea Gauthier, Mutlu Cukurova  

**一句话要点**：探索生成式AI助手在学习分析反馈中的对话模式，以支持不同自我调节学习能力的学生

**关键词**：学习分析仪表板, 生成式AI助手, 自我调节学习, 对话分析, 教育技术, 个性化反馈

## 3 点简述
- 核心问题：学生，尤其是自我调节学习能力较低者，难以理解和利用学习分析仪表板的反馈。
- 方法要点：在10周学期中，集成生成式AI助手到仪表板，分析学生提问模式、助手回答质量和学生感知。
- 实验或效果：发现低自我调节学习能力学生寻求澄清和安慰，高能力学生关注技术和策略；助手提供清晰解释但个性化有限，对低能力学生尤其有益。
