...
**关键词**：学术海报编辑, 交互式框架, 代理系统, 多级API编辑, 视觉语言模型评估, 基准构建

## 3 点简述
- 核心问题：学术海报设计需平衡高密度内容与复杂布局，现有单次生成方法难以对齐主观用户意图。
- 方法要点：APEX为首个代理框架，支持基于API的多级细粒度编辑和审阅调整机制，实现交互式控制。
- 实验或效果：在APEX-Bench基准上，APEX显著优于基线方法，评估涵盖指令完成度、修改范围和视觉一致性。
