...
**关键词**：浮点数可满足性, 分阶段优化, SMT求解, 数值优化, 投影辅助下降, 位级精度

## 3 点简述
- 核心问题：浮点数可满足性求解面临可扩展性差和准确性不足的挑战，传统方法依赖位级推理或数值优化，效率有限。
- 方法要点：StageSAT将公式重构为三阶段优化问题，从快速投影辅助下降开始，逐步提升精度至位级和晶格细化，确保解的正确性。
- 实验或效果：在SMT-COMP'25等基准测试中，StageSAT在相同时间预算下解决更多公式，实现99.4%召回率和0%误报，速度提升5-10倍。
