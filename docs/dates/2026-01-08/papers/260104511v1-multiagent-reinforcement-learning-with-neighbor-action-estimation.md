...
**一句话要点**：提出基于邻居动作估计的多智能体强化学习框架，以解决通信受限环境中的协作决策问题。

**关键词**：多智能体强化学习, 动作估计, 去中心化协作, 机器人操作, 通信受限环境

## 3 点简述
- 核心问题：现有方法依赖显式动作交换，在通信受限的真实工程环境中不实用。
- 方法要点：引入轻量级动作估计神经网络，仅用局部可观测信息推断邻居行为，无需显式动作共享。
- 实验或效果：在双臂机器人协作任务中验证，提升系统鲁棒性和部署可行性，减少对信息基础设施的依赖。
