...
**arXiv**：[2601.05074v1](https://arxiv.org/abs/2601.05074) · [PDF](https://arxiv.org/pdf/2601.05074.pdf)  
**作者**：Julian Kulozik, Nathanaël Jarrassé  

**一句话要点**：提出补偿效应放大控制（CEAC），利用躯干运动实现上肢假肢肘部协调位置与速度控制

**关键词**：上肢假肢控制, 运动补偿, 肘部协调, 躯干输入, 连续速度调制

## 3 点简述
- 核心问题：上肢假肢中间关节（如肘部）的直观连续速度控制仍具挑战性
- 方法要点：基于躯干屈伸运动输入，放大自然耦合并引入可控延迟以调制假肢关节位置与速度
- 实验或效果：在绘图和目标任务中，性能媲美自然手臂运动，保持人体工学姿势并恢复关节协调
