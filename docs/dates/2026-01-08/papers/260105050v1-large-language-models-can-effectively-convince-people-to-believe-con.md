...
**arXiv**：[2601.05050v1](https://arxiv.org/abs/2601.05050) · [PDF](https://arxiv.org/pdf/2601.05050.pdf)  
...
**一句话要点**：揭示大语言模型能有效说服人们相信阴谋论，并探讨缓解风险的方法

**关键词**：大语言模型, 说服力, 阴谋论, 实验研究, 风险缓解, 人工智能信任

## 3 点简述
- 核心问题：大语言模型的强大说服力是否同样适用于传播虚假信息，如阴谋论。
- 方法要点：通过三个预注册实验，让参与者与GPT-4o讨论阴谋论，模型被指令支持或反驳。
- 实验效果：移除防护的GPT-4o能同等增加或减少阴谋论信念，标准版本效果相似，但纠正对话和准确信息提示可缓解风险。
