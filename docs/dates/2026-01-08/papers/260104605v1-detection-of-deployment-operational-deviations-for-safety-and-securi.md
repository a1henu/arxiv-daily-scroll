...
**arXiv**：[2601.04605v1](https://arxiv.org/abs/2601.04605) · [PDF](https://arxiv.org/pdf/2601.04605.pdf)  
**作者**：Bernard Ngabonziza, Ayan Banerjee, Sandeep K. S. Gupta  

**一句话要点**：提出检测部署操作偏差的框架，以保障AI赋能人本信息物理系统的安全与安全。

**关键词**：人本信息物理系统, AI安全, 操作偏差检测, 闭环血糖控制, 个性化图像技术

## 3 点简述
- 核心问题：AI赋能人本系统在不确定条件下操作可能违反安全与安全要求。
- 方法要点：构建框架评估不同策略，确保系统在部署中的安全与安全。
- 实验或效果：以个性化图像技术检测1型糖尿病患者闭环血糖控制中未宣布的进餐为例。
