...
**arXiv**：[2601.04761v1](https://arxiv.org/abs/2601.04761) · [PDF](https://arxiv.org/pdf/2601.04761.pdf)  
**作者**：Rupsa Rani Mishra, D. Chandrasekhar Rao, Ajaya Kumar Tripathy  

**一句话要点**：提出基于物联网和新型机器学习算法的智能穿戴设备，用于奶牛常见疾病检测与监测

**关键词**：物联网穿戴设备, 奶牛疾病检测, 机器学习算法, 信息物理系统, 健康监测

## 3 点简述
- 核心问题：大规模养殖中人工监测奶牛疾病存在劳动密集、耗时、准确性低等问题，影响动物健康和农场效率
- 方法要点：设计物联网驱动的信息物理系统框架，通过穿戴设备收集生理和行为数据，并采用新型机器学习算法进行多疾病预测
- 实验或效果：未知
