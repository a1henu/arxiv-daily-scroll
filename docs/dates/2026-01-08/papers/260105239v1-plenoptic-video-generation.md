...
**一句话要点**：提出PlenopticDreamer框架以解决多视角视频生成中的时空一致性问题

**关键词**：多视角视频生成, 时空一致性, 自回归模型, 视频检索, 相机控制, 视频重渲染

## 3 点简述
- 核心问题：现有单视角视频重渲染方法在多视角场景下难以保持时空一致性
- 方法要点：采用自回归训练多输入单输出视频条件模型，结合相机引导的视频检索策略
- 实验或效果：在Basic和Agibot基准测试中实现最先进的视频重渲染，提升视角同步和视觉保真度
