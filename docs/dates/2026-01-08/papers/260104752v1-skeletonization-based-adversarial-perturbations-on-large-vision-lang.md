...
**arXiv**：[2601.04752v1](https://arxiv.org/abs/2601.04752) · [PDF](https://arxiv.org/pdf/2601.04752.pdf)  
**作者**：Masatomo Yoshida, Haruto Namura, Nicola Adami, Masahiro Okuda  

**一句话要点**：提出基于骨架化的对抗攻击方法，以评估大视觉语言模型在数学文本识别中的视觉能力与局限。

**关键词**：对抗攻击, 骨架化, 大视觉语言模型, 数学文本识别, 视觉能力评估

## 3 点简述
- 核心问题：探索基础模型在视觉任务中的能力与局限，特别是针对数学公式图像的识别挑战。
- 方法要点：利用骨架化技术减少搜索空间，设计针对文本图像的对抗扰动攻击。
- 实验或效果：评估字符和语义变化，应用于ChatGPT展示实际影响，揭示模型视觉解释与推理能力。
