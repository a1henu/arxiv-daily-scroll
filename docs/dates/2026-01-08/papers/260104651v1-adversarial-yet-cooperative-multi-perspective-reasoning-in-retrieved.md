...
**关键词**：检索增强生成, 对抗推理, 多视角推理, 过程感知奖励, 语言模型优化

## 3 点简述
- 核心问题：现有检索增强推理模型存在单视角推理限制和过度依赖结果导向奖励，影响深度自校正推理能力。
- 方法要点：设计Reasoner-Verifier对抗框架，结合过程感知优势奖励，优化推理忠实度和验证严谨性，无需外部评分模型。
- 实验或效果：在多个基准测试中验证了方法的有效性，提升了推理性能。
