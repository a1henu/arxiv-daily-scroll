...
**一句话要点**：提出工业级GenAI框架，在GPU与成本约束下评估40余种视觉语言模型的长视频推理能力

**关键词**：长视频理解, 工业级多模态推理, 视觉语言模型评估, GPU约束优化, 制药领域应用

## 3 点简述
- 核心问题：工业场景（如制药）需在严格GPU、延迟和成本约束下处理长视频，现有方法难以扩展
- 方法要点：构建大规模多模态推理架构，处理超20万PDF、2.5万视频和多语言音频，分析多模态、注意力机制等
- 实验或效果：在商品GPU上SDPA注意力实现3-8倍效率提升，多模态在8/12任务域改善，揭示时间对齐和关键帧检测瓶颈
