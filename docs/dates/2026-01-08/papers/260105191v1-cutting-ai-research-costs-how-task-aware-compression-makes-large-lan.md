...
**一句话要点**：提出AgentCompress系统，通过任务感知压缩降低大语言模型代理在科研任务中的计算成本

**关键词**：任务感知压缩, 大语言模型代理, 计算成本优化, 模型路由, 科研自动化

## 3 点简述
- 核心问题：大语言模型在自主科研任务中计算成本高昂，限制学术实验室使用
- 方法要点：基于任务开头词快速评估难度，路由至压缩模型变体，决策时间低于毫秒
- 实验或效果：在四个科学领域的500个工作流测试中，计算成本降低68.3%，成功率保持96.2%
