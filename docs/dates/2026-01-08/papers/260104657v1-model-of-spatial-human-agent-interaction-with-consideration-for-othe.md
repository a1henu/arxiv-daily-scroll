...
**一句话要点**：提出考虑他人的空间交互模型，以优化公共空间中通信机器人的对话启动

**关键词**：空间交互模型, 通信机器人, 考虑他人, VR实验, 行为估计

## 3 点简述
- 核心问题：公共空间中通信机器人需启动对话同时避免干扰行人，需平衡沟通需求与干扰风险。
- 方法要点：构建计算模型，通过量化参数调整内部状态以考虑他人，基于行为估计沟通欲望。
- 实验或效果：VR实验验证模型，低考虑值机器人抑制参与者移动，高考虑值则否；机器人接近行为减少参与者移动。
