...
**一句话要点**：提出轻量级自定义CNN，在农业和城市领域的五个异构图像数据集上实现竞争性性能

**关键词**：自定义卷积神经网络, 异构图像数据集, 迁移学习, 农业图像分类, 城市视觉监控, 轻量级模型

## 3 点简述
- 研究CNN在农业和城市领域五个异构图像数据集上的有效性，包括芒果品种分类、稻田品种识别等任务
- 评估自定义CNN、ResNet-18和VGG-16，比较从头训练和迁移学习，分析架构复杂性和预训练的影响
- 开发高效自定义CNN，在多个应用领域实现竞争性性能，提供资源有限环境下部署深度学习的实用见解
