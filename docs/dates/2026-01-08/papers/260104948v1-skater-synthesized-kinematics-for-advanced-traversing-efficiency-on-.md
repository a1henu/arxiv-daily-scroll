...
**arXiv**：[2601.04948v1](https://arxiv.org/abs/2601.04948) · [PDF](https://arxiv.org/pdf/2601.04948.pdf)  
**作者**：Junchi Gu, Feiyang Yuan, Weize Shi, Tianchen Huang, Haopeng Zhang, Xiaohu Zhang, Yu Wang, Wei Gao, Shiwu Zhang  

**一句话要点**：提出基于轮滑的人形机器人SKATER，通过强化学习控制滑行步态以提升能量效率和关节寿命。

**关键词**：人形机器人, 轮滑运动, 深度强化学习, 滑行步态, 能量效率, 关节磨损

## 3 点简述
- 问题：传统人形机器人行走或跑步时足部频繁撞击地面，产生高冲击力，导致关节磨损和能量利用率低。
- 方法：为机器人足部配备被动轮滑装置，并开发基于深度强化学习的控制框架，针对滑行步态设计奖励函数。
- 效果：在物理机器人上部署，滑行步态相比传统行走在冲击强度和运输成本上分别降低75.86%和63.34%。
