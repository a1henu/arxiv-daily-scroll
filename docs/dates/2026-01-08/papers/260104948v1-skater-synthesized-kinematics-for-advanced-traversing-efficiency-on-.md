...
**关键词**：人形机器人, 轮滑运动, 深度强化学习, 能量效率, 关节磨损, 滑行步态

## 3 点简述
- 问题：人形机器人行走或跑步时足部频繁撞击地面产生高冲击力，导致关节磨损和能量利用率低。
- 方法：为机器人脚部配备被动轮滑装置，并开发基于深度强化学习的控制框架，奖励函数设计考虑轮滑内在特性。
- 效果：在物理机器人上部署，滑行步态相比传统双足行走，冲击强度和运输成本分别降低75.86%和63.34%。
