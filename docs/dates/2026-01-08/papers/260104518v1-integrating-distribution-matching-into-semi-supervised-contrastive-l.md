...
**一句话要点**：提出集成分布匹配的半监督对比学习方法，以提升小标注数据与大无标注数据场景下的图像分类精度

**关键词**：半监督学习, 对比学习, 分布匹配, 伪标签, 图像分类, 特征嵌入

## 3 点简述
- 核心问题：现实场景中标注数据稀缺，半监督学习需有效利用无标注数据提升分类性能
- 方法要点：在基于伪标签的半监督对比学习中，引入标注与无标注特征嵌入的分布匹配机制
- 实验或效果：在多个数据集上验证了该方法能提高图像分类准确率，具体提升幅度未知
