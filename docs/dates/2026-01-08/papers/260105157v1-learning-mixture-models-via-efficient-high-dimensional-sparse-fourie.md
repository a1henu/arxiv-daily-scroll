...
**一句话要点**：提出高效高维稀疏傅里叶变换方法以学习重尾分布混合模型

**关键词**：混合模型学习, 稀疏傅里叶变换, 重尾分布, 参数估计, 高维统计

## 3 点简述
- 核心问题：学习高维重尾分布混合模型参数，传统方法依赖低阶矩，样本需求高。
- 方法要点：基于特征函数重尾特性，利用高效高维稀疏傅里叶变换，无需均值最小分离。
- 实验或效果：算法在多项式时间和样本内有效，适用于拉普拉斯等分布，不适用于高斯分布。
