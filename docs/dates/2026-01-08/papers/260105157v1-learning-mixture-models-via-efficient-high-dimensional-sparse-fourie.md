...
**关键词**：混合模型学习, 高维稀疏傅里叶变换, 重尾分布, 参数估计, 鲁棒统计

## 3 点简述
- 核心问题：高效学习高维球形分布混合的参数，适用于重尾分布如拉普拉斯分布，无需最小均值分离
- 方法要点：利用高维稀疏傅里叶变换技术，绕过矩方法的局限性，实现多项式时间与样本复杂度
- 实验或效果：算法在重尾分布下有效，应用于鲁棒均值估计，已激发后续研究
