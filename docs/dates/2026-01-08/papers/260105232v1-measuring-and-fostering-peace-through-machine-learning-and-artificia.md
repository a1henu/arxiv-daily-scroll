...
**关键词**：和平测量, 社交媒体分析, 神经网络, 实时反馈工具, 内容偏见

## 3 点简述
- 核心问题：如何从新闻和社交媒体中测量和平水平，并应对内容创作者偏向情感激活的偏见
- 方法要点：使用神经网络分析新闻文本嵌入，结合词级和上下文级方法评估社交媒体和平维度
- 实验或效果：模型在不同新闻数据集上表现高准确度，开发并测试了实时反馈和平水平的Chrome扩展MirrorMirror
