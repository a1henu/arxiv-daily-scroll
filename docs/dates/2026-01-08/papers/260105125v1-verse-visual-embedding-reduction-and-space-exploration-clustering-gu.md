...
**一句话要点**：提出VERSE方法，通过聚类引导视觉嵌入空间分析，增强视觉丰富文档理解模型的训练数据。

**关键词**：视觉语言模型, 视觉丰富文档理解, 嵌入空间分析, 聚类引导, 合成数据生成, 模型优化

## 3 点简述
- 核心问题：视觉语言模型在视觉丰富文档理解中，视觉嵌入空间难以可视化，影响模型评估和性能提升。
- 方法要点：VERSE通过降维和聚类分析视觉嵌入，识别问题区域并指导合成数据生成以优化训练。
