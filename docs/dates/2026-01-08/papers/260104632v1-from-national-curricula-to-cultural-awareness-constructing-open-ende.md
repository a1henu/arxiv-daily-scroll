...
**arXiv**：[2601.04632v1](https://arxiv.org/abs/2601.04632) · [PDF](https://arxiv.org/pdf/2601.04632.pdf)  
**作者**：Haneul Yoo, Won Ik Cho, Geunhye Kim, Jiyoon Han  

**一句话要点**：提出CuCu框架，利用国家社会课程构建文化特定开放问答数据集以促进文化对齐。

**关键词**：文化对齐, 开放问答数据集, 多智能体框架, 国家课程利用, 韩国社会研究

## 3 点简述
- 核心问题：大语言模型在跨语言文化任务中表现不均，受英语中心数据影响。
- 方法要点：基于国家社会课程，通过多智能体LLM框架自动生成文化特定开放问答对。
- 实验或效果：应用于韩国课程构建KCaQA数据集，覆盖文化主题并产生本地化响应。
