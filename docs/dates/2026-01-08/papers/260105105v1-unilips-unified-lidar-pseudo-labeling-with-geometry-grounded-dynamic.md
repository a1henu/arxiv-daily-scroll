...
**关键词**：LiDAR伪标签, 几何一致性, 自动驾驶感知, 3D语义分割, 动态场景分解, 多模态融合

## 3 点简述
- 核心问题：无标签LiDAR数据在自动驾驶中成本高，缺乏人工标注限制了3D感知研究。
- 方法要点：基于时间几何一致性，融合文本和2D视觉模型线索，通过迭代更新实现几何-语义一致性。
- 实验或效果：在三个数据集上验证，优于现有伪标签方法，提升深度预测精度达51.5%和22.0% MAE。
