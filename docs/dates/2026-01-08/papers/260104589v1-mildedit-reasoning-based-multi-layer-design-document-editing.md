...
**关键词**：多图层文档编辑, 图层感知推理, 强化学习训练, 多模态推理器, 设计文档基准

## 3 点简述
- 核心问题：现有方法忽视多图层设计文档编辑，缺乏图层感知推理能力，导致无法准确定位和协调修改
- 方法要点：结合强化学习训练的多模态推理器进行图层级理解，与图像编辑器协同实现针对性修改
- 实验或效果：在MiLDEBench基准上，MiLDEAgent显著优于开源基线，性能接近闭源模型，建立了首个强基线
