...
**一句话要点**：提出基于照明角谱编码的方法，以控制衍射网络实现多任务全光计算。

**关键词**：衍射神经网络, 全光计算, 多任务控制, 角谱编码, 图像翻译

## 3 点简述
- 核心问题：衍射神经网络通常针对单一任务训练，限制了多任务系统的应用潜力。
- 方法要点：通过振幅掩模选择性控制照明角谱，作为任务编码器，实现不同网络功能。
- 实验或效果：训练单一网络执行多种图像到图像翻译任务，如手写数字转换为不同值的印刷数字。
