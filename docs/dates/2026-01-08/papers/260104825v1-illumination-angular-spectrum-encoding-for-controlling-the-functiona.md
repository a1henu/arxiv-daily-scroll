...
**一句话要点**：提出基于照明角谱编码的方法以控制衍射网络的多功能光学计算

**关键词**：衍射神经网络, 光学计算, 角谱编码, 多任务控制, 图像翻译

## 3 点简述
- 核心问题：衍射神经网络通常仅针对单一任务训练，限制了其在需要多功能系统中的应用。
- 方法要点：通过振幅掩模选择性控制照明角谱，作为任务编码器，实现单网络的多功能控制。
- 实验或效果：数值模拟展示了单网络执行多种图像到图像翻译任务，如手写数字转换为不同值的印刷数字。
