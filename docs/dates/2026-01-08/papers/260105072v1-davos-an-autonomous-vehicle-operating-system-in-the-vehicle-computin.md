...
**arXiv**：[2601.05072v1](https://arxiv.org/abs/2601.05072) · [PDF](https://arxiv.org/pdf/2601.05072.pdf)  
**作者**：Yuxin Wang, Yuankai He, Boyang Tian, Lichen Xian, Weisong Shi  

**一句话要点**：提出DAVOS统一车辆操作系统架构，以支持车辆计算时代的实时自主驾驶与数据服务。

**关键词**：车辆操作系统, 实时自主驾驶, 数据服务, 系统架构, 车辆计算

## 3 点简述
- 核心问题：现有车辆操作系统碎片化，难以协调实时驾驶与数据服务，缺乏SSEE（安全、安全、效率、可扩展性）统一支持。
- 方法要点：设计DAVOS作为统一操作系统架构，在单一框架内整合实时自主驾驶与可扩展车辆计算。
- 实验或效果：未知，论文未提供具体实验或效果细节。
