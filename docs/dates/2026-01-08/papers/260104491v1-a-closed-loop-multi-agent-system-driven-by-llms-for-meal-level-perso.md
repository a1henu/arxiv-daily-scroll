...
**arXiv**：[2601.04491v1](https://arxiv.org/abs/2601.04491) · [PDF](https://arxiv.org/pdf/2601.04491.pdf)  
**作者**：Muqing Xu  

**一句话要点**：提出基于LLM的多智能体闭环系统，用于餐级个性化营养管理，结合图像记录与智能控制。

**关键词**：个性化营养管理, 多智能体系统, 大语言模型驱动, 图像营养估计, 闭环控制, 餐级推荐

## 3 点简述
- 核心问题：现有营养管理系统通常分离食物记录、营养分析和推荐，缺乏餐级闭环支持。
- 方法要点：系统整合视觉、对话和状态管理智能体，通过照片估计营养并更新每日摄入预算，自适应调整餐计划。
- 实验或效果：在SNAPMe餐图像和模拟用户实验中，展示竞争性营养估计、个性化菜单和高效任务规划。
