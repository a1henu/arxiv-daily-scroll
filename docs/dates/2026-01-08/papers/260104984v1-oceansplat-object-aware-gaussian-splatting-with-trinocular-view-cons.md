...
**一句话要点**：提出OceanSplat，基于三目视图一致性和深度正则化，优化水下场景的3D高斯泼溅重建。

**关键词**：水下场景重建, 3D高斯泼溅, 视图一致性, 深度正则化, 散射介质

## 3 点简述
- 核心问题：水下光学退化导致多视图不一致，影响3D几何重建精度。
- 方法要点：通过三目视图一致性约束和合成极线深度先验，自监督优化3D高斯空间分布。
- 实验或效果：在真实和模拟水下场景中，显著减少漂浮伪影，提升重建和恢复性能。
