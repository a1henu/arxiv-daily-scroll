...
**arXiv**：[2511.05311v1](https://arxiv.org/abs/2511.05311) · [PDF](https://arxiv.org/pdf/2511.05311.pdf)  
**作者**：Valeriu Dimidov, Faisal Hawlader, Sasan Jafarnejad, Raphaël Frank  

**一句话要点**：提出LLM代理清理维护日志以改进汽车预测性维护

**关键词**：预测性维护, 大语言模型, 日志清理, 汽车行业, 机器学习模型, 数据噪声处理
