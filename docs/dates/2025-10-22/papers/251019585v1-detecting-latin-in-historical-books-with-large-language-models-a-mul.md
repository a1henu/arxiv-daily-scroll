...
**arXiv**：[2510.19585v1](https://arxiv.org/abs/2510.19585) · [PDF](https://arxiv.org/pdf/2510.19585.pdf)  
**作者**：Yu Wu, Ke Shu, Jonas Fischer, Lidia Pivovarova, David Rosson, Eetu Mäkelä, Mikko Tolonen  

**一句话要点**：提出基于大语言模型的拉丁语检测方法，以解决历史书籍中混合语言片段提取问题。

**关键词**：拉丁语检测, 大语言模型, 多模态基准, 历史文档分析, 混合语言处理
