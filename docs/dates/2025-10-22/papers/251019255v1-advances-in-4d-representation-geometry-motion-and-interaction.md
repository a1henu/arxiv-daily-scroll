...
**arXiv**：[2510.19255v1](https://arxiv.org/abs/2510.19255) · [PDF](https://arxiv.org/pdf/2510.19255.pdf)  
**作者**：Mingrui Zhao, Sauradip Nag, Kai Wang, Aditya Vora, Guangda Ji, Peter Chun, Ali Mahdavi-Amiri, Hao Zhang  

**一句话要点**：综述4D表示方法，指导选择与定制以处理几何、运动和交互问题

**关键词**：4D表示, 神经场, 几何建模, 运动分析, 交互建模, 生成式AI
