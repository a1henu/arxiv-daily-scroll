...
**arXiv**：[2510.19695v1](https://arxiv.org/abs/2510.19695) · [PDF](https://arxiv.org/pdf/2510.19695.pdf)  
**作者**：Rashik Shadman, M G Sarwar Murshed, Faraz Hussain  

**一句话要点**：提出Ensemble-CAM以增强基于深度学习的面部呈现攻击检测系统的可解释性

**关键词**：面部呈现攻击检测, 可解释人工智能, 视觉解释, 深度学习模型, Ensemble-CAM
...
> Presentation attacks represent a critical security threat where adversaries
