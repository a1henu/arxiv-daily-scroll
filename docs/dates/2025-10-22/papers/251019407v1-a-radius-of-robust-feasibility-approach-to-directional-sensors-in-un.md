...
**arXiv**：[2510.19407v1](https://arxiv.org/abs/2510.19407) · [PDF](https://arxiv.org/pdf/2510.19407.pdf)  
**作者**：Vanshika Datta, C. Nahak  

**一句话要点**：提出半径稳健可行性方法以增强不确定地形中定向传感器网络的覆盖

**关键词**：定向传感器网络, 半径稳健可行性, 分布式贪婪算法, 传感器覆盖优化, 不确定性处理
...
> A sensor has the ability to probe its surroundings. However, uncertainties in
