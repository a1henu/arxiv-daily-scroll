...
**arXiv**：[2510.19282v1](https://arxiv.org/abs/2510.19282) · [PDF](https://arxiv.org/pdf/2510.19282.pdf)  
**作者**：Safa Ben Atitallah, Maha Driss, Wadii Boulila, Anis Koubaa  

**一句话要点**：提出基于原型网络和集成学习的少样本学习方法以增强早期阿尔茨海默病检测

**关键词**：阿尔茨海默病检测, 少样本学习, 集成学习, 原型网络, 卷积神经网络, 医学图像分析
...
> Alzheimer disease is a severe brain disorder that causes harm in various
