...
**arXiv**：[2510.19182v1](https://arxiv.org/abs/2510.19182) · [PDF](https://arxiv.org/pdf/2510.19182.pdf)  
**作者**：Warisa Nusrat, Mostafijur Rahman, Ayatullah Faruk Mollah  

**一句话要点**：应用XceptionNet等深度网络实现疟疾血细胞图像自动检测，准确率达97.55%。

**关键词**：疟疾检测, 血细胞图像, XceptionNet, 残差注意力网络, 深度学习, 自动诊断
